...
-   Don't request alt text for elements hidden from assistive technologies
...
-   `noExcessiveNestedTestSuites`: Fix another edge case where the rule would
    alert on heavily nested zod schemas. Contributed by @dyc3
