...
impl ActionCategory {
	...
	pub fn to_str(&self) -> Cow<'static, str> {
		match self {
			...
			ActionCategory::Source(SourceActionKind::Other(tag)) => Cow::Owned(format!("source.biome.{tag}")),

			ActionCategory::Other(other_action) => match other_action {
				OtherActionCategory::InlineSuppression => Cow::Borrowed("quickfix.suppressRule.inline.biome"),
				OtherActionCategory::ToplevelSuppression => Cow::Borrowed("quickfix.suppressRule.topLevel.biome"),
