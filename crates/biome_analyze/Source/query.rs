...
/// Trait implemented for types that lint rules can query in order to emit
/// diagnostics or code actions.
pub trait Queryable: Sized {
	...
	/// this method
	fn key() -> QueryKey<Self::Language> { QueryKey::TypeId(TypeId::of::<Self::Input>()) }
...
/// This trait is implemented on all types that supports the registration of
/// [Visitor]
