	...
	T: AstNode,
{
	...
	where
		N: AstNode<Language = Self::Language>,
		Self: Sized, {
		// Lookup the first token of `prev_node` and `next_node`, and transfer the
		// leading trivia of the former to the later
		...
		// Lookup the last token of `prev_node` and `next_node`, and transfer the
		// trailing trivia of the former to the later
