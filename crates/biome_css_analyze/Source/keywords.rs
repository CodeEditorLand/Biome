...
pub const LEVEL_ONE_AND_TWO_PSEUDO_ELEMENTS: [&str; 5] = ["after", "before", "first-letter", "first-line", "slotted"];
...
pub const RESOURCE_STATE_PSEUDO_CLASSES: [&str; 7] =
	["buffering", "muted", "paused", "playing", "seeking", "stalled", "volume-locked"];
