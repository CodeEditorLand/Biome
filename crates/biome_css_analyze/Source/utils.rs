...
pub fn is_css_variable(value:&str) -> bool { value.to_lowercase_cow().starts_with("var(") }
...
pub fn is_page_pseudo_class(prop:&str) -> bool { AT_RULE_PAGE_PSEUDO_CLASSES.contains(&prop) }
