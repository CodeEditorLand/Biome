...
pub(crate) fn migrate_eslint_any_rule(
	...
	match eslint_name {
		...
		"@next/google-font-display" => {
			...
			let rule = group.use_google_font_display.get_or_insert(Default::default());
		...
		"@next/google-font-preconnect" => {
			...
			let rule = group.use_google_font_preconnect.get_or_insert(Default::default());
		...
		"@next/no-document-import-in-page" => {
			...
			let rule = group.no_document_import_in_page.get_or_insert(Default::default());
		...
		"@next/no-head-import-in-document" => {
			...
			let rule = group.no_head_import_in_document.get_or_insert(Default::default());
		...
		"@stylistic/jsx-self-closing-comp" => {
			...
			let rule = group.use_self_closing_elements.get_or_insert(Default::default());
		...
		"@typescript-eslint/adjacent-overload-signatures" => {
			...
			let rule = group.use_adjacent_overload_signatures.get_or_insert(Default::default());
		...
		"@typescript-eslint/array-type" => {
			...
			let rule = group.use_consistent_array_type.get_or_insert(Default::default());
		...
		"@typescript-eslint/default-param-last" => {
			...
			let rule = group.use_default_parameter_last.get_or_insert(Default::default());
		...
		"@typescript-eslint/explicit-member-accessibility" => {
			...
			let rule = group.use_consistent_member_accessibility.get_or_insert(Default::default());
		...
		"@typescript-eslint/naming-convention" => {
			...
			let rule = group.use_naming_convention.get_or_insert(Default::default());
		...
		"@typescript-eslint/no-dupe-class-members" => {
			...
			let rule = group.no_duplicate_class_members.get_or_insert(Default::default());
		...
		"@typescript-eslint/no-empty-function" => {
			...
			let rule = group.no_empty_block_statements.get_or_insert(Default::default());
		...
		"@typescript-eslint/no-extra-non-null-assertion" => {
			...
			let rule = group.no_extra_non_null_assertion.get_or_insert(Default::default());
		...
		"@typescript-eslint/no-invalid-void-type" => {
			...
			let rule = group.no_confusing_void_type.get_or_insert(Default::default());
		...
		"@typescript-eslint/no-misused-new" => {
			...
			let rule = group.no_misleading_instantiator.get_or_insert(Default::default());
		...
		"@typescript-eslint/no-non-null-assertion" => {
			...
			let rule = group.no_non_null_assertion.get_or_insert(Default::default());
		...
		"@typescript-eslint/no-restricted-imports" => {
			...
			let rule = group.no_restricted_imports.get_or_insert(Default::default());
		...
		"@typescript-eslint/no-this-alias" => {
			...
			let rule = group.no_useless_this_alias.get_or_insert(Default::default());
		...
		"@typescript-eslint/no-unnecessary-type-constraint" => {
			...
			let rule = group.no_useless_type_constraint.get_or_insert(Default::default());
		...
		"@typescript-eslint/no-unsafe-declaration-merging" => {
			...
			let rule = group.no_unsafe_declaration_merging.get_or_insert(Default::default());
		...
		"@typescript-eslint/no-use-before-define" => {
			...
			let rule = group.no_invalid_use_before_declaration.get_or_insert(Default::default());
		...
		"@typescript-eslint/no-useless-constructor" => {
			...
			let rule = group.no_useless_constructor.get_or_insert(Default::default());
		...
		"@typescript-eslint/no-useless-empty-export" => {
			...
			let rule = group.no_useless_empty_export.get_or_insert(Default::default());
		...
		"@typescript-eslint/parameter-properties" => {
			...
			let rule = group.no_parameter_properties.get_or_insert(Default::default());
		...
		"@typescript-eslint/prefer-as-const" => {
			...
			let rule = group.use_as_const_assertion.get_or_insert(Default::default());
		...
		"@typescript-eslint/prefer-enum-initializers" => {
			...
			let rule = group.use_enum_initializers.get_or_insert(Default::default());
		...
		"@typescript-eslint/prefer-function-type" => {
			...
			let rule = group.use_shorthand_function_type.get_or_insert(Default::default());
		...
		"@typescript-eslint/prefer-literal-enum-member" => {
			...
			let rule = group.use_literal_enum_members.get_or_insert(Default::default());
		...
		"@typescript-eslint/prefer-namespace-keyword" => {
			...
			let rule = group.use_namespace_keyword.get_or_insert(Default::default());
		...
		"constructor-super" => {
			...
			let rule = group.no_invalid_constructor_super.get_or_insert(Default::default());
		...
		"default-case" => {
			...
			let rule = group.use_default_switch_clause.get_or_insert(Default::default());
		...
		"default-case-last" => {
			...
			let rule = group.use_default_switch_clause_last.get_or_insert(Default::default());
		...
		"for-direction" => {
			...
			let rule = group.use_valid_for_direction.get_or_insert(Default::default());
		...
		"import-access/eslint-plugin-import-access" => {
			...
			let rule = group.use_import_restrictions.get_or_insert(Default::default());
		...
		"import/no-extraneous-dependencies" => {
			...
			let rule = group.no_undeclared_dependencies.get_or_insert(Default::default());
		...
		"jest/max-nested-describe" => {
			...
			let rule = group.no_excessive_nested_test_suites.get_or_insert(Default::default());
		...
		"jest/no-duplicate-hooks" => {
			...
			let rule = group.no_duplicate_test_hooks.get_or_insert(Default::default());
		...
		"jest/no-standalone-expect" => {
			...
			let rule = group.no_misplaced_assertion.get_or_insert(Default::default());
		...
		"jsx-a11y/aria-activedescendant-has-tabindex" => {
			...
			let rule = group.use_aria_activedescendant_with_tabindex.get_or_insert(Default::default());
		...
		"jsx-a11y/aria-proptypes" => {
			...
			let rule = group.use_valid_aria_values.get_or_insert(Default::default());
		...
		"jsx-a11y/aria-unsupported-elements" => {
			...
			let rule = group.no_aria_unsupported_elements.get_or_insert(Default::default());
		...
		"jsx-a11y/autocomplete-valid" => {
			...
			let rule = group.use_valid_autocomplete.get_or_insert(Default::default());
		...
		"jsx-a11y/click-events-have-key-events" => {
			...
			let rule = group.use_key_with_click_events.get_or_insert(Default::default());
		...
		"jsx-a11y/interactive-supports-focus" => {
			...
			let rule = group.use_focusable_interactive.get_or_insert(Default::default());
		...
		"jsx-a11y/label-has-associated-control" => {
			...
			let rule = group.no_label_without_control.get_or_insert(Default::default());
		...
		"jsx-a11y/mouse-events-have-key-events" => {
			...
			let rule = group.use_key_with_mouse_events.get_or_insert(Default::default());
		...
		"jsx-a11y/no-aria-hidden-on-focusable" => {
			...
			let rule = group.no_aria_hidden_on_focusable.get_or_insert(Default::default());
		...
		"jsx-a11y/no-distracting-elements" => {
			...
			let rule = group.no_distracting_elements.get_or_insert(Default::default());
		...
		"jsx-a11y/no-noninteractive-tabindex" => {
			...
			let rule = group.no_noninteractive_tabindex.get_or_insert(Default::default());
		...
		"jsx-a11y/no-static-element-interactions" => {
			...
			let rule = group.no_static_element_interactions.get_or_insert(Default::default());
		...
		"jsx-a11y/prefer-tag-over-role" => {
			...
			let rule = group.use_semantic_elements.get_or_insert(Default::default());
		...
		"jsx-a11y/role-has-required-aria-props" => {
			...
			let rule = group.use_aria_props_for_role.get_or_insert(Default::default());
		...
		"jsx-a11y/role-supports-aria-props" => {
			...
			let rule = group.use_aria_props_supported_by_role.get_or_insert(Default::default());
		...
		"no-async-promise-executor" => {
			...
			let rule = group.no_async_promise_executor.get_or_insert(Default::default());
		...
		"no-case-declarations" => {
			...
			let rule = group.no_switch_declarations.get_or_insert(Default::default());
		...
		"no-cond-assign" => {
			...
			let rule = group.no_assign_in_expressions.get_or_insert(Default::default());
		...
		"no-constant-condition" => {
			...
			let rule = group.no_constant_condition.get_or_insert(Default::default());
		...
		"no-constructor-return" => {
			...
			let rule = group.no_constructor_return.get_or_insert(Default::default());
		...
		"no-control-regex" => {
			...
			let rule = group.no_control_characters_in_regex.get_or_insert(Default::default());
		...
		"no-dupe-args" => {
			...
			let rule = group.no_duplicate_parameters.get_or_insert(Default::default());
		...
		"no-dupe-keys" => {
			...
			let rule = group.no_duplicate_object_keys.get_or_insert(Default::default());
		...
		"no-empty-character-class" => {
			...
			let rule = group.no_empty_character_class_in_regex.get_or_insert(Default::default());
		...
		"no-extra-boolean-cast" => {
			...
			let rule = group.no_extra_boolean_cast.get_or_insert(Default::default());
		...
		"no-fallthrough" => {
			...
			let rule = group.no_fallthrough_switch_clause.get_or_insert(Default::default());
		...
		"no-inner-declarations" => {
			...
			let rule = group.no_inner_declarations.get_or_insert(Default::default());
		...
		"no-irregular-whitespace" => {
			...
			let rule = group.no_irregular_whitespace.get_or_insert(Default::default());
		...
		"no-lone-blocks" => {
			...
			let rule = group.no_useless_lone_block_statements.get_or_insert(Default::default());
		...
		"no-lonely-if" => {
			...
			let rule = group.use_collapsed_else_if.get_or_insert(Default::default());
		...
		"no-misleading-character-class" => {
			...
			let rule = group.no_misleading_character_class.get_or_insert(Default::default());
		...
		"no-new-native-nonconstructor" => {
			...
			let rule = group.no_invalid_builtin_instantiation.get_or_insert(Default::default());
		...
		"no-new-wrappers" => {
			...
			let rule = group.use_consistent_builtin_instantiation.get_or_insert(Default::default());
		...
		"no-nonoctal-decimal-escape" => {
			...
			let rule = group.no_nonoctal_decimal_escape.get_or_insert(Default::default());
		...
		"no-obj-calls" => {
			...
			let rule = group.no_global_object_calls.get_or_insert(Default::default());
		...
		"no-prototype-builtins" => {
			...
			let rule = group.no_prototype_builtins.get_or_insert(Default::default());
		...
		"no-restricted-globals" => {
			...
			let rule = group.no_restricted_globals.get_or_insert(Default::default());
		...
		"no-shadow-restricted-names" => {
			...
			let rule = group.no_shadow_restricted_names.get_or_insert(Default::default());
		...
		"no-template-curly-in-string" => {
			...
			let rule = group.no_template_curly_in_string.get_or_insert(Default::default());
		...
		"no-undef" => {
			...
			let rule = group.no_undeclared_variables.get_or_insert(Default::default());
		...
		"no-undef-init" => {
			...
			let rule = group.no_useless_undefined_initialization.get_or_insert(Default::default());
		...
		"no-unsafe-optional-chaining" => {
			...
			let rule = group.no_unsafe_optional_chaining.get_or_insert(Default::default());
		...
		"no-unused-private-class-members" => {
			...
			let rule = group.no_unused_private_class_members.get_or_insert(Default::default());
		...
		"no-useless-concat" => {
			...
			let rule = group.no_useless_string_concat.get_or_insert(Default::default());
		...
		"no-useless-escape" => {
			...
			let rule = group.no_useless_escape_in_regex.get_or_insert(Default::default());
		...
		"one-var" => {
			...
			let rule = group.use_single_var_declarator.get_or_insert(Default::default());
		...
		"prefer-exponentiation-operator" => {
			...
			let rule = group.use_exponentiation_operator.get_or_insert(Default::default());
		...
		"react-hooks/exhaustive-deps" => {
			...
			let rule = group.use_exhaustive_dependencies.get_or_insert(Default::default());
		...
		"react-hooks/rules-of-hooks" => {
			...
			let rule = group.use_hook_at_top_level.get_or_insert(Default::default());
		...
		"react-refresh/only-export-components" => {
			...
			let rule = group.use_component_export_only_modules.get_or_insert(Default::default());
		...
		"react/jsx-curly-brace-presence" => {
			...
			let rule = group.use_consistent_curly_braces.get_or_insert(Default::default());
		...
		"react/jsx-key" => {
			...
			let rule = group.use_jsx_key_in_iterable.get_or_insert(Default::default());
		...
		"react/jsx-no-duplicate-props" => {
			...
			let rule = group.no_duplicate_jsx_props.get_or_insert(Default::default());
		...
		"react/no-danger" => {
			...
			let rule = group.no_dangerously_set_inner_html.get_or_insert(Default::default());
		...
		"react/void-dom-elements-no-children" => {
			...
			let rule = group.no_void_elements_with_children.get_or_insert(Default::default());
		...
		"solidjs/no-react-specific-props" => {
			...
			let rule = group.no_react_specific_props.get_or_insert(Default::default());
		...
		"sonarjs/cognitive-complexity" => {
			...
			let rule = group.no_excessive_cognitive_complexity.get_or_insert(Default::default());
		...
		"unicorn/explicit-length-check" => {
			...
			let rule = group.use_explicit_length_check.get_or_insert(Default::default());
		...
		"unicorn/filename-case" => {
			...
			let rule = group.use_filenaming_convention.get_or_insert(Default::default());
		...
		"unicorn/no-useless-switch-case" => {
			...
			let rule = group.no_useless_switch_case.get_or_insert(Default::default());
		...
		"unicorn/prefer-module" => {
			...
			let rule = group.no_global_dirname_filename.get_or_insert(Default::default());
		...
		"unicorn/prefer-node-protocol" => {
			...
			let rule = group.use_nodejs_import_protocol.get_or_insert(Default::default());
		...
		"unicorn/require-number-to-fixed-digits-argument" => {
			...
			let rule = group.use_number_to_fixed_digits_argument.get_or_insert(Default::default());
