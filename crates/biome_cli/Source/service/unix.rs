...
/// Try to connect to the global socket and wait for the connection to become
/// ready
...
pub(crate) async fn ensure_daemon(
	...
	Err(last_error.unwrap_or_else(|| io::Error::new(io::ErrorKind::Other, "could not connect to the daemon socket")))
}
