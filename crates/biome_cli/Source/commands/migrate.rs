...
use biome_service::{
	...
	workspace::RegisterProjectFolderParams,
};
...
use crate::{
	...
	execute::{execute_mode, Execution, TraversalMode},
...
pub(crate) fn migrate(
	...
	let LoadedConfiguration { configuration: _, diagnostics: _, directory_path, file_path } =
