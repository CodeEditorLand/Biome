...
use crate::{
	...
	GritLanguage as Language,
	GritSyntaxElement as SyntaxElement,
	GritSyntaxElementChildren as SyntaxElementChildren,
	GritSyntaxKind::{self as SyntaxKind, *},
	GritSyntaxList as SyntaxList,
	GritSyntaxNode as SyntaxNode,
...
impl GritAnnotation {
	...
	pub fn as_fields(&self) -> GritAnnotationFields {
		GritAnnotationFields { value_token:self.value_token() }
	}
...
impl GritBacktickSnippetLiteral {
	...
	pub fn as_fields(&self) -> GritBacktickSnippetLiteralFields {
		GritBacktickSnippetLiteralFields { value_token:self.value_token() }
	}
...
impl GritBooleanLiteral {
	...
	pub fn as_fields(&self) -> GritBooleanLiteralFields {
		GritBooleanLiteralFields { value:self.value() }
	}
...
impl GritBubble {
	...
	pub fn variables(&self) -> Option<GritBubbleScope> { support::node(&self.syntax, 1usize) }
...
impl GritBubbleScope {
	...
	pub fn variables(&self) -> GritVariableList { support::list(&self.syntax, 1usize) }
...
impl GritCodeSnippet {
	...
	pub fn as_fields(&self) -> GritCodeSnippetFields {
		GritCodeSnippetFields { source:self.source() }
	}
...
impl GritCurlyPredicateList {
	...
	pub fn predicates(&self) -> GritPredicateList { support::list(&self.syntax, 1usize) }
...
impl GritDot {
	...
	pub fn as_fields(&self) -> GritDotFields { GritDotFields { dot_token:self.dot_token() } }
...
impl GritDotdotdot {
	...
	pub fn as_fields(&self) -> GritDotdotdotFields {
		GritDotdotdotFields { dotdotdot_token:self.dotdotdot_token(), pattern:self.pattern() }
	}
...
impl GritDoubleLiteral {
	...
	pub fn as_fields(&self) -> GritDoubleLiteralFields {
		GritDoubleLiteralFields { value_token:self.value_token() }
	}
...
impl GritEvery {
	...
	pub fn as_fields(&self) -> GritEveryFields {
		GritEveryFields { every_token:self.every_token(), pattern:self.pattern() }
	}
...
impl GritFiles {
	...
	pub fn files(&self) -> GritPatternList { support::list(&self.syntax, 2usize) }
...
impl GritFunctionDefinition {
	...
	pub fn name(&self) -> SyntaxResult<GritName> { support::required_node(&self.syntax, 1usize) }

	pub fn l_paren_token(&self) -> SyntaxResult<SyntaxToken> {
		support::required_token(&self.syntax, 2usize)
	}

	pub fn args(&self) -> GritVariableList { support::list(&self.syntax, 3usize) }
...
impl GritIntLiteral {
	...
	pub fn as_fields(&self) -> GritIntLiteralFields {
		GritIntLiteralFields { value_token:self.value_token() }
	}
...
impl GritLanguageDeclaration {
	...
	pub fn flavor(&self) -> Option<GritLanguageFlavor> { support::node(&self.syntax, 2usize) }
...
impl GritLanguageFlavor {
	...
	pub fn flavors(&self) -> GritLanguageFlavorList { support::list(&self.syntax, 1usize) }
...
impl GritLanguageFlavorKind {
	...
	pub fn as_fields(&self) -> GritLanguageFlavorKindFields {
		GritLanguageFlavorKindFields { flavor_kind:self.flavor_kind() }
	}
...
impl GritLanguageName {
	...
	pub fn as_fields(&self) -> GritLanguageNameFields {
		GritLanguageNameFields { language_kind:self.language_kind() }
	}
...
impl GritLike {
	...
	pub fn threshold(&self) -> Option<GritLikeThreshold> { support::node(&self.syntax, 1usize) }
...
impl GritList {
	...
	pub fn name(&self) -> Option<GritName> { support::node(&self.syntax, 0usize) }

	pub fn l_brack_token(&self) -> SyntaxResult<SyntaxToken> {
		support::required_token(&self.syntax, 1usize)
	}

	pub fn patterns(&self) -> GritListPatternList { support::list(&self.syntax, 2usize) }
...
impl GritMap {
	...
	pub fn elements(&self) -> GritMapElementList { support::list(&self.syntax, 1usize) }
...
impl GritMapAccessor {
	...
	pub fn as_fields(&self) -> GritMapAccessorFields {
		GritMapAccessorFields { map:self.map(), dot_token:self.dot_token(), key:self.key() }
	}
...
impl GritMapElement {
	...
	pub fn as_fields(&self) -> GritMapElementFields {
		GritMapElementFields { key:self.key(), colon_token:self.colon_token(), value:self.value() }
	}

	pub fn key(&self) -> SyntaxResult<GritName> { support::required_node(&self.syntax, 0usize) }
...
impl GritName {
	...
	pub fn as_fields(&self) -> GritNameFields { GritNameFields { value_token:self.value_token() } }
...
impl GritNamedArg {
	...
	pub fn as_fields(&self) -> GritNamedArgFields {
		GritNamedArgFields { name:self.name(), eq_token:self.eq_token(), pattern:self.pattern() }
	}

	pub fn name(&self) -> SyntaxResult<GritName> { support::required_node(&self.syntax, 0usize) }
...
impl GritNegativeIntLiteral {
	...
	pub fn as_fields(&self) -> GritNegativeIntLiteralFields {
		GritNegativeIntLiteralFields { value_token:self.value_token() }
	}
...
impl GritNodeLike {
	...
	pub fn named_args(&self) -> GritNamedArgList { support::list(&self.syntax, 2usize) }
...
impl GritNot {
	...
	pub fn as_fields(&self) -> GritNotFields { GritNotFields { token:self.token() } }
...
impl GritPatternAfter {
	...
	pub fn as_fields(&self) -> GritPatternAfterFields {
		GritPatternAfterFields { after_token:self.after_token(), pattern:self.pattern() }
	}
...
impl GritPatternAnd {
	...
	pub fn patterns(&self) -> GritPatternList { support::list(&self.syntax, 2usize) }
...
impl GritPatternArgList {
	...
	pub fn as_fields(&self) -> GritPatternArgListFields {
		GritPatternArgListFields { grit_variable_list:self.grit_variable_list() }
	}

	pub fn grit_variable_list(&self) -> GritVariableList { support::list(&self.syntax, 0usize) }
}
...
impl GritPatternBefore {
	...
	pub fn as_fields(&self) -> GritPatternBeforeFields {
		GritPatternBeforeFields { before_token:self.before_token(), pattern:self.pattern() }
	}
...
impl GritPatternContainsUntilClause {
	...
	pub fn as_fields(&self) -> GritPatternContainsUntilClauseFields {
		GritPatternContainsUntilClauseFields { until_token:self.until_token(), until:self.until() }
	}
...
impl GritPatternDefinition {
	...
	pub fn visibility_token(&self) -> Option<SyntaxToken> { support::token(&self.syntax, 0usize) }

	pub fn pattern_token(&self) -> SyntaxResult<SyntaxToken> {
		support::required_token(&self.syntax, 1usize)
	}

	pub fn name(&self) -> SyntaxResult<GritName> { support::required_node(&self.syntax, 2usize) }

	pub fn l_paren_token(&self) -> SyntaxResult<SyntaxToken> {
		support::required_token(&self.syntax, 3usize)
	}

	pub fn args(&self) -> SyntaxResult<GritPatternArgList> {
...
impl GritPatternDefinitionBody {
	...
	pub fn patterns(&self) -> GritPatternList { support::list(&self.syntax, 1usize) }
...
impl GritPatternIncludes {
	...
	pub fn as_fields(&self) -> GritPatternIncludesFields {
		GritPatternIncludesFields { includes_token:self.includes_token(), includes:self.includes() }
	}
...
impl GritPatternMaybe {
	...
	pub fn as_fields(&self) -> GritPatternMaybeFields {
		GritPatternMaybeFields { maybe_token:self.maybe_token(), pattern:self.pattern() }
	}
...
impl GritPatternNot {
	...
	pub fn as_fields(&self) -> GritPatternNotFields {
		GritPatternNotFields { not:self.not(), pattern:self.pattern() }
	}

	pub fn not(&self) -> SyntaxResult<GritNot> { support::required_node(&self.syntax, 0usize) }
...
impl GritPredicateAnd {
	...
	pub fn and_token(&self) -> Option<SyntaxToken> { support::token(&self.syntax, 0usize) }

	pub fn l_curly_token(&self) -> SyntaxResult<SyntaxToken> {
		support::required_token(&self.syntax, 1usize)
	}

	pub fn predicates(&self) -> GritPredicateList { support::list(&self.syntax, 2usize) }
...
impl GritPredicateMaybe {
	...
	pub fn as_fields(&self) -> GritPredicateMaybeFields {
		GritPredicateMaybeFields { maybe_token:self.maybe_token(), predicate:self.predicate() }
	}
...
impl GritPredicateNot {
	...
	pub fn as_fields(&self) -> GritPredicateNotFields {
		GritPredicateNotFields { not:self.not(), predicate:self.predicate() }
	}
...
impl GritPredicateReturn {
	...
	pub fn as_fields(&self) -> GritPredicateReturnFields {
		GritPredicateReturnFields { return_token:self.return_token(), pattern:self.pattern() }
	}
...
impl GritPredicateRewrite {
	...
	pub fn annotation(&self) -> Option<GritAnnotation> { support::node(&self.syntax, 1usize) }
...
impl GritRawBacktickSnippetLiteral {
	...
	pub fn as_fields(&self) -> GritRawBacktickSnippetLiteralFields {
		GritRawBacktickSnippetLiteralFields { value_token:self.value_token() }
	}
...
impl GritRegexLiteral {
	...
	pub fn as_fields(&self) -> GritRegexLiteralFields {
		GritRegexLiteralFields { value_token:self.value_token() }
	}
...
impl GritRegexPattern {
	...
	pub fn as_fields(&self) -> GritRegexPatternFields {
		GritRegexPatternFields { regex:self.regex(), variables:self.variables() }
	}
...
impl GritRoot {
	...
	pub fn version(&self) -> Option<AnyGritVersion> { support::node(&self.syntax, 1usize) }

	pub fn language(&self) -> Option<AnyGritLanguageDeclaration> {
		support::node(&self.syntax, 2usize)
	}

	pub fn definitions(&self) -> GritDefinitionList { support::list(&self.syntax, 3usize) }
...
impl GritSequential {
	...
	pub fn sequential(&self) -> GritPatternList { support::list(&self.syntax, 2usize) }
...
impl GritSnippetRegexLiteral {
	...
	pub fn as_fields(&self) -> GritSnippetRegexLiteralFields {
		GritSnippetRegexLiteralFields { value_token:self.value_token() }
	}
...
impl GritSome {
	...
	pub fn as_fields(&self) -> GritSomeFields {
		GritSomeFields { some_token:self.some_token(), pattern:self.pattern() }
	}
...
impl GritStringLiteral {
	...
	pub fn as_fields(&self) -> GritStringLiteralFields {
		GritStringLiteralFields { value_token:self.value_token() }
	}
...
impl GritUndefinedLiteral {
	...
	pub fn as_fields(&self) -> GritUndefinedLiteralFields {
		GritUndefinedLiteralFields { token_token:self.token_token() }
	}
...
impl GritUnderscore {
	...
	pub fn as_fields(&self) -> GritUnderscoreFields {
		GritUnderscoreFields { token_token:self.token_token() }
	}
...
impl GritVariable {
	...
	pub fn as_fields(&self) -> GritVariableFields {
		GritVariableFields { value_token:self.value_token() }
	}
...
impl GritWithin {
	...
	pub fn as_fields(&self) -> GritWithinFields {
		GritWithinFields { within_token:self.within_token(), pattern:self.pattern() }
	}
...
impl AstNode for GritAddOperation {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_ADD_OPERATION }
...
impl From<GritAddOperation> for SyntaxNode {
	fn from(n:GritAddOperation) -> SyntaxNode { n.syntax }
}
impl From<GritAddOperation> for SyntaxElement {
	fn from(n:GritAddOperation) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritAnnotation {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_ANNOTATION }
...
impl From<GritAnnotation> for SyntaxNode {
	fn from(n:GritAnnotation) -> SyntaxNode { n.syntax }
}
impl From<GritAnnotation> for SyntaxElement {
	fn from(n:GritAnnotation) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritAssignmentAsPattern {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_ASSIGNMENT_AS_PATTERN }
...
impl From<GritAssignmentAsPattern> for SyntaxNode {
	fn from(n:GritAssignmentAsPattern) -> SyntaxNode { n.syntax }
}
impl From<GritAssignmentAsPattern> for SyntaxElement {
	fn from(n:GritAssignmentAsPattern) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritBacktickSnippetLiteral {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_BACKTICK_SNIPPET_LITERAL }
...
impl From<GritBacktickSnippetLiteral> for SyntaxNode {
	fn from(n:GritBacktickSnippetLiteral) -> SyntaxNode { n.syntax }
}
impl From<GritBacktickSnippetLiteral> for SyntaxElement {
	fn from(n:GritBacktickSnippetLiteral) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritBooleanLiteral {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_BOOLEAN_LITERAL }
...
impl From<GritBooleanLiteral> for SyntaxNode {
	fn from(n:GritBooleanLiteral) -> SyntaxNode { n.syntax }
}
impl From<GritBooleanLiteral> for SyntaxElement {
	fn from(n:GritBooleanLiteral) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritBracketedPattern {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_BRACKETED_PATTERN }
...
impl From<GritBracketedPattern> for SyntaxNode {
	fn from(n:GritBracketedPattern) -> SyntaxNode { n.syntax }
}
impl From<GritBracketedPattern> for SyntaxElement {
	fn from(n:GritBracketedPattern) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritBracketedPredicate {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_BRACKETED_PREDICATE }
...
impl From<GritBracketedPredicate> for SyntaxNode {
	fn from(n:GritBracketedPredicate) -> SyntaxNode { n.syntax }
}
impl From<GritBracketedPredicate> for SyntaxElement {
	fn from(n:GritBracketedPredicate) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritBubble {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_BUBBLE }
...
impl std::fmt::Debug for GritBubble {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritBubble")
			.field("bubble_token", &support::DebugSyntaxResult(self.bubble_token()))
			.field("variables", &support::DebugOptionalElement(self.variables()))
			.field("pattern", &support::DebugSyntaxResult(self.pattern()))
			.finish()
	}
}
impl From<GritBubble> for SyntaxNode {
	fn from(n:GritBubble) -> SyntaxNode { n.syntax }
}
impl From<GritBubble> for SyntaxElement {
	fn from(n:GritBubble) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritBubbleScope {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_BUBBLE_SCOPE }
...
impl From<GritBubbleScope> for SyntaxNode {
	fn from(n:GritBubbleScope) -> SyntaxNode { n.syntax }
}
impl From<GritBubbleScope> for SyntaxElement {
	fn from(n:GritBubbleScope) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritCodeSnippet {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_CODE_SNIPPET }
...
impl From<GritCodeSnippet> for SyntaxNode {
	fn from(n:GritCodeSnippet) -> SyntaxNode { n.syntax }
}
impl From<GritCodeSnippet> for SyntaxElement {
	fn from(n:GritCodeSnippet) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritCurlyPattern {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_CURLY_PATTERN }
...
impl From<GritCurlyPattern> for SyntaxNode {
	fn from(n:GritCurlyPattern) -> SyntaxNode { n.syntax }
}
impl From<GritCurlyPattern> for SyntaxElement {
	fn from(n:GritCurlyPattern) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritCurlyPredicateList {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_CURLY_PREDICATE_LIST }
...
impl From<GritCurlyPredicateList> for SyntaxNode {
	fn from(n:GritCurlyPredicateList) -> SyntaxNode { n.syntax }
}
impl From<GritCurlyPredicateList> for SyntaxElement {
	fn from(n:GritCurlyPredicateList) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritDivOperation {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_DIV_OPERATION }
...
impl From<GritDivOperation> for SyntaxNode {
	fn from(n:GritDivOperation) -> SyntaxNode { n.syntax }
}
impl From<GritDivOperation> for SyntaxElement {
	fn from(n:GritDivOperation) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritDot {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_DOT }
...
impl From<GritDot> for SyntaxNode {
	fn from(n:GritDot) -> SyntaxNode { n.syntax }
}
impl From<GritDot> for SyntaxElement {
	fn from(n:GritDot) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritDotdotdot {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_DOTDOTDOT }
...
impl std::fmt::Debug for GritDotdotdot {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritDotdotdot")
			.field("dotdotdot_token", &support::DebugSyntaxResult(self.dotdotdot_token()))
			.field("pattern", &support::DebugOptionalElement(self.pattern()))
			.finish()
	}
}
impl From<GritDotdotdot> for SyntaxNode {
	fn from(n:GritDotdotdot) -> SyntaxNode { n.syntax }
}
impl From<GritDotdotdot> for SyntaxElement {
	fn from(n:GritDotdotdot) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritDoubleLiteral {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_DOUBLE_LITERAL }
...
impl From<GritDoubleLiteral> for SyntaxNode {
	fn from(n:GritDoubleLiteral) -> SyntaxNode { n.syntax }
}
impl From<GritDoubleLiteral> for SyntaxElement {
	fn from(n:GritDoubleLiteral) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritEvery {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_EVERY }
...
impl std::fmt::Debug for GritEvery {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritEvery")
			.field("every_token", &support::DebugSyntaxResult(self.every_token()))
			.field("pattern", &support::DebugSyntaxResult(self.pattern()))
			.finish()
	}
}
impl From<GritEvery> for SyntaxNode {
	fn from(n:GritEvery) -> SyntaxNode { n.syntax }
}
impl From<GritEvery> for SyntaxElement {
	fn from(n:GritEvery) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritFiles {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_FILES }
...
impl std::fmt::Debug for GritFiles {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritFiles")
			.field("multifile_token", &support::DebugSyntaxResult(self.multifile_token()))
			.field("l_curly_token", &support::DebugSyntaxResult(self.l_curly_token()))
...
impl From<GritFiles> for SyntaxNode {
	fn from(n:GritFiles) -> SyntaxNode { n.syntax }
}
impl From<GritFiles> for SyntaxElement {
	fn from(n:GritFiles) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritFunctionDefinition {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_FUNCTION_DEFINITION }
...
impl std::fmt::Debug for GritFunctionDefinition {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritFunctionDefinition")
			.field("function_token", &support::DebugSyntaxResult(self.function_token()))
...
impl From<GritFunctionDefinition> for SyntaxNode {
	fn from(n:GritFunctionDefinition) -> SyntaxNode { n.syntax }
}
impl From<GritFunctionDefinition> for SyntaxElement {
	fn from(n:GritFunctionDefinition) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritIntLiteral {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_INT_LITERAL }
...
impl From<GritIntLiteral> for SyntaxNode {
	fn from(n:GritIntLiteral) -> SyntaxNode { n.syntax }
}
impl From<GritIntLiteral> for SyntaxElement {
	fn from(n:GritIntLiteral) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritLanguageDeclaration {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_LANGUAGE_DECLARATION }
...
impl std::fmt::Debug for GritLanguageDeclaration {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritLanguageDeclaration")
			.field("language_token", &support::DebugSyntaxResult(self.language_token()))
			.field("name", &support::DebugSyntaxResult(self.name()))
...
impl From<GritLanguageDeclaration> for SyntaxNode {
	fn from(n:GritLanguageDeclaration) -> SyntaxNode { n.syntax }
}
impl From<GritLanguageDeclaration> for SyntaxElement {
	fn from(n:GritLanguageDeclaration) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritLanguageFlavor {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_LANGUAGE_FLAVOR }
...
impl From<GritLanguageFlavor> for SyntaxNode {
	fn from(n:GritLanguageFlavor) -> SyntaxNode { n.syntax }
}
impl From<GritLanguageFlavor> for SyntaxElement {
	fn from(n:GritLanguageFlavor) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritLanguageFlavorKind {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_LANGUAGE_FLAVOR_KIND }
...
impl std::fmt::Debug for GritLanguageFlavorKind {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritLanguageFlavorKind")
			.field("flavor_kind", &support::DebugSyntaxResult(self.flavor_kind()))
			.finish()
	}
}
impl From<GritLanguageFlavorKind> for SyntaxNode {
	fn from(n:GritLanguageFlavorKind) -> SyntaxNode { n.syntax }
}
impl From<GritLanguageFlavorKind> for SyntaxElement {
	fn from(n:GritLanguageFlavorKind) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritLanguageName {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_LANGUAGE_NAME }
...
impl std::fmt::Debug for GritLanguageName {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritLanguageName")
			.field("language_kind", &support::DebugSyntaxResult(self.language_kind()))
			.finish()
	}
}
impl From<GritLanguageName> for SyntaxNode {
	fn from(n:GritLanguageName) -> SyntaxNode { n.syntax }
}
impl From<GritLanguageName> for SyntaxElement {
	fn from(n:GritLanguageName) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritLanguageSpecificSnippet {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_LANGUAGE_SPECIFIC_SNIPPET }
...
impl std::fmt::Debug for GritLanguageSpecificSnippet {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritLanguageSpecificSnippet")
			...
			.field("snippet_token", &support::DebugSyntaxResult(self.snippet_token()))
			.finish()
	}
}
impl From<GritLanguageSpecificSnippet> for SyntaxNode {
	fn from(n:GritLanguageSpecificSnippet) -> SyntaxNode { n.syntax }
}
impl From<GritLanguageSpecificSnippet> for SyntaxElement {
	fn from(n:GritLanguageSpecificSnippet) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritLike {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_LIKE }
...
impl std::fmt::Debug for GritLike {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritLike")
			...
			.field("threshold", &support::DebugOptionalElement(self.threshold()))
			.field("l_curly_token", &support::DebugSyntaxResult(self.l_curly_token()))
...
impl From<GritLike> for SyntaxNode {
	fn from(n:GritLike) -> SyntaxNode { n.syntax }
}
impl From<GritLike> for SyntaxElement {
	fn from(n:GritLike) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritLikeThreshold {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_LIKE_THRESHOLD }
...
impl From<GritLikeThreshold> for SyntaxNode {
	fn from(n:GritLikeThreshold) -> SyntaxNode { n.syntax }
}
impl From<GritLikeThreshold> for SyntaxElement {
	fn from(n:GritLikeThreshold) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritList {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_LIST }
...
impl From<GritList> for SyntaxNode {
	fn from(n:GritList) -> SyntaxNode { n.syntax }
}
impl From<GritList> for SyntaxElement {
	fn from(n:GritList) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritListAccessor {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_LIST_ACCESSOR }
...
impl From<GritListAccessor> for SyntaxNode {
	fn from(n:GritListAccessor) -> SyntaxNode { n.syntax }
}
impl From<GritListAccessor> for SyntaxElement {
	fn from(n:GritListAccessor) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritMap {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_MAP }
...
impl From<GritMap> for SyntaxNode {
	fn from(n:GritMap) -> SyntaxNode { n.syntax }
}
impl From<GritMap> for SyntaxElement {
	fn from(n:GritMap) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritMapAccessor {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_MAP_ACCESSOR }
...
impl From<GritMapAccessor> for SyntaxNode {
	fn from(n:GritMapAccessor) -> SyntaxNode { n.syntax }
}
impl From<GritMapAccessor> for SyntaxElement {
	fn from(n:GritMapAccessor) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritMapElement {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_MAP_ELEMENT }
...
impl From<GritMapElement> for SyntaxNode {
	fn from(n:GritMapElement) -> SyntaxNode { n.syntax }
}
impl From<GritMapElement> for SyntaxElement {
	fn from(n:GritMapElement) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritModOperation {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_MOD_OPERATION }
...
impl std::fmt::Debug for GritModOperation {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritModOperation")
			.field("left", &support::DebugSyntaxResult(self.left()))
			.field("remainder_token", &support::DebugSyntaxResult(self.remainder_token()))
			.field("right", &support::DebugSyntaxResult(self.right()))
			.finish()
	}
}
impl From<GritModOperation> for SyntaxNode {
	fn from(n:GritModOperation) -> SyntaxNode { n.syntax }
}
impl From<GritModOperation> for SyntaxElement {
	fn from(n:GritModOperation) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritMulOperation {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_MUL_OPERATION }
...
impl From<GritMulOperation> for SyntaxNode {
	fn from(n:GritMulOperation) -> SyntaxNode { n.syntax }
}
impl From<GritMulOperation> for SyntaxElement {
	fn from(n:GritMulOperation) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritName {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_NAME }
...
impl From<GritName> for SyntaxNode {
	fn from(n:GritName) -> SyntaxNode { n.syntax }
}
impl From<GritName> for SyntaxElement {
	fn from(n:GritName) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritNamedArg {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_NAMED_ARG }
...
impl From<GritNamedArg> for SyntaxNode {
	fn from(n:GritNamedArg) -> SyntaxNode { n.syntax }
}
impl From<GritNamedArg> for SyntaxElement {
	fn from(n:GritNamedArg) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritNegativeIntLiteral {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_NEGATIVE_INT_LITERAL }
...
impl From<GritNegativeIntLiteral> for SyntaxNode {
	fn from(n:GritNegativeIntLiteral) -> SyntaxNode { n.syntax }
}
impl From<GritNegativeIntLiteral> for SyntaxElement {
	fn from(n:GritNegativeIntLiteral) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritNodeLike {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_NODE_LIKE }
...
impl From<GritNodeLike> for SyntaxNode {
	fn from(n:GritNodeLike) -> SyntaxNode { n.syntax }
}
impl From<GritNodeLike> for SyntaxElement {
	fn from(n:GritNodeLike) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritNot {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_NOT }
...
impl From<GritNot> for SyntaxNode {
	fn from(n:GritNot) -> SyntaxNode { n.syntax }
}
impl From<GritNot> for SyntaxElement {
	fn from(n:GritNot) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPatternAccumulate {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PATTERN_ACCUMULATE }
...
impl std::fmt::Debug for GritPatternAccumulate {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritPatternAccumulate")
			.field("left", &support::DebugSyntaxResult(self.left()))
			.field("add_assign_token", &support::DebugSyntaxResult(self.add_assign_token()))
			.field("right", &support::DebugSyntaxResult(self.right()))
			.finish()
	}
}
impl From<GritPatternAccumulate> for SyntaxNode {
	fn from(n:GritPatternAccumulate) -> SyntaxNode { n.syntax }
}
impl From<GritPatternAccumulate> for SyntaxElement {
	fn from(n:GritPatternAccumulate) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPatternAfter {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PATTERN_AFTER }
...
impl std::fmt::Debug for GritPatternAfter {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritPatternAfter")
			.field("after_token", &support::DebugSyntaxResult(self.after_token()))
			.field("pattern", &support::DebugSyntaxResult(self.pattern()))
			.finish()
	}
}
impl From<GritPatternAfter> for SyntaxNode {
	fn from(n:GritPatternAfter) -> SyntaxNode { n.syntax }
}
impl From<GritPatternAfter> for SyntaxElement {
	fn from(n:GritPatternAfter) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPatternAnd {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PATTERN_AND }
...
impl From<GritPatternAnd> for SyntaxNode {
	fn from(n:GritPatternAnd) -> SyntaxNode { n.syntax }
}
impl From<GritPatternAnd> for SyntaxElement {
	fn from(n:GritPatternAnd) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPatternAny {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PATTERN_ANY }
...
impl From<GritPatternAny> for SyntaxNode {
	fn from(n:GritPatternAny) -> SyntaxNode { n.syntax }
}
impl From<GritPatternAny> for SyntaxElement {
	fn from(n:GritPatternAny) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPatternArgList {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PATTERN_ARG_LIST }
...
impl From<GritPatternArgList> for SyntaxNode {
	fn from(n:GritPatternArgList) -> SyntaxNode { n.syntax }
}
impl From<GritPatternArgList> for SyntaxElement {
	fn from(n:GritPatternArgList) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPatternAs {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PATTERN_AS }
...
impl From<GritPatternAs> for SyntaxNode {
	fn from(n:GritPatternAs) -> SyntaxNode { n.syntax }
}
impl From<GritPatternAs> for SyntaxElement {
	fn from(n:GritPatternAs) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPatternBefore {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PATTERN_BEFORE }
...
impl std::fmt::Debug for GritPatternBefore {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritPatternBefore")
			.field("before_token", &support::DebugSyntaxResult(self.before_token()))
			.field("pattern", &support::DebugSyntaxResult(self.pattern()))
			.finish()
	}
}
impl From<GritPatternBefore> for SyntaxNode {
	fn from(n:GritPatternBefore) -> SyntaxNode { n.syntax }
}
impl From<GritPatternBefore> for SyntaxElement {
	fn from(n:GritPatternBefore) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPatternContains {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PATTERN_CONTAINS }
...
impl std::fmt::Debug for GritPatternContains {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritPatternContains")
			.field("contains_token", &support::DebugSyntaxResult(self.contains_token()))
			.field("contains", &support::DebugSyntaxResult(self.contains()))
			.field("until_clause", &support::DebugOptionalElement(self.until_clause()))
			.finish()
	}
}
impl From<GritPatternContains> for SyntaxNode {
	fn from(n:GritPatternContains) -> SyntaxNode { n.syntax }
}
impl From<GritPatternContains> for SyntaxElement {
	fn from(n:GritPatternContains) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPatternContainsUntilClause {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PATTERN_CONTAINS_UNTIL_CLAUSE }
...
impl std::fmt::Debug for GritPatternContainsUntilClause {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritPatternContainsUntilClause")
			.field("until_token", &support::DebugSyntaxResult(self.until_token()))
			.field("until", &support::DebugSyntaxResult(self.until()))
			.finish()
	}
}
impl From<GritPatternContainsUntilClause> for SyntaxNode {
	fn from(n:GritPatternContainsUntilClause) -> SyntaxNode { n.syntax }
}
impl From<GritPatternContainsUntilClause> for SyntaxElement {
	fn from(n:GritPatternContainsUntilClause) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPatternDefinition {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PATTERN_DEFINITION }
...
impl std::fmt::Debug for GritPatternDefinition {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritPatternDefinition")
			.field("visibility_token", &support::DebugOptionalElement(self.visibility_token()))
			.field("pattern_token", &support::DebugSyntaxResult(self.pattern_token()))
			.field("name", &support::DebugSyntaxResult(self.name()))
			.field("l_paren_token", &support::DebugSyntaxResult(self.l_paren_token()))
...
impl From<GritPatternDefinition> for SyntaxNode {
	fn from(n:GritPatternDefinition) -> SyntaxNode { n.syntax }
}
impl From<GritPatternDefinition> for SyntaxElement {
	fn from(n:GritPatternDefinition) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPatternDefinitionBody {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PATTERN_DEFINITION_BODY }
...
impl From<GritPatternDefinitionBody> for SyntaxNode {
	fn from(n:GritPatternDefinitionBody) -> SyntaxNode { n.syntax }
}
impl From<GritPatternDefinitionBody> for SyntaxElement {
	fn from(n:GritPatternDefinitionBody) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPatternElseClause {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PATTERN_ELSE_CLAUSE }
...
impl std::fmt::Debug for GritPatternElseClause {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritPatternElseClause")
			...
			.field("else_pattern", &support::DebugSyntaxResult(self.else_pattern()))
			.finish()
	}
}
impl From<GritPatternElseClause> for SyntaxNode {
	fn from(n:GritPatternElseClause) -> SyntaxNode { n.syntax }
}
impl From<GritPatternElseClause> for SyntaxElement {
	fn from(n:GritPatternElseClause) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPatternIfElse {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PATTERN_IF_ELSE }
...
impl std::fmt::Debug for GritPatternIfElse {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritPatternIfElse")
			...
			.field("l_paren_token", &support::DebugSyntaxResult(self.l_paren_token()))
			.field("if_predicate", &support::DebugSyntaxResult(self.if_predicate()))
			.field("r_paren_token", &support::DebugSyntaxResult(self.r_paren_token()))
			.field("then_pattern", &support::DebugSyntaxResult(self.then_pattern()))
			.field("else_clause", &support::DebugOptionalElement(self.else_clause()))
			.finish()
	}
}
impl From<GritPatternIfElse> for SyntaxNode {
	fn from(n:GritPatternIfElse) -> SyntaxNode { n.syntax }
}
impl From<GritPatternIfElse> for SyntaxElement {
	fn from(n:GritPatternIfElse) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPatternIncludes {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PATTERN_INCLUDES }
...
impl std::fmt::Debug for GritPatternIncludes {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritPatternIncludes")
			.field("includes_token", &support::DebugSyntaxResult(self.includes_token()))
			.field("includes", &support::DebugSyntaxResult(self.includes()))
			.finish()
	}
}
impl From<GritPatternIncludes> for SyntaxNode {
	fn from(n:GritPatternIncludes) -> SyntaxNode { n.syntax }
}
impl From<GritPatternIncludes> for SyntaxElement {
	fn from(n:GritPatternIncludes) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPatternLimit {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PATTERN_LIMIT }
...
impl std::fmt::Debug for GritPatternLimit {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritPatternLimit")
			.field("pattern", &support::DebugSyntaxResult(self.pattern()))
			.field("limit_token", &support::DebugSyntaxResult(self.limit_token()))
			.field("limit", &support::DebugSyntaxResult(self.limit()))
			.finish()
	}
}
impl From<GritPatternLimit> for SyntaxNode {
	fn from(n:GritPatternLimit) -> SyntaxNode { n.syntax }
}
impl From<GritPatternLimit> for SyntaxElement {
	fn from(n:GritPatternLimit) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPatternMaybe {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PATTERN_MAYBE }
...
impl std::fmt::Debug for GritPatternMaybe {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritPatternMaybe")
			.field("maybe_token", &support::DebugSyntaxResult(self.maybe_token()))
			.field("pattern", &support::DebugSyntaxResult(self.pattern()))
			.finish()
	}
}
impl From<GritPatternMaybe> for SyntaxNode {
	fn from(n:GritPatternMaybe) -> SyntaxNode { n.syntax }
}
impl From<GritPatternMaybe> for SyntaxElement {
	fn from(n:GritPatternMaybe) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPatternNot {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PATTERN_NOT }
...
impl From<GritPatternNot> for SyntaxNode {
	fn from(n:GritPatternNot) -> SyntaxNode { n.syntax }
}
impl From<GritPatternNot> for SyntaxElement {
	fn from(n:GritPatternNot) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPatternOr {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PATTERN_OR }
...
impl From<GritPatternOr> for SyntaxNode {
	fn from(n:GritPatternOr) -> SyntaxNode { n.syntax }
}
impl From<GritPatternOr> for SyntaxElement {
	fn from(n:GritPatternOr) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPatternOrElse {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PATTERN_OR_ELSE }
...
impl std::fmt::Debug for GritPatternOrElse {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritPatternOrElse")
			.field("orelse_token", &support::DebugSyntaxResult(self.orelse_token()))
			.field("l_curly_token", &support::DebugSyntaxResult(self.l_curly_token()))
			.field("patterns", &self.patterns())
			.field("r_curly_token", &support::DebugSyntaxResult(self.r_curly_token()))
			.finish()
...
impl From<GritPatternOrElse> for SyntaxNode {
	fn from(n:GritPatternOrElse) -> SyntaxNode { n.syntax }
}
impl From<GritPatternOrElse> for SyntaxElement {
	fn from(n:GritPatternOrElse) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPatternWhere {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PATTERN_WHERE }
...
impl std::fmt::Debug for GritPatternWhere {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritPatternWhere")
			.field("pattern", &support::DebugSyntaxResult(self.pattern()))
			.field("where_token", &support::DebugSyntaxResult(self.where_token()))
			.field("side_condition", &support::DebugSyntaxResult(self.side_condition()))
			.finish()
	}
}
impl From<GritPatternWhere> for SyntaxNode {
	fn from(n:GritPatternWhere) -> SyntaxNode { n.syntax }
}
impl From<GritPatternWhere> for SyntaxElement {
	fn from(n:GritPatternWhere) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPredicateAccumulate {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PREDICATE_ACCUMULATE }
...
impl From<GritPredicateAccumulate> for SyntaxNode {
	fn from(n:GritPredicateAccumulate) -> SyntaxNode { n.syntax }
}
impl From<GritPredicateAccumulate> for SyntaxElement {
	fn from(n:GritPredicateAccumulate) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPredicateAnd {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PREDICATE_AND }
...
impl std::fmt::Debug for GritPredicateAnd {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritPredicateAnd")
			.field("and_token", &support::DebugOptionalElement(self.and_token()))
			.field("l_curly_token", &support::DebugSyntaxResult(self.l_curly_token()))
			.field("predicates", &self.predicates())
			.field("r_curly_token", &support::DebugSyntaxResult(self.r_curly_token()))
			.finish()
...
impl From<GritPredicateAnd> for SyntaxNode {
	fn from(n:GritPredicateAnd) -> SyntaxNode { n.syntax }
}
impl From<GritPredicateAnd> for SyntaxElement {
	fn from(n:GritPredicateAnd) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPredicateAny {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PREDICATE_ANY }
...
impl From<GritPredicateAny> for SyntaxNode {
	fn from(n:GritPredicateAny) -> SyntaxNode { n.syntax }
}
impl From<GritPredicateAny> for SyntaxElement {
	fn from(n:GritPredicateAny) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPredicateAssignment {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PREDICATE_ASSIGNMENT }
...
impl From<GritPredicateAssignment> for SyntaxNode {
	fn from(n:GritPredicateAssignment) -> SyntaxNode { n.syntax }
}
impl From<GritPredicateAssignment> for SyntaxElement {
	fn from(n:GritPredicateAssignment) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPredicateCall {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PREDICATE_CALL }
...
impl From<GritPredicateCall> for SyntaxNode {
	fn from(n:GritPredicateCall) -> SyntaxNode { n.syntax }
}
impl From<GritPredicateCall> for SyntaxElement {
	fn from(n:GritPredicateCall) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPredicateDefinition {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PREDICATE_DEFINITION }
...
impl std::fmt::Debug for GritPredicateDefinition {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritPredicateDefinition")
			.field("predicate_token", &support::DebugSyntaxResult(self.predicate_token()))
			.field("name", &support::DebugSyntaxResult(self.name()))
			.field("l_paren_token", &support::DebugSyntaxResult(self.l_paren_token()))
			.field("args", &support::DebugSyntaxResult(self.args()))
			.field("r_paren_token", &support::DebugSyntaxResult(self.r_paren_token()))
...
impl From<GritPredicateDefinition> for SyntaxNode {
	fn from(n:GritPredicateDefinition) -> SyntaxNode { n.syntax }
}
impl From<GritPredicateDefinition> for SyntaxElement {
	fn from(n:GritPredicateDefinition) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPredicateElseClause {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PREDICATE_ELSE_CLAUSE }
...
impl std::fmt::Debug for GritPredicateElseClause {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritPredicateElseClause")
			.field("else_token", &support::DebugSyntaxResult(self.else_token()))
			.field("else_predicate", &support::DebugSyntaxResult(self.else_predicate()))
			.finish()
	}
}
impl From<GritPredicateElseClause> for SyntaxNode {
	fn from(n:GritPredicateElseClause) -> SyntaxNode { n.syntax }
}
impl From<GritPredicateElseClause> for SyntaxElement {
	fn from(n:GritPredicateElseClause) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPredicateEqual {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PREDICATE_EQUAL }
...
impl std::fmt::Debug for GritPredicateEqual {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritPredicateEqual")
			.field("left", &support::DebugSyntaxResult(self.left()))
			.field("equality_token", &support::DebugSyntaxResult(self.equality_token()))
			.field("right", &support::DebugSyntaxResult(self.right()))
			.finish()
	}
}
impl From<GritPredicateEqual> for SyntaxNode {
	fn from(n:GritPredicateEqual) -> SyntaxNode { n.syntax }
}
impl From<GritPredicateEqual> for SyntaxElement {
	fn from(n:GritPredicateEqual) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPredicateGreater {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PREDICATE_GREATER }
...
impl std::fmt::Debug for GritPredicateGreater {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritPredicateGreater")
			.field("left", &support::DebugSyntaxResult(self.left()))
			.field("r_angle_token", &support::DebugSyntaxResult(self.r_angle_token()))
			.field("right", &support::DebugSyntaxResult(self.right()))
			.finish()
	}
}
impl From<GritPredicateGreater> for SyntaxNode {
	fn from(n:GritPredicateGreater) -> SyntaxNode { n.syntax }
}
impl From<GritPredicateGreater> for SyntaxElement {
	fn from(n:GritPredicateGreater) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPredicateGreaterEqual {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PREDICATE_GREATER_EQUAL }
...
impl From<GritPredicateGreaterEqual> for SyntaxNode {
	fn from(n:GritPredicateGreaterEqual) -> SyntaxNode { n.syntax }
}
impl From<GritPredicateGreaterEqual> for SyntaxElement {
	fn from(n:GritPredicateGreaterEqual) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPredicateIfElse {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PREDICATE_IF_ELSE }
...
impl std::fmt::Debug for GritPredicateIfElse {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritPredicateIfElse")
			...
			.field("if_predicate", &support::DebugSyntaxResult(self.if_predicate()))
			.field("r_paren_token", &support::DebugSyntaxResult(self.r_paren_token()))
			.field("then_predicate", &support::DebugSyntaxResult(self.then_predicate()))
			.field("else_clause", &support::DebugOptionalElement(self.else_clause()))
			.finish()
	}
}
impl From<GritPredicateIfElse> for SyntaxNode {
	fn from(n:GritPredicateIfElse) -> SyntaxNode { n.syntax }
}
impl From<GritPredicateIfElse> for SyntaxElement {
	fn from(n:GritPredicateIfElse) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPredicateLess {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PREDICATE_LESS }
...
impl std::fmt::Debug for GritPredicateLess {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritPredicateLess")
			.field("left", &support::DebugSyntaxResult(self.left()))
			.field("l_angle_token", &support::DebugSyntaxResult(self.l_angle_token()))
			.field("right", &support::DebugSyntaxResult(self.right()))
			.finish()
	}
}
impl From<GritPredicateLess> for SyntaxNode {
	fn from(n:GritPredicateLess) -> SyntaxNode { n.syntax }
}
impl From<GritPredicateLess> for SyntaxElement {
	fn from(n:GritPredicateLess) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPredicateLessEqual {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PREDICATE_LESS_EQUAL }
...
impl From<GritPredicateLessEqual> for SyntaxNode {
	fn from(n:GritPredicateLessEqual) -> SyntaxNode { n.syntax }
}
impl From<GritPredicateLessEqual> for SyntaxElement {
	fn from(n:GritPredicateLessEqual) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPredicateMatch {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PREDICATE_MATCH }
...
impl std::fmt::Debug for GritPredicateMatch {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritPredicateMatch")
			.field("left", &support::DebugSyntaxResult(self.left()))
			.field("match_token", &support::DebugSyntaxResult(self.match_token()))
			.field("right", &support::DebugSyntaxResult(self.right()))
			.finish()
	}
}
impl From<GritPredicateMatch> for SyntaxNode {
	fn from(n:GritPredicateMatch) -> SyntaxNode { n.syntax }
}
impl From<GritPredicateMatch> for SyntaxElement {
	fn from(n:GritPredicateMatch) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPredicateMaybe {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PREDICATE_MAYBE }
...
impl From<GritPredicateMaybe> for SyntaxNode {
	fn from(n:GritPredicateMaybe) -> SyntaxNode { n.syntax }
}
impl From<GritPredicateMaybe> for SyntaxElement {
	fn from(n:GritPredicateMaybe) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPredicateNot {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PREDICATE_NOT }
...
impl From<GritPredicateNot> for SyntaxNode {
	fn from(n:GritPredicateNot) -> SyntaxNode { n.syntax }
}
impl From<GritPredicateNot> for SyntaxElement {
	fn from(n:GritPredicateNot) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPredicateNotEqual {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PREDICATE_NOT_EQUAL }
...
impl std::fmt::Debug for GritPredicateNotEqual {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritPredicateNotEqual")
			.field("left", &support::DebugSyntaxResult(self.left()))
			.field("inequality_token", &support::DebugSyntaxResult(self.inequality_token()))
			.field("right", &support::DebugSyntaxResult(self.right()))
			.finish()
	}
}
impl From<GritPredicateNotEqual> for SyntaxNode {
	fn from(n:GritPredicateNotEqual) -> SyntaxNode { n.syntax }
}
impl From<GritPredicateNotEqual> for SyntaxElement {
	fn from(n:GritPredicateNotEqual) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPredicateOr {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PREDICATE_OR }
...
impl From<GritPredicateOr> for SyntaxNode {
	fn from(n:GritPredicateOr) -> SyntaxNode { n.syntax }
}
impl From<GritPredicateOr> for SyntaxElement {
	fn from(n:GritPredicateOr) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPredicateReturn {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PREDICATE_RETURN }
...
impl std::fmt::Debug for GritPredicateReturn {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritPredicateReturn")
			.field("return_token", &support::DebugSyntaxResult(self.return_token()))
			.field("pattern", &support::DebugSyntaxResult(self.pattern()))
			.finish()
	}
}
impl From<GritPredicateReturn> for SyntaxNode {
	fn from(n:GritPredicateReturn) -> SyntaxNode { n.syntax }
}
impl From<GritPredicateReturn> for SyntaxElement {
	fn from(n:GritPredicateReturn) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritPredicateRewrite {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PREDICATE_REWRITE }
...
impl std::fmt::Debug for GritPredicateRewrite {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritPredicateRewrite")
			.field("left", &support::DebugSyntaxResult(self.left()))
			.field("annotation", &support::DebugOptionalElement(self.annotation()))
			.field("fat_arrow_token", &support::DebugSyntaxResult(self.fat_arrow_token()))
			.field("right", &support::DebugSyntaxResult(self.right()))
			.finish()
	}
}
impl From<GritPredicateRewrite> for SyntaxNode {
	fn from(n:GritPredicateRewrite) -> SyntaxNode { n.syntax }
}
impl From<GritPredicateRewrite> for SyntaxElement {
	fn from(n:GritPredicateRewrite) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritRawBacktickSnippetLiteral {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_RAW_BACKTICK_SNIPPET_LITERAL }
...
impl From<GritRawBacktickSnippetLiteral> for SyntaxNode {
	fn from(n:GritRawBacktickSnippetLiteral) -> SyntaxNode { n.syntax }
}
impl From<GritRawBacktickSnippetLiteral> for SyntaxElement {
	fn from(n:GritRawBacktickSnippetLiteral) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritRegexLiteral {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_REGEX_LITERAL }
...
impl From<GritRegexLiteral> for SyntaxNode {
	fn from(n:GritRegexLiteral) -> SyntaxNode { n.syntax }
}
impl From<GritRegexLiteral> for SyntaxElement {
	fn from(n:GritRegexLiteral) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritRegexPattern {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_REGEX_PATTERN }
...
impl From<GritRegexPattern> for SyntaxNode {
	fn from(n:GritRegexPattern) -> SyntaxNode { n.syntax }
}
impl From<GritRegexPattern> for SyntaxElement {
	fn from(n:GritRegexPattern) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritRegexPatternVariables {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_REGEX_PATTERN_VARIABLES }
...
impl From<GritRegexPatternVariables> for SyntaxNode {
	fn from(n:GritRegexPatternVariables) -> SyntaxNode { n.syntax }
}
impl From<GritRegexPatternVariables> for SyntaxElement {
	fn from(n:GritRegexPatternVariables) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritRewrite {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_REWRITE }
...
impl From<GritRewrite> for SyntaxNode {
	fn from(n:GritRewrite) -> SyntaxNode { n.syntax }
}
impl From<GritRewrite> for SyntaxElement {
	fn from(n:GritRewrite) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritRoot {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_ROOT }
...
impl From<GritRoot> for SyntaxNode {
	fn from(n:GritRoot) -> SyntaxNode { n.syntax }
}
impl From<GritRoot> for SyntaxElement {
	fn from(n:GritRoot) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritSequential {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_SEQUENTIAL }
...
impl std::fmt::Debug for GritSequential {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritSequential")
			.field("sequential_token", &support::DebugSyntaxResult(self.sequential_token()))
			.field("l_curly_token", &support::DebugSyntaxResult(self.l_curly_token()))
...
impl From<GritSequential> for SyntaxNode {
	fn from(n:GritSequential) -> SyntaxNode { n.syntax }
}
impl From<GritSequential> for SyntaxElement {
	fn from(n:GritSequential) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritSnippetRegexLiteral {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_SNIPPET_REGEX_LITERAL }
...
impl From<GritSnippetRegexLiteral> for SyntaxNode {
	fn from(n:GritSnippetRegexLiteral) -> SyntaxNode { n.syntax }
}
impl From<GritSnippetRegexLiteral> for SyntaxElement {
	fn from(n:GritSnippetRegexLiteral) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritSome {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_SOME }
...
impl From<GritSome> for SyntaxNode {
	fn from(n:GritSome) -> SyntaxNode { n.syntax }
}
impl From<GritSome> for SyntaxElement {
	fn from(n:GritSome) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritStringLiteral {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_STRING_LITERAL }
...
impl From<GritStringLiteral> for SyntaxNode {
	fn from(n:GritStringLiteral) -> SyntaxNode { n.syntax }
}
impl From<GritStringLiteral> for SyntaxElement {
	fn from(n:GritStringLiteral) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritSubOperation {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_SUB_OPERATION }
...
impl From<GritSubOperation> for SyntaxNode {
	fn from(n:GritSubOperation) -> SyntaxNode { n.syntax }
}
impl From<GritSubOperation> for SyntaxElement {
	fn from(n:GritSubOperation) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritUndefinedLiteral {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_UNDEFINED_LITERAL }
...
impl std::fmt::Debug for GritUndefinedLiteral {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritUndefinedLiteral")
			.field("token_token", &support::DebugSyntaxResult(self.token_token()))
			.finish()
	}
}
impl From<GritUndefinedLiteral> for SyntaxNode {
	fn from(n:GritUndefinedLiteral) -> SyntaxNode { n.syntax }
}
impl From<GritUndefinedLiteral> for SyntaxElement {
	fn from(n:GritUndefinedLiteral) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritUnderscore {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_UNDERSCORE }
...
impl From<GritUnderscore> for SyntaxNode {
	fn from(n:GritUnderscore) -> SyntaxNode { n.syntax }
}
impl From<GritUnderscore> for SyntaxElement {
	fn from(n:GritUnderscore) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritVariable {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_VARIABLE }
...
impl From<GritVariable> for SyntaxNode {
	fn from(n:GritVariable) -> SyntaxNode { n.syntax }
}
impl From<GritVariable> for SyntaxElement {
	fn from(n:GritVariable) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritVersion {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_VERSION }
...
impl std::fmt::Debug for GritVersion {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritVersion")
			.field("engine_token", &support::DebugSyntaxResult(self.engine_token()))
			.field("biome_token", &support::DebugSyntaxResult(self.biome_token()))
			.field("l_paren_token", &support::DebugSyntaxResult(self.l_paren_token()))
...
impl From<GritVersion> for SyntaxNode {
	fn from(n:GritVersion) -> SyntaxNode { n.syntax }
}
impl From<GritVersion> for SyntaxElement {
	fn from(n:GritVersion) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for GritWithin {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_WITHIN }
...
impl std::fmt::Debug for GritWithin {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("GritWithin")
			.field("within_token", &support::DebugSyntaxResult(self.within_token()))
			.field("pattern", &support::DebugSyntaxResult(self.pattern()))
			.finish()
	}
}
impl From<GritWithin> for SyntaxNode {
	fn from(n:GritWithin) -> SyntaxNode { n.syntax }
}
impl From<GritWithin> for SyntaxElement {
	fn from(n:GritWithin) -> SyntaxElement { n.syntax.into() }
}
...
impl From<GritListAccessor> for AnyGritContainer {
	fn from(node:GritListAccessor) -> AnyGritContainer { AnyGritContainer::GritListAccessor(node) }
}
impl From<GritMapAccessor> for AnyGritContainer {
	fn from(node:GritMapAccessor) -> AnyGritContainer { AnyGritContainer::GritMapAccessor(node) }
}
impl From<GritVariable> for AnyGritContainer {
	fn from(node:GritVariable) -> AnyGritContainer { AnyGritContainer::GritVariable(node) }
}
...
impl AstNode for AnyGritLanguageDeclaration {
	...
	fn can_cast(kind:SyntaxKind) -> bool {
		matches!(kind, GRIT_BOGUS_LANGUAGE_DECLARATION | GRIT_LANGUAGE_DECLARATION)
	}
...
impl AstNode for AnyGritLanguageFlavorKind {
	...
	fn can_cast(kind:SyntaxKind) -> bool {
		matches!(kind, GRIT_BOGUS_LANGUAGE_FLAVOR_KIND | GRIT_LANGUAGE_FLAVOR_KIND)
	}
		...
		let res = match syntax.kind() {
			...
			_ => {
				if let Some(any_grit_container) = AnyGritContainer::cast(syntax) {
					return Some(AnyGritListAccessorSubject::AnyGritContainer(any_grit_container));
				}
				return None;
			},
		};
...
impl From<GritIntLiteral> for AnyGritListIndex {
	fn from(node:GritIntLiteral) -> AnyGritListIndex { AnyGritListIndex::GritIntLiteral(node) }
}
...
impl From<GritDotdotdot> for AnyGritListPattern {
	fn from(node:GritDotdotdot) -> AnyGritListPattern { AnyGritListPattern::GritDotdotdot(node) }
}
...
impl From<GritBogusLiteral> for AnyGritLiteral {
	fn from(node:GritBogusLiteral) -> AnyGritLiteral { AnyGritLiteral::GritBogusLiteral(node) }
}
impl From<GritBooleanLiteral> for AnyGritLiteral {
	fn from(node:GritBooleanLiteral) -> AnyGritLiteral { AnyGritLiteral::GritBooleanLiteral(node) }
}
impl From<GritCodeSnippet> for AnyGritLiteral {
	fn from(node:GritCodeSnippet) -> AnyGritLiteral { AnyGritLiteral::GritCodeSnippet(node) }
}
impl From<GritDoubleLiteral> for AnyGritLiteral {
	fn from(node:GritDoubleLiteral) -> AnyGritLiteral { AnyGritLiteral::GritDoubleLiteral(node) }
}
impl From<GritIntLiteral> for AnyGritLiteral {
	fn from(node:GritIntLiteral) -> AnyGritLiteral { AnyGritLiteral::GritIntLiteral(node) }
}
impl From<GritList> for AnyGritLiteral {
	fn from(node:GritList) -> AnyGritLiteral { AnyGritLiteral::GritList(node) }
}
impl From<GritMap> for AnyGritLiteral {
	fn from(node:GritMap) -> AnyGritLiteral { AnyGritLiteral::GritMap(node) }
}
impl From<GritStringLiteral> for AnyGritLiteral {
	fn from(node:GritStringLiteral) -> AnyGritLiteral { AnyGritLiteral::GritStringLiteral(node) }
}
...
impl From<GritMap> for AnyGritMapAccessorSubject {
	fn from(node:GritMap) -> AnyGritMapAccessorSubject { AnyGritMapAccessorSubject::GritMap(node) }
}
impl AstNode for AnyGritMapAccessorSubject {
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			...
			_ => {
				if let Some(any_grit_container) = AnyGritContainer::cast(syntax) {
					return Some(AnyGritMapAccessorSubject::AnyGritContainer(any_grit_container));
				}
				return None;
			},
		};
...
impl From<GritMapElement> for AnyGritMapElement {
	fn from(node:GritMapElement) -> AnyGritMapElement { AnyGritMapElement::GritMapElement(node) }
}
...
impl From<GritName> for AnyGritMapKey {
	fn from(node:GritName) -> AnyGritMapKey { AnyGritMapKey::GritName(node) }
}
impl From<GritVariable> for AnyGritMapKey {
	fn from(node:GritVariable) -> AnyGritMapKey { AnyGritMapKey::GritVariable(node) }
}
impl AstNode for AnyGritMapKey {
	...
	fn can_cast(kind:SyntaxKind) -> bool { matches!(kind, GRIT_NAME | GRIT_VARIABLE) }
...
impl From<GritNamedArg> for AnyGritMaybeNamedArg {
	fn from(node:GritNamedArg) -> AnyGritMaybeNamedArg { AnyGritMaybeNamedArg::GritNamedArg(node) }
}
...
impl From<GritAddOperation> for AnyGritPattern {
	fn from(node:GritAddOperation) -> AnyGritPattern { AnyGritPattern::GritAddOperation(node) }
}
...
impl From<GritBogusPattern> for AnyGritPattern {
	fn from(node:GritBogusPattern) -> AnyGritPattern { AnyGritPattern::GritBogusPattern(node) }
}
...
impl From<GritBubble> for AnyGritPattern {
	fn from(node:GritBubble) -> AnyGritPattern { AnyGritPattern::GritBubble(node) }
}
impl From<GritDivOperation> for AnyGritPattern {
	fn from(node:GritDivOperation) -> AnyGritPattern { AnyGritPattern::GritDivOperation(node) }
}
impl From<GritDot> for AnyGritPattern {
	fn from(node:GritDot) -> AnyGritPattern { AnyGritPattern::GritDot(node) }
}
impl From<GritEvery> for AnyGritPattern {
	fn from(node:GritEvery) -> AnyGritPattern { AnyGritPattern::GritEvery(node) }
}
impl From<GritFiles> for AnyGritPattern {
	fn from(node:GritFiles) -> AnyGritPattern { AnyGritPattern::GritFiles(node) }
}
impl From<GritLike> for AnyGritPattern {
	fn from(node:GritLike) -> AnyGritPattern { AnyGritPattern::GritLike(node) }
}
impl From<GritListAccessor> for AnyGritPattern {
	fn from(node:GritListAccessor) -> AnyGritPattern { AnyGritPattern::GritListAccessor(node) }
}
impl From<GritMapAccessor> for AnyGritPattern {
	fn from(node:GritMapAccessor) -> AnyGritPattern { AnyGritPattern::GritMapAccessor(node) }
}
impl From<GritModOperation> for AnyGritPattern {
	fn from(node:GritModOperation) -> AnyGritPattern { AnyGritPattern::GritModOperation(node) }
}
impl From<GritMulOperation> for AnyGritPattern {
	fn from(node:GritMulOperation) -> AnyGritPattern { AnyGritPattern::GritMulOperation(node) }
}
impl From<GritNodeLike> for AnyGritPattern {
	fn from(node:GritNodeLike) -> AnyGritPattern { AnyGritPattern::GritNodeLike(node) }
}
...
impl From<GritPatternAfter> for AnyGritPattern {
	fn from(node:GritPatternAfter) -> AnyGritPattern { AnyGritPattern::GritPatternAfter(node) }
}
impl From<GritPatternAnd> for AnyGritPattern {
	fn from(node:GritPatternAnd) -> AnyGritPattern { AnyGritPattern::GritPatternAnd(node) }
}
impl From<GritPatternAny> for AnyGritPattern {
	fn from(node:GritPatternAny) -> AnyGritPattern { AnyGritPattern::GritPatternAny(node) }
}
impl From<GritPatternAs> for AnyGritPattern {
	fn from(node:GritPatternAs) -> AnyGritPattern { AnyGritPattern::GritPatternAs(node) }
}
impl From<GritPatternBefore> for AnyGritPattern {
	fn from(node:GritPatternBefore) -> AnyGritPattern { AnyGritPattern::GritPatternBefore(node) }
}
...
impl From<GritPatternIfElse> for AnyGritPattern {
	fn from(node:GritPatternIfElse) -> AnyGritPattern { AnyGritPattern::GritPatternIfElse(node) }
}
...
impl From<GritPatternLimit> for AnyGritPattern {
	fn from(node:GritPatternLimit) -> AnyGritPattern { AnyGritPattern::GritPatternLimit(node) }
}
impl From<GritPatternMaybe> for AnyGritPattern {
	fn from(node:GritPatternMaybe) -> AnyGritPattern { AnyGritPattern::GritPatternMaybe(node) }
}
impl From<GritPatternNot> for AnyGritPattern {
	fn from(node:GritPatternNot) -> AnyGritPattern { AnyGritPattern::GritPatternNot(node) }
}
impl From<GritPatternOr> for AnyGritPattern {
	fn from(node:GritPatternOr) -> AnyGritPattern { AnyGritPattern::GritPatternOr(node) }
}
impl From<GritPatternOrElse> for AnyGritPattern {
	fn from(node:GritPatternOrElse) -> AnyGritPattern { AnyGritPattern::GritPatternOrElse(node) }
}
impl From<GritPatternWhere> for AnyGritPattern {
	fn from(node:GritPatternWhere) -> AnyGritPattern { AnyGritPattern::GritPatternWhere(node) }
}
impl From<GritRegexPattern> for AnyGritPattern {
	fn from(node:GritRegexPattern) -> AnyGritPattern { AnyGritPattern::GritRegexPattern(node) }
}
impl From<GritRewrite> for AnyGritPattern {
	fn from(node:GritRewrite) -> AnyGritPattern { AnyGritPattern::GritRewrite(node) }
}
impl From<GritSequential> for AnyGritPattern {
	fn from(node:GritSequential) -> AnyGritPattern { AnyGritPattern::GritSequential(node) }
}
impl From<GritSome> for AnyGritPattern {
	fn from(node:GritSome) -> AnyGritPattern { AnyGritPattern::GritSome(node) }
}
impl From<GritSubOperation> for AnyGritPattern {
	fn from(node:GritSubOperation) -> AnyGritPattern { AnyGritPattern::GritSubOperation(node) }
}
impl From<GritUnderscore> for AnyGritPattern {
	fn from(node:GritUnderscore) -> AnyGritPattern { AnyGritPattern::GritUnderscore(node) }
}
impl From<GritVariable> for AnyGritPattern {
	fn from(node:GritVariable) -> AnyGritPattern { AnyGritPattern::GritVariable(node) }
}
impl From<GritWithin> for AnyGritPattern {
	fn from(node:GritWithin) -> AnyGritPattern { AnyGritPattern::GritWithin(node) }
}
...
impl From<GritPredicateAnd> for AnyGritPredicate {
	fn from(node:GritPredicateAnd) -> AnyGritPredicate { AnyGritPredicate::GritPredicateAnd(node) }
}
impl From<GritPredicateAny> for AnyGritPredicate {
	fn from(node:GritPredicateAny) -> AnyGritPredicate { AnyGritPredicate::GritPredicateAny(node) }
}
...
impl From<GritPredicateNot> for AnyGritPredicate {
	fn from(node:GritPredicateNot) -> AnyGritPredicate { AnyGritPredicate::GritPredicateNot(node) }
}
...
impl From<GritPredicateOr> for AnyGritPredicate {
	fn from(node:GritPredicateOr) -> AnyGritPredicate { AnyGritPredicate::GritPredicateOr(node) }
}
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let syntax = match AnyGritContainer::try_cast(syntax) {
			Ok(any_grit_container) => {
				return Some(AnyGritPredicateMatchSubject::AnyGritContainer(any_grit_container));
			},
			Err(syntax) => syntax,
		};
		if let Some(any_grit_literal) = AnyGritLiteral::cast(syntax) {
			return Some(AnyGritPredicateMatchSubject::AnyGritLiteral(any_grit_literal));
		}
		None
	}
...
impl From<GritRegexLiteral> for AnyGritRegex {
	fn from(node:GritRegexLiteral) -> AnyGritRegex { AnyGritRegex::GritRegexLiteral(node) }
}
...
impl From<GritBogusVersion> for AnyGritVersion {
	fn from(node:GritBogusVersion) -> AnyGritVersion { AnyGritVersion::GritBogusVersion(node) }
}
impl From<GritVersion> for AnyGritVersion {
	fn from(node:GritVersion) -> AnyGritVersion { AnyGritVersion::GritVersion(node) }
}
impl AstNode for AnyGritVersion {
	...
	fn can_cast(kind:SyntaxKind) -> bool { matches!(kind, GRIT_BOGUS_VERSION | GRIT_VERSION) }
...
impl AstNode for GritBogus {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_BOGUS }
...
impl From<GritBogus> for SyntaxNode {
	fn from(n:GritBogus) -> SyntaxNode { n.syntax }
}
impl From<GritBogus> for SyntaxElement {
	fn from(n:GritBogus) -> SyntaxElement { n.syntax.into() }
}
#[derive(Clone, PartialEq, Eq, Hash, Serialize)]
...
impl AstNode for GritBogusContainer {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_BOGUS_CONTAINER }
...
impl From<GritBogusContainer> for SyntaxNode {
	fn from(n:GritBogusContainer) -> SyntaxNode { n.syntax }
}
impl From<GritBogusContainer> for SyntaxElement {
	fn from(n:GritBogusContainer) -> SyntaxElement { n.syntax.into() }
}
#[derive(Clone, PartialEq, Eq, Hash, Serialize)]
...
impl AstNode for GritBogusDefinition {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_BOGUS_DEFINITION }
...
impl From<GritBogusDefinition> for SyntaxNode {
	fn from(n:GritBogusDefinition) -> SyntaxNode { n.syntax }
}
impl From<GritBogusDefinition> for SyntaxElement {
	fn from(n:GritBogusDefinition) -> SyntaxElement { n.syntax.into() }
}
#[derive(Clone, PartialEq, Eq, Hash, Serialize)]
...
impl AstNode for GritBogusLanguageDeclaration {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_BOGUS_LANGUAGE_DECLARATION }
...
impl From<GritBogusLanguageDeclaration> for SyntaxNode {
	fn from(n:GritBogusLanguageDeclaration) -> SyntaxNode { n.syntax }
}
impl From<GritBogusLanguageDeclaration> for SyntaxElement {
	fn from(n:GritBogusLanguageDeclaration) -> SyntaxElement { n.syntax.into() }
}
#[derive(Clone, PartialEq, Eq, Hash, Serialize)]
...
impl AstNode for GritBogusLanguageFlavorKind {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_BOGUS_LANGUAGE_FLAVOR_KIND }
...
impl From<GritBogusLanguageFlavorKind> for SyntaxNode {
	fn from(n:GritBogusLanguageFlavorKind) -> SyntaxNode { n.syntax }
}
impl From<GritBogusLanguageFlavorKind> for SyntaxElement {
	fn from(n:GritBogusLanguageFlavorKind) -> SyntaxElement { n.syntax.into() }
}
#[derive(Clone, PartialEq, Eq, Hash, Serialize)]
...
impl AstNode for GritBogusLiteral {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_BOGUS_LITERAL }
...
impl From<GritBogusLiteral> for SyntaxNode {
	fn from(n:GritBogusLiteral) -> SyntaxNode { n.syntax }
}
impl From<GritBogusLiteral> for SyntaxElement {
	fn from(n:GritBogusLiteral) -> SyntaxElement { n.syntax.into() }
}
#[derive(Clone, PartialEq, Eq, Hash, Serialize)]
...
impl AstNode for GritBogusMapElement {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_BOGUS_MAP_ELEMENT }
...
impl From<GritBogusMapElement> for SyntaxNode {
	fn from(n:GritBogusMapElement) -> SyntaxNode { n.syntax }
}
impl From<GritBogusMapElement> for SyntaxElement {
	fn from(n:GritBogusMapElement) -> SyntaxElement { n.syntax.into() }
}
#[derive(Clone, PartialEq, Eq, Hash, Serialize)]
...
impl AstNode for GritBogusNamedArg {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_BOGUS_NAMED_ARG }
...
impl From<GritBogusNamedArg> for SyntaxNode {
	fn from(n:GritBogusNamedArg) -> SyntaxNode { n.syntax }
}
impl From<GritBogusNamedArg> for SyntaxElement {
	fn from(n:GritBogusNamedArg) -> SyntaxElement { n.syntax.into() }
}
#[derive(Clone, PartialEq, Eq, Hash, Serialize)]
...
impl AstNode for GritBogusPattern {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_BOGUS_PATTERN }
...
impl From<GritBogusPattern> for SyntaxNode {
	fn from(n:GritBogusPattern) -> SyntaxNode { n.syntax }
}
impl From<GritBogusPattern> for SyntaxElement {
	fn from(n:GritBogusPattern) -> SyntaxElement { n.syntax.into() }
}
#[derive(Clone, PartialEq, Eq, Hash, Serialize)]
...
impl AstNode for GritBogusPredicate {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_BOGUS_PREDICATE }
...
impl From<GritBogusPredicate> for SyntaxNode {
	fn from(n:GritBogusPredicate) -> SyntaxNode { n.syntax }
}
impl From<GritBogusPredicate> for SyntaxElement {
	fn from(n:GritBogusPredicate) -> SyntaxElement { n.syntax.into() }
}
#[derive(Clone, PartialEq, Eq, Hash, Serialize)]
...
impl AstNode for GritBogusVersion {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_BOGUS_VERSION }
...
impl From<GritBogusVersion> for SyntaxNode {
	fn from(n:GritBogusVersion) -> SyntaxNode { n.syntax }
}
impl From<GritBogusVersion> for SyntaxElement {
	fn from(n:GritBogusVersion) -> SyntaxElement { n.syntax.into() }
}
...
impl AstNode for GritDefinitionList {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_DEFINITION_LIST }

	fn cast(syntax:SyntaxNode) -> Option<GritDefinitionList> {
		if Self::can_cast(syntax.kind()) {
			Some(GritDefinitionList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for GritLanguageFlavorList {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_LANGUAGE_FLAVOR_LIST }

	fn cast(syntax:SyntaxNode) -> Option<GritLanguageFlavorList> {
		if Self::can_cast(syntax.kind()) {
			Some(GritLanguageFlavorList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for GritListPatternList {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_LIST_PATTERN_LIST }

	fn cast(syntax:SyntaxNode) -> Option<GritListPatternList> {
		if Self::can_cast(syntax.kind()) {
			Some(GritListPatternList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for GritMapElementList {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_MAP_ELEMENT_LIST }

	fn cast(syntax:SyntaxNode) -> Option<GritMapElementList> {
		if Self::can_cast(syntax.kind()) {
			Some(GritMapElementList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for GritNamedArgList {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_NAMED_ARG_LIST }

	fn cast(syntax:SyntaxNode) -> Option<GritNamedArgList> {
		if Self::can_cast(syntax.kind()) {
			Some(GritNamedArgList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for GritPatternList {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PATTERN_LIST }

	fn cast(syntax:SyntaxNode) -> Option<GritPatternList> {
		if Self::can_cast(syntax.kind()) {
			Some(GritPatternList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for GritPredicateList {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PREDICATE_LIST }

	fn cast(syntax:SyntaxNode) -> Option<GritPredicateList> {
		if Self::can_cast(syntax.kind()) {
			Some(GritPredicateList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for GritVariableList {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_VARIABLE_LIST }

	fn cast(syntax:SyntaxNode) -> Option<GritVariableList> {
		if Self::can_cast(syntax.kind()) {
			Some(GritVariableList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
