...
impl GritBubble {
	...
	pub fn scope(&self) -> Option<GritBubbleScope> { support::node(&self.syntax, 1usize) }
...
impl GritPatternDefinition {
	...
	pub fn args(&self) -> GritVariableList { support::list(&self.syntax, 4usize) }
...
impl GritRegexPatternVariables {
	...
	pub fn args(&self) -> GritVariableList { support::list(&self.syntax, 1usize) }
...
impl AstNode for GritPredicateCurly {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == GRIT_PREDICATE_CURLY }
...
impl From<GritPredicateCurly> for SyntaxNode {
	fn from(n:GritPredicateCurly) -> SyntaxNode { n.syntax }
}
impl From<GritPredicateCurly> for SyntaxElement {
	fn from(n:GritPredicateCurly) -> SyntaxElement { n.syntax.into() }
}
