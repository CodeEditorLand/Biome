...
macro_rules! map_syntax_node {
	($node:expr, $pattern:pat => $body:expr) => {
		match $node {
			node => {
				match $crate::GritSyntaxNode::kind(&node) {
					...
					$crate::GritSyntaxKind::GRIT_ASSIGNMENT_AS_PATTERN => {
						let $pattern =
							unsafe { $crate::GritAssignmentAsPattern::new_unchecked(node) };
						$body
					},
					...
					$crate::GritSyntaxKind::GRIT_BRACKETED_PREDICATE => {
						let $pattern =
							unsafe { $crate::GritBracketedPredicate::new_unchecked(node) };
						$body
					},
					...
					$crate::GritSyntaxKind::GRIT_CURLY_PREDICATE_LIST => {
						let $pattern =
							unsafe { $crate::GritCurlyPredicateList::new_unchecked(node) };
						$body
					},
					...
					$crate::GritSyntaxKind::GRIT_FUNCTION_DEFINITION => {
						let $pattern =
							unsafe { $crate::GritFunctionDefinition::new_unchecked(node) };
						$body
					},
					...
					$crate::GritSyntaxKind::GRIT_LANGUAGE_DECLARATION => {
						let $pattern =
							unsafe { $crate::GritLanguageDeclaration::new_unchecked(node) };
						$body
					},
					...
					$crate::GritSyntaxKind::GRIT_LANGUAGE_FLAVOR_KIND => {
						let $pattern =
							unsafe { $crate::GritLanguageFlavorKind::new_unchecked(node) };
						$body
					},
					...
					$crate::GritSyntaxKind::GRIT_NEGATIVE_INT_LITERAL => {
						let $pattern =
							unsafe { $crate::GritNegativeIntLiteral::new_unchecked(node) };
						$body
					},
					...
					$crate::GritSyntaxKind::GRIT_PATTERN_ACCUMULATE => {
						let $pattern =
							unsafe { $crate::GritPatternAccumulate::new_unchecked(node) };
						$body
					},
					...
					$crate::GritSyntaxKind::GRIT_PATTERN_DEFINITION => {
						let $pattern =
							unsafe { $crate::GritPatternDefinition::new_unchecked(node) };
						$body
					},
					...
					$crate::GritSyntaxKind::GRIT_PATTERN_ELSE_CLAUSE => {
						let $pattern =
							unsafe { $crate::GritPatternElseClause::new_unchecked(node) };
						$body
					},
					...
					$crate::GritSyntaxKind::GRIT_PREDICATE_ACCUMULATE => {
						let $pattern =
							unsafe { $crate::GritPredicateAccumulate::new_unchecked(node) };
						$body
					},
					...
					$crate::GritSyntaxKind::GRIT_PREDICATE_ASSIGNMENT => {
						let $pattern =
							unsafe { $crate::GritPredicateAssignment::new_unchecked(node) };
						$body
					},
					...
					$crate::GritSyntaxKind::GRIT_PREDICATE_DEFINITION => {
						let $pattern =
							unsafe { $crate::GritPredicateDefinition::new_unchecked(node) };
						$body
					},
					$crate::GritSyntaxKind::GRIT_PREDICATE_ELSE_CLAUSE => {
						let $pattern =
							unsafe { $crate::GritPredicateElseClause::new_unchecked(node) };
						$body
					},
					...
					$crate::GritSyntaxKind::GRIT_PREDICATE_LESS_EQUAL => {
						let $pattern =
							unsafe { $crate::GritPredicateLessEqual::new_unchecked(node) };
						$body
					},
					...
					$crate::GritSyntaxKind::GRIT_PREDICATE_NOT_EQUAL => {
						let $pattern =
							unsafe { $crate::GritPredicateNotEqual::new_unchecked(node) };
						$body
					},
					...
					$crate::GritSyntaxKind::GRIT_SNIPPET_REGEX_LITERAL => {
						let $pattern =
							unsafe { $crate::GritSnippetRegexLiteral::new_unchecked(node) };
						$body
					},
					...
					$crate::GritSyntaxKind::GRIT_LANGUAGE_FLAVOR_LIST => {
						let $pattern =
							unsafe { $crate::GritLanguageFlavorList::new_unchecked(node) };
						$body
					},
