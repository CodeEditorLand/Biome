...
impl<'source> GraphqlParser<'source> {
	pub fn new(source:&'source str) -> Self {
		Self { context:ParserContext::default(), source:GraphqlTokenSource::from_str(source) }
	}

	pub fn finish(self) -> (Vec<Event<GraphqlSyntaxKind>>, Vec<ParseDiagnostic>, Vec<Trivia>) {
...
#[inline]
fn is_nth_at_non_kw_name(p:&mut GraphqlParser, n:usize) -> bool { p.nth_at(n, T![ident]) }
