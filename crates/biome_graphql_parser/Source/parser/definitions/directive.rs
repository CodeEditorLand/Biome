...
use biome_parser::{
	Parser, TokenSet, parse_lists::ParseSeparatedList, parse_recovery::ParseRecovery, parsed_syntax::ParsedSyntax,
...
impl ParseSeparatedList for DirectiveLocationList {
	...
	fn recover(
		...
		parsed_element.or_recover(p, &DirectiveLocationListParseRecovery, expected_directive_location)
	}
