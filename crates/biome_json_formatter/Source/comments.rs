...
use biome_formatter::comments::{
	CommentKind, CommentPlacement, CommentStyle, Comments, DecoratedComment, SourceComment, is_alignable_comment,
};
...
impl FormatRule<SourceComment<JsonLanguage>> for FormatJsonLeadingComment {
	...
	fn fmt(&self, comment: &SourceComment<JsonLanguage>, f: &mut Formatter<Self::Context>) -> FormatResult<()> {
...
fn handle_empty_list_comment(comment: DecoratedComment<JsonLanguage>) -> CommentPlacement<JsonLanguage> {
	if !matches!(
