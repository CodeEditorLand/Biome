use std::{default::Default, fmt, rc::Rc, str::FromStr};
...
use crate::{
	comments::{FormatJsonLeadingComment, JsonComments},
	JsonCommentStyle,
};
...
impl CstFormatContext for JsonFormatContext {
	...
	fn comments(&self) -> &JsonComments { &self.comments }
}
...
pub struct JsonFormatOptions {
	...
	/// syntactic structures. Defaults to "none".
