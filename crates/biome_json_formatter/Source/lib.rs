...
use crate::{comments::JsonCommentStyle, context::JsonFormatOptions, cst::FormatJsonSyntaxNode};
...
impl JsonFormatLanguage {
	pub fn new(options:JsonFormatOptions) -> Self { Self { options } }
}
...
mod tests {
	...
	use crate::{context::JsonFormatOptions, format_node};
