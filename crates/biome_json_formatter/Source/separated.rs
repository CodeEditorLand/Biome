...
use biome_formatter::separated::{FormatSeparatedElementRule, FormatSeparatedIter, TrailingSeparator};
...
pub(crate) trait FormatAstSeparatedListExtension: AstSeparatedList<Language = JsonLanguage> {
	...
	fn format_separated(
		...
		JsonFormatSeparatedIter::new(self.elements(), separator, JsonFormatSeparatedElementRule { node: PhantomData })
