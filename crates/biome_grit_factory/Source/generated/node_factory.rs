...
pub fn grit_bubble(
	...
	GritBubbleBuilder { bubble_token, pattern, scope:None }
}
	...
	pub fn build(self) -> GritBubble {
		GritBubble::unwrap_cast(SyntaxNode::new_detached(
			...
			[
				...
				self.scope.map(|token| SyntaxElement::Node(token.into_syntax())),
...
pub fn grit_named_arg(name:GritName, eq_token:SyntaxToken, pattern:AnyGritPattern) -> GritNamedArg {
...
pub fn grit_pattern_before(before_token:SyntaxToken, pattern:AnyGritPattern) -> GritPatternBefore {
...
pub fn grit_raw_backtick_snippet_literal(value_token:SyntaxToken) -> GritRawBacktickSnippetLiteral {
