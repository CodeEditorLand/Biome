...
pub fn grit_bubble(
	...
	GritBubbleBuilder { bubble_token, pattern, variables: None }
}
...
pub fn grit_dotdotdot(dotdotdot_token: SyntaxToken) -> GritDotdotdotBuilder {
	GritDotdotdotBuilder { dotdotdot_token, pattern: None }
}
	...
	pub fn build(self) -> GritDotdotdot {
		GritDotdotdot::unwrap_cast(SyntaxNode::new_detached(
			...
			[
				...
				self.pattern.map(|token| SyntaxElement::Node(token.into_syntax())),
			],
		))
	}
}
...
pub fn grit_every(every_token: SyntaxToken, pattern: AnyGritMaybeCurlyPattern) -> GritEvery {
	GritEvery::unwrap_cast(SyntaxNode::new_detached(
		...
		[Some(SyntaxElement::Token(every_token)), Some(SyntaxElement::Node(pattern.into_syntax()))],
	))
}
pub fn grit_files(
...
pub fn grit_language_declaration(
	...
	GritLanguageDeclarationBuilder { language_token, name, flavor: None, semicolon_token: None }
}
	...
	pub fn build(self) -> GritLanguageDeclaration {
		GritLanguageDeclaration::unwrap_cast(SyntaxNode::new_detached(
			...
			[
				...
				self.flavor.map(|token| SyntaxElement::Node(token.into_syntax())),
...
pub fn grit_like(
	...
	GritLikeBuilder { like_token, l_curly_token, example, r_curly_token, threshold: None }
}
	...
	pub fn build(self) -> GritLike {
		GritLike::unwrap_cast(SyntaxNode::new_detached(
			...
			[
				...
				self.threshold.map(|token| SyntaxElement::Node(token.into_syntax())),
...
pub fn grit_list(
	...
	GritListBuilder { l_brack_token, patterns, r_brack_token, name: None }
}
...
pub fn grit_pattern_after(after_token: SyntaxToken, pattern: AnyGritPattern) -> GritPatternAfter {
	GritPatternAfter::unwrap_cast(SyntaxNode::new_detached(
		...
		[Some(SyntaxElement::Token(after_token)), Some(SyntaxElement::Node(pattern.into_syntax()))],
	))
}
...
pub fn grit_pattern_contains(
	...
	GritPatternContainsBuilder { contains_token, contains, until_clause: None }
}
	...
	pub fn build(self) -> GritPatternContains {
		GritPatternContains::unwrap_cast(SyntaxNode::new_detached(
			...
			[
				...
				self.until_clause.map(|token| SyntaxElement::Node(token.into_syntax())),
			],
		))
	}
}
pub fn grit_pattern_contains_until_clause(
	...
	GritPatternContainsUntilClause::unwrap_cast(SyntaxNode::new_detached(
		...
		[Some(SyntaxElement::Token(until_token)), Some(SyntaxElement::Node(until.into_syntax()))],
	))
}
...
impl GritPatternDefinitionBuilder {
	...
	pub fn build(self) -> GritPatternDefinition {
		GritPatternDefinition::unwrap_cast(SyntaxNode::new_detached(
			...
			[
				self.visibility_token.map(|token| SyntaxElement::Token(token)),
				Some(SyntaxElement::Token(self.pattern_token)),
				Some(SyntaxElement::Node(self.name.into_syntax())),
				Some(SyntaxElement::Token(self.l_paren_token)),
				Some(SyntaxElement::Node(self.args.into_syntax())),
				Some(SyntaxElement::Token(self.r_paren_token)),
				self.language.map(|token| SyntaxElement::Node(token.into_syntax())),
...
pub fn grit_pattern_maybe(
	...
	GritPatternMaybe::unwrap_cast(SyntaxNode::new_detached(
		...
		[Some(SyntaxElement::Token(maybe_token)), Some(SyntaxElement::Node(pattern.into_syntax()))],
	))
}
...
pub fn grit_predicate_and(
	...
	GritPredicateAndBuilder { l_curly_token, predicates, r_curly_token, and_token: None }
}
...
pub fn grit_predicate_rewrite(
	...
	GritPredicateRewriteBuilder { left, fat_arrow_token, right, annotation: None }
}
	...
	pub fn build(self) -> GritPredicateRewrite {
		GritPredicateRewrite::unwrap_cast(SyntaxNode::new_detached(
			...
			[
				...
				self.annotation.map(|token| SyntaxElement::Node(token.into_syntax())),
...
pub fn grit_regex_pattern(regex: AnyGritRegex) -> GritRegexPatternBuilder {
	GritRegexPatternBuilder { regex, variables: None }
}
...
pub fn grit_rewrite(
	...
	GritRewriteBuilder { left, fat_arrow_token, right, annotation: None }
}
...
pub fn grit_root(definitions: GritDefinitionList, eof_token: SyntaxToken) -> GritRootBuilder {
	GritRootBuilder { definitions, eof_token, bom_token: None, version: None, language: None }
}
	...
	pub fn build(self) -> GritRoot {
		GritRoot::unwrap_cast(SyntaxNode::new_detached(
			...
			[
				...
				self.version.map(|token| SyntaxElement::Node(token.into_syntax())),
				self.language.map(|token| SyntaxElement::Node(token.into_syntax())),
...
pub fn grit_some(some_token: SyntaxToken, pattern: AnyGritMaybeCurlyPattern) -> GritSome {
	GritSome::unwrap_cast(SyntaxNode::new_detached(
		...
		[Some(SyntaxElement::Token(some_token)), Some(SyntaxElement::Node(pattern.into_syntax()))],
	))
}
