...
pub fn json_member(name:JsonMemberName, colon_token:SyntaxToken, value:AnyJsonValue) -> JsonMember {
...
pub fn json_root(value:AnyJsonValue, eof_token:SyntaxToken) -> JsonRootBuilder {
	JsonRootBuilder { value, eof_token, bom_token:None }
}
...
where
	I: IntoIterator<Item = Option<SyntaxElement>>,
	I::IntoIter: ExactSizeIterator, {
	JsonBogusValue::unwrap_cast(SyntaxNode::new_detached(JsonSyntaxKind::JSON_BOGUS_VALUE, slots))
}
