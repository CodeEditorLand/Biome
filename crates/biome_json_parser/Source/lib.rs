...
pub(crate) type JsonLosslessTreeSink<'source> = LosslessTreeSink<'source, JsonLanguage, JsonSyntaxFactory>;
...
pub fn parse_json_with_cache(source: &str, cache: &mut NodeCache, config: JsonParserOptions) -> JsonParse {
