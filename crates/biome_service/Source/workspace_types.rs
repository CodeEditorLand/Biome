...
fn instance_type<'a>(
	...
	match ty {
		// If the instance type is an object, generate a TS object type with the corresponding
		// properties
		InstanceType::Object => {
		...
		// If the instance type is an array, generate a TS array type with the corresponding item
		// type
		InstanceType::Array => {
