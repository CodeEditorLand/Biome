...
pub use crate::{
	diagnostics::{TransportError, WorkspaceError},
	matcher::Matcher,
	workspace::Workspace,
};
...
pub struct App<'app> {
	...
	/// A reference to the internal console, where its buffer will be used to
...
impl<'app> App<'app> {
	...
	/// Create a new instance of the app using the specified [FileSystem] and
	...
	/// Create a new instance of the app using the specified [FileSystem],
	/// [Console] and [Workspace] implementation
	pub fn new(
		fs:DynRef<'app, dyn FileSystem>,
		console:&'app mut dyn Console,
		workspace:WorkspaceRef<'app>,
	) -> Self {
		Self { fs, console, workspace }
	}
}
