...
use biome_diagnostics::{Applicability, Diagnostic, DiagnosticExt, Severity, category};
use biome_formatter::{
	AttributePosition,
	BracketSpacing,
	FormatError,
...
use crate::{
	...
	file_handlers::{FixAllParams, is_diagnostic_error},
	settings::{
		FormatSettings,
...
impl ServiceLanguage for JsLanguage {
	...
	fn resolve_analyzer_options(
		...
		AnalyzerOptions { configuration, file_path:path.to_path_buf(), suppression_reason }
	}
}
