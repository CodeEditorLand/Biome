...
impl ScopeId {
	...
	pub(crate) fn index(self) -> usize {
		// SAFETY: The internal representation ensures that the value is never
		// equal to 0. Thus, it is safe to substract 1.
...
impl SemanticModelData {
	...
	pub(crate) fn scope(&self, range:TextRange) -> ScopeId {
		// Seeking an interval in `self.scope_by_range` require a non-empty
		// interval
