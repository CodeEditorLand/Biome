...
const ISO_COUNTRIES: &[&str] = &[
	...
	"BT", "BO", "BA", "BW", "BR", "IO", "VG", "BN", "BG", "BF", "MM", "BI",
	"KH", "CM", "CA", "CV", "KY", "CF", "TD", "CL", "CN", "CX", "CC", "CO",
	"KM", "CK", "CR", "HR", "CU", "CY", "CZ", "CD", "DK", "DJ", "DM", "DO",
	"EC", "EG", "SV", "GQ", "ER", "EE", "ET", "FK", "FO", "FJ", "FI", "FR",
	"PF", "GA", "GM", "GE", "DE", "GH", "GI", "GR", "GL", "GD", "GU", "GT",
	"GN", "GW", "GY", "HT", "VA", "HN", "HK", "HU", "IS", "IN", "ID", "IR",
	"IQ", "IE", "IM", "IL", "IT", "CI", "JM", "JP", "JE", "JO", "KZ", "KE",
	"KI", "KW", "KG", "LA", "LV", "LB", "LS", "LR", "LY", "LI", "LT", "LU",
	"MO", "MK", "MG", "MW", "MY", "MV", "ML", "MT", "MH", "MR", "MU", "YT",
	"MX", "FM", "MD", "MC", "MN", "ME", "MS", "MA", "MZ", "NA", "NR", "NP",
	"NL", "AN", "NC", "NZ", "NI", "NE", "NG", "NU", "KP", "MP", "NO", "OM",
	"PK", "PW", "PA", "PG", "PY", "PE", "PH", "PN", "PL", "PT", "PR", "QA",
	"CG", "RO", "RU", "RW", "BL", "SH", "KN", "LC", "MF", "PM", "VC", "WS",
	"SM", "ST", "SA", "SN", "RS", "SC", "SL", "SG", "SK", "SI", "SB", "SO",
	"ZA", "KR", "ES", "LK", "SD", "SR", "SJ", "SZ", "SE", "CH", "SY", "TW",
	"TJ", "TZ", "TH", "TL", "TG", "TK", "TO", "TT", "TN", "TR", "TM", "TC",
	"TV", "UG", "UA", "AE", "GB", "US", "UY", "VI", "UZ", "VU", "VE", "VN",
	"WF", "EH", "YE", "ZM", "ZW",
];
...
const ISO_LANGUAGES: &[&str] = &[
	...
	"zh-Hans", "zh-Hant", "co", "hr", "cs", "da", "nl", "en", "eo", "et", "fo",
	"fa", "fj", "fi", "fr", "fy", "gl", "gd", "gv", "ka", "de", "el", "kl",
	"gn", "gu", "ht", "ha", "he", "iw", "hi", "hu", "is", "io", "id", "in",
	"ia", "ie", "iu", "ik", "ga", "it", "ja", "jv", "kn", "ks", "kk", "rw",
	"ky", "rn", "ko", "ku", "lo", "la", "lv", "li", "ln", "lt", "mk", "mg",
	"ms", "ml", "mt", "mi", "mr", "mo", "mn", "na", "ne", "no", "oc", "or",
	"om", "ps", "pl", "pt", "pa", "qu", "rm", "ro", "ru", "sm", "sg", "sa",
	"sr", "sh", "st", "tn", "sn", "ii", "sd", "si", "ss", "sk", "sl", "so",
	"es", "su", "sw", "sv", "tl", "tg", "ta", "tt", "te", "th", "bo", "ti",
	"to", "ts", "tr", "tk", "tw", "ug", "uk", "ur", "uz", "vi", "vo", "wa",
	"cy", "wo", "xh", "yi", "ji", "yo", "zu",
];
...
impl Aria {
	fn inherits_role(
		...
		if !self.roles.contains_key(candidate_role_name) {
			return Err(format!(
				"The role '{candidate_role_name}' doesn't exist"
			));
		}
...
#[derive(
	Clone, Copy, Debug, Eq, Ord, PartialEq, PartialOrd, serde::Deserialize,
)]
...
fn main() -> io::Result<()> {
	...
	let aria_attribute_names: Vec<_> =
		data.attributes.keys().map(|name| name.as_str()).collect();
	let abstract_aria_roles: BTreeMap<_, _> =
		data.roles.iter().filter(|(_, role)| role.is_abstract).collect();
	let abstract_aria_role_names: Vec<_> =
		abstract_aria_roles.keys().map(|name| name.as_str()).collect();
	...
	let aria_properties =
		generate_enums(&aria_attribute_names[..], "AriaPropertiesEnum");

	let abstract_roles =
		generate_enums(&abstract_aria_role_names[..], "AriaAbstractRolesEnum");
	let structure_roles = generate_enums(
		&structure_aria_roles[..],
		"AriaDocumentStructureRolesEnum",
	);
	let widget_roles =
		generate_enums(&widget_aria_roles[..], "AriaWidgetRolesEnum");
...
fn generate_enums(array: &[&str], enum_name: &str) -> TokenStream {
	...
	for property in array {
		let name =
			Ident::new(&Case::Pascal.convert(property), Span::call_site());
