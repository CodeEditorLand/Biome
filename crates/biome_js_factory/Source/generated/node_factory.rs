...
use biome_js_syntax::{
	JsSyntaxElement as SyntaxElement,
	JsSyntaxNode as SyntaxNode,
...
pub fn js_await_expression(await_token:SyntaxToken, argument:AnyJsExpression) -> JsAwaitExpression {
...
pub fn js_new_expression(new_token:SyntaxToken, callee:AnyJsExpression) -> JsNewExpressionBuilder {
...
impl JsPropertyClassMemberBuilder {
	pub fn with_property_annotation(mut self, property_annotation:AnyTsPropertyAnnotation) -> Self {
...
impl JsVariableDeclaratorBuilder {
	pub fn with_variable_annotation(mut self, variable_annotation:AnyTsVariableAnnotation) -> Self {
...
pub fn jsx_opening_element(
	...
	JsxOpeningElementBuilder { l_angle_token, name, attributes, r_angle_token, type_arguments:None }
}
...
pub fn ts_global_declaration(global_token:SyntaxToken, body:TsModuleBlock) -> TsGlobalDeclaration {
...
pub fn ts_implements_clause(implements_token:SyntaxToken, types:TsTypeList) -> TsImplementsClause {
...
pub fn ts_qualified_name(left:AnyTsName, dot_token:SyntaxToken, right:JsName) -> TsQualifiedName {
...
pub fn ts_type_operator_type(operator_token_token:SyntaxToken, ty:AnyTsType) -> TsTypeOperatorType {
...
pub fn ts_typeof_type(typeof_token:SyntaxToken, expression_name:AnyTsName) -> TsTypeofTypeBuilder {
