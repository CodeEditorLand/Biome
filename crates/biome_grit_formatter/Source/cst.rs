use crate::prelude::*;
use biome_formatter::{
	FormatOwnedWithRule, FormatRefWithRule, FormatResult, FormatToken,
};
...
impl AsFormat<GritFormatContext> for GritSyntaxNode {
	type Format<'a> =
		FormatRefWithRule<'a, GritSyntaxNode, FormatGritSyntaxNode>;
...
impl AsFormat<GritFormatContext> for GritSyntaxToken {
	type Format<'a> =
		FormatRefWithRule<'a, GritSyntaxToken, FormatGritSyntaxToken>;
