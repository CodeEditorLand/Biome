...
impl CommentStyle for GritCommentStyle {
	...
	fn get_comment_kind(_comment: &biome_rowan::SyntaxTriviaPieceComments<Self::Language>) -> CommentKind {
		CommentKind::Line
	}
...
impl FormatRule<SourceComment<GritLanguage>> for FormatGritLeadingComment {
	...
	fn fmt(&self, comment: &SourceComment<GritLanguage>, f: &mut Formatter<Self::Context>) -> FormatResult<()> {
