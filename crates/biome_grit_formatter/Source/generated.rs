...
use crate::{
	AsFormat, FormatBogusNodeRule, FormatNodeRule, GritFormatContext,
	...
	for crate::grit::patterns::add_operation::FormatGritAddOperation
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritAddOperation>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::grit::patterns::assignment_as_pattern::FormatGritAssignmentAsPattern
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritAssignmentAsPattern>::fmt(
			self, node, f,
		)
	}
}
impl AsFormat<GritFormatContext>
	for biome_grit_syntax::GritAssignmentAsPattern
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl IntoFormat<GritFormatContext>
	for biome_grit_syntax::GritAssignmentAsPattern
{
	type Format = FormatOwnedWithRule<
        biome_grit_syntax::GritAssignmentAsPattern,
...
impl AsFormat<GritFormatContext>
	for biome_grit_syntax::GritBacktickSnippetLiteral
{
	type Format<'a> = FormatRefWithRule<
        'a,
	...
	for crate::grit::value::boolean_literal::FormatGritBooleanLiteral
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritBooleanLiteral>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::grit::patterns::bracketed_pattern::FormatGritBracketedPattern
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritBracketedPattern>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::grit::predicates::bracketed_predicate::FormatGritBracketedPredicate
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritBracketedPredicate>::fmt(
			self, node, f,
		)
	}
}
...
impl IntoFormat<GritFormatContext>
	for biome_grit_syntax::GritBracketedPredicate
{
	type Format = FormatOwnedWithRule<
        biome_grit_syntax::GritBracketedPredicate,
        crate::grit::predicates::bracketed_predicate::FormatGritBracketedPredicate,
	...
	for crate::grit::auxiliary::bubble::FormatGritBubble
{
	...
	fn fmt(
		&self,
		node: &biome_grit_syntax::GritBubble,
		f: &mut GritFormatter,
	) -> FormatResult<()> {
	...
	for crate::grit::patterns::curly_pattern::FormatGritCurlyPattern
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritCurlyPattern>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::grit::predicates::curly_predicate_list::FormatGritCurlyPredicateList
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritCurlyPredicateList>::fmt(
			self, node, f,
		)
	}
}
...
impl IntoFormat<GritFormatContext>
	for biome_grit_syntax::GritCurlyPredicateList
{
	type Format = FormatOwnedWithRule<
        biome_grit_syntax::GritCurlyPredicateList,
        crate::grit::predicates::curly_predicate_list::FormatGritCurlyPredicateList,
	...
	for crate::grit::patterns::div_operation::FormatGritDivOperation
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritDivOperation>::fmt(
			self, node, f,
		)
	}
}
...
impl FormatRule<biome_grit_syntax::GritDot>
	for crate::grit::auxiliary::dot::FormatGritDot
{
	type Context = GritFormatContext;
	#[inline(always)]
	fn fmt(
		&self,
		node: &biome_grit_syntax::GritDot,
		f: &mut GritFormatter,
	) -> FormatResult<()> {
...
impl AsFormat<GritFormatContext> for biome_grit_syntax::GritDot {
	...
	fn format(&self) -> Self::Format<'_> {
		...
		FormatRefWithRule::new(
			self,
			crate::grit::auxiliary::dot::FormatGritDot::default(),
		)
	}
}
	...
	for crate::grit::value::double_literal::FormatGritDoubleLiteral
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritDoubleLiteral>::fmt(
			self, node, f,
		)
	}
}
...
impl FormatRule<biome_grit_syntax::GritEvery>
	for crate::grit::auxiliary::every::FormatGritEvery
{
	type Context = GritFormatContext;
	#[inline(always)]
	fn fmt(
		&self,
		node: &biome_grit_syntax::GritEvery,
		f: &mut GritFormatter,
	) -> FormatResult<()> {
...
impl FormatRule<biome_grit_syntax::GritFiles>
	for crate::grit::auxiliary::files::FormatGritFiles
{
	type Context = GritFormatContext;
	#[inline(always)]
	fn fmt(
		&self,
		node: &biome_grit_syntax::GritFiles,
		f: &mut GritFormatter,
	) -> FormatResult<()> {
...
impl IntoFormat<GritFormatContext>
	for biome_grit_syntax::GritFunctionDefinition
{
	type Format = FormatOwnedWithRule<
        biome_grit_syntax::GritFunctionDefinition,
        crate::grit::declarations::function_definition::FormatGritFunctionDefinition,
	...
	for crate::grit::auxiliary::language_declaration::FormatGritLanguageDeclaration
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritLanguageDeclaration>::fmt(
			self, node, f,
		)
	}
}
impl AsFormat<GritFormatContext>
	for biome_grit_syntax::GritLanguageDeclaration
{
	type Format<'a> = FormatRefWithRule<
        'a,
	...
	for crate::grit::auxiliary::language_flavor::FormatGritLanguageFlavor
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritLanguageFlavor>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::grit::auxiliary::language_flavor_kind::FormatGritLanguageFlavorKind
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritLanguageFlavorKind>::fmt(
			self, node, f,
		)
	}
}
...
impl IntoFormat<GritFormatContext>
	for biome_grit_syntax::GritLanguageFlavorKind
{
	type Format = FormatOwnedWithRule<
        biome_grit_syntax::GritLanguageFlavorKind,
        crate::grit::auxiliary::language_flavor_kind::FormatGritLanguageFlavorKind,
	...
	for crate::grit::auxiliary::language_name::FormatGritLanguageName
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritLanguageName>::fmt(
			self, node, f,
		)
	}
}
...
impl AsFormat<GritFormatContext>
	for biome_grit_syntax::GritLanguageSpecificSnippet
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl FormatRule<biome_grit_syntax::GritLike>
	for crate::grit::auxiliary::like::FormatGritLike
{
	type Context = GritFormatContext;
	#[inline(always)]
	fn fmt(
		&self,
		node: &biome_grit_syntax::GritLike,
		f: &mut GritFormatter,
	) -> FormatResult<()> {
	...
	for crate::grit::auxiliary::like_threshold::FormatGritLikeThreshold
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritLikeThreshold>::fmt(
			self, node, f,
		)
	}
}
...
impl FormatRule<biome_grit_syntax::GritList>
	for crate::grit::auxiliary::list::FormatGritList
{
	type Context = GritFormatContext;
	#[inline(always)]
	fn fmt(
		&self,
		node: &biome_grit_syntax::GritList,
		f: &mut GritFormatter,
	) -> FormatResult<()> {
	...
	for crate::grit::auxiliary::list_accessor::FormatGritListAccessor
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritListAccessor>::fmt(
			self, node, f,
		)
	}
}
...
impl FormatRule<biome_grit_syntax::GritMap>
	for crate::grit::auxiliary::map::FormatGritMap
{
	type Context = GritFormatContext;
	#[inline(always)]
	fn fmt(
		&self,
		node: &biome_grit_syntax::GritMap,
		f: &mut GritFormatter,
	) -> FormatResult<()> {
...
impl AsFormat<GritFormatContext> for biome_grit_syntax::GritMap {
	...
	fn format(&self) -> Self::Format<'_> {
		...
		FormatRefWithRule::new(
			self,
			crate::grit::auxiliary::map::FormatGritMap::default(),
		)
	}
}
	...
	for crate::grit::patterns::mod_operation::FormatGritModOperation
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritModOperation>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::grit::patterns::mul_operation::FormatGritMulOperation
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritMulOperation>::fmt(
			self, node, f,
		)
	}
}
...
impl FormatRule<biome_grit_syntax::GritName>
	for crate::grit::auxiliary::name::FormatGritName
{
	type Context = GritFormatContext;
	#[inline(always)]
	fn fmt(
		&self,
		node: &biome_grit_syntax::GritName,
		f: &mut GritFormatter,
	) -> FormatResult<()> {
	...
	for crate::grit::value::negative_int_literal::FormatGritNegativeIntLiteral
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritNegativeIntLiteral>::fmt(
			self, node, f,
		)
	}
}
...
impl IntoFormat<GritFormatContext>
	for biome_grit_syntax::GritNegativeIntLiteral
{
	type Format = FormatOwnedWithRule<
		biome_grit_syntax::GritNegativeIntLiteral,
		crate::grit::value::negative_int_literal::FormatGritNegativeIntLiteral,
...
impl FormatRule<biome_grit_syntax::GritNot>
	for crate::grit::auxiliary::not::FormatGritNot
{
	type Context = GritFormatContext;
	#[inline(always)]
	fn fmt(
		&self,
		node: &biome_grit_syntax::GritNot,
		f: &mut GritFormatter,
	) -> FormatResult<()> {
...
impl AsFormat<GritFormatContext> for biome_grit_syntax::GritNot {
	...
	fn format(&self) -> Self::Format<'_> {
		...
		FormatRefWithRule::new(
			self,
			crate::grit::auxiliary::not::FormatGritNot::default(),
		)
	}
}
	...
	for crate::grit::patterns::pattern_accumulate::FormatGritPatternAccumulate
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritPatternAccumulate>::fmt(
			self, node, f,
		)
	}
}
...
impl IntoFormat<GritFormatContext>
	for biome_grit_syntax::GritPatternAccumulate
{
	type Format = FormatOwnedWithRule<
		biome_grit_syntax::GritPatternAccumulate,
		crate::grit::patterns::pattern_accumulate::FormatGritPatternAccumulate,
	...
	for crate::grit::patterns::pattern_after::FormatGritPatternAfter
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritPatternAfter>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::grit::patterns::pattern_arg_list::FormatGritPatternArgList
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritPatternArgList>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::grit::patterns::pattern_before::FormatGritPatternBefore
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritPatternBefore>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::grit::patterns::pattern_contains::FormatGritPatternContains
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritPatternContains>::fmt(
			self, node, f,
		)
	}
}
...
impl AsFormat<GritFormatContext>
	for biome_grit_syntax::GritPatternContainsUntilClause
{
	type Format<'a> = FormatRefWithRule<
        'a,
	...
	for crate::grit::patterns::pattern_definition::FormatGritPatternDefinition
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritPatternDefinition>::fmt(
			self, node, f,
		)
	}
}
...
impl IntoFormat<GritFormatContext>
	for biome_grit_syntax::GritPatternDefinition
{
	type Format = FormatOwnedWithRule<
		biome_grit_syntax::GritPatternDefinition,
		crate::grit::patterns::pattern_definition::FormatGritPatternDefinition,
...
impl AsFormat<GritFormatContext>
	for biome_grit_syntax::GritPatternDefinitionBody
{
	type Format<'a> = FormatRefWithRule<
        'a,
	...
	for crate::grit::patterns::pattern_else_clause::FormatGritPatternElseClause
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritPatternElseClause>::fmt(
			self, node, f,
		)
	}
}
...
impl IntoFormat<GritFormatContext>
	for biome_grit_syntax::GritPatternElseClause
{
	type Format = FormatOwnedWithRule<
		biome_grit_syntax::GritPatternElseClause,
		crate::grit::patterns::pattern_else_clause::FormatGritPatternElseClause,
	...
	for crate::grit::patterns::pattern_if_else::FormatGritPatternIfElse
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritPatternIfElse>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::grit::patterns::pattern_includes::FormatGritPatternIncludes
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritPatternIncludes>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::grit::patterns::pattern_limit::FormatGritPatternLimit
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritPatternLimit>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::grit::patterns::pattern_maybe::FormatGritPatternMaybe
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritPatternMaybe>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::grit::patterns::pattern_or_else::FormatGritPatternOrElse
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritPatternOrElse>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::grit::patterns::pattern_where::FormatGritPatternWhere
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritPatternWhere>::fmt(
			self, node, f,
		)
	}
}
...
impl AsFormat<GritFormatContext>
	for biome_grit_syntax::GritPredicateAccumulate
{
	type Format<'a> = FormatRefWithRule<
        'a,
	...
	for crate::grit::predicates::predicate_and::FormatGritPredicateAnd
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritPredicateAnd>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::grit::predicates::predicate_any::FormatGritPredicateAny
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritPredicateAny>::fmt(
			self, node, f,
		)
	}
}
...
impl AsFormat<GritFormatContext>
	for biome_grit_syntax::GritPredicateAssignment
{
	type Format<'a> = FormatRefWithRule<
        'a,
	...
	for crate::grit::predicates::predicate_call::FormatGritPredicateCall
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritPredicateCall>::fmt(
			self, node, f,
		)
	}
}
...
impl AsFormat<GritFormatContext>
	for biome_grit_syntax::GritPredicateDefinition
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<GritFormatContext>
	for biome_grit_syntax::GritPredicateElseClause
{
	type Format<'a> = FormatRefWithRule<
        'a,
	...
	for crate::grit::predicates::predicate_equal::FormatGritPredicateEqual
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritPredicateEqual>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::grit::predicates::predicate_greater::FormatGritPredicateGreater
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritPredicateGreater>::fmt(
			self, node, f,
		)
	}
}
...
impl AsFormat<GritFormatContext>
	for biome_grit_syntax::GritPredicateGreaterEqual
{
	type Format<'a> = FormatRefWithRule<
        'a,
	...
	for crate::grit::predicates::predicate_if_else::FormatGritPredicateIfElse
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritPredicateIfElse>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::grit::predicates::predicate_less::FormatGritPredicateLess
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritPredicateLess>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::grit::predicates::predicate_less_equal::FormatGritPredicateLessEqual
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritPredicateLessEqual>::fmt(
			self, node, f,
		)
	}
}
...
impl IntoFormat<GritFormatContext>
	for biome_grit_syntax::GritPredicateLessEqual
{
	type Format = FormatOwnedWithRule<
        biome_grit_syntax::GritPredicateLessEqual,
        crate::grit::predicates::predicate_less_equal::FormatGritPredicateLessEqual,
	...
	for crate::grit::predicates::predicate_match::FormatGritPredicateMatch
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritPredicateMatch>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::grit::predicates::predicate_maybe::FormatGritPredicateMaybe
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritPredicateMaybe>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::grit::predicates::predicate_not::FormatGritPredicateNot
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritPredicateNot>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::grit::predicates::predicate_not_equal::FormatGritPredicateNotEqual
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritPredicateNotEqual>::fmt(
			self, node, f,
		)
	}
}
...
impl IntoFormat<GritFormatContext>
	for biome_grit_syntax::GritPredicateNotEqual
{
	type Format = FormatOwnedWithRule<
        biome_grit_syntax::GritPredicateNotEqual,
        crate::grit::predicates::predicate_not_equal::FormatGritPredicateNotEqual,
	...
	for crate::grit::predicates::predicate_return::FormatGritPredicateReturn
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritPredicateReturn>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::grit::predicates::predicate_rewrite::FormatGritPredicateRewrite
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritPredicateRewrite>::fmt(
			self, node, f,
		)
	}
}
...
impl AsFormat<GritFormatContext>
	for biome_grit_syntax::GritRawBacktickSnippetLiteral
{
	type Format<'a> = FormatRefWithRule<
        'a,
	...
	for crate::grit::value::regex_literal::FormatGritRegexLiteral
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritRegexLiteral>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::grit::patterns::regex_pattern::FormatGritRegexPattern
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritRegexPattern>::fmt(
			self, node, f,
		)
	}
}
...
impl AsFormat<GritFormatContext>
	for biome_grit_syntax::GritRegexPatternVariables
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl FormatRule<biome_grit_syntax::GritRoot>
	for crate::grit::auxiliary::root::FormatGritRoot
{
	type Context = GritFormatContext;
	#[inline(always)]
	fn fmt(
		&self,
		node: &biome_grit_syntax::GritRoot,
		f: &mut GritFormatter,
	) -> FormatResult<()> {
	...
	for crate::grit::value::snippet_regex_literal::FormatGritSnippetRegexLiteral
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritSnippetRegexLiteral>::fmt(
			self, node, f,
		)
	}
}
impl AsFormat<GritFormatContext>
	for biome_grit_syntax::GritSnippetRegexLiteral
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl FormatRule<biome_grit_syntax::GritSome>
	for crate::grit::auxiliary::some::FormatGritSome
{
	type Context = GritFormatContext;
	#[inline(always)]
	fn fmt(
		&self,
		node: &biome_grit_syntax::GritSome,
		f: &mut GritFormatter,
	) -> FormatResult<()> {
	...
	for crate::grit::value::string_literal::FormatGritStringLiteral
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritStringLiteral>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::grit::patterns::sub_operation::FormatGritSubOperation
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritSubOperation>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::grit::value::undefined_literal::FormatGritUndefinedLiteral
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_grit_syntax::GritUndefinedLiteral>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::grit::auxiliary::within::FormatGritWithin
{
	...
	fn fmt(
		&self,
		node: &biome_grit_syntax::GritWithin,
		f: &mut GritFormatter,
	) -> FormatResult<()> {
...
impl IntoFormat<GritFormatContext>
	for biome_grit_syntax::GritLanguageFlavorList
{
	type Format = FormatOwnedWithRule<
		biome_grit_syntax::GritLanguageFlavorList,
		crate::grit::lists::language_flavor_list::FormatGritLanguageFlavorList,
...
impl FormatRule<biome_grit_syntax::GritBogus>
	for crate::grit::bogus::bogus::FormatGritBogus
{
	type Context = GritFormatContext;
	#[inline(always)]
	fn fmt(
		&self,
		node: &biome_grit_syntax::GritBogus,
		f: &mut GritFormatter,
	) -> FormatResult<()> {
...
impl AsFormat<GritFormatContext> for biome_grit_syntax::GritBogus {
	...
	fn format(&self) -> Self::Format<'_> {
		...
		FormatRefWithRule::new(
			self,
			crate::grit::bogus::bogus::FormatGritBogus::default(),
		)
	}
}
	...
	for crate::grit::bogus::bogus_container::FormatGritBogusContainer
{
	...
	fn fmt(
		...
		FormatBogusNodeRule::<biome_grit_syntax::GritBogusContainer>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::grit::bogus::bogus_definition::FormatGritBogusDefinition
{
	...
	fn fmt(
		...
		FormatBogusNodeRule::<biome_grit_syntax::GritBogusDefinition>::fmt(
			self, node, f,
		)
	}
}
...
impl AsFormat<GritFormatContext>
	for biome_grit_syntax::GritBogusLanguageDeclaration
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<GritFormatContext>
	for biome_grit_syntax::GritBogusLanguageFlavorKind
{
	type Format<'a> = FormatRefWithRule<
        'a,
	...
	for crate::grit::bogus::bogus_literal::FormatGritBogusLiteral
{
	...
	fn fmt(
		...
		FormatBogusNodeRule::<biome_grit_syntax::GritBogusLiteral>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::grit::bogus::bogus_map_element::FormatGritBogusMapElement
{
	...
	fn fmt(
		...
		FormatBogusNodeRule::<biome_grit_syntax::GritBogusMapElement>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::grit::bogus::bogus_named_arg::FormatGritBogusNamedArg
{
	...
	fn fmt(
		...
		FormatBogusNodeRule::<biome_grit_syntax::GritBogusNamedArg>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::grit::bogus::bogus_pattern::FormatGritBogusPattern
{
	...
	fn fmt(
		...
		FormatBogusNodeRule::<biome_grit_syntax::GritBogusPattern>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::grit::bogus::bogus_predicate::FormatGritBogusPredicate
{
	...
	fn fmt(
		...
		FormatBogusNodeRule::<biome_grit_syntax::GritBogusPredicate>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::grit::bogus::bogus_version::FormatGritBogusVersion
{
	...
	fn fmt(
		...
		FormatBogusNodeRule::<biome_grit_syntax::GritBogusVersion>::fmt(
			self, node, f,
		)
	}
}
...
impl AsFormat<GritFormatContext>
	for biome_grit_syntax::AnyGritCodeSnippetSource
{
	type Format<'a> = FormatRefWithRule<
		'a,
...
impl AsFormat<GritFormatContext>
	for biome_grit_syntax::AnyGritLanguageDeclaration
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<GritFormatContext>
	for biome_grit_syntax::AnyGritLanguageFlavorKind
{
	type Format<'a> = FormatRefWithRule<
		'a,
...
impl AsFormat<GritFormatContext>
	for biome_grit_syntax::AnyGritListAccessorSubject
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<GritFormatContext>
	for biome_grit_syntax::AnyGritMapAccessorSubject
{
	type Format<'a> = FormatRefWithRule<
		'a,
...
impl AsFormat<GritFormatContext>
	for biome_grit_syntax::AnyGritMaybeCurlyPattern
{
	type Format<'a> = FormatRefWithRule<
		'a,
...
impl AsFormat<GritFormatContext>
	for biome_grit_syntax::AnyGritPredicateMatchSubject
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<GritFormatContext> for biome_grit_syntax::AnyGritRegex {
	...
	fn format(&self) -> Self::Format<'_> {
		...
		FormatRefWithRule::new(
			self,
			crate::grit::any::regex::FormatAnyGritRegex::default(),
		)
	}
}
