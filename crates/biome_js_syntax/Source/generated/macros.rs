...
macro_rules! map_syntax_node {
	($node:expr, $pattern:pat => $body:expr) => {
		match $node {
			node => {
				match $crate::JsSyntaxNode::kind(&node) {
					...
					$crate::JsSyntaxKind::JS_ARRAY_ASSIGNMENT_PATTERN => {
						let $pattern =
							unsafe { $crate::JsArrayAssignmentPattern::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::JS_ARRAY_ASSIGNMENT_PATTERN_REST_ELEMENT => {
						let $pattern = unsafe {
							$crate::JsArrayAssignmentPatternRestElement::new_unchecked(node)
						};
						$body
					},
					$crate::JsSyntaxKind::JS_ARRAY_BINDING_PATTERN => {
						let $pattern =
							unsafe { $crate::JsArrayBindingPattern::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::JS_ARRAY_BINDING_PATTERN_REST_ELEMENT => {
						let $pattern = unsafe {
							$crate::JsArrayBindingPatternRestElement::new_unchecked(node)
						};
						$body
					},
					...
					$crate::JsSyntaxKind::JS_ASSIGNMENT_EXPRESSION => {
						let $pattern =
							unsafe { $crate::JsAssignmentExpression::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::JS_CONDITIONAL_EXPRESSION => {
						let $pattern =
							unsafe { $crate::JsConditionalExpression::new_unchecked(node) };
						$body
					},
					$crate::JsSyntaxKind::JS_CONSTRUCTOR_CLASS_MEMBER => {
						let $pattern =
							unsafe { $crate::JsConstructorClassMember::new_unchecked(node) };
						$body
					},
					$crate::JsSyntaxKind::JS_CONSTRUCTOR_PARAMETERS => {
						let $pattern =
							unsafe { $crate::JsConstructorParameters::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::JS_DEFAULT_IMPORT_SPECIFIER => {
						let $pattern =
							unsafe { $crate::JsDefaultImportSpecifier::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::JS_EXPORT_DEFAULT_DECLARATION_CLAUSE => {
						let $pattern = unsafe {
							$crate::JsExportDefaultDeclarationClause::new_unchecked(node)
						};
						$body
					},
					...
					$crate::JsSyntaxKind::JS_EXPORT_NAMED_FROM_CLAUSE => {
						let $pattern =
							unsafe { $crate::JsExportNamedFromClause::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::JS_EXPORT_NAMED_SPECIFIER => {
						let $pattern =
							unsafe { $crate::JsExportNamedSpecifier::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::JS_EXPRESSION_STATEMENT => {
						let $pattern =
							unsafe { $crate::JsExpressionStatement::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::JS_FOR_VARIABLE_DECLARATION => {
						let $pattern =
							unsafe { $crate::JsForVariableDeclaration::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::JS_FUNCTION_DECLARATION => {
						let $pattern =
							unsafe { $crate::JsFunctionDeclaration::new_unchecked(node) };
						$body
					},
					$crate::JsSyntaxKind::JS_FUNCTION_EXPORT_DEFAULT_DECLARATION => {
						let $pattern = unsafe {
							$crate::JsFunctionExportDefaultDeclaration::new_unchecked(node)
						};
						$body
					},
					...
					$crate::JsSyntaxKind::JS_IDENTIFIER_ASSIGNMENT => {
						let $pattern =
							unsafe { $crate::JsIdentifierAssignment::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::JS_IDENTIFIER_EXPRESSION => {
						let $pattern =
							unsafe { $crate::JsIdentifierExpression::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::JS_IMPORT_ASSERTION_ENTRY => {
						let $pattern =
							unsafe { $crate::JsImportAssertionEntry::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::JS_IMPORT_CALL_EXPRESSION => {
						let $pattern =
							unsafe { $crate::JsImportCallExpression::new_unchecked(node) };
						$body
					},
					$crate::JsSyntaxKind::JS_IMPORT_COMBINED_CLAUSE => {
						let $pattern =
							unsafe { $crate::JsImportCombinedClause::new_unchecked(node) };
						$body
					},
					$crate::JsSyntaxKind::JS_IMPORT_DEFAULT_CLAUSE => {
						let $pattern =
							unsafe { $crate::JsImportDefaultClause::new_unchecked(node) };
						$body
					},
					$crate::JsSyntaxKind::JS_IMPORT_META_EXPRESSION => {
						let $pattern =
							unsafe { $crate::JsImportMetaExpression::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::JS_IMPORT_NAMESPACE_CLAUSE => {
						let $pattern =
							unsafe { $crate::JsImportNamespaceClause::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::JS_INSTANCEOF_EXPRESSION => {
						let $pattern =
							unsafe { $crate::JsInstanceofExpression::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::JS_NAMED_IMPORT_SPECIFIER => {
						let $pattern =
							unsafe { $crate::JsNamedImportSpecifier::new_unchecked(node) };
						$body
					},
					$crate::JsSyntaxKind::JS_NAMED_IMPORT_SPECIFIERS => {
						let $pattern =
							unsafe { $crate::JsNamedImportSpecifiers::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::JS_NEW_TARGET_EXPRESSION => {
						let $pattern =
							unsafe { $crate::JsNewTargetExpression::new_unchecked(node) };
						$body
					},
					$crate::JsSyntaxKind::JS_NULL_LITERAL_EXPRESSION => {
						let $pattern =
							unsafe { $crate::JsNullLiteralExpression::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::JS_OBJECT_ASSIGNMENT_PATTERN_PROPERTY => {
						let $pattern = unsafe {
							$crate::JsObjectAssignmentPatternProperty::new_unchecked(node)
						};
						$body
					},
					...
					$crate::JsSyntaxKind::JS_OBJECT_BINDING_PATTERN => {
						let $pattern =
							unsafe { $crate::JsObjectBindingPattern::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::JS_POST_UPDATE_EXPRESSION => {
						let $pattern =
							unsafe { $crate::JsPostUpdateExpression::new_unchecked(node) };
						$body
					},
					$crate::JsSyntaxKind::JS_PRE_UPDATE_EXPRESSION => {
						let $pattern =
							unsafe { $crate::JsPreUpdateExpression::new_unchecked(node) };
						$body
					},
					$crate::JsSyntaxKind::JS_PRIVATE_CLASS_MEMBER_NAME => {
						let $pattern =
							unsafe { $crate::JsPrivateClassMemberName::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::JS_PROPERTY_CLASS_MEMBER => {
						let $pattern =
							unsafe { $crate::JsPropertyClassMember::new_unchecked(node) };
						$body
					},
					$crate::JsSyntaxKind::JS_PROPERTY_OBJECT_MEMBER => {
						let $pattern =
							unsafe { $crate::JsPropertyObjectMember::new_unchecked(node) };
						$body
					},
					$crate::JsSyntaxKind::JS_REFERENCE_IDENTIFIER => {
						let $pattern =
							unsafe { $crate::JsReferenceIdentifier::new_unchecked(node) };
						$body
					},
					$crate::JsSyntaxKind::JS_REGEX_LITERAL_EXPRESSION => {
						let $pattern =
							unsafe { $crate::JsRegexLiteralExpression::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::JS_STATIC_MEMBER_ASSIGNMENT => {
						let $pattern =
							unsafe { $crate::JsStaticMemberAssignment::new_unchecked(node) };
						$body
					},
					$crate::JsSyntaxKind::JS_STATIC_MEMBER_EXPRESSION => {
						let $pattern =
							unsafe { $crate::JsStaticMemberExpression::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::JS_TEMPLATE_CHUNK_ELEMENT => {
						let $pattern =
							unsafe { $crate::JsTemplateChunkElement::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::JS_TRY_FINALLY_STATEMENT => {
						let $pattern =
							unsafe { $crate::JsTryFinallyStatement::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::JS_VARIABLE_DECLARATION => {
						let $pattern =
							unsafe { $crate::JsVariableDeclaration::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::JSX_REFERENCE_IDENTIFIER => {
						let $pattern =
							unsafe { $crate::JsxReferenceIdentifier::new_unchecked(node) };
						$body
					},
					$crate::JsSyntaxKind::JSX_SELF_CLOSING_ELEMENT => {
						let $pattern =
							unsafe { $crate::JsxSelfClosingElement::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::TS_ACCESSIBILITY_MODIFIER => {
						let $pattern =
							unsafe { $crate::TsAccessibilityModifier::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::TS_CONSTRUCTOR_SIGNATURE_CLASS_MEMBER => {
						let $pattern = unsafe {
							$crate::TsConstructorSignatureClassMember::new_unchecked(node)
						};
						$body
					},
					...
					$crate::JsSyntaxKind::TS_EXPORT_ASSIGNMENT_CLAUSE => {
						let $pattern =
							unsafe { $crate::TsExportAssignmentClause::new_unchecked(node) };
						$body
					},
					$crate::JsSyntaxKind::TS_EXPORT_DECLARE_CLAUSE => {
						let $pattern =
							unsafe { $crate::TsExportDeclareClause::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::TS_IMPORT_TYPE_ARGUMENTS => {
						let $pattern =
							unsafe { $crate::TsImportTypeArguments::new_unchecked(node) };
						$body
					},
					$crate::JsSyntaxKind::TS_IMPORT_TYPE_ASSERTION => {
						let $pattern =
							unsafe { $crate::TsImportTypeAssertion::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::TS_IMPORT_TYPE_QUALIFIER => {
						let $pattern =
							unsafe { $crate::TsImportTypeQualifier::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::TS_INTERFACE_DECLARATION => {
						let $pattern =
							unsafe { $crate::TsInterfaceDeclaration::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::TS_LITERAL_ENUM_MEMBER_NAME => {
						let $pattern =
							unsafe { $crate::TsLiteralEnumMemberName::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::TS_MAPPED_TYPE_OPTIONAL_MODIFIER_CLAUSE => {
						let $pattern = unsafe {
							$crate::TsMappedTypeOptionalModifierClause::new_unchecked(node)
						};
						$body
					},
					$crate::JsSyntaxKind::TS_MAPPED_TYPE_READONLY_MODIFIER_CLAUSE => {
						let $pattern = unsafe {
							$crate::TsMappedTypeReadonlyModifierClause::new_unchecked(node)
						};
						$body
					},
					...
					$crate::JsSyntaxKind::TS_NAMED_TUPLE_TYPE_ELEMENT => {
						let $pattern =
							unsafe { $crate::TsNamedTupleTypeElement::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::TS_PREDICATE_RETURN_TYPE => {
						let $pattern =
							unsafe { $crate::TsPredicateReturnType::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::TS_QUALIFIED_MODULE_NAME => {
						let $pattern =
							unsafe { $crate::TsQualifiedModuleName::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::TS_REST_TUPLE_TYPE_ELEMENT => {
						let $pattern =
							unsafe { $crate::TsRestTupleTypeElement::new_unchecked(node) };
						$body
					},
					$crate::JsSyntaxKind::TS_RETURN_TYPE_ANNOTATION => {
						let $pattern =
							unsafe { $crate::TsReturnTypeAnnotation::new_unchecked(node) };
						$body
					},
					$crate::JsSyntaxKind::TS_SATISFIES_ASSIGNMENT => {
						let $pattern =
							unsafe { $crate::TsSatisfiesAssignment::new_unchecked(node) };
						$body
					},
					$crate::JsSyntaxKind::TS_SATISFIES_EXPRESSION => {
						let $pattern =
							unsafe { $crate::TsSatisfiesExpression::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::TS_TEMPLATE_CHUNK_ELEMENT => {
						let $pattern =
							unsafe { $crate::TsTemplateChunkElement::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::TS_TEMPLATE_LITERAL_TYPE => {
						let $pattern =
							unsafe { $crate::TsTemplateLiteralType::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::TS_TYPE_ALIAS_DECLARATION => {
						let $pattern =
							unsafe { $crate::TsTypeAliasDeclaration::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::TS_TYPE_CONSTRAINT_CLAUSE => {
						let $pattern =
							unsafe { $crate::TsTypeConstraintClause::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::JS_ARRAY_ASSIGNMENT_PATTERN_ELEMENT_LIST => {
						let $pattern = unsafe {
							$crate::JsArrayAssignmentPatternElementList::new_unchecked(node)
						};
						$body
					},
					$crate::JsSyntaxKind::JS_ARRAY_BINDING_PATTERN_ELEMENT_LIST => {
						let $pattern = unsafe {
							$crate::JsArrayBindingPatternElementList::new_unchecked(node)
						};
						$body
					},
					...
					$crate::JsSyntaxKind::JS_OBJECT_BINDING_PATTERN_PROPERTY_LIST => {
						let $pattern = unsafe {
							$crate::JsObjectBindingPatternPropertyList::new_unchecked(node)
						};
						$body
					},
					...
					$crate::JsSyntaxKind::JS_PROPERTY_MODIFIER_LIST => {
						let $pattern =
							unsafe { $crate::JsPropertyModifierList::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::JS_TEMPLATE_ELEMENT_LIST => {
						let $pattern =
							unsafe { $crate::JsTemplateElementList::new_unchecked(node) };
						$body
					},
					$crate::JsSyntaxKind::JS_VARIABLE_DECLARATOR_LIST => {
						let $pattern =
							unsafe { $crate::JsVariableDeclaratorList::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::TS_TEMPLATE_ELEMENT_LIST => {
						let $pattern =
							unsafe { $crate::TsTemplateElementList::new_unchecked(node) };
						$body
					},
					$crate::JsSyntaxKind::TS_TUPLE_TYPE_ELEMENT_LIST => {
						let $pattern =
							unsafe { $crate::TsTupleTypeElementList::new_unchecked(node) };
						$body
					},
					...
					$crate::JsSyntaxKind::TS_UNION_TYPE_VARIANT_LIST => {
						let $pattern =
							unsafe { $crate::TsUnionTypeVariantList::new_unchecked(node) };
						$body
					},
