...
impl JsAccessorModifier {
	pub fn with_modifier_token(self, element: SyntaxToken) -> Self {
		Self::unwrap_cast(self.syntax.splice_slots(0usize..=0usize, once(Some(element.into()))))
	}
}
impl JsArrayAssignmentPattern {
	...
	pub fn with_elements(self, element: JsArrayAssignmentPatternElementList) -> Self {
		Self::unwrap_cast(
			self.syntax.splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
		)
	}
	pub fn with_r_brack_token(self, element: SyntaxToken) -> Self {
		Self::unwrap_cast(self.syntax.splice_slots(2usize..=2usize, once(Some(element.into()))))
	}
}
impl JsArrayAssignmentPatternElement {
	pub fn with_pattern(self, element: AnyJsAssignmentPattern) -> Self {
		Self::unwrap_cast(
			self.syntax.splice_slots(0usize..=0usize, once(Some(element.into_syntax().into()))),
		)
	}
...
impl JsArrowFunctionExpression {
	pub fn with_async_token(self, element: Option<SyntaxToken>) -> Self {
		Self::unwrap_cast(
			self.syntax.splice_slots(0usize..=0usize, once(element.map(|element| element.into()))),
		)
	}
	...
	pub fn with_parameters(self, element: AnyJsArrowFunctionParameters) -> Self {
		Self::unwrap_cast(
			self.syntax.splice_slots(2usize..=2usize, once(Some(element.into_syntax().into()))),
		)
	}
	...
	pub fn with_fat_arrow_token(self, element: SyntaxToken) -> Self {
		Self::unwrap_cast(self.syntax.splice_slots(4usize..=4usize, once(Some(element.into()))))
	}
	pub fn with_body(self, element: AnyJsFunctionBody) -> Self {
		Self::unwrap_cast(
			self.syntax.splice_slots(5usize..=5usize, once(Some(element.into_syntax().into()))),
		)
	}
}
impl JsAssignmentExpression {
	...
	pub fn with_operator_token_token(self, element: SyntaxToken) -> Self {
		Self::unwrap_cast(self.syntax.splice_slots(1usize..=1usize, once(Some(element.into()))))
	}
...
impl JsBreakStatement {
	...
	pub fn with_semicolon_token(self, element: Option<SyntaxToken>) -> Self {
		Self::unwrap_cast(
			self.syntax.splice_slots(2usize..=2usize, once(element.map(|element| element.into()))),
		)
	}
}
...
impl JsCallExpression {
	...
	pub fn with_optional_chain_token(self, element: Option<SyntaxToken>) -> Self {
		Self::unwrap_cast(
			self.syntax.splice_slots(1usize..=1usize, once(element.map(|element| element.into()))),
		)
	}
	...
	pub fn with_arguments(self, element: JsCallArguments) -> Self {
		Self::unwrap_cast(
			self.syntax.splice_slots(3usize..=3usize, once(Some(element.into_syntax().into()))),
		)
	}
}
impl JsCaseClause {
...
impl JsCatchDeclaration {
	...
	pub fn with_r_paren_token(self, element: SyntaxToken) -> Self {
		Self::unwrap_cast(self.syntax.splice_slots(3usize..=3usize, once(Some(element.into()))))
	}
}
impl JsClassDeclaration {
	...
	pub fn with_l_curly_token(self, element: SyntaxToken) -> Self {
		Self::unwrap_cast(self.syntax.splice_slots(7usize..=7usize, once(Some(element.into()))))
	}
	pub fn with_members(self, element: JsClassMemberList) -> Self {
		Self::unwrap_cast(
			self.syntax.splice_slots(8usize..=8usize, once(Some(element.into_syntax().into()))),
		)
	}
	pub fn with_r_curly_token(self, element: SyntaxToken) -> Self {
		Self::unwrap_cast(self.syntax.splice_slots(9usize..=9usize, once(Some(element.into()))))
	}
}
...
impl JsClassExpression {
	...
	pub fn with_l_curly_token(self, element: SyntaxToken) -> Self {
		Self::unwrap_cast(self.syntax.splice_slots(6usize..=6usize, once(Some(element.into()))))
	}
	pub fn with_members(self, element: JsClassMemberList) -> Self {
		Self::unwrap_cast(
			self.syntax.splice_slots(7usize..=7usize, once(Some(element.into_syntax().into()))),
		)
	}
	pub fn with_r_curly_token(self, element: SyntaxToken) -> Self {
		Self::unwrap_cast(self.syntax.splice_slots(8usize..=8usize, once(Some(element.into()))))
	}
}
...
impl JsConditionalExpression {
	...
	pub fn with_alternate(self, element: AnyJsExpression) -> Self {
		Self::unwrap_cast(
			self.syntax.splice_slots(4usize..=4usize, once(Some(element.into_syntax().into()))),
		)
	}
}
...
impl JsDoWhileStatement {
	...
	pub fn with_r_paren_token(self, element: SyntaxToken) -> Self {
		Self::unwrap_cast(self.syntax.splice_slots(5usize..=5usize, once(Some(element.into()))))
	}
	pub fn with_semicolon_token(self, element: Option<SyntaxToken>) -> Self {
		Self::unwrap_cast(
			self.syntax.splice_slots(6usize..=6usize, once(element.map(|element| element.into()))),
		)
	}
}
impl JsElseClause {
...
impl JsExportNamedClause {
	...
	pub fn with_semicolon_token(self, element: Option<SyntaxToken>) -> Self {
		Self::unwrap_cast(
			self.syntax.splice_slots(4usize..=4usize, once(element.map(|element| element.into()))),
		)
	}
}
impl JsExportNamedFromClause {
	...
	pub fn with_semicolon_token(self, element: Option<SyntaxToken>) -> Self {
		Self::unwrap_cast(
			self.syntax.splice_slots(7usize..=7usize, once(element.map(|element| element.into()))),
		)
	}
}
...
impl JsForInStatement {
	...
	pub fn with_body(self, element: AnyJsStatement) -> Self {
		Self::unwrap_cast(
			self.syntax.splice_slots(6usize..=6usize, once(Some(element.into_syntax().into()))),
		)
	}
}
...
impl TsCallSignatureTypeMember {
	...
	pub fn with_separator_token_token(self, element: Option<SyntaxToken>) -> Self {
		Self::unwrap_cast(
			self.syntax.splice_slots(3usize..=3usize, once(element.map(|element| element.into()))),
		)
	}
}
...
impl TsGetterSignatureTypeMember {
	...
	pub fn with_separator_token_token(self, element: Option<SyntaxToken>) -> Self {
		Self::unwrap_cast(
			self.syntax.splice_slots(5usize..=5usize, once(element.map(|element| element.into()))),
		)
	}
}
...
impl TsMappedType {
	...
	pub fn with_semicolon_token(self, element: Option<SyntaxToken>) -> Self {
		Self::unwrap_cast(
			self.syntax
				.splice_slots(10usize..=10usize, once(element.map(|element| element.into()))),
		)
	}
	pub fn with_r_curly_token(self, element: SyntaxToken) -> Self {
		Self::unwrap_cast(self.syntax.splice_slots(11usize..=11usize, once(Some(element.into()))))
	}
}
