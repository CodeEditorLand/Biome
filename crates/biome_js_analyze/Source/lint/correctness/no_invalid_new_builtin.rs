...
use biome_js_syntax::{
	AnyJsExpression, JsCallExpression, JsNewExpression, global_identifier, static_value::StaticValue,
};
...
impl Rule for NoInvalidNewBuiltin {
	...
	fn action(ctx: &RuleContext<Self>, _: &Self::State) -> Option<JsRuleAction> {
		...
		mutation.replace_node_discard_trivia::<AnyJsExpression>(node.clone().into(), call_expression.into());
