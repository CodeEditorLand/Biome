...
fn is_function_that_is_ok_parameter_not_be_used(parent_function: &Option<AnyJsParameterParentFunction>) -> bool {
	matches!(
		parent_function,
		Some(
...
impl Rule for NoUnusedFunctionParameters {
	...
	fn run(ctx: &RuleContext<Self>) -> Self::Signals {
		...
		let parent_function = match declaration.parent_binding_pattern_declaration().unwrap_or(declaration) {
