...
use biome_js_syntax::{
	AnyJsClass, AnyJsClassMember, JsGetterClassMember, JsMethodClassMember, JsPropertyClassMember, JsSetterClassMember,
	TsGetterSignatureClassMember, TsIndexSignatureClassMember, TsInitializedPropertySignatureClassMember,
	...
	fn run(ctx: &RuleContext<Self>) -> Self::Signals {
		...
		let all_members_static = class_declaration
			...
			.filter_map(|member| match member {
				...
				AnyJsClassMember::TsInitializedPropertySignatureClassMember(m) => Some(m.has_static_modifier()),
				AnyJsClassMember::TsMethodSignatureClassMember(m) => Some(m.has_static_modifier()),
				AnyJsClassMember::TsPropertySignatureClassMember(m) => Some(m.has_static_modifier()),
