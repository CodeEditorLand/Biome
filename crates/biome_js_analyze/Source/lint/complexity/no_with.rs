...
impl Rule for NoWith {
	...
	fn run(_ctx:&RuleContext<Self>) -> Option<Self::State> { Some(()) }
	...
	fn diagnostic(ctx:&RuleContext<Self>, _:&Self::State) -> Option<RuleDiagnostic> {
		...
		Some(
			...
			.note(
				"The with statement is potentially problematic because it adds members of an \
				 object to the current\nscope, making it impossible to tell what a variable \
