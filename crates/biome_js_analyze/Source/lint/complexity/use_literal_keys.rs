...
impl Rule for UseLiteralKeys {
	...
	fn run(ctx:&RuleContext<Self>) -> Self::Signals {
		...
		// A computed property `["something"]` can always be simplified to a string
		// literal "something", unless it is a template literal inside that contains
		// unescaped new line characters:
		//
		// const a = {
		//   [`line1
		//   line2`]: true
