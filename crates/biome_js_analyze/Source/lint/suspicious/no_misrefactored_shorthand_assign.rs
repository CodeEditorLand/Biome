...
use biome_js_syntax::{AnyJsExpression, JsAssignmentExpression, JsAssignmentOperator, JsBinaryExpression};
...
impl Rule for NoMisrefactoredShorthandAssign {
	...
	fn run(ctx: &RuleContext<Self>) -> Self::Signals {
		...
		let variable_position_in_expression = find_variable_position(&binary_expression, &left_text)?;
