...
use biome_js_syntax::{AnyJsClass, JsDirective, JsDirectiveList, JsFileSource, JsFunctionBody, JsModule, JsScript};
...
impl Rule for NoRedundantUseStrict {
	...
	fn action(ctx: &RuleContext<Self>, _state: &Self::State) -> Option<JsRuleAction> {
		...
		Some(JsRuleAction::new(
			...
			markup! { "Remove the redundant "<Emphasis>"use strict"</Emphasis>" directive." }.to_owned(),
			mutation,
		))
	}
}
