...
use biome_analyze::{Ast, FixKind, Rule, RuleDiagnostic, RuleSource, RuleSourceKind, declare_lint_rule};
...
use biome_js_syntax::{
	AnyJsDeclarationClause, JsSyntaxKind, TriviaPieceKind, TsInterfaceDeclaration, TsTypeAliasDeclaration,
};
