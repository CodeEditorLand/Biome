...
const IRREGULAR_WHITESPACES: &[char; 22] = &[
	'\u{c}', '\u{b}', '\u{85}', '\u{feff}', '\u{a0}', '\u{1680}', '\u{180e}', '\u{2000}', '\u{2001}', '\u{2002}',
	'\u{2003}', '\u{2004}', '\u{2005}', '\u{2006}', '\u{2007}', '\u{2008}', '\u{2009}', '\u{200a}', '\u{200b}',
...
fn get_irregular_whitespace(syntax: &JsSyntaxNode) -> Vec<TextRange> {
	...
	let is_whitespace =
		|trivia: &SyntaxTriviaPiece<JsLanguage>| trivia.is_whitespace() && !trivia.text().replace(' ', "").is_empty();
