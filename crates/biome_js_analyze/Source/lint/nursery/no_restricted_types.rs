...
#[derive(Clone, Debug, Default, biome_deserialize_macros::Deserializable, Deserialize, Serialize, Eq, PartialEq)]
...
#[derive(Debug, Clone, Default, biome_deserialize_macros::Deserializable, Deserialize, Serialize, Eq, PartialEq)]
...
impl From<CustomRestrictedType> for CustomRestrictedTypeOptions {
	fn from(options: CustomRestrictedType) -> Self {
		match options {
			CustomRestrictedType::Plain(message) => CustomRestrictedTypeOptions { message, use_instead: None },
