...
use biome_js_factory::make::{
	...
	js_string_literal_single_quotes,
	js_template_chunk,
...
use self::{
	...
	presets::UseSortedClassesPreset,
	sort::{
		get_sort_class_name_range,
		should_ignore_postfix,
		should_ignore_prefix,
		sort_class_name,
	},
...
impl Rule for UseSortedClasses {
	...
	fn diagnostic(ctx:&RuleContext<Self>, _:&Self::State) -> Option<RuleDiagnostic> {
		...
		// Calculate the range offset to account for the ignored prefix and
		// postfix.
