//! DO NOT EDIT MANUALLY - this file is autogenerated from the default Tailwind
//! CSS config. To update, run `pnpm gen:tailwind-preset` from
//! `packages/@biomejs/tailwindcss-config-analyzer`.
