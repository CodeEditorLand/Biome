//! The following structures define the config required to compute sort-related
//! information about CSS classes (`ClassInfo`) that is later used to compare
//! and sort them. A sort config includes:
...
impl SortConfig {
	...
	pub fn new(preset:&ConfigPreset) -> Self {
		...
		Self { utilities:preset.utilities, variants:preset.variants, layer_index_map }
	}
}
