...
impl Rule for UseTopLevelRegex {
	...
	fn run(ctx:&RuleContext<Self>) -> Self::Signals {
		let regex = ctx.query();
		// Ignore regular expressions with the g and/or y flags, as calling test/exec
		// has side effects. https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp/lastIndex#avoiding_side_effects
