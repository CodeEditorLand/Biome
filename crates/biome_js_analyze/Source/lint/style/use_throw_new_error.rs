...
use biome_js_syntax::{AnyJsExpression, JsCallExpression, JsNewExpression, JsParenthesizedExpression, JsSyntaxKind, T};
...
pub(crate) fn convert_call_expression_to_new_expression(expr: &JsCallExpression) -> Option<JsNewExpression> {
