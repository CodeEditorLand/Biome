...
use biome_js_factory::{
	make,
	make::{jsx_string, jsx_string_literal},
};
...
/// Verify that a JSX attribute value has a valid tab index, meaning it is not
/// positive.
...
/// Verify if number string is an integer less than equal zero. Non-integer
