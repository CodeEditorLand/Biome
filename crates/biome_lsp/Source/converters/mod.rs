//! The crate contains a set of converters to translate between `lsp-types` and
//! `biome_rowan` (and vice versa) types.
...
impl WideChar {
	...
	fn len(&self) -> TextSize { self.end - self.start }
