...
use biome_lsp_converters::{PositionEncoding, from_proto, line_index::LineIndex, to_proto};
...
pub(crate) fn apply_document_changes(
	...
	// Skip to the last full document change, as it invalidates all previous changes
	// anyways.
...
#[cfg(test)]
mod tests {
	use biome_lsp_converters::{PositionEncoding, WideEncoding, line_index::LineIndex};
