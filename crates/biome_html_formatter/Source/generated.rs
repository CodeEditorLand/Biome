...
use crate::{
	AsFormat, FormatBogusNodeRule, FormatNodeRule, HtmlFormatContext,
	HtmlFormatter, IntoFormat,
};
use biome_formatter::{
...
impl AsFormat<HtmlFormatContext>
	for biome_html_syntax::HtmlAttributeInitializerClause
{
	type Format<'a> = FormatRefWithRule<
        'a,
	...
	for crate::html::auxiliary::closing_element::FormatHtmlClosingElement
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_html_syntax::HtmlClosingElement>::fmt(
			self, node, f,
		)
	}
}
...
impl FormatRule<biome_html_syntax::HtmlName>
	for crate::html::auxiliary::name::FormatHtmlName
{
	type Context = HtmlFormatContext;
	#[inline(always)]
	fn fmt(
		&self,
		node: &biome_html_syntax::HtmlName,
		f: &mut HtmlFormatter,
	) -> FormatResult<()> {
	...
	for crate::html::auxiliary::opening_element::FormatHtmlOpeningElement
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_html_syntax::HtmlOpeningElement>::fmt(
			self, node, f,
		)
	}
}
...
impl FormatRule<biome_html_syntax::HtmlRoot>
	for crate::html::auxiliary::root::FormatHtmlRoot
{
	type Context = HtmlFormatContext;
	#[inline(always)]
	fn fmt(
		&self,
		node: &biome_html_syntax::HtmlRoot,
		f: &mut HtmlFormatter,
	) -> FormatResult<()> {
	...
	for crate::html::auxiliary::self_closing_element::FormatHtmlSelfClosingElement
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_html_syntax::HtmlSelfClosingElement>::fmt(
			self, node, f,
		)
	}
}
...
impl IntoFormat<HtmlFormatContext>
	for biome_html_syntax::HtmlSelfClosingElement
{
	type Format = FormatOwnedWithRule<
        biome_html_syntax::HtmlSelfClosingElement,
        crate::html::auxiliary::self_closing_element::FormatHtmlSelfClosingElement,
	...
	for crate::html::auxiliary::string::FormatHtmlString
{
	...
	fn fmt(
		&self,
		node: &biome_html_syntax::HtmlString,
		f: &mut HtmlFormatter,
	) -> FormatResult<()> {
...
impl FormatRule<biome_html_syntax::HtmlBogus>
	for crate::html::bogus::bogus::FormatHtmlBogus
{
	type Context = HtmlFormatContext;
	#[inline(always)]
	fn fmt(
		&self,
		node: &biome_html_syntax::HtmlBogus,
		f: &mut HtmlFormatter,
	) -> FormatResult<()> {
...
impl AsFormat<HtmlFormatContext> for biome_html_syntax::HtmlBogus {
	...
	fn format(&self) -> Self::Format<'_> {
		...
		FormatRefWithRule::new(
			self,
			crate::html::bogus::bogus::FormatHtmlBogus::default(),
		)
	}
}
	...
	for crate::html::bogus::bogus_attribute::FormatHtmlBogusAttribute
{
	...
	fn fmt(
		...
		FormatBogusNodeRule::<biome_html_syntax::HtmlBogusAttribute>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::html::bogus::bogus_element::FormatHtmlBogusElement
{
	...
	fn fmt(
		...
		FormatBogusNodeRule::<biome_html_syntax::HtmlBogusElement>::fmt(
			self, node, f,
		)
	}
}
