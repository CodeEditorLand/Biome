...
impl AsFormat<HtmlFormatContext> for biome_html_syntax::HtmlName {
	...
	fn format(&self) -> Self::Format<'_> {
		#![allow(clippy::default_constructed_unit_structs)]
		FormatRefWithRule::new(self, crate::html::auxiliary::name::FormatHtmlName::default())
	}
}
impl IntoFormat<HtmlFormatContext> for biome_html_syntax::HtmlName {
	...
	fn into_format(self) -> Self::Format {
		#![allow(clippy::default_constructed_unit_structs)]
		FormatOwnedWithRule::new(self, crate::html::auxiliary::name::FormatHtmlName::default())
	}
}
