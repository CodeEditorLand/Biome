...
impl HtmlFormatOptions {
	pub fn new(_file_source:HtmlFileSource) -> Self { Self { ..Default::default() } }
	...
	pub fn indent_style(&self) -> IndentStyle { self.indent_style }

	pub fn indent_width(&self) -> IndentWidth { self.indent_width }

	pub fn line_ending(&self) -> LineEnding { self.line_ending }

	pub fn line_width(&self) -> LineWidth { self.line_width }
...
impl CstFormatContext for HtmlFormatContext {
	...
	fn comments(&self) -> &HtmlComments { &self.comments }
}
