use biome_css_syntax::{CssDeclarationOrRuleBlock, stmt_ext::CssBlockLike};
...
impl FormatNodeRule<CssDeclarationOrRuleBlock> for FormatCssDeclarationOrRuleBlock {
	...
	fn fmt_dangling_comments(&self, _:&CssDeclarationOrRuleBlock, _:&mut CssFormatter) -> FormatResult<()> {
