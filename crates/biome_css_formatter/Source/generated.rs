	...
	for crate::css::auxiliary::list_of_component_values_expression::FormatCssListOfComponentValuesExpression
{
	...
	fn fmt(
		&self,
		node: &biome_css_syntax::CssListOfComponentValuesExpression,
		f: &mut CssFormatter,
	) -> FormatResult<()> {
	...
	for crate::css::statements::position_try_at_rule::FormatCssPositionTryAtRule
{
	type Context = CssFormatContext;
	#[inline(always)]
	fn fmt(&self, node: &biome_css_syntax::CssPositionTryAtRule, f: &mut CssFormatter) -> FormatResult<()> {
	...
	for crate::css::pseudo::pseudo_class_function_selector_list::FormatCssPseudoClassFunctionSelectorList
{
	...
	fn fmt(
		&self,
		node: &biome_css_syntax::CssPseudoClassFunctionSelectorList,
		f: &mut CssFormatter,
	) -> FormatResult<()> {
	...
	for crate::css::pseudo::pseudo_element_function_identifier::FormatCssPseudoElementFunctionIdentifier
{
	...
	fn fmt(
		&self,
		node: &biome_css_syntax::CssPseudoElementFunctionIdentifier,
		f: &mut CssFormatter,
	) -> FormatResult<()> {
	...
	for crate::css::auxiliary::value_at_rule_named_import_specifier::FormatCssValueAtRuleNamedImportSpecifier
{
	...
	fn fmt(
		&self,
		node: &biome_css_syntax::CssValueAtRuleNamedImportSpecifier,
		f: &mut CssFormatter,
	) -> FormatResult<()> {
	...
	for crate::css::statements::view_transition_at_rule::FormatCssViewTransitionAtRule
{
	type Context = CssFormatContext;
	#[inline(always)]
	fn fmt(&self, node: &biome_css_syntax::CssViewTransitionAtRule, f: &mut CssFormatter) -> FormatResult<()> {
