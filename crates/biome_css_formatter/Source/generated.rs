...
use crate::{
	AsFormat, CssFormatContext, CssFormatter, FormatBogusNodeRule,
	FormatNodeRule, IntoFormat,
};
use biome_formatter::{
	FormatOwnedWithRule, FormatRefWithRule, FormatResult, FormatRule,
};
impl FormatRule<biome_css_syntax::CssAtRule>
	for crate::css::statements::at_rule::FormatCssAtRule
{
	type Context = CssFormatContext;
	#[inline(always)]
	fn fmt(
		&self,
		node: &biome_css_syntax::CssAtRule,
		f: &mut CssFormatter,
	) -> FormatResult<()> {
	...
	for crate::css::auxiliary::attribute_matcher::FormatCssAttributeMatcher
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssAttributeMatcher>::fmt(
			self, node, f,
		)
	}
}
...
impl IntoFormat<CssFormatContext>
	for biome_css_syntax::CssAttributeMatcherValue
{
	type Format = FormatOwnedWithRule<
        biome_css_syntax::CssAttributeMatcherValue,
        crate::css::auxiliary::attribute_matcher_value::FormatCssAttributeMatcherValue,
	...
	for crate::css::selectors::attribute_selector::FormatCssAttributeSelector
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssAttributeSelector>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::auxiliary::binary_expression::FormatCssBinaryExpression
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssBinaryExpression>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::auxiliary::bracketed_value::FormatCssBracketedValue
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssBracketedValue>::fmt(
			self, node, f,
		)
	}
}
...
impl FormatRule<biome_css_syntax::CssColor>
	for crate::css::value::color::FormatCssColor
{
	type Context = CssFormatContext;
	#[inline(always)]
	fn fmt(
		&self,
		node: &biome_css_syntax::CssColor,
		f: &mut CssFormatter,
	) -> FormatResult<()> {
...
impl AsFormat<CssFormatContext> for biome_css_syntax::CssColor {
	type Format<'a> = FormatRefWithRule<
		...
		crate::css::value::color::FormatCssColor,
	>;
	fn format(&self) -> Self::Format<'_> {
		#![allow(clippy::default_constructed_unit_structs)]
		FormatRefWithRule::new(
			self,
			crate::css::value::color::FormatCssColor::default(),
		)
	}
}
	...
	for crate::css::statements::color_profile_at_rule::FormatCssColorProfileAtRule
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssColorProfileAtRule>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::selectors::complex_selector::FormatCssComplexSelector
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssComplexSelector>::fmt(
			self, node, f,
		)
	}
}
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssComposesImportSpecifier
{
	type Format<'a> = FormatRefWithRule<
        'a,
	...
	for crate::css::properties::composes_property::FormatCssComposesProperty
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssComposesProperty>::fmt(
			self, node, f,
		)
	}
}
...
impl IntoFormat<CssFormatContext>
	for biome_css_syntax::CssComposesPropertyValue
{
	type Format = FormatOwnedWithRule<
        biome_css_syntax::CssComposesPropertyValue,
        crate::css::auxiliary::composes_property_value::FormatCssComposesPropertyValue,
	...
	for crate::css::selectors::compound_selector::FormatCssCompoundSelector
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssCompoundSelector>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::auxiliary::container_and_query::FormatCssContainerAndQuery
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssContainerAndQuery>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::statements::container_at_rule::FormatCssContainerAtRule
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssContainerAtRule>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::auxiliary::container_not_query::FormatCssContainerNotQuery
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssContainerNotQuery>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::auxiliary::container_or_query::FormatCssContainerOrQuery
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssContainerOrQuery>::fmt(
			self, node, f,
		)
	}
}
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssContainerQueryInParens
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssContainerStyleInParens
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssContainerStyleNotQuery
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl IntoFormat<CssFormatContext>
	for biome_css_syntax::CssContainerStyleOrQuery
{
	type Format = FormatOwnedWithRule<
        biome_css_syntax::CssContainerStyleOrQuery,
        crate::css::auxiliary::container_style_or_query::FormatCssContainerStyleOrQuery,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssContainerStyleQueryInParens
{
	...
	for crate::css::statements::counter_style_at_rule::FormatCssCounterStyleAtRule
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssCounterStyleAtRule>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::value::custom_identifier::FormatCssCustomIdentifier
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssCustomIdentifier>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::value::dashed_identifier::FormatCssDashedIdentifier
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssDashedIdentifier>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::auxiliary::declaration_block::FormatCssDeclarationBlock
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssDeclarationBlock>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::auxiliary::declaration_important::FormatCssDeclarationImportant
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssDeclarationImportant>::fmt(
			self, node, f,
		)
	}
}
...
impl IntoFormat<CssFormatContext>
	for biome_css_syntax::CssDeclarationImportant
{
	type Format = FormatOwnedWithRule<
        biome_css_syntax::CssDeclarationImportant,
        crate::css::auxiliary::declaration_important::FormatCssDeclarationImportant,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssDeclarationOrAtRuleBlock
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssDeclarationOrRuleBlock
{
	type Format<'a> = FormatRefWithRule<
        'a,
	...
	for crate::css::statements::document_at_rule::FormatCssDocumentAtRule
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssDocumentAtRule>::fmt(
			self, node, f,
		)
	}
}
...
impl IntoFormat<CssFormatContext>
	for biome_css_syntax::CssDocumentCustomMatcher
{
	type Format = FormatOwnedWithRule<
        biome_css_syntax::CssDocumentCustomMatcher,
        crate::css::auxiliary::document_custom_matcher::FormatCssDocumentCustomMatcher,
	...
	for crate::css::statements::font_face_at_rule::FormatCssFontFaceAtRule
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssFontFaceAtRule>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::auxiliary::font_family_name::FormatCssFontFamilyName
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssFontFamilyName>::fmt(
			self, node, f,
		)
	}
}
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssFontFeatureValuesBlock
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssFontPaletteValuesAtRule
{
	type Format<'a> = FormatRefWithRule<
        'a,
	...
	for crate::css::auxiliary::function::FormatCssFunction
{
	...
	fn fmt(
		&self,
		node: &biome_css_syntax::CssFunction,
		f: &mut CssFormatter,
	) -> FormatResult<()> {
	...
	for crate::css::auxiliary::generic_delimiter::FormatCssGenericDelimiter
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssGenericDelimiter>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::properties::generic_property::FormatCssGenericProperty
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssGenericProperty>::fmt(
			self, node, f,
		)
	}
}
...
impl IntoFormat<CssFormatContext>
	for biome_css_syntax::CssImportAnonymousLayer
{
	type Format = FormatOwnedWithRule<
        biome_css_syntax::CssImportAnonymousLayer,
        crate::css::auxiliary::import_anonymous_layer::FormatCssImportAnonymousLayer,
	...
	for crate::css::auxiliary::import_named_layer::FormatCssImportNamedLayer
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssImportNamedLayer>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::auxiliary::import_supports::FormatCssImportSupports
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssImportSupports>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::statements::keyframes_at_rule::FormatCssKeyframesAtRule
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssKeyframesAtRule>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::auxiliary::keyframes_block::FormatCssKeyframesBlock
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssKeyframesBlock>::fmt(
			self, node, f,
		)
	}
}
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssKeyframesIdentSelector
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssKeyframesPercentageSelector
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssKeyframesScopeFunction
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl IntoFormat<CssFormatContext>
	for biome_css_syntax::CssKeyframesScopePrefix
{
	type Format = FormatOwnedWithRule<
        biome_css_syntax::CssKeyframesScopePrefix,
        crate::css::auxiliary::keyframes_scope_prefix::FormatCssKeyframesScopePrefix,
	...
	for crate::css::auxiliary::keyframes_scoped_name::FormatCssKeyframesScopedName
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssKeyframesScopedName>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::auxiliary::layer_declaration::FormatCssLayerDeclaration
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssLayerDeclaration>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::auxiliary::layer_reference::FormatCssLayerReference
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssLayerReference>::fmt(
			self, node, f,
		)
	}
}
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssListOfComponentValuesExpression
{
	...
	for crate::css::auxiliary::media_and_condition::FormatCssMediaAndCondition
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssMediaAndCondition>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::auxiliary::media_and_type_query::FormatCssMediaAndTypeQuery
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssMediaAndTypeQuery>::fmt(
			self, node, f,
		)
	}
}
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssMediaConditionInParens
{
	type Format<'a> = FormatRefWithRule<
        'a,
	...
	for crate::css::auxiliary::media_condition_query::FormatCssMediaConditionQuery
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssMediaConditionQuery>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::auxiliary::media_not_condition::FormatCssMediaNotCondition
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssMediaNotCondition>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::auxiliary::media_or_condition::FormatCssMediaOrCondition
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssMediaOrCondition>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::auxiliary::media_type::FormatCssMediaType
{
	...
	fn fmt(
		&self,
		node: &biome_css_syntax::CssMediaType,
		f: &mut CssFormatter,
	) -> FormatResult<()> {
	...
	for crate::css::auxiliary::media_type_query::FormatCssMediaTypeQuery
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssMediaTypeQuery>::fmt(
			self, node, f,
		)
	}
}
...
impl IntoFormat<CssFormatContext>
	for biome_css_syntax::CssNamedNamespacePrefix
{
	type Format = FormatOwnedWithRule<
        biome_css_syntax::CssNamedNamespacePrefix,
        crate::css::auxiliary::named_namespace_prefix::FormatCssNamedNamespacePrefix,
	...
	for crate::css::auxiliary::namespace::FormatCssNamespace
{
	...
	fn fmt(
		&self,
		node: &biome_css_syntax::CssNamespace,
		f: &mut CssFormatter,
	) -> FormatResult<()> {
	...
	for crate::css::statements::namespace_at_rule::FormatCssNamespaceAtRule
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssNamespaceAtRule>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::auxiliary::nested_qualified_rule::FormatCssNestedQualifiedRule
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssNestedQualifiedRule>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::selectors::nested_selector::FormatCssNestedSelector
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssNestedSelector>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::auxiliary::nth_offset::FormatCssNthOffset
{
	...
	fn fmt(
		&self,
		node: &biome_css_syntax::CssNthOffset,
		f: &mut CssFormatter,
	) -> FormatResult<()> {
...
impl FormatRule<biome_css_syntax::CssNumber>
	for crate::css::value::number::FormatCssNumber
{
	type Context = CssFormatContext;
	#[inline(always)]
	fn fmt(
		&self,
		node: &biome_css_syntax::CssNumber,
		f: &mut CssFormatter,
	) -> FormatResult<()> {
...
impl AsFormat<CssFormatContext> for biome_css_syntax::CssNumber {
	...
	fn format(&self) -> Self::Format<'_> {
		...
		FormatRefWithRule::new(
			self,
			crate::css::value::number::FormatCssNumber::default(),
		)
	}
}
	...
	for crate::css::auxiliary::page_at_rule_block::FormatCssPageAtRuleBlock
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssPageAtRuleBlock>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::pseudo::page_selector_pseudo::FormatCssPageSelectorPseudo
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssPageSelectorPseudo>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::auxiliary::parameter::FormatCssParameter
{
	...
	fn fmt(
		&self,
		node: &biome_css_syntax::CssParameter,
		f: &mut CssFormatter,
	) -> FormatResult<()> {
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssParenthesizedExpression
{
	type Format<'a> = FormatRefWithRule<
        'a,
	...
	for crate::css::statements::property_at_rule::FormatCssPropertyAtRule
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssPropertyAtRule>::fmt(
			self, node, f,
		)
	}
}
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssPseudoClassFunctionCompoundSelectorList
{
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssPseudoClassFunctionIdentifier
{
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssPseudoClassFunctionNth
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssPseudoClassFunctionRelativeSelectorList
{
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssPseudoClassFunctionSelector
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssPseudoClassFunctionSelectorList
{
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssPseudoClassFunctionValueList
{
	type Format<'a> = FormatRefWithRule<
        'a,
	...
	for crate::css::pseudo::pseudo_class_identifier::FormatCssPseudoClassIdentifier
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssPseudoClassIdentifier>::fmt(
			self, node, f,
		)
	}
}
...
impl IntoFormat<CssFormatContext>
	for biome_css_syntax::CssPseudoClassIdentifier
{
	type Format = FormatOwnedWithRule<
        biome_css_syntax::CssPseudoClassIdentifier,
        crate::css::pseudo::pseudo_class_identifier::FormatCssPseudoClassIdentifier,
	...
	for crate::css::pseudo::pseudo_class_nth::FormatCssPseudoClassNth
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssPseudoClassNth>::fmt(
			self, node, f,
		)
	}
}
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssPseudoClassNthIdentifier
{
	type Format<'a> = FormatRefWithRule<
        'a,
	...
	for crate::css::pseudo::pseudo_class_nth_number::FormatCssPseudoClassNthNumber
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssPseudoClassNthNumber>::fmt(
			self, node, f,
		)
	}
}
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssPseudoClassNthSelector
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssPseudoClassOfNthSelector
{
	type Format<'a> = FormatRefWithRule<
        'a,
	...
	for crate::css::selectors::pseudo_class_selector::FormatCssPseudoClassSelector
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssPseudoClassSelector>::fmt(
			self, node, f,
		)
	}
}
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssPseudoElementFunctionIdentifier
{
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssPseudoElementFunctionSelector
{
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssPseudoElementIdentifier
{
	type Format<'a> = FormatRefWithRule<
        'a,
	...
	for crate::css::auxiliary::query_feature_boolean::FormatCssQueryFeatureBoolean
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssQueryFeatureBoolean>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::auxiliary::query_feature_plain::FormatCssQueryFeaturePlain
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssQueryFeaturePlain>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::auxiliary::query_feature_range::FormatCssQueryFeatureRange
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssQueryFeatureRange>::fmt(
			self, node, f,
		)
	}
}
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssQueryFeatureRangeComparison
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssQueryFeatureRangeInterval
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl FormatRule<biome_css_syntax::CssRatio>
	for crate::css::value::ratio::FormatCssRatio
{
	type Context = CssFormatContext;
	#[inline(always)]
	fn fmt(
		&self,
		node: &biome_css_syntax::CssRatio,
		f: &mut CssFormatter,
	) -> FormatResult<()> {
...
impl AsFormat<CssFormatContext> for biome_css_syntax::CssRatio {
	type Format<'a> = FormatRefWithRule<
		...
		crate::css::value::ratio::FormatCssRatio,
	>;
	fn format(&self) -> Self::Format<'_> {
		#![allow(clippy::default_constructed_unit_structs)]
		FormatRefWithRule::new(
			self,
			crate::css::value::ratio::FormatCssRatio::default(),
		)
	}
}
	...
	for crate::css::value::regular_dimension::FormatCssRegularDimension
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssRegularDimension>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::selectors::relative_selector::FormatCssRelativeSelector
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssRelativeSelector>::fmt(
			self, node, f,
		)
	}
}
...
impl FormatRule<biome_css_syntax::CssRoot>
	for crate::css::auxiliary::root::FormatCssRoot
{
	type Context = CssFormatContext;
	#[inline(always)]
	fn fmt(
		&self,
		node: &biome_css_syntax::CssRoot,
		f: &mut CssFormatter,
	) -> FormatResult<()> {
...
impl AsFormat<CssFormatContext> for biome_css_syntax::CssRoot {
	...
	fn format(&self) -> Self::Format<'_> {
		...
		FormatRefWithRule::new(
			self,
			crate::css::auxiliary::root::FormatCssRoot::default(),
		)
	}
}
	...
	for crate::css::auxiliary::rule_block::FormatCssRuleBlock
{
	...
	fn fmt(
		&self,
		node: &biome_css_syntax::CssRuleBlock,
		f: &mut CssFormatter,
	) -> FormatResult<()> {
	...
	for crate::css::auxiliary::scope_edge::FormatCssScopeEdge
{
	...
	fn fmt(
		&self,
		node: &biome_css_syntax::CssScopeEdge,
		f: &mut CssFormatter,
	) -> FormatResult<()> {
	...
	for crate::css::auxiliary::scope_range_interval::FormatCssScopeRangeInterval
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssScopeRangeInterval>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::auxiliary::scope_range_start::FormatCssScopeRangeStart
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssScopeRangeStart>::fmt(
			self, node, f,
		)
	}
}
...
impl FormatRule<biome_css_syntax::CssString>
	for crate::css::value::string::FormatCssString
{
	type Context = CssFormatContext;
	#[inline(always)]
	fn fmt(
		&self,
		node: &biome_css_syntax::CssString,
		f: &mut CssFormatter,
	) -> FormatResult<()> {
...
impl AsFormat<CssFormatContext> for biome_css_syntax::CssString {
	...
	fn format(&self) -> Self::Format<'_> {
		...
		FormatRefWithRule::new(
			self,
			crate::css::value::string::FormatCssString::default(),
		)
	}
}
...
impl IntoFormat<CssFormatContext>
	for biome_css_syntax::CssSupportsAndCondition
{
	type Format = FormatOwnedWithRule<
        biome_css_syntax::CssSupportsAndCondition,
        crate::css::auxiliary::supports_and_condition::FormatCssSupportsAndCondition,
	...
	for crate::css::statements::supports_at_rule::FormatCssSupportsAtRule
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssSupportsAtRule>::fmt(
			self, node, f,
		)
	}
}
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssSupportsConditionInParens
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssSupportsFeatureDeclaration
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl IntoFormat<CssFormatContext>
	for biome_css_syntax::CssSupportsNotCondition
{
	type Format = FormatOwnedWithRule<
        biome_css_syntax::CssSupportsNotCondition,
        crate::css::auxiliary::supports_not_condition::FormatCssSupportsNotCondition,
	...
	for crate::css::auxiliary::supports_or_condition::FormatCssSupportsOrCondition
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssSupportsOrCondition>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::auxiliary::unicode_codepoint::FormatCssUnicodeCodepoint
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssUnicodeCodepoint>::fmt(
			self, node, f,
		)
	}
}
...
impl IntoFormat<CssFormatContext>
	for biome_css_syntax::CssUnicodeRangeInterval
{
	type Format = FormatOwnedWithRule<
        biome_css_syntax::CssUnicodeRangeInterval,
        crate::css::auxiliary::unicode_range_interval::FormatCssUnicodeRangeInterval,
...
impl IntoFormat<CssFormatContext>
	for biome_css_syntax::CssUnicodeRangeWildcard
{
	type Format = FormatOwnedWithRule<
        biome_css_syntax::CssUnicodeRangeWildcard,
        crate::css::auxiliary::unicode_range_wildcard::FormatCssUnicodeRangeWildcard,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssUniversalNamespacePrefix
{
	type Format<'a> = FormatRefWithRule<
        'a,
	...
	for crate::css::selectors::universal_selector::FormatCssUniversalSelector
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssUniversalSelector>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::statements::unknown_block_at_rule::FormatCssUnknownBlockAtRule
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssUnknownBlockAtRule>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::value::unknown_dimension::FormatCssUnknownDimension
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssUnknownDimension>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::statements::unknown_value_at_rule::FormatCssUnknownValueAtRule
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_css_syntax::CssUnknownValueAtRule>::fmt(
			self, node, f,
		)
	}
}
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssValueAtRuleDeclarationClause
{
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssValueAtRuleGenericProperty
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssValueAtRuleImportClause
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssValueAtRuleImportSpecifier
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssValueAtRuleNamedImportSpecifier
{
...
impl IntoFormat<CssFormatContext>
	for biome_css_syntax::CssCompoundSelectorList
{
	type Format = FormatOwnedWithRule<
        biome_css_syntax::CssCompoundSelectorList,
        crate::css::lists::compound_selector_list::FormatCssCompoundSelectorList,
...
impl IntoFormat<CssFormatContext>
	for biome_css_syntax::CssCustomIdentifierList
{
	type Format = FormatOwnedWithRule<
        biome_css_syntax::CssCustomIdentifierList,
        crate::css::lists::custom_identifier_list::FormatCssCustomIdentifierList,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssDeclarationOrAtRuleList
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl IntoFormat<CssFormatContext>
	for biome_css_syntax::CssDeclarationOrRuleList
{
	type Format = FormatOwnedWithRule<
        biome_css_syntax::CssDeclarationOrRuleList,
        crate::css::lists::declaration_or_rule_list::FormatCssDeclarationOrRuleList,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssFontFeatureValuesItemList
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssGenericComponentValueList
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl IntoFormat<CssFormatContext>
	for biome_css_syntax::CssKeyframesSelectorList
{
	type Format = FormatOwnedWithRule<
        biome_css_syntax::CssKeyframesSelectorList,
        crate::css::lists::keyframes_selector_list::FormatCssKeyframesSelectorList,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssPageSelectorPseudoList
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl IntoFormat<CssFormatContext>
	for biome_css_syntax::CssRelativeSelectorList
{
	type Format = FormatOwnedWithRule<
        biome_css_syntax::CssRelativeSelectorList,
        crate::css::lists::relative_selector_list::FormatCssRelativeSelectorList,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssValueAtRuleImportSpecifierList
{
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssValueAtRulePropertyList
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl FormatRule<biome_css_syntax::CssBogus>
	for crate::css::bogus::bogus::FormatCssBogus
{
	type Context = CssFormatContext;
	#[inline(always)]
	fn fmt(
		&self,
		node: &biome_css_syntax::CssBogus,
		f: &mut CssFormatter,
	) -> FormatResult<()> {
...
impl AsFormat<CssFormatContext> for biome_css_syntax::CssBogus {
	type Format<'a> = FormatRefWithRule<
		'a,
		biome_css_syntax::CssBogus,
		crate::css::bogus::bogus::FormatCssBogus,
	>;
	fn format(&self) -> Self::Format<'_> {
		#![allow(clippy::default_constructed_unit_structs)]
		FormatRefWithRule::new(
			self,
			crate::css::bogus::bogus::FormatCssBogus::default(),
		)
	}
}
	...
	for crate::css::bogus::bogus_at_rule::FormatCssBogusAtRule
{
	...
	fn fmt(
		...
		FormatBogusNodeRule::<biome_css_syntax::CssBogusAtRule>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::bogus::bogus_block::FormatCssBogusBlock
{
	...
	fn fmt(
		...
		FormatBogusNodeRule::<biome_css_syntax::CssBogusBlock>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::bogus::bogus_custom_identifier::FormatCssBogusCustomIdentifier
{
	...
	fn fmt(
		...
		FormatBogusNodeRule::<biome_css_syntax::CssBogusCustomIdentifier>::fmt(
			self, node, f,
		)
	}
}
...
impl IntoFormat<CssFormatContext>
	for biome_css_syntax::CssBogusCustomIdentifier
{
	type Format = FormatOwnedWithRule<
        biome_css_syntax::CssBogusCustomIdentifier,
        crate::css::bogus::bogus_custom_identifier::FormatCssBogusCustomIdentifier,
	...
	for crate::css::bogus::bogus_declaration_item::FormatCssBogusDeclarationItem
{
	...
	fn fmt(
		...
		FormatBogusNodeRule::<biome_css_syntax::CssBogusDeclarationItem>::fmt(
			self, node, f,
		)
	}
}
...
impl IntoFormat<CssFormatContext>
	for biome_css_syntax::CssBogusDeclarationItem
{
	type Format = FormatOwnedWithRule<
        biome_css_syntax::CssBogusDeclarationItem,
        crate::css::bogus::bogus_declaration_item::FormatCssBogusDeclarationItem,
	...
	for crate::css::bogus::bogus_document_matcher::FormatCssBogusDocumentMatcher
{
	...
	fn fmt(
		...
		FormatBogusNodeRule::<biome_css_syntax::CssBogusDocumentMatcher>::fmt(
			self, node, f,
		)
	}
}
...
impl IntoFormat<CssFormatContext>
	for biome_css_syntax::CssBogusDocumentMatcher
{
	type Format = FormatOwnedWithRule<
        biome_css_syntax::CssBogusDocumentMatcher,
        crate::css::bogus::bogus_document_matcher::FormatCssBogusDocumentMatcher,
	...
	for crate::css::bogus::bogus_font_family_name::FormatCssBogusFontFamilyName
{
	...
	fn fmt(
		...
		FormatBogusNodeRule::<biome_css_syntax::CssBogusFontFamilyName>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::bogus::bogus_keyframes_item::FormatCssBogusKeyframesItem
{
	...
	fn fmt(
		...
		FormatBogusNodeRule::<biome_css_syntax::CssBogusKeyframesItem>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::bogus::bogus_keyframes_name::FormatCssBogusKeyframesName
{
	...
	fn fmt(
		...
		FormatBogusNodeRule::<biome_css_syntax::CssBogusKeyframesName>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::bogus::bogus_layer::FormatCssBogusLayer
{
	...
	fn fmt(
		...
		FormatBogusNodeRule::<biome_css_syntax::CssBogusLayer>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::bogus::bogus_media_query::FormatCssBogusMediaQuery
{
	...
	fn fmt(
		...
		FormatBogusNodeRule::<biome_css_syntax::CssBogusMediaQuery>::fmt(
			self, node, f,
		)
	}
}
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssBogusPageSelectorPseudo
{
	type Format<'a> = FormatRefWithRule<
        'a,
	...
	for crate::css::bogus::bogus_parameter::FormatCssBogusParameter
{
	...
	fn fmt(
		...
		FormatBogusNodeRule::<biome_css_syntax::CssBogusParameter>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::bogus::bogus_property::FormatCssBogusProperty
{
	...
	fn fmt(
		...
		FormatBogusNodeRule::<biome_css_syntax::CssBogusProperty>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::bogus::bogus_property_value::FormatCssBogusPropertyValue
{
	...
	fn fmt(
		...
		FormatBogusNodeRule::<biome_css_syntax::CssBogusPropertyValue>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::bogus::bogus_pseudo_class::FormatCssBogusPseudoClass
{
	...
	fn fmt(
		...
		FormatBogusNodeRule::<biome_css_syntax::CssBogusPseudoClass>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::bogus::bogus_pseudo_element::FormatCssBogusPseudoElement
{
	...
	fn fmt(
		...
		FormatBogusNodeRule::<biome_css_syntax::CssBogusPseudoElement>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::bogus::bogus_rule::FormatCssBogusRule
{
	...
	fn fmt(
		&self,
		node: &biome_css_syntax::CssBogusRule,
		f: &mut CssFormatter,
	) -> FormatResult<()> {
		FormatBogusNodeRule::<biome_css_syntax::CssBogusRule>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::bogus::bogus_scope_range::FormatCssBogusScopeRange
{
	...
	fn fmt(
		...
		FormatBogusNodeRule::<biome_css_syntax::CssBogusScopeRange>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::bogus::bogus_selector::FormatCssBogusSelector
{
	...
	fn fmt(
		...
		FormatBogusNodeRule::<biome_css_syntax::CssBogusSelector>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::css::bogus::bogus_sub_selector::FormatCssBogusSubSelector
{
	...
	fn fmt(
		...
		FormatBogusNodeRule::<biome_css_syntax::CssBogusSubSelector>::fmt(
			self, node, f,
		)
	}
}
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssBogusUnicodeRangeValue
{
	type Format<'a> = FormatRefWithRule<
        'a,
	...
	for crate::css::bogus::bogus_url_modifier::FormatCssBogusUrlModifier
{
	...
	fn fmt(
		...
		FormatBogusNodeRule::<biome_css_syntax::CssBogusUrlModifier>::fmt(
			self, node, f,
		)
	}
}
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssUnknownAtRuleComponentList
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::CssValueAtRuleGenericValue
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::AnyCssAttributeMatcherValue
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::AnyCssComposesImportSource
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::AnyCssContainerAndCombinableQuery
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::AnyCssContainerQueryInParens
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::AnyCssContainerStyleAndCombinableQuery
{
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::AnyCssContainerStyleInParens
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::AnyCssContainerStyleOrCombinableQuery
{
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::AnyCssDeclarationOrAtRule
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::AnyCssDeclarationOrAtRuleBlock
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl IntoFormat<CssFormatContext>
	for biome_css_syntax::AnyCssDeclarationOrRule
{
	type Format = FormatOwnedWithRule<
		biome_css_syntax::AnyCssDeclarationOrRule,
		crate::css::any::declaration_or_rule::FormatAnyCssDeclarationOrRule,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::AnyCssDeclarationOrRuleBlock
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::AnyCssFontFeatureValuesBlock
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::AnyCssFontFeatureValuesItem
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::AnyCssGenericComponentValue
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::AnyCssImportSupportsCondition
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::AnyCssKeyframesIdentifier
{
	type Format<'a> = FormatRefWithRule<
		'a,
...
impl IntoFormat<CssFormatContext>
	for biome_css_syntax::AnyCssKeyframesSelector
{
	type Format = FormatOwnedWithRule<
		biome_css_syntax::AnyCssKeyframesSelector,
		crate::css::any::keyframes_selector::FormatAnyCssKeyframesSelector,
...
impl AsFormat<CssFormatContext> for biome_css_syntax::AnyCssLayer {
	...
	fn format(&self) -> Self::Format<'_> {
		...
		FormatRefWithRule::new(
			self,
			crate::css::any::layer::FormatAnyCssLayer::default(),
		)
	}
}
...
impl IntoFormat<CssFormatContext>
	for biome_css_syntax::AnyCssMediaTypeCondition
{
	type Format = FormatOwnedWithRule<
		biome_css_syntax::AnyCssMediaTypeCondition,
		crate::css::any::media_type_condition::FormatAnyCssMediaTypeCondition,
...
impl IntoFormat<CssFormatContext>
	for biome_css_syntax::AnyCssPageSelectorPseudo
{
	type Format = FormatOwnedWithRule<
		biome_css_syntax::AnyCssPageSelectorPseudo,
		crate::css::any::page_selector_pseudo::FormatAnyCssPageSelectorPseudo,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::AnyCssPseudoClassNthSelector
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl IntoFormat<CssFormatContext>
	for biome_css_syntax::AnyCssQueryFeatureValue
{
	type Format = FormatOwnedWithRule<
		biome_css_syntax::AnyCssQueryFeatureValue,
		crate::css::any::query_feature_value::FormatAnyCssQueryFeatureValue,
...
impl AsFormat<CssFormatContext> for biome_css_syntax::AnyCssRule {
	...
	fn format(&self) -> Self::Format<'_> {
		...
		FormatRefWithRule::new(
			self,
			crate::css::any::rule::FormatAnyCssRule::default(),
		)
	}
}
...
impl IntoFormat<CssFormatContext>
	for biome_css_syntax::AnyCssStartingStyleBlock
{
	type Format = FormatOwnedWithRule<
		biome_css_syntax::AnyCssStartingStyleBlock,
		crate::css::any::starting_style_block::FormatAnyCssStartingStyleBlock,
...
impl IntoFormat<CssFormatContext>
	for biome_css_syntax::AnyCssSupportsCondition
{
	type Format = FormatOwnedWithRule<
		biome_css_syntax::AnyCssSupportsCondition,
		crate::css::any::supports_condition::FormatAnyCssSupportsCondition,
...
impl AsFormat<CssFormatContext> for biome_css_syntax::AnyCssValue {
	...
	fn format(&self) -> Self::Format<'_> {
		...
		FormatRefWithRule::new(
			self,
			crate::css::any::value::FormatAnyCssValue::default(),
		)
	}
}
...
impl IntoFormat<CssFormatContext>
	for biome_css_syntax::AnyCssValueAtRuleClause
{
	type Format = FormatOwnedWithRule<
		biome_css_syntax::AnyCssValueAtRuleClause,
		crate::css::any::value_at_rule_clause::FormatAnyCssValueAtRuleClause,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::AnyCssValueAtRuleImportSource
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::AnyCssValueAtRuleImportSpecifier
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<CssFormatContext>
	for biome_css_syntax::AnyCssValueAtRuleProperty
{
	type Format<'a> = FormatRefWithRule<
        'a,
