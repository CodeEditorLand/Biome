	...
	for crate::css::auxiliary::container_size_feature_in_parens::FormatCssContainerSizeFeatureInParens
{
	...
	fn fmt(
		&self,
		node:&biome_css_syntax::CssContainerSizeFeatureInParens,
		f:&mut CssFormatter,
	) -> FormatResult<()> {
	...
	for crate::css::selectors::pseudo_element_function_selector::FormatCssPseudoElementFunctionSelector
{
	...
	fn fmt(
		&self,
		node:&biome_css_syntax::CssPseudoElementFunctionSelector,
		f:&mut CssFormatter,
	) -> FormatResult<()> {
	...
	for crate::css::auxiliary::value_at_rule_declaration_clause::FormatCssValueAtRuleDeclarationClause
{
	...
	fn fmt(
		&self,
		node:&biome_css_syntax::CssValueAtRuleDeclarationClause,
		f:&mut CssFormatter,
	) -> FormatResult<()> {
