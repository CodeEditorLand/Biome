...
use crate::{
	...
	syntax::{
		is_at_identifier,
		parse_error::{expected_any_pseudo_element, expected_identifier, expected_selector},
		parse_regular_identifier,
		selector::{
			eat_or_recover_selector_function_close_token,
			parse_selector,
			parse_selector_identifier,
...
const PSEUDO_ELEMENT_FUNCTION_IDENTIFIER_SET:TokenSet<CssSyntaxKind> = token_set![HIGHLIGHT_KW, PART_KW];
#[inline]
