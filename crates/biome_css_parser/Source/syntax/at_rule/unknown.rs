...
///
/// An unknown CSS at-rule is identified by being an identifier followed by
...
///
/// When encountered during parsing, `CssUnknownAtRule` serves as a fallback
/// mechanism, allowing the parser to continue processing the stylesheet by
/// treating the unsupported rule as part of an unformed tree. This enables
