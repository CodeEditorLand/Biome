...
pub fn graphql_argument(name:GraphqlLiteralName, colon_token:SyntaxToken, value:AnyGraphqlValue) -> GraphqlArgument {
...
pub fn graphql_description(graphql_string_value:GraphqlStringValue) -> GraphqlDescription {
	GraphqlDescription::unwrap_cast(SyntaxNode::new_detached(
		...
		[Some(SyntaxElement::Node(graphql_string_value.into_syntax()))],
	))
}
pub fn graphql_directive(at_token:SyntaxToken, name:GraphqlNameReference) -> GraphqlDirectiveBuilder {
	GraphqlDirectiveBuilder { at_token, name, arguments:None }
}
...
impl GraphqlDirectiveDefinitionBuilder {
	...
	pub fn build(self) -> GraphqlDirectiveDefinition {
		GraphqlDirectiveDefinition::unwrap_cast(SyntaxNode::new_detached(
			...
			[
				self.description.map(|token| SyntaxElement::Node(token.into_syntax())),
				Some(SyntaxElement::Token(self.directive_token)),
				Some(SyntaxElement::Token(self.at_token)),
				Some(SyntaxElement::Node(self.name.into_syntax())),
				self.arguments.map(|token| SyntaxElement::Node(token.into_syntax())),
				self.repeatable_token.map(|token| SyntaxElement::Token(token)),
				Some(SyntaxElement::Token(self.on_token)),
				self.bitwise_or_token.map(|token| SyntaxElement::Token(token)),
...
pub fn graphql_enum_type_definition(
	...
	GraphqlEnumTypeDefinitionBuilder { enum_token, name, directives, description:None, enum_values:None }
}
	...
	pub fn build(self) -> GraphqlEnumTypeDefinition {
		GraphqlEnumTypeDefinition::unwrap_cast(SyntaxNode::new_detached(
			...
			[
				...
				self.enum_values.map(|token| SyntaxElement::Node(token.into_syntax())),
			],
		))
	}
}
pub fn graphql_enum_type_extension(
	...
	GraphqlEnumTypeExtensionBuilder { extend_token, enum_token, name, directives, enum_values:None }
}
...
pub fn graphql_enum_value_definition(
	...
	GraphqlEnumValueDefinitionBuilder { value, directives, description:None }
}
...
pub fn graphql_field(name:GraphqlLiteralName, directives:GraphqlDirectiveList) -> GraphqlFieldBuilder {
	GraphqlFieldBuilder { name, directives, alias:None, arguments:None, selection_set:None }
}
...
impl GraphqlFieldBuilder {
	...
	pub fn build(self) -> GraphqlField {
		GraphqlField::unwrap_cast(SyntaxNode::new_detached(
			...
			[
				self.alias.map(|token| SyntaxElement::Node(token.into_syntax())),
				Some(SyntaxElement::Node(self.name.into_syntax())),
				self.arguments.map(|token| SyntaxElement::Node(token.into_syntax())),
				Some(SyntaxElement::Node(self.directives.into_syntax())),
				self.selection_set.map(|token| SyntaxElement::Node(token.into_syntax())),
			],
		))
	}
}
pub fn graphql_field_definition(
	...
	GraphqlFieldDefinitionBuilder { name, colon_token, ty, directives, description:None, arguments:None }
}
...
pub fn graphql_implements_interfaces(
	...
	GraphqlImplementsInterfacesBuilder { implements_token, interfaces, amp_token:None }
}
...
pub fn graphql_inline_fragment(
	...
	GraphqlInlineFragmentBuilder { dotdotdot_token, directives, selection_set, type_condition:None }
}
	...
	pub fn build(self) -> GraphqlInlineFragment {
		GraphqlInlineFragment::unwrap_cast(SyntaxNode::new_detached(
			...
			[
				...
				self.type_condition.map(|token| SyntaxElement::Node(token.into_syntax())),
				Some(SyntaxElement::Node(self.directives.into_syntax())),
...
pub fn graphql_input_object_type_definition(
	...
	GraphqlInputObjectTypeDefinitionBuilder { input_token, name, directives, description:None, input_fields:None }
}
	...
	pub fn build(self) -> GraphqlInputObjectTypeDefinition {
		GraphqlInputObjectTypeDefinition::unwrap_cast(SyntaxNode::new_detached(
			...
			[
				...
				Some(SyntaxElement::Node(self.name.into_syntax())),
				Some(SyntaxElement::Node(self.directives.into_syntax())),
				self.input_fields.map(|token| SyntaxElement::Node(token.into_syntax())),
			],
		))
	}
}
pub fn graphql_input_object_type_extension(
	...
	GraphqlInputObjectTypeExtensionBuilder { extend_token, input_token, name, directives, input_fields:None }
}
...
pub fn graphql_input_value_definition(
	...
	GraphqlInputValueDefinitionBuilder { name, colon_token, ty, directives, description:None, default:None }
}
	...
	pub fn build(self) -> GraphqlInterfaceTypeDefinition {
		GraphqlInterfaceTypeDefinition::unwrap_cast(SyntaxNode::new_detached(
			...
			[
				...
				Some(SyntaxElement::Node(self.name.into_syntax())),
				self.implements.map(|token| SyntaxElement::Node(token.into_syntax())),
				Some(SyntaxElement::Node(self.directives.into_syntax())),
				self.fields.map(|token| SyntaxElement::Node(token.into_syntax())),
			],
		))
	}
}
...
pub fn graphql_non_null_type(base:AnyGraphqlPrimitiveType, excl_token:SyntaxToken) -> GraphqlNonNullType {
...
pub fn graphql_object_type_definition(
	...
	GraphqlObjectTypeDefinitionBuilder { type_token, name, directives, description:None, implements:None, fields:None }
}
...
pub fn graphql_object_type_extension(
	...
	GraphqlObjectTypeExtensionBuilder { extend_token, type_token, name, directives, implements:None, fields:None }
}
...
pub fn graphql_operation_definition(
	...
	GraphqlOperationDefinitionBuilder { ty, directives, selection_set, name:None, variables:None }
}
	...
	pub fn build(self) -> GraphqlOperationDefinition {
		GraphqlOperationDefinition::unwrap_cast(SyntaxNode::new_detached(
			...
			[
				...
				self.variables.map(|token| SyntaxElement::Node(token.into_syntax())),
				Some(SyntaxElement::Node(self.directives.into_syntax())),
				Some(SyntaxElement::Node(self.selection_set.into_syntax())),
			],
		))
...
pub fn graphql_root(definitions:GraphqlDefinitionList, eof_token:SyntaxToken) -> GraphqlRootBuilder {
	GraphqlRootBuilder { definitions, eof_token, bom_token:None }
}
...
pub fn graphql_scalar_type_definition(
	...
	GraphqlScalarTypeDefinitionBuilder { scalar_token, name, directives, description:None }
}
...
pub fn graphql_schema_definition(
	...
	GraphqlSchemaDefinitionBuilder { schema_token, directives, root_operation_types, description:None }
}
...
pub fn graphql_schema_extension(
	...
	GraphqlSchemaExtensionBuilder { extend_token, schema_token, directives, root_operation_types:None }
}
...
impl GraphqlSchemaExtensionBuilder {
	pub fn with_root_operation_types(mut self, root_operation_types:GraphqlRootOperationTypes) -> Self {
	...
	pub fn build(self) -> GraphqlSchemaExtension {
		GraphqlSchemaExtension::unwrap_cast(SyntaxNode::new_detached(
			...
			[
				...
				Some(SyntaxElement::Token(self.schema_token)),
				Some(SyntaxElement::Node(self.directives.into_syntax())),
				self.root_operation_types.map(|token| SyntaxElement::Node(token.into_syntax())),
			],
		))
	}
}
...
pub fn graphql_type_condition(on_token:SyntaxToken, ty:GraphqlNameReference) -> GraphqlTypeCondition {
...
pub fn graphql_union_member_types(
	...
	GraphqlUnionMemberTypesBuilder { eq_token, members, bitwise_or_token:None }
}
...
pub fn graphql_union_type_definition(
	...
	GraphqlUnionTypeDefinitionBuilder { union_token, name, directives, description:None, union_members:None }
}
	...
	pub fn build(self) -> GraphqlUnionTypeDefinition {
		GraphqlUnionTypeDefinition::unwrap_cast(SyntaxNode::new_detached(
			...
			[
				...
				Some(SyntaxElement::Node(self.name.into_syntax())),
				Some(SyntaxElement::Node(self.directives.into_syntax())),
				self.union_members.map(|token| SyntaxElement::Node(token.into_syntax())),
			],
		))
	}
}
pub fn graphql_union_type_extension(
	...
	GraphqlUnionTypeExtensionBuilder { extend_token, union_token, name, directives, union_members:None }
}
...
pub fn graphql_variable_binding(dollar_token:SyntaxToken, name:GraphqlLiteralName) -> GraphqlVariableBinding {
...
pub fn graphql_variable_definition(
	...
	GraphqlVariableDefinitionBuilder { variable, colon_token, ty, directives, default:None }
}
...
pub fn graphql_variable_reference(dollar_token:SyntaxToken, name:GraphqlLiteralName) -> GraphqlVariableReference {
...
pub fn graphql_directive_location_list<I, S>(items:I, separators:S) -> GraphqlDirectiveLocationList
where
...
pub fn graphql_implements_interface_list<I, S>(items:I, separators:S) -> GraphqlImplementsInterfaceList
where
...
pub fn graphql_root_operation_type_definition_list<I>(items:I) -> GraphqlRootOperationTypeDefinitionList
where
...
where
	...
	I::IntoIter: ExactSizeIterator, {
	GraphqlBogus::unwrap_cast(SyntaxNode::new_detached(GraphqlSyntaxKind::GRAPHQL_BOGUS, slots))
}
pub fn graphql_bogus_definition<I>(slots:I) -> GraphqlBogusDefinition
where
	I: IntoIterator<Item = Option<SyntaxElement>>,
	I::IntoIter: ExactSizeIterator, {
	GraphqlBogusDefinition::unwrap_cast(SyntaxNode::new_detached(GraphqlSyntaxKind::GRAPHQL_BOGUS_DEFINITION, slots))
}
pub fn graphql_bogus_selection<I>(slots:I) -> GraphqlBogusSelection
where
	I: IntoIterator<Item = Option<SyntaxElement>>,
	I::IntoIter: ExactSizeIterator, {
	GraphqlBogusSelection::unwrap_cast(SyntaxNode::new_detached(GraphqlSyntaxKind::GRAPHQL_BOGUS_SELECTION, slots))
}
pub fn graphql_bogus_type<I>(slots:I) -> GraphqlBogusType
where
	I: IntoIterator<Item = Option<SyntaxElement>>,
	I::IntoIter: ExactSizeIterator, {
	GraphqlBogusType::unwrap_cast(SyntaxNode::new_detached(GraphqlSyntaxKind::GRAPHQL_BOGUS_TYPE, slots))
}
pub fn graphql_bogus_value<I>(slots:I) -> GraphqlBogusValue
where
	I: IntoIterator<Item = Option<SyntaxElement>>,
	I::IntoIter: ExactSizeIterator, {
	GraphqlBogusValue::unwrap_cast(SyntaxNode::new_detached(GraphqlSyntaxKind::GRAPHQL_BOGUS_VALUE, slots))
}
