...
use biome_diagnostics::{Diagnostic, DiagnosticTags, MessageAndDescription, console::fmt::Display, location::AsSpan};
...
impl ProjectDiagnostic {
	...
	// pub fn new_failed_deserialization(manifest_path: &str, diagnostics:
	// Vec<Error>) -> Self {     let mut diagnostic = Self::new(markup!("Failed to
	// deserialize the manifest"));     diagnostic.verbose_advice = Advice {
	...
	pub fn new_internal() -> Self {
		Self::new("Failed to retrieve the project during internal operations").with_tag(DiagnosticTags::INTERNAL)
	}
