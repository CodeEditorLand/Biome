...
/// use std::num::NonZeroU8;
///
/// use biome_formatter::{IndentStyle, SimpleFormatOptions, format, format_args, prelude::*};
///
/// # fn main() -> FormatResult<()> {
/// let context = SimpleFormatContext::new(SimpleFormatOptions {
/// 	indent_style:IndentStyle::Space,
...
///
/// ```
/// use biome_formatter::{LineWidth, format, format_args, prelude::*};
///
/// # fn main() -> FormatResult<()> {
/// let elements = format!(
/// 	SimpleFormatContext::default(),
...
///
/// ```
/// use biome_formatter::{SimpleFormatContext, format, prelude::*, write};
...
///
/// ```
/// use biome_formatter::{Buffer, SimpleFormatContext, format, prelude::*, write};
///
/// struct MyFormat;
///
