...
pub struct Argument<'fmt, Context> {
	...
	/// Stores the lifetime of the value. To get the most out of our dear borrow
	/// checker.
...
#[cfg(test)]
mod tests {
	use crate::{FormatState, VecBuffer, format_args, format_element::tag::Tag, prelude::*, write};
