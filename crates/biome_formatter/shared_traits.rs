// Code that must be included in every language specific formatter crate.
// Redefining these types in every formatter crate is necessary because of
// Rust's orphan rule that prohibits implementing unowned traits (traits defined
// in this file) on unowned types (node types)
