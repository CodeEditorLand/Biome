...
impl CssAtRule {
	...
	pub fn as_fields(&self) -> CssAtRuleFields {
		CssAtRuleFields { at_token:self.at_token(), rule:self.rule() }
	}
...
impl CssDocumentCustomMatcher {
	...
	pub fn value(&self) -> SyntaxResult<CssString> { support::required_node(&self.syntax, 2usize) }
...
impl CssFontFamilyName {
	...
	pub fn as_fields(&self) -> CssFontFamilyNameFields {
		CssFontFamilyNameFields { names:self.names() }
	}
...
impl CssGenericDelimiter {
	...
	pub fn as_fields(&self) -> CssGenericDelimiterFields {
		CssGenericDelimiterFields { value:self.value() }
	}
...
impl CssIdentifier {
	...
	pub fn as_fields(&self) -> CssIdentifierFields {
		CssIdentifierFields { value_token:self.value_token() }
	}
...
impl CssMetavariable {
	...
	pub fn as_fields(&self) -> CssMetavariableFields {
		CssMetavariableFields { value_token:self.value_token() }
	}
...
impl CssNestedSelector {
	...
	pub fn as_fields(&self) -> CssNestedSelectorFields {
		CssNestedSelectorFields { amp_token:self.amp_token() }
	}
...
impl CssNthOffset {
	...
	pub fn as_fields(&self) -> CssNthOffsetFields {
		CssNthOffsetFields { sign:self.sign(), value:self.value() }
	}
...
impl CssNumber {
	...
	pub fn as_fields(&self) -> CssNumberFields {
		CssNumberFields { value_token:self.value_token() }
	}
...
impl CssPageSelector {
	...
	pub fn as_fields(&self) -> CssPageSelectorFields {
		CssPageSelectorFields { ty:self.ty(), pseudos:self.pseudos() }
	}
...
impl CssScopeRangeStart {
	...
	pub fn as_fields(&self) -> CssScopeRangeStartFields {
		CssScopeRangeStartFields { start:self.start() }
	}
...
impl CssString {
	...
	pub fn as_fields(&self) -> CssStringFields {
		CssStringFields { value_token:self.value_token() }
	}
...
impl CssUrlValueRaw {
	...
	pub fn as_fields(&self) -> CssUrlValueRawFields {
		CssUrlValueRawFields { value_token:self.value_token() }
	}
...
impl AstNode for AnyCssKeyframesScope {
	...
	fn can_cast(kind:SyntaxKind) -> bool {
		matches!(kind, CSS_KEYFRAMES_SCOPE_FUNCTION | CSS_KEYFRAMES_SCOPE_PREFIX)
	}
...
impl AstNode for AnyCssMediaInParens {
	...
	fn can_cast(kind:SyntaxKind) -> bool {
		matches!(kind, CSS_MEDIA_CONDITION_IN_PARENS | CSS_MEDIA_FEATURE_IN_PARENS)
	}
...
impl AstNode for AnyCssNamespacePrefix {
	...
	fn can_cast(kind:SyntaxKind) -> bool {
		matches!(kind, CSS_NAMED_NAMESPACE_PREFIX | CSS_UNIVERSAL_NAMESPACE_PREFIX)
	}
...
impl AstNode for AnyCssPageSelectorPseudo {
	...
	fn can_cast(kind:SyntaxKind) -> bool {
		matches!(kind, CSS_BOGUS_PAGE_SELECTOR_PSEUDO | CSS_PAGE_SELECTOR_PSEUDO)
	}
...
impl AstNode for AnyCssStartingStyleBlock {
	...
	fn can_cast(kind:SyntaxKind) -> bool {
		matches!(kind, CSS_BOGUS_BLOCK | CSS_DECLARATION_BLOCK | CSS_RULE_BLOCK)
	}
...
impl AstNode for AnyCssValueAtRuleProperty {
	...
	fn can_cast(kind:SyntaxKind) -> bool {
		matches!(kind, CSS_BOGUS_PROPERTY | CSS_VALUE_AT_RULE_GENERIC_PROPERTY)
	}
