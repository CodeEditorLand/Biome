...
#[allow(unused)]
use biome_rowan::{AstNodeList, AstNodeListIterator, AstNodeSlotMap, AstSeparatedList, AstSeparatedListNodesIterator};
use serde::{Serialize, Serializer, ser::SerializeSeq};

use crate::{
	CssLanguage as Language,
	CssSyntaxElement as SyntaxElement,
	CssSyntaxElementChildren as SyntaxElementChildren,
	CssSyntaxKind::{self as SyntaxKind, *},
	CssSyntaxList as SyntaxList,
	CssSyntaxNode as SyntaxNode,
	CssSyntaxToken as SyntaxToken,
...
impl CssAtRule {
	...
	pub fn as_fields(&self) -> CssAtRuleFields { CssAtRuleFields { at_token:self.at_token(), rule:self.rule() } }

	pub fn at_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn rule(&self) -> SyntaxResult<AnyCssAtRule> { support::required_node(&self.syntax, 1usize) }
}
...
impl CssAttributeMatcher {
	...
	pub fn as_fields(&self) -> CssAttributeMatcherFields {
		CssAttributeMatcherFields { operator:self.operator(), value:self.value(), modifier:self.modifier() }
	}

	pub fn operator(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn value(&self) -> SyntaxResult<CssAttributeMatcherValue> { support::required_node(&self.syntax, 1usize) }

	pub fn modifier(&self) -> Option<SyntaxToken> { support::token(&self.syntax, 2usize) }
}
...
impl CssAttributeMatcherValue {
	...
	pub fn as_fields(&self) -> CssAttributeMatcherValueFields { CssAttributeMatcherValueFields { name:self.name() } }

	pub fn name(&self) -> SyntaxResult<AnyCssAttributeMatcherValue> { support::required_node(&self.syntax, 0usize) }
}
...
impl CssAttributeName {
	...
	pub fn as_fields(&self) -> CssAttributeNameFields {
		CssAttributeNameFields { namespace:self.namespace(), name:self.name() }
	}

	pub fn namespace(&self) -> Option<CssNamespace> { support::node(&self.syntax, 0usize) }

	pub fn name(&self) -> SyntaxResult<CssIdentifier> { support::required_node(&self.syntax, 1usize) }
}
...
impl CssAttributeSelector {
	...
	pub fn l_brack_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn name(&self) -> SyntaxResult<CssAttributeName> { support::required_node(&self.syntax, 1usize) }

	pub fn matcher(&self) -> Option<CssAttributeMatcher> { support::node(&self.syntax, 2usize) }

	pub fn r_brack_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 3usize) }
}
...
impl CssBinaryExpression {
	...
	pub fn as_fields(&self) -> CssBinaryExpressionFields {
		CssBinaryExpressionFields { left:self.left(), operator_token:self.operator_token(), right:self.right() }
	}

	pub fn left(&self) -> SyntaxResult<AnyCssExpression> { support::required_node(&self.syntax, 0usize) }

	pub fn operator_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 1usize) }

	pub fn right(&self) -> SyntaxResult<AnyCssExpression> { support::required_node(&self.syntax, 2usize) }
}
...
impl CssBracketedValue {
	...
	pub fn items(&self) -> CssBracketedValueList { support::list(&self.syntax, 1usize) }

	pub fn r_brack_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 2usize) }
}
...
impl CssCharsetAtRule {
	...
	pub fn charset_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn encoding(&self) -> SyntaxResult<CssString> { support::required_node(&self.syntax, 1usize) }

	pub fn semicolon_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 2usize) }
}
...
impl CssClassSelector {
	...
	pub fn as_fields(&self) -> CssClassSelectorFields {
		CssClassSelectorFields { dot_token:self.dot_token(), name:self.name() }
	}

	pub fn dot_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn name(&self) -> SyntaxResult<CssCustomIdentifier> { support::required_node(&self.syntax, 1usize) }
}
...
impl CssColor {
	...
	pub fn as_fields(&self) -> CssColorFields {
		CssColorFields { hash_token:self.hash_token(), value_token:self.value_token() }
	}

	pub fn hash_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn value_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 1usize) }
}
...
impl CssColorProfileAtRule {
	...
	pub fn color_profile_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn name(&self) -> SyntaxResult<CssCustomIdentifier> { support::required_node(&self.syntax, 1usize) }

	pub fn block(&self) -> SyntaxResult<AnyCssDeclarationBlock> { support::required_node(&self.syntax, 2usize) }
}
...
impl CssComplexSelector {
	...
	pub fn as_fields(&self) -> CssComplexSelectorFields {
		CssComplexSelectorFields { left:self.left(), combinator:self.combinator(), right:self.right() }
	}

	pub fn left(&self) -> SyntaxResult<AnyCssSelector> { support::required_node(&self.syntax, 0usize) }

	pub fn combinator(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 1usize) }

	pub fn right(&self) -> SyntaxResult<AnyCssSelector> { support::required_node(&self.syntax, 2usize) }
}
...
impl CssComposesImportSpecifier {
	...
	pub fn as_fields(&self) -> CssComposesImportSpecifierFields {
		CssComposesImportSpecifierFields { from_token:self.from_token(), source:self.source() }
	}

	pub fn from_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn source(&self) -> SyntaxResult<AnyCssComposesImportSource> { support::required_node(&self.syntax, 1usize) }
}
...
impl CssComposesProperty {
	...
	pub fn as_fields(&self) -> CssComposesPropertyFields {
		CssComposesPropertyFields { name:self.name(), colon_token:self.colon_token(), value:self.value() }
	}

	pub fn name(&self) -> SyntaxResult<CssIdentifier> { support::required_node(&self.syntax, 0usize) }

	pub fn colon_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 1usize) }

	pub fn value(&self) -> SyntaxResult<CssComposesPropertyValue> { support::required_node(&self.syntax, 2usize) }
}
...
impl CssComposesPropertyValue {
	...
	pub fn as_fields(&self) -> CssComposesPropertyValueFields {
		CssComposesPropertyValueFields { classes:self.classes(), specifier:self.specifier() }
	}

	pub fn classes(&self) -> CssComposesClassList { support::list(&self.syntax, 0usize) }

	pub fn specifier(&self) -> Option<CssComposesImportSpecifier> { support::node(&self.syntax, 1usize) }
}
...
impl CssCompoundSelector {
	...
	pub fn nesting_selectors(&self) -> CssNestedSelectorList { support::list(&self.syntax, 0usize) }

	pub fn simple_selector(&self) -> Option<AnyCssSimpleSelector> { support::node(&self.syntax, 1usize) }

	pub fn sub_selectors(&self) -> CssSubSelectorList { support::list(&self.syntax, 2usize) }
}
...
impl CssContainerAndQuery {
	...
	pub fn as_fields(&self) -> CssContainerAndQueryFields {
		CssContainerAndQueryFields { left:self.left(), and_token:self.and_token(), right:self.right() }
	}

	pub fn left(&self) -> SyntaxResult<AnyCssContainerQueryInParens> { support::required_node(&self.syntax, 0usize) }

	pub fn and_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 1usize) }
...
impl CssContainerAtRule {
	...
	pub fn container_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn name(&self) -> Option<CssCustomIdentifier> { support::node(&self.syntax, 1usize) }

	pub fn query(&self) -> SyntaxResult<AnyCssContainerQuery> { support::required_node(&self.syntax, 2usize) }

	pub fn block(&self) -> SyntaxResult<AnyCssConditionalBlock> { support::required_node(&self.syntax, 3usize) }
}
...
impl CssContainerNotQuery {
	...
	pub fn as_fields(&self) -> CssContainerNotQueryFields {
		CssContainerNotQueryFields { not_token:self.not_token(), query:self.query() }
	}

	pub fn not_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn query(&self) -> SyntaxResult<AnyCssContainerQueryInParens> { support::required_node(&self.syntax, 1usize) }
}
...
impl CssContainerOrQuery {
	...
	pub fn as_fields(&self) -> CssContainerOrQueryFields {
		CssContainerOrQueryFields { left:self.left(), or_token:self.or_token(), right:self.right() }
	}

	pub fn left(&self) -> SyntaxResult<AnyCssContainerQueryInParens> { support::required_node(&self.syntax, 0usize) }

	pub fn or_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 1usize) }
...
impl CssContainerQueryInParens {
	...
	pub fn l_paren_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn query(&self) -> SyntaxResult<AnyCssContainerQuery> { support::required_node(&self.syntax, 1usize) }

	pub fn r_paren_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 2usize) }
}
...
impl CssContainerSizeFeatureInParens {
	...
	pub fn feature(&self) -> SyntaxResult<AnyCssQueryFeature> { support::required_node(&self.syntax, 1usize) }
...
impl CssContainerStyleAndQuery {
	...
	pub fn as_fields(&self) -> CssContainerStyleAndQueryFields {
		CssContainerStyleAndQueryFields { left:self.left(), and_token:self.and_token(), right:self.right() }
	}

	pub fn left(&self) -> SyntaxResult<CssContainerStyleInParens> { support::required_node(&self.syntax, 0usize) }
...
impl CssContainerStyleInParens {
	...
	pub fn query(&self) -> SyntaxResult<AnyCssContainerStyleInParens> { support::required_node(&self.syntax, 1usize) }
...
impl CssContainerStyleNotQuery {
	...
	pub fn as_fields(&self) -> CssContainerStyleNotQueryFields {
		CssContainerStyleNotQueryFields { not_token:self.not_token(), query:self.query() }
	}

	pub fn not_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn query(&self) -> SyntaxResult<CssContainerStyleInParens> { support::required_node(&self.syntax, 1usize) }
}
...
impl CssContainerStyleOrQuery {
	...
	pub fn as_fields(&self) -> CssContainerStyleOrQueryFields {
		CssContainerStyleOrQueryFields { left:self.left(), or_token:self.or_token(), right:self.right() }
	}
...
impl CssContainerStyleQueryInParens {
	...
	pub fn style_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn l_paren_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 1usize) }

	pub fn query(&self) -> SyntaxResult<AnyCssContainerStyleQuery> { support::required_node(&self.syntax, 2usize) }

	pub fn r_paren_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 3usize) }
}
...
impl CssCounterStyleAtRule {
	...
	pub fn counter_style_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }
...
impl CssCustomIdentifier {
	...
	pub fn as_fields(&self) -> CssCustomIdentifierFields {
		CssCustomIdentifierFields { value_token:self.value_token() }
	}

	pub fn value_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }
}
...
impl CssDashedIdentifier {
	...
	pub fn as_fields(&self) -> CssDashedIdentifierFields {
		CssDashedIdentifierFields { value_token:self.value_token() }
	}
...
impl CssDeclaration {
	...
	pub fn as_fields(&self) -> CssDeclarationFields {
		CssDeclarationFields { property:self.property(), important:self.important() }
	}

	pub fn property(&self) -> SyntaxResult<AnyCssProperty> { support::required_node(&self.syntax, 0usize) }

	pub fn important(&self) -> Option<CssDeclarationImportant> { support::node(&self.syntax, 1usize) }
}
...
impl CssDeclarationBlock {
	...
	pub fn l_curly_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn declarations(&self) -> CssDeclarationList { support::list(&self.syntax, 1usize) }

	pub fn r_curly_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 2usize) }
}
...
impl CssDeclarationImportant {
	...
	pub fn as_fields(&self) -> CssDeclarationImportantFields {
		CssDeclarationImportantFields { excl_token:self.excl_token(), important_token:self.important_token() }
	}

	pub fn excl_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn important_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 1usize) }
}
...
impl CssDeclarationOrAtRuleBlock {
	...
	pub fn items(&self) -> CssDeclarationOrAtRuleList { support::list(&self.syntax, 1usize) }
...
impl CssDeclarationOrRuleBlock {
	...
	pub fn items(&self) -> CssDeclarationOrRuleList { support::list(&self.syntax, 1usize) }
...
impl CssDeclarationWithSemicolon {
	...
	pub fn as_fields(&self) -> CssDeclarationWithSemicolonFields {
		CssDeclarationWithSemicolonFields { declaration:self.declaration(), semicolon_token:self.semicolon_token() }
	}

	pub fn declaration(&self) -> SyntaxResult<CssDeclaration> { support::required_node(&self.syntax, 0usize) }
...
impl CssDocumentAtRule {
	...
	pub fn document_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn matchers(&self) -> CssDocumentMatcherList { support::list(&self.syntax, 1usize) }

	pub fn block(&self) -> SyntaxResult<AnyCssRuleBlock> { support::required_node(&self.syntax, 2usize) }
}
...
impl CssDocumentCustomMatcher {
	...
	pub fn name(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn l_paren_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 1usize) }

	pub fn value(&self) -> Option<AnyCssUrlValue> { support::node(&self.syntax, 2usize) }
...
impl CssEmptyDeclaration {
	...
	pub fn as_fields(&self) -> CssEmptyDeclarationFields {
		CssEmptyDeclarationFields { semicolon_token:self.semicolon_token() }
	}

	pub fn semicolon_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }
}
...
impl CssFontFaceAtRule {
	...
	pub fn as_fields(&self) -> CssFontFaceAtRuleFields {
		CssFontFaceAtRuleFields { font_face_token:self.font_face_token(), block:self.block() }
	}

	pub fn font_face_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn block(&self) -> SyntaxResult<AnyCssDeclarationBlock> { support::required_node(&self.syntax, 1usize) }
}
...
impl CssFontFamilyName {
	...
	pub fn as_fields(&self) -> CssFontFamilyNameFields { CssFontFamilyNameFields { names:self.names() } }

	pub fn names(&self) -> CssCustomIdentifierList { support::list(&self.syntax, 0usize) }
}
...
impl CssFontFeatureValuesAtRule {
	...
	pub fn names(&self) -> CssFontFamilyNameList { support::list(&self.syntax, 1usize) }

	pub fn block(&self) -> SyntaxResult<AnyCssFontFeatureValuesBlock> { support::required_node(&self.syntax, 2usize) }
}
...
impl CssFontFeatureValuesBlock {
	...
	pub fn items(&self) -> CssFontFeatureValuesItemList { support::list(&self.syntax, 1usize) }
...
impl CssFontFeatureValuesItem {
	...
	pub fn as_fields(&self) -> CssFontFeatureValuesItemFields {
		CssFontFeatureValuesItemFields { at_token:self.at_token(), name:self.name(), block:self.block() }
	}

	pub fn at_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn name(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 1usize) }
...
impl CssFontPaletteValuesAtRule {
	...
	pub fn name(&self) -> SyntaxResult<CssDashedIdentifier> { support::required_node(&self.syntax, 1usize) }
...
impl CssGenericDelimiter {
	...
	pub fn as_fields(&self) -> CssGenericDelimiterFields { CssGenericDelimiterFields { value:self.value() } }

	pub fn value(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }
}
...
impl CssGenericProperty {
	...
	pub fn as_fields(&self) -> CssGenericPropertyFields {
		CssGenericPropertyFields { name:self.name(), colon_token:self.colon_token(), value:self.value() }
	}

	pub fn name(&self) -> SyntaxResult<AnyCssDeclarationName> { support::required_node(&self.syntax, 0usize) }

	pub fn colon_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 1usize) }

	pub fn value(&self) -> CssGenericComponentValueList { support::list(&self.syntax, 2usize) }
}
...
impl CssIdSelector {
	...
	pub fn as_fields(&self) -> CssIdSelectorFields {
		CssIdSelectorFields { hash_token:self.hash_token(), name:self.name() }
	}
...
impl CssIdentifier {
	...
	pub fn as_fields(&self) -> CssIdentifierFields { CssIdentifierFields { value_token:self.value_token() } }
...
impl CssImportAnonymousLayer {
	...
	pub fn as_fields(&self) -> CssImportAnonymousLayerFields {
		CssImportAnonymousLayerFields { layer_token:self.layer_token() }
	}

	pub fn layer_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }
}
...
impl CssImportAtRule {
	...
	pub fn import_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn url(&self) -> SyntaxResult<AnyCssImportUrl> { support::required_node(&self.syntax, 1usize) }

	pub fn layer(&self) -> Option<AnyCssImportLayer> { support::node(&self.syntax, 2usize) }

	pub fn supports(&self) -> Option<CssImportSupports> { support::node(&self.syntax, 3usize) }

	pub fn media(&self) -> CssMediaQueryList { support::list(&self.syntax, 4usize) }

	pub fn semicolon_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 5usize) }
}
...
impl CssImportNamedLayer {
	...
	pub fn name(&self) -> CssLayerNameList { support::list(&self.syntax, 2usize) }
...
impl CssImportSupports {
	...
	pub fn supports_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }
...
impl CssKeyframesAtRule {
	...
	pub fn as_fields(&self) -> CssKeyframesAtRuleFields {
		CssKeyframesAtRuleFields { keyframes_token:self.keyframes_token(), name:self.name(), block:self.block() }
	}

	pub fn keyframes_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn name(&self) -> SyntaxResult<AnyCssKeyframesName> { support::required_node(&self.syntax, 1usize) }

	pub fn block(&self) -> SyntaxResult<AnyCssKeyframesBlock> { support::required_node(&self.syntax, 2usize) }
}
...
impl CssKeyframesBlock {
	...
	pub fn items(&self) -> CssKeyframesItemList { support::list(&self.syntax, 1usize) }
...
impl CssKeyframesIdentSelector {
	...
	pub fn as_fields(&self) -> CssKeyframesIdentSelectorFields {
		CssKeyframesIdentSelectorFields { selector:self.selector() }
	}

	pub fn selector(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }
}
...
impl CssKeyframesItem {
	...
	pub fn as_fields(&self) -> CssKeyframesItemFields {
		CssKeyframesItemFields { selectors:self.selectors(), block:self.block() }
	}
...
impl CssKeyframesPercentageSelector {
	...
	pub fn as_fields(&self) -> CssKeyframesPercentageSelectorFields {
		CssKeyframesPercentageSelectorFields { selector:self.selector() }
	}

	pub fn selector(&self) -> SyntaxResult<CssPercentage> { support::required_node(&self.syntax, 0usize) }
}
...
impl CssKeyframesScopeFunction {
	...
	pub fn scope(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn l_paren_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 1usize) }

	pub fn name(&self) -> SyntaxResult<AnyCssKeyframesIdentifier> { support::required_node(&self.syntax, 2usize) }
...
impl CssKeyframesScopePrefix {
	...
	pub fn as_fields(&self) -> CssKeyframesScopePrefixFields {
		CssKeyframesScopePrefixFields { scope:self.scope(), name:self.name() }
	}

	pub fn scope(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn name(&self) -> SyntaxResult<AnyCssKeyframesIdentifier> { support::required_node(&self.syntax, 1usize) }
}
...
impl CssKeyframesScopedName {
	...
	pub fn as_fields(&self) -> CssKeyframesScopedNameFields {
		CssKeyframesScopedNameFields { colon_token:self.colon_token(), scope:self.scope() }
	}

	pub fn colon_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn scope(&self) -> SyntaxResult<AnyCssKeyframesScope> { support::required_node(&self.syntax, 1usize) }
}
...
impl CssLayerAtRule {
	...
	pub fn as_fields(&self) -> CssLayerAtRuleFields {
		CssLayerAtRuleFields { layer_token:self.layer_token(), layer:self.layer() }
	}

	pub fn layer_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn layer(&self) -> SyntaxResult<AnyCssLayer> { support::required_node(&self.syntax, 1usize) }
}
...
impl CssLayerDeclaration {
	...
	pub fn as_fields(&self) -> CssLayerDeclarationFields {
		CssLayerDeclarationFields { references:self.references(), block:self.block() }
	}

	pub fn references(&self) -> CssLayerReferenceList { support::list(&self.syntax, 0usize) }

	pub fn block(&self) -> SyntaxResult<AnyCssConditionalBlock> { support::required_node(&self.syntax, 1usize) }
}
...
impl CssLayerReference {
	...
	pub fn as_fields(&self) -> CssLayerReferenceFields {
		CssLayerReferenceFields { references:self.references(), semicolon_token:self.semicolon_token() }
	}

	pub fn references(&self) -> CssLayerReferenceList { support::list(&self.syntax, 0usize) }

	pub fn semicolon_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 1usize) }
}
...
impl CssListOfComponentValuesExpression {
	...
	pub fn as_fields(&self) -> CssListOfComponentValuesExpressionFields {
		CssListOfComponentValuesExpressionFields { css_component_value_list:self.css_component_value_list() }
	}

	pub fn css_component_value_list(&self) -> CssComponentValueList { support::list(&self.syntax, 0usize) }
}
...
impl CssMarginAtRule {
	...
	pub fn as_fields(&self) -> CssMarginAtRuleFields {
		CssMarginAtRuleFields { at_token:self.at_token(), name:self.name(), block:self.block() }
	}
	...
	pub fn block(&self) -> SyntaxResult<AnyCssDeclarationOrAtRuleBlock> { support::required_node(&self.syntax, 2usize) }
}
...
impl CssMediaAndCondition {
	...
	pub fn as_fields(&self) -> CssMediaAndConditionFields {
		CssMediaAndConditionFields { left:self.left(), and_token:self.and_token(), right:self.right() }
	}

	pub fn left(&self) -> SyntaxResult<AnyCssMediaInParens> { support::required_node(&self.syntax, 0usize) }
...
impl CssMediaAndTypeQuery {
	...
	pub fn as_fields(&self) -> CssMediaAndTypeQueryFields {
		CssMediaAndTypeQueryFields { left:self.left(), and_token:self.and_token(), right:self.right() }
	}

	pub fn left(&self) -> SyntaxResult<CssMediaTypeQuery> { support::required_node(&self.syntax, 0usize) }

	pub fn and_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 1usize) }

	pub fn right(&self) -> SyntaxResult<AnyCssMediaTypeCondition> { support::required_node(&self.syntax, 2usize) }
}
...
impl CssMediaAtRule {
	...
	pub fn as_fields(&self) -> CssMediaAtRuleFields {
		CssMediaAtRuleFields { media_token:self.media_token(), queries:self.queries(), block:self.block() }
	}

	pub fn media_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn queries(&self) -> CssMediaQueryList { support::list(&self.syntax, 1usize) }

	pub fn block(&self) -> SyntaxResult<AnyCssConditionalBlock> { support::required_node(&self.syntax, 2usize) }
}
...
impl CssMediaConditionInParens {
	...
	pub fn condition(&self) -> SyntaxResult<AnyCssMediaCondition> { support::required_node(&self.syntax, 1usize) }
...
impl CssMediaConditionQuery {
	...
	pub fn as_fields(&self) -> CssMediaConditionQueryFields {
		CssMediaConditionQueryFields { condition:self.condition() }
	}

	pub fn condition(&self) -> SyntaxResult<AnyCssMediaCondition> { support::required_node(&self.syntax, 0usize) }
}
...
impl CssMediaNotCondition {
	...
	pub fn as_fields(&self) -> CssMediaNotConditionFields {
		CssMediaNotConditionFields { not_token:self.not_token(), condition:self.condition() }
	}

	pub fn not_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn condition(&self) -> SyntaxResult<AnyCssMediaInParens> { support::required_node(&self.syntax, 1usize) }
}
...
impl CssMediaOrCondition {
	...
	pub fn as_fields(&self) -> CssMediaOrConditionFields {
		CssMediaOrConditionFields { left:self.left(), or_token:self.or_token(), right:self.right() }
	}
...
impl CssMediaType {
	...
	pub fn as_fields(&self) -> CssMediaTypeFields { CssMediaTypeFields { value:self.value() } }

	pub fn value(&self) -> SyntaxResult<CssIdentifier> { support::required_node(&self.syntax, 0usize) }
}
...
impl CssMediaTypeQuery {
	...
	pub fn as_fields(&self) -> CssMediaTypeQueryFields {
		CssMediaTypeQueryFields { modifier:self.modifier(), ty:self.ty() }
	}

	pub fn modifier(&self) -> Option<SyntaxToken> { support::token(&self.syntax, 0usize) }

	pub fn ty(&self) -> SyntaxResult<CssMediaType> { support::required_node(&self.syntax, 1usize) }
}
...
impl CssMetavariable {
	...
	pub fn as_fields(&self) -> CssMetavariableFields { CssMetavariableFields { value_token:self.value_token() } }
...
impl CssNamedNamespacePrefix {
	...
	pub fn as_fields(&self) -> CssNamedNamespacePrefixFields { CssNamedNamespacePrefixFields { name:self.name() } }
...
impl CssNamespace {
	...
	pub fn as_fields(&self) -> CssNamespaceFields {
		CssNamespaceFields { prefix:self.prefix(), bitwise_or_token:self.bitwise_or_token() }
	}

	pub fn prefix(&self) -> Option<AnyCssNamespacePrefix> { support::node(&self.syntax, 0usize) }

	pub fn bitwise_or_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 1usize) }
}
...
impl CssNamespaceAtRule {
	...
	pub fn namespace_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn prefix(&self) -> Option<CssIdentifier> { support::node(&self.syntax, 1usize) }

	pub fn url(&self) -> SyntaxResult<AnyCssNamespaceUrl> { support::required_node(&self.syntax, 2usize) }

	pub fn semicolon_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 3usize) }
}
...
impl CssNestedQualifiedRule {
	...
	pub fn as_fields(&self) -> CssNestedQualifiedRuleFields {
		CssNestedQualifiedRuleFields { prelude:self.prelude(), block:self.block() }
	}

	pub fn prelude(&self) -> CssRelativeSelectorList { support::list(&self.syntax, 0usize) }

	pub fn block(&self) -> SyntaxResult<AnyCssDeclarationOrRuleBlock> { support::required_node(&self.syntax, 1usize) }
}
...
impl CssNestedSelector {
	...
	pub fn as_fields(&self) -> CssNestedSelectorFields { CssNestedSelectorFields { amp_token:self.amp_token() } }

	pub fn amp_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }
}
...
impl CssNthOffset {
	...
	pub fn as_fields(&self) -> CssNthOffsetFields { CssNthOffsetFields { sign:self.sign(), value:self.value() } }

	pub fn sign(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn value(&self) -> SyntaxResult<CssNumber> { support::required_node(&self.syntax, 1usize) }
}
...
impl CssNumber {
	...
	pub fn as_fields(&self) -> CssNumberFields { CssNumberFields { value_token:self.value_token() } }
...
impl CssPageAtRule {
	...
	pub fn as_fields(&self) -> CssPageAtRuleFields {
		CssPageAtRuleFields { page_token:self.page_token(), selectors:self.selectors(), block:self.block() }
	}

	pub fn page_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn selectors(&self) -> CssPageSelectorList { support::list(&self.syntax, 1usize) }

	pub fn block(&self) -> SyntaxResult<AnyCssPageAtRuleBlock> { support::required_node(&self.syntax, 2usize) }
}
...
impl CssPageAtRuleBlock {
	...
	pub fn items(&self) -> CssPageAtRuleItemList { support::list(&self.syntax, 1usize) }
...
impl CssPageSelector {
	...
	pub fn as_fields(&self) -> CssPageSelectorFields { CssPageSelectorFields { ty:self.ty(), pseudos:self.pseudos() } }

	pub fn ty(&self) -> Option<CssCustomIdentifier> { support::node(&self.syntax, 0usize) }

	pub fn pseudos(&self) -> CssPageSelectorPseudoList { support::list(&self.syntax, 1usize) }
}
...
impl CssPageSelectorPseudo {
	...
	pub fn as_fields(&self) -> CssPageSelectorPseudoFields {
		CssPageSelectorPseudoFields { colon_token:self.colon_token(), selector:self.selector() }
	}

	pub fn colon_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn selector(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 1usize) }
}
...
impl CssParameter {
	...
	pub fn as_fields(&self) -> CssParameterFields {
		CssParameterFields { any_css_expression:self.any_css_expression() }
	}

	pub fn any_css_expression(&self) -> SyntaxResult<AnyCssExpression> { support::required_node(&self.syntax, 0usize) }
}
...
impl CssParenthesizedExpression {
	...
	pub fn expression(&self) -> Option<AnyCssExpression> { support::node(&self.syntax, 1usize) }
...
impl CssPercentage {
	...
	pub fn as_fields(&self) -> CssPercentageFields {
		CssPercentageFields { value_token:self.value_token(), percent_token:self.percent_token() }
	}

	pub fn value_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn percent_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 1usize) }
}
...
impl CssPropertyAtRule {
	...
	pub fn as_fields(&self) -> CssPropertyAtRuleFields {
		CssPropertyAtRuleFields { property_token:self.property_token(), name:self.name(), block:self.block() }
	}

	pub fn property_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }
...
impl CssPseudoClassFunctionCompoundSelector {
	...
	pub fn selector(&self) -> SyntaxResult<AnyCssCompoundSelector> { support::required_node(&self.syntax, 2usize) }
...
impl CssPseudoClassFunctionCompoundSelectorList {
	...
	pub fn compound_selectors(&self) -> CssCompoundSelectorList { support::list(&self.syntax, 2usize) }
...
impl CssPseudoClassFunctionIdentifier {
	...
	pub fn name_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn l_paren_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 1usize) }

	pub fn ident(&self) -> SyntaxResult<CssIdentifier> { support::required_node(&self.syntax, 2usize) }
...
impl CssPseudoClassFunctionRelativeSelectorList {
	...
	pub fn relative_selectors(&self) -> CssRelativeSelectorList { support::list(&self.syntax, 2usize) }
...
impl CssPseudoClassFunctionSelector {
	...
	pub fn selector(&self) -> SyntaxResult<AnyCssSelector> { support::required_node(&self.syntax, 2usize) }
...
impl CssPseudoClassFunctionSelectorList {
	...
	pub fn selectors(&self) -> CssSelectorList { support::list(&self.syntax, 2usize) }
...
impl CssPseudoClassFunctionValueList {
	...
	pub fn values(&self) -> CssPseudoValueList { support::list(&self.syntax, 2usize) }
...
impl CssPseudoClassIdentifier {
	...
	pub fn as_fields(&self) -> CssPseudoClassIdentifierFields { CssPseudoClassIdentifierFields { name:self.name() } }
...
impl CssPseudoClassNth {
	...
	pub fn sign(&self) -> Option<SyntaxToken> { support::token(&self.syntax, 0usize) }

	pub fn value(&self) -> Option<CssNumber> { support::node(&self.syntax, 1usize) }

	pub fn symbol_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 2usize) }

	pub fn offset(&self) -> Option<CssNthOffset> { support::node(&self.syntax, 3usize) }
}
...
impl CssPseudoClassNthIdentifier {
	...
	pub fn as_fields(&self) -> CssPseudoClassNthIdentifierFields {
		CssPseudoClassNthIdentifierFields { value:self.value() }
	}
...
impl CssPseudoClassNthNumber {
	...
	pub fn as_fields(&self) -> CssPseudoClassNthNumberFields {
		CssPseudoClassNthNumberFields { sign:self.sign(), value:self.value() }
	}
...
impl CssPseudoClassNthSelector {
	...
	pub fn as_fields(&self) -> CssPseudoClassNthSelectorFields {
		CssPseudoClassNthSelectorFields { nth:self.nth(), of_selector:self.of_selector() }
	}

	pub fn nth(&self) -> SyntaxResult<AnyCssPseudoClassNth> { support::required_node(&self.syntax, 0usize) }

	pub fn of_selector(&self) -> Option<CssPseudoClassOfNthSelector> { support::node(&self.syntax, 1usize) }
}
...
impl CssPseudoClassOfNthSelector {
	...
	pub fn as_fields(&self) -> CssPseudoClassOfNthSelectorFields {
		CssPseudoClassOfNthSelectorFields { of_token:self.of_token(), selectors:self.selectors() }
	}

	pub fn of_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn selectors(&self) -> CssSelectorList { support::list(&self.syntax, 1usize) }
}
...
impl CssPseudoClassSelector {
	...
	pub fn as_fields(&self) -> CssPseudoClassSelectorFields {
		CssPseudoClassSelectorFields { colon_token:self.colon_token(), class:self.class() }
	}

	pub fn colon_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn class(&self) -> SyntaxResult<AnyCssPseudoClass> { support::required_node(&self.syntax, 1usize) }
}
...
impl CssPseudoElementSelector {
	...
	pub fn as_fields(&self) -> CssPseudoElementSelectorFields {
		CssPseudoElementSelectorFields { double_colon_token:self.double_colon_token(), element:self.element() }
	}

	pub fn double_colon_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn element(&self) -> SyntaxResult<AnyCssPseudoElement> { support::required_node(&self.syntax, 1usize) }
}
...
impl CssQualifiedRule {
	...
	pub fn as_fields(&self) -> CssQualifiedRuleFields {
		CssQualifiedRuleFields { prelude:self.prelude(), block:self.block() }
	}
...
impl CssQueryFeatureBoolean {
	...
	pub fn as_fields(&self) -> CssQueryFeatureBooleanFields { CssQueryFeatureBooleanFields { name:self.name() } }
...
impl CssQueryFeaturePlain {
	...
	pub fn as_fields(&self) -> CssQueryFeaturePlainFields {
		CssQueryFeaturePlainFields { name:self.name(), colon_token:self.colon_token(), value:self.value() }
	}
	...
	pub fn value(&self) -> SyntaxResult<AnyCssQueryFeatureValue> { support::required_node(&self.syntax, 2usize) }
}
...
impl CssQueryFeatureRange {
	...
	pub fn as_fields(&self) -> CssQueryFeatureRangeFields {
		CssQueryFeatureRangeFields { left:self.left(), comparison:self.comparison(), right:self.right() }
	}

	pub fn left(&self) -> SyntaxResult<CssIdentifier> { support::required_node(&self.syntax, 0usize) }

	pub fn comparison(&self) -> SyntaxResult<CssQueryFeatureRangeComparison> {
		support::required_node(&self.syntax, 1usize)
	}

	pub fn right(&self) -> SyntaxResult<AnyCssQueryFeatureValue> { support::required_node(&self.syntax, 2usize) }
}
...
impl CssQueryFeatureRangeComparison {
	...
	pub fn as_fields(&self) -> CssQueryFeatureRangeComparisonFields {
		CssQueryFeatureRangeComparisonFields { operator:self.operator() }
	}
...
impl CssQueryFeatureRangeInterval {
	...
	pub fn left(&self) -> SyntaxResult<AnyCssQueryFeatureValue> { support::required_node(&self.syntax, 0usize) }

	pub fn left_comparison(&self) -> SyntaxResult<CssQueryFeatureRangeComparison> {
		support::required_node(&self.syntax, 1usize)
	}

	pub fn name(&self) -> SyntaxResult<CssIdentifier> { support::required_node(&self.syntax, 2usize) }

	pub fn right_comparison(&self) -> SyntaxResult<CssQueryFeatureRangeComparison> {
		support::required_node(&self.syntax, 3usize)
	}

	pub fn right(&self) -> SyntaxResult<AnyCssQueryFeatureValue> { support::required_node(&self.syntax, 4usize) }
}
...
impl CssQueryFeatureReverseRange {
	...
	pub fn as_fields(&self) -> CssQueryFeatureReverseRangeFields {
		CssQueryFeatureReverseRangeFields { left:self.left(), comparison:self.comparison(), right:self.right() }
	}
	...
	pub fn right(&self) -> SyntaxResult<CssIdentifier> { support::required_node(&self.syntax, 2usize) }
}
...
impl CssRatio {
	...
	pub fn numerator(&self) -> SyntaxResult<CssNumber> { support::required_node(&self.syntax, 0usize) }

	pub fn slash_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 1usize) }

	pub fn denominator(&self) -> SyntaxResult<CssNumber> { support::required_node(&self.syntax, 2usize) }
}
...
impl CssRegularDimension {
	...
	pub fn as_fields(&self) -> CssRegularDimensionFields {
		CssRegularDimensionFields { value_token:self.value_token(), unit_token:self.unit_token() }
	}

	pub fn value_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn unit_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 1usize) }
}
...
impl CssRelativeSelector {
	...
	pub fn as_fields(&self) -> CssRelativeSelectorFields {
		CssRelativeSelectorFields { combinator:self.combinator(), selector:self.selector() }
	}

	pub fn combinator(&self) -> Option<SyntaxToken> { support::token(&self.syntax, 0usize) }

	pub fn selector(&self) -> SyntaxResult<AnyCssSelector> { support::required_node(&self.syntax, 1usize) }
}
...
impl CssRoot {
	...
	pub fn as_fields(&self) -> CssRootFields {
		CssRootFields { bom_token:self.bom_token(), rules:self.rules(), eof_token:self.eof_token() }
	}

	pub fn bom_token(&self) -> Option<SyntaxToken> { support::token(&self.syntax, 0usize) }

	pub fn rules(&self) -> CssRuleList { support::list(&self.syntax, 1usize) }

	pub fn eof_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 2usize) }
}
...
impl CssScopeAtRule {
	...
	pub fn as_fields(&self) -> CssScopeAtRuleFields {
		CssScopeAtRuleFields { scope_token:self.scope_token(), range:self.range(), block:self.block() }
	}

	pub fn scope_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn range(&self) -> Option<AnyCssScopeRange> { support::node(&self.syntax, 1usize) }
...
impl CssScopeRangeEnd {
	...
	pub fn as_fields(&self) -> CssScopeRangeEndFields {
		CssScopeRangeEndFields { to_token:self.to_token(), end:self.end() }
	}

	pub fn to_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn end(&self) -> SyntaxResult<CssScopeEdge> { support::required_node(&self.syntax, 1usize) }
}
...
impl CssScopeRangeInterval {
	...
	pub fn as_fields(&self) -> CssScopeRangeIntervalFields {
		CssScopeRangeIntervalFields { start:self.start(), to_token:self.to_token(), end:self.end() }
	}

	pub fn start(&self) -> SyntaxResult<CssScopeEdge> { support::required_node(&self.syntax, 0usize) }

	pub fn to_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 1usize) }

	pub fn end(&self) -> SyntaxResult<CssScopeEdge> { support::required_node(&self.syntax, 2usize) }
}
...
impl CssScopeRangeStart {
	...
	pub fn as_fields(&self) -> CssScopeRangeStartFields { CssScopeRangeStartFields { start:self.start() } }
...
impl CssStartingStyleAtRule {
	...
	pub fn as_fields(&self) -> CssStartingStyleAtRuleFields {
		CssStartingStyleAtRuleFields { starting_style_token:self.starting_style_token(), block:self.block() }
	}

	pub fn starting_style_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn block(&self) -> SyntaxResult<AnyCssStartingStyleBlock> { support::required_node(&self.syntax, 1usize) }
}
...
impl CssString {
	...
	pub fn as_fields(&self) -> CssStringFields { CssStringFields { value_token:self.value_token() } }
...
impl CssSupportsAndCondition {
	...
	pub fn as_fields(&self) -> CssSupportsAndConditionFields {
		CssSupportsAndConditionFields { left:self.left(), and_token:self.and_token(), right:self.right() }
	}

	pub fn left(&self) -> SyntaxResult<AnyCssSupportsInParens> { support::required_node(&self.syntax, 0usize) }
...
impl CssSupportsAtRule {
	...
	pub fn condition(&self) -> SyntaxResult<AnyCssSupportsCondition> { support::required_node(&self.syntax, 1usize) }
...
impl CssSupportsFeatureDeclaration {
	...
	pub fn declaration(&self) -> SyntaxResult<CssDeclaration> { support::required_node(&self.syntax, 1usize) }
...
impl CssSupportsFeatureSelector {
	...
	pub fn selector_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }
...
impl CssSupportsNotCondition {
	...
	pub fn as_fields(&self) -> CssSupportsNotConditionFields {
		CssSupportsNotConditionFields { not_token:self.not_token(), query:self.query() }
	}

	pub fn not_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn query(&self) -> SyntaxResult<AnyCssSupportsInParens> { support::required_node(&self.syntax, 1usize) }
}
...
impl CssSupportsOrCondition {
	...
	pub fn as_fields(&self) -> CssSupportsOrConditionFields {
		CssSupportsOrConditionFields { left:self.left(), or_token:self.or_token(), right:self.right() }
	}
...
impl CssTypeSelector {
	...
	pub fn as_fields(&self) -> CssTypeSelectorFields {
		CssTypeSelectorFields { namespace:self.namespace(), ident:self.ident() }
	}

	pub fn namespace(&self) -> Option<CssNamespace> { support::node(&self.syntax, 0usize) }

	pub fn ident(&self) -> SyntaxResult<CssIdentifier> { support::required_node(&self.syntax, 1usize) }
}
...
impl CssUnicodeCodepoint {
	...
	pub fn as_fields(&self) -> CssUnicodeCodepointFields {
		CssUnicodeCodepointFields { value_token:self.value_token() }
	}
...
impl CssUnicodeRange {
	...
	pub fn as_fields(&self) -> CssUnicodeRangeFields {
		CssUnicodeRangeFields { prefix_token:self.prefix_token(), value:self.value() }
	}

	pub fn prefix_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }

	pub fn value(&self) -> SyntaxResult<AnyCssUnicodeValue> { support::required_node(&self.syntax, 1usize) }
}
...
impl CssUnicodeRangeInterval {
	...
	pub fn as_fields(&self) -> CssUnicodeRangeIntervalFields {
		CssUnicodeRangeIntervalFields { start:self.start(), minus_token:self.minus_token(), end:self.end() }
	}

	pub fn start(&self) -> SyntaxResult<CssUnicodeCodepoint> { support::required_node(&self.syntax, 0usize) }

	pub fn minus_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 1usize) }

	pub fn end(&self) -> SyntaxResult<CssUnicodeCodepoint> { support::required_node(&self.syntax, 2usize) }
}
...
impl CssUnicodeRangeWildcard {
	...
	pub fn as_fields(&self) -> CssUnicodeRangeWildcardFields {
		CssUnicodeRangeWildcardFields { value_token:self.value_token() }
	}
...
impl CssUniversalNamespacePrefix {
	...
	pub fn as_fields(&self) -> CssUniversalNamespacePrefixFields {
		CssUniversalNamespacePrefixFields { star_token:self.star_token() }
	}

	pub fn star_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 0usize) }
}
...
impl CssUniversalSelector {
	...
	pub fn as_fields(&self) -> CssUniversalSelectorFields {
		CssUniversalSelectorFields { namespace:self.namespace(), star_token:self.star_token() }
	}

	pub fn namespace(&self) -> Option<CssNamespace> { support::node(&self.syntax, 0usize) }

	pub fn star_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 1usize) }
}
...
impl CssUnknownBlockAtRule {
	...
	pub fn as_fields(&self) -> CssUnknownBlockAtRuleFields {
		CssUnknownBlockAtRuleFields { name:self.name(), components:self.components(), block:self.block() }
	}
	...
	pub fn block(&self) -> SyntaxResult<AnyCssDeclarationOrRuleBlock> { support::required_node(&self.syntax, 2usize) }
}
...
impl CssUnknownDimension {
	...
	pub fn as_fields(&self) -> CssUnknownDimensionFields {
		CssUnknownDimensionFields { value_token:self.value_token(), unit_token:self.unit_token() }
	}
...
impl CssUrlFunction {
	...
	pub fn modifiers(&self) -> CssUrlModifierList { support::list(&self.syntax, 3usize) }

	pub fn r_paren_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 4usize) }
}
...
impl CssUrlValueRaw {
	...
	pub fn as_fields(&self) -> CssUrlValueRawFields { CssUrlValueRawFields { value_token:self.value_token() } }
...
impl CssValueAtRule {
	...
	pub fn clause(&self) -> SyntaxResult<AnyCssValueAtRuleClause> { support::required_node(&self.syntax, 1usize) }
...
impl CssValueAtRuleDeclarationClause {
	...
	pub fn as_fields(&self) -> CssValueAtRuleDeclarationClauseFields {
		CssValueAtRuleDeclarationClauseFields { properties:self.properties() }
	}

	pub fn properties(&self) -> CssValueAtRulePropertyList { support::list(&self.syntax, 0usize) }
}
...
impl CssValueAtRuleGenericProperty {
	...
	pub fn as_fields(&self) -> CssValueAtRuleGenericPropertyFields {
		CssValueAtRuleGenericPropertyFields { name:self.name(), colon_token:self.colon_token(), value:self.value() }
	}
	...
	pub fn value(&self) -> SyntaxResult<CssValueAtRuleGenericValue> { support::required_node(&self.syntax, 2usize) }
}
...
impl CssValueAtRuleImportClause {
	...
	pub fn specifiers(&self) -> CssValueAtRuleImportSpecifierList { support::list(&self.syntax, 0usize) }

	pub fn from_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 1usize) }

	pub fn source(&self) -> SyntaxResult<AnyCssValueAtRuleImportSource> { support::required_node(&self.syntax, 2usize) }
}
...
impl CssValueAtRuleNamedImportSpecifier {
	...
	pub fn as_token(&self) -> SyntaxResult<SyntaxToken> { support::required_token(&self.syntax, 1usize) }

	pub fn local_name(&self) -> SyntaxResult<CssIdentifier> { support::required_node(&self.syntax, 2usize) }
}
...
impl AnyCssContainerQueryInParens {
	...
	pub fn as_css_container_size_feature_in_parens(&self) -> Option<&CssContainerSizeFeatureInParens> {
		match &self {
	...
	pub fn as_css_container_style_query_in_parens(&self) -> Option<&CssContainerStyleQueryInParens> {
		match &self {
...
impl AnyCssExpression {
	...
	pub fn as_css_list_of_component_values_expression(&self) -> Option<&CssListOfComponentValuesExpression> {
		match &self {
...
impl AnyCssPseudoClass {
	...
	pub fn as_css_pseudo_class_function_compound_selector(&self) -> Option<&CssPseudoClassFunctionCompoundSelector> {
		match &self {
	...
	pub fn as_css_pseudo_class_function_identifier(&self) -> Option<&CssPseudoClassFunctionIdentifier> {
		match &self {
	...
	pub fn as_css_pseudo_class_function_selector_list(&self) -> Option<&CssPseudoClassFunctionSelectorList> {
		match &self {
	...
	pub fn as_css_pseudo_class_function_value_list(&self) -> Option<&CssPseudoClassFunctionValueList> {
		match &self {
...
impl AnyCssPseudoElement {
	...
	pub fn as_css_pseudo_element_function_identifier(&self) -> Option<&CssPseudoElementFunctionIdentifier> {
		match &self {
	...
	pub fn as_css_pseudo_element_function_selector(&self) -> Option<&CssPseudoElementFunctionSelector> {
		match &self {
...
impl AnyCssValueAtRuleClause {
	pub fn as_css_value_at_rule_declaration_clause(&self) -> Option<&CssValueAtRuleDeclarationClause> {
		match &self {
...
impl AnyCssValueAtRuleImportSpecifier {
	...
	pub fn as_css_value_at_rule_named_import_specifier(&self) -> Option<&CssValueAtRuleNamedImportSpecifier> {
		match &self {
			AnyCssValueAtRuleImportSpecifier::CssValueAtRuleNamedImportSpecifier(item) => Some(item),
...
impl AstNode for CssAtRule {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_AT_RULE as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_AT_RULE }
...
impl From<CssAtRule> for SyntaxNode {
	fn from(n:CssAtRule) -> SyntaxNode { n.syntax }
}
impl From<CssAtRule> for SyntaxElement {
	fn from(n:CssAtRule) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssAttributeMatcher {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_ATTRIBUTE_MATCHER as u16));
...
impl AstNode for CssAttributeMatcherValue {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_ATTRIBUTE_MATCHER_VALUE as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_ATTRIBUTE_MATCHER_VALUE }
...
impl From<CssAttributeMatcherValue> for SyntaxNode {
	fn from(n:CssAttributeMatcherValue) -> SyntaxNode { n.syntax }
}
impl From<CssAttributeMatcherValue> for SyntaxElement {
	fn from(n:CssAttributeMatcherValue) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssAttributeName {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_ATTRIBUTE_NAME as u16));
...
impl std::fmt::Debug for CssAttributeName {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssAttributeName")
			.field("namespace", &support::DebugOptionalElement(self.namespace()))
			.field("name", &support::DebugSyntaxResult(self.name()))
			.finish()
	}
}
...
impl AstNode for CssAttributeSelector {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_ATTRIBUTE_SELECTOR as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_ATTRIBUTE_SELECTOR }
...
impl std::fmt::Debug for CssAttributeSelector {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssAttributeSelector")
			.field("l_brack_token", &support::DebugSyntaxResult(self.l_brack_token()))
			.field("name", &support::DebugSyntaxResult(self.name()))
			.field("matcher", &support::DebugOptionalElement(self.matcher()))
			.field("r_brack_token", &support::DebugSyntaxResult(self.r_brack_token()))
			.finish()
	}
}
impl From<CssAttributeSelector> for SyntaxNode {
	fn from(n:CssAttributeSelector) -> SyntaxNode { n.syntax }
}
impl From<CssAttributeSelector> for SyntaxElement {
	fn from(n:CssAttributeSelector) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssBinaryExpression {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_BINARY_EXPRESSION as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_BINARY_EXPRESSION }
...
impl From<CssBinaryExpression> for SyntaxNode {
	fn from(n:CssBinaryExpression) -> SyntaxNode { n.syntax }
}
impl From<CssBinaryExpression> for SyntaxElement {
	fn from(n:CssBinaryExpression) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssBracketedValue {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_BRACKETED_VALUE as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_BRACKETED_VALUE }
...
impl From<CssBracketedValue> for SyntaxNode {
	fn from(n:CssBracketedValue) -> SyntaxNode { n.syntax }
}
impl From<CssBracketedValue> for SyntaxElement {
	fn from(n:CssBracketedValue) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssCharsetAtRule {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_CHARSET_AT_RULE as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_CHARSET_AT_RULE }
...
impl std::fmt::Debug for CssCharsetAtRule {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssCharsetAtRule")
			.field("charset_token", &support::DebugSyntaxResult(self.charset_token()))
			.field("encoding", &support::DebugSyntaxResult(self.encoding()))
			.field("semicolon_token", &support::DebugSyntaxResult(self.semicolon_token()))
			.finish()
	}
}
impl From<CssCharsetAtRule> for SyntaxNode {
	fn from(n:CssCharsetAtRule) -> SyntaxNode { n.syntax }
}
impl From<CssCharsetAtRule> for SyntaxElement {
	fn from(n:CssCharsetAtRule) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssClassSelector {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_CLASS_SELECTOR as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_CLASS_SELECTOR }
...
impl From<CssClassSelector> for SyntaxNode {
	fn from(n:CssClassSelector) -> SyntaxNode { n.syntax }
}
impl From<CssClassSelector> for SyntaxElement {
	fn from(n:CssClassSelector) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssColor {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_COLOR as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_COLOR }
...
impl std::fmt::Debug for CssColor {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssColor")
			...
			.field("value_token", &support::DebugSyntaxResult(self.value_token()))
			.finish()
	}
}
impl From<CssColor> for SyntaxNode {
	fn from(n:CssColor) -> SyntaxNode { n.syntax }
}
impl From<CssColor> for SyntaxElement {
	fn from(n:CssColor) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssColorProfileAtRule {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_COLOR_PROFILE_AT_RULE as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_COLOR_PROFILE_AT_RULE }
...
impl std::fmt::Debug for CssColorProfileAtRule {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssColorProfileAtRule")
			.field("color_profile_token", &support::DebugSyntaxResult(self.color_profile_token()))
			.field("name", &support::DebugSyntaxResult(self.name()))
...
impl From<CssColorProfileAtRule> for SyntaxNode {
	fn from(n:CssColorProfileAtRule) -> SyntaxNode { n.syntax }
}
impl From<CssColorProfileAtRule> for SyntaxElement {
	fn from(n:CssColorProfileAtRule) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssComplexSelector {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_COMPLEX_SELECTOR as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_COMPLEX_SELECTOR }
...
impl From<CssComplexSelector> for SyntaxNode {
	fn from(n:CssComplexSelector) -> SyntaxNode { n.syntax }
}
impl From<CssComplexSelector> for SyntaxElement {
	fn from(n:CssComplexSelector) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssComposesImportSpecifier {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_COMPOSES_IMPORT_SPECIFIER }
...
impl From<CssComposesImportSpecifier> for SyntaxNode {
	fn from(n:CssComposesImportSpecifier) -> SyntaxNode { n.syntax }
}
impl From<CssComposesImportSpecifier> for SyntaxElement {
	fn from(n:CssComposesImportSpecifier) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssComposesProperty {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_COMPOSES_PROPERTY as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_COMPOSES_PROPERTY }
...
impl std::fmt::Debug for CssComposesProperty {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssComposesProperty")
			.field("name", &support::DebugSyntaxResult(self.name()))
			.field("colon_token", &support::DebugSyntaxResult(self.colon_token()))
			.field("value", &support::DebugSyntaxResult(self.value()))
			.finish()
	}
}
impl From<CssComposesProperty> for SyntaxNode {
	fn from(n:CssComposesProperty) -> SyntaxNode { n.syntax }
}
impl From<CssComposesProperty> for SyntaxElement {
	fn from(n:CssComposesProperty) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssComposesPropertyValue {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_COMPOSES_PROPERTY_VALUE as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_COMPOSES_PROPERTY_VALUE }
...
impl std::fmt::Debug for CssComposesPropertyValue {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssComposesPropertyValue")
			...
			.field("specifier", &support::DebugOptionalElement(self.specifier()))
			.finish()
	}
}
impl From<CssComposesPropertyValue> for SyntaxNode {
	fn from(n:CssComposesPropertyValue) -> SyntaxNode { n.syntax }
}
impl From<CssComposesPropertyValue> for SyntaxElement {
	fn from(n:CssComposesPropertyValue) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssCompoundSelector {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_COMPOUND_SELECTOR as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_COMPOUND_SELECTOR }
...
impl std::fmt::Debug for CssCompoundSelector {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssCompoundSelector")
			...
			.field("simple_selector", &support::DebugOptionalElement(self.simple_selector()))
			.field("sub_selectors", &self.sub_selectors())
			.finish()
	}
}
impl From<CssCompoundSelector> for SyntaxNode {
	fn from(n:CssCompoundSelector) -> SyntaxNode { n.syntax }
}
impl From<CssCompoundSelector> for SyntaxElement {
	fn from(n:CssCompoundSelector) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssContainerAndQuery {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_CONTAINER_AND_QUERY as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_CONTAINER_AND_QUERY }
...
impl From<CssContainerAndQuery> for SyntaxNode {
	fn from(n:CssContainerAndQuery) -> SyntaxNode { n.syntax }
}
impl From<CssContainerAndQuery> for SyntaxElement {
	fn from(n:CssContainerAndQuery) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssContainerAtRule {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_CONTAINER_AT_RULE as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_CONTAINER_AT_RULE }
...
impl From<CssContainerAtRule> for SyntaxNode {
	fn from(n:CssContainerAtRule) -> SyntaxNode { n.syntax }
}
impl From<CssContainerAtRule> for SyntaxElement {
	fn from(n:CssContainerAtRule) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssContainerNotQuery {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_CONTAINER_NOT_QUERY as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_CONTAINER_NOT_QUERY }
...
impl From<CssContainerNotQuery> for SyntaxNode {
	fn from(n:CssContainerNotQuery) -> SyntaxNode { n.syntax }
}
impl From<CssContainerNotQuery> for SyntaxElement {
	fn from(n:CssContainerNotQuery) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssContainerOrQuery {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_CONTAINER_OR_QUERY as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_CONTAINER_OR_QUERY }
...
impl From<CssContainerOrQuery> for SyntaxNode {
	fn from(n:CssContainerOrQuery) -> SyntaxNode { n.syntax }
}
impl From<CssContainerOrQuery> for SyntaxElement {
	fn from(n:CssContainerOrQuery) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssContainerQueryInParens {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_CONTAINER_QUERY_IN_PARENS }
...
impl std::fmt::Debug for CssContainerQueryInParens {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssContainerQueryInParens")
			.field("l_paren_token", &support::DebugSyntaxResult(self.l_paren_token()))
			.field("query", &support::DebugSyntaxResult(self.query()))
			.field("r_paren_token", &support::DebugSyntaxResult(self.r_paren_token()))
			.finish()
	}
}
impl From<CssContainerQueryInParens> for SyntaxNode {
	fn from(n:CssContainerQueryInParens) -> SyntaxNode { n.syntax }
}
impl From<CssContainerQueryInParens> for SyntaxElement {
	fn from(n:CssContainerQueryInParens) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssContainerSizeFeatureInParens {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_CONTAINER_SIZE_FEATURE_IN_PARENS }
...
impl From<CssContainerSizeFeatureInParens> for SyntaxNode {
	fn from(n:CssContainerSizeFeatureInParens) -> SyntaxNode { n.syntax }
}
impl From<CssContainerSizeFeatureInParens> for SyntaxElement {
	fn from(n:CssContainerSizeFeatureInParens) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssContainerStyleAndQuery {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_CONTAINER_STYLE_AND_QUERY }
...
impl From<CssContainerStyleAndQuery> for SyntaxNode {
	fn from(n:CssContainerStyleAndQuery) -> SyntaxNode { n.syntax }
}
impl From<CssContainerStyleAndQuery> for SyntaxElement {
	fn from(n:CssContainerStyleAndQuery) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssContainerStyleInParens {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_CONTAINER_STYLE_IN_PARENS }
...
impl From<CssContainerStyleInParens> for SyntaxNode {
	fn from(n:CssContainerStyleInParens) -> SyntaxNode { n.syntax }
}
impl From<CssContainerStyleInParens> for SyntaxElement {
	fn from(n:CssContainerStyleInParens) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssContainerStyleNotQuery {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_CONTAINER_STYLE_NOT_QUERY }
...
impl From<CssContainerStyleNotQuery> for SyntaxNode {
	fn from(n:CssContainerStyleNotQuery) -> SyntaxNode { n.syntax }
}
impl From<CssContainerStyleNotQuery> for SyntaxElement {
	fn from(n:CssContainerStyleNotQuery) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssContainerStyleOrQuery {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_CONTAINER_STYLE_OR_QUERY }
...
impl From<CssContainerStyleOrQuery> for SyntaxNode {
	fn from(n:CssContainerStyleOrQuery) -> SyntaxNode { n.syntax }
}
impl From<CssContainerStyleOrQuery> for SyntaxElement {
	fn from(n:CssContainerStyleOrQuery) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssContainerStyleQueryInParens {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_CONTAINER_STYLE_QUERY_IN_PARENS }
...
impl std::fmt::Debug for CssContainerStyleQueryInParens {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssContainerStyleQueryInParens")
			.field("style_token", &support::DebugSyntaxResult(self.style_token()))
			.field("l_paren_token", &support::DebugSyntaxResult(self.l_paren_token()))
			.field("query", &support::DebugSyntaxResult(self.query()))
			.field("r_paren_token", &support::DebugSyntaxResult(self.r_paren_token()))
			.finish()
...
impl From<CssContainerStyleQueryInParens> for SyntaxNode {
	fn from(n:CssContainerStyleQueryInParens) -> SyntaxNode { n.syntax }
}
impl From<CssContainerStyleQueryInParens> for SyntaxElement {
	fn from(n:CssContainerStyleQueryInParens) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssCounterStyleAtRule {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_COUNTER_STYLE_AT_RULE as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_COUNTER_STYLE_AT_RULE }
...
impl From<CssCounterStyleAtRule> for SyntaxNode {
	fn from(n:CssCounterStyleAtRule) -> SyntaxNode { n.syntax }
}
impl From<CssCounterStyleAtRule> for SyntaxElement {
	fn from(n:CssCounterStyleAtRule) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssCustomIdentifier {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_CUSTOM_IDENTIFIER as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_CUSTOM_IDENTIFIER }
...
impl From<CssCustomIdentifier> for SyntaxNode {
	fn from(n:CssCustomIdentifier) -> SyntaxNode { n.syntax }
}
impl From<CssCustomIdentifier> for SyntaxElement {
	fn from(n:CssCustomIdentifier) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssDashedIdentifier {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_DASHED_IDENTIFIER as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_DASHED_IDENTIFIER }
...
impl From<CssDashedIdentifier> for SyntaxNode {
	fn from(n:CssDashedIdentifier) -> SyntaxNode { n.syntax }
}
impl From<CssDashedIdentifier> for SyntaxElement {
	fn from(n:CssDashedIdentifier) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssDeclaration {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_DECLARATION as u16));
...
impl std::fmt::Debug for CssDeclaration {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssDeclaration")
			...
			.field("important", &support::DebugOptionalElement(self.important()))
			.finish()
	}
}
...
impl AstNode for CssDeclarationBlock {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_DECLARATION_BLOCK as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_DECLARATION_BLOCK }
...
impl std::fmt::Debug for CssDeclarationBlock {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssDeclarationBlock")
			.field("l_curly_token", &support::DebugSyntaxResult(self.l_curly_token()))
			.field("declarations", &self.declarations())
			.field("r_curly_token", &support::DebugSyntaxResult(self.r_curly_token()))
			.finish()
	}
}
impl From<CssDeclarationBlock> for SyntaxNode {
	fn from(n:CssDeclarationBlock) -> SyntaxNode { n.syntax }
}
impl From<CssDeclarationBlock> for SyntaxElement {
	fn from(n:CssDeclarationBlock) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssDeclarationImportant {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_DECLARATION_IMPORTANT as u16));
...
impl std::fmt::Debug for CssDeclarationImportant {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssDeclarationImportant")
			...
			.field("important_token", &support::DebugSyntaxResult(self.important_token()))
			.finish()
	}
}
...
impl AstNode for CssDeclarationOrAtRuleBlock {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_DECLARATION_OR_AT_RULE_BLOCK }
...
impl From<CssDeclarationOrAtRuleBlock> for SyntaxNode {
	fn from(n:CssDeclarationOrAtRuleBlock) -> SyntaxNode { n.syntax }
}
impl From<CssDeclarationOrAtRuleBlock> for SyntaxElement {
	fn from(n:CssDeclarationOrAtRuleBlock) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssDeclarationOrRuleBlock {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_DECLARATION_OR_RULE_BLOCK }
...
impl From<CssDeclarationOrRuleBlock> for SyntaxNode {
	fn from(n:CssDeclarationOrRuleBlock) -> SyntaxNode { n.syntax }
}
impl From<CssDeclarationOrRuleBlock> for SyntaxElement {
	fn from(n:CssDeclarationOrRuleBlock) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssDeclarationWithSemicolon {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_DECLARATION_WITH_SEMICOLON }
...
impl std::fmt::Debug for CssDeclarationWithSemicolon {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssDeclarationWithSemicolon")
			.field("declaration", &support::DebugSyntaxResult(self.declaration()))
			.field("semicolon_token", &support::DebugOptionalElement(self.semicolon_token()))
			.finish()
	}
}
impl From<CssDeclarationWithSemicolon> for SyntaxNode {
	fn from(n:CssDeclarationWithSemicolon) -> SyntaxNode { n.syntax }
}
impl From<CssDeclarationWithSemicolon> for SyntaxElement {
	fn from(n:CssDeclarationWithSemicolon) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssDocumentAtRule {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_DOCUMENT_AT_RULE as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_DOCUMENT_AT_RULE }
...
impl std::fmt::Debug for CssDocumentAtRule {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssDocumentAtRule")
			.field("document_token", &support::DebugSyntaxResult(self.document_token()))
...
impl From<CssDocumentAtRule> for SyntaxNode {
	fn from(n:CssDocumentAtRule) -> SyntaxNode { n.syntax }
}
impl From<CssDocumentAtRule> for SyntaxElement {
	fn from(n:CssDocumentAtRule) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssDocumentCustomMatcher {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_DOCUMENT_CUSTOM_MATCHER as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_DOCUMENT_CUSTOM_MATCHER }
...
impl From<CssDocumentCustomMatcher> for SyntaxNode {
	fn from(n:CssDocumentCustomMatcher) -> SyntaxNode { n.syntax }
}
impl From<CssDocumentCustomMatcher> for SyntaxElement {
	fn from(n:CssDocumentCustomMatcher) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssEmptyDeclaration {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_EMPTY_DECLARATION as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_EMPTY_DECLARATION }
...
impl From<CssEmptyDeclaration> for SyntaxNode {
	fn from(n:CssEmptyDeclaration) -> SyntaxNode { n.syntax }
}
impl From<CssEmptyDeclaration> for SyntaxElement {
	fn from(n:CssEmptyDeclaration) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssFontFaceAtRule {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_FONT_FACE_AT_RULE as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_FONT_FACE_AT_RULE }
...
impl std::fmt::Debug for CssFontFaceAtRule {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssFontFaceAtRule")
			.field("font_face_token", &support::DebugSyntaxResult(self.font_face_token()))
			.field("block", &support::DebugSyntaxResult(self.block()))
			.finish()
	}
}
impl From<CssFontFaceAtRule> for SyntaxNode {
	fn from(n:CssFontFaceAtRule) -> SyntaxNode { n.syntax }
}
impl From<CssFontFaceAtRule> for SyntaxElement {
	fn from(n:CssFontFaceAtRule) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssFontFamilyName {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_FONT_FAMILY_NAME as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_FONT_FAMILY_NAME }
...
impl std::fmt::Debug for CssFontFamilyName {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssFontFamilyName").field("names", &self.names()).finish()
	}
}
impl From<CssFontFamilyName> for SyntaxNode {
	fn from(n:CssFontFamilyName) -> SyntaxNode { n.syntax }
}
impl From<CssFontFamilyName> for SyntaxElement {
	fn from(n:CssFontFamilyName) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssFontFeatureValuesAtRule {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_FONT_FEATURE_VALUES_AT_RULE }
...
impl From<CssFontFeatureValuesAtRule> for SyntaxNode {
	fn from(n:CssFontFeatureValuesAtRule) -> SyntaxNode { n.syntax }
}
impl From<CssFontFeatureValuesAtRule> for SyntaxElement {
	fn from(n:CssFontFeatureValuesAtRule) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssFontFeatureValuesBlock {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_FONT_FEATURE_VALUES_BLOCK }
...
impl From<CssFontFeatureValuesBlock> for SyntaxNode {
	fn from(n:CssFontFeatureValuesBlock) -> SyntaxNode { n.syntax }
}
impl From<CssFontFeatureValuesBlock> for SyntaxElement {
	fn from(n:CssFontFeatureValuesBlock) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssFontFeatureValuesItem {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_FONT_FEATURE_VALUES_ITEM }
...
impl From<CssFontFeatureValuesItem> for SyntaxNode {
	fn from(n:CssFontFeatureValuesItem) -> SyntaxNode { n.syntax }
}
impl From<CssFontFeatureValuesItem> for SyntaxElement {
	fn from(n:CssFontFeatureValuesItem) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssFontPaletteValuesAtRule {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_FONT_PALETTE_VALUES_AT_RULE }
...
impl From<CssFontPaletteValuesAtRule> for SyntaxNode {
	fn from(n:CssFontPaletteValuesAtRule) -> SyntaxNode { n.syntax }
}
impl From<CssFontPaletteValuesAtRule> for SyntaxElement {
	fn from(n:CssFontPaletteValuesAtRule) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssFunction {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_FUNCTION as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_FUNCTION }
...
impl From<CssFunction> for SyntaxNode {
	fn from(n:CssFunction) -> SyntaxNode { n.syntax }
}
impl From<CssFunction> for SyntaxElement {
	fn from(n:CssFunction) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssGenericDelimiter {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_GENERIC_DELIMITER as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_GENERIC_DELIMITER }
...
impl From<CssGenericDelimiter> for SyntaxNode {
	fn from(n:CssGenericDelimiter) -> SyntaxNode { n.syntax }
}
impl From<CssGenericDelimiter> for SyntaxElement {
	fn from(n:CssGenericDelimiter) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssGenericProperty {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_GENERIC_PROPERTY as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_GENERIC_PROPERTY }
...
impl From<CssGenericProperty> for SyntaxNode {
	fn from(n:CssGenericProperty) -> SyntaxNode { n.syntax }
}
impl From<CssGenericProperty> for SyntaxElement {
	fn from(n:CssGenericProperty) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssIdSelector {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_ID_SELECTOR as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_ID_SELECTOR }
...
impl From<CssIdSelector> for SyntaxNode {
	fn from(n:CssIdSelector) -> SyntaxNode { n.syntax }
}
impl From<CssIdSelector> for SyntaxElement {
	fn from(n:CssIdSelector) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssIdentifier {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_IDENTIFIER as u16));
...
impl AstNode for CssImportAnonymousLayer {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_IMPORT_ANONYMOUS_LAYER as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_IMPORT_ANONYMOUS_LAYER }
...
impl std::fmt::Debug for CssImportAnonymousLayer {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssImportAnonymousLayer")
			.field("layer_token", &support::DebugSyntaxResult(self.layer_token()))
			.finish()
	}
}
impl From<CssImportAnonymousLayer> for SyntaxNode {
	fn from(n:CssImportAnonymousLayer) -> SyntaxNode { n.syntax }
}
impl From<CssImportAnonymousLayer> for SyntaxElement {
	fn from(n:CssImportAnonymousLayer) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssImportAtRule {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_IMPORT_AT_RULE as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_IMPORT_AT_RULE }
...
impl std::fmt::Debug for CssImportAtRule {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssImportAtRule")
			.field("import_token", &support::DebugSyntaxResult(self.import_token()))
...
impl From<CssImportAtRule> for SyntaxNode {
	fn from(n:CssImportAtRule) -> SyntaxNode { n.syntax }
}
impl From<CssImportAtRule> for SyntaxElement {
	fn from(n:CssImportAtRule) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssImportNamedLayer {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_IMPORT_NAMED_LAYER as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_IMPORT_NAMED_LAYER }
...
impl From<CssImportNamedLayer> for SyntaxNode {
	fn from(n:CssImportNamedLayer) -> SyntaxNode { n.syntax }
}
impl From<CssImportNamedLayer> for SyntaxElement {
	fn from(n:CssImportNamedLayer) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssImportSupports {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_IMPORT_SUPPORTS as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_IMPORT_SUPPORTS }
...
impl std::fmt::Debug for CssImportSupports {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssImportSupports")
			.field("supports_token", &support::DebugSyntaxResult(self.supports_token()))
			.field("l_paren_token", &support::DebugSyntaxResult(self.l_paren_token()))
...
impl From<CssImportSupports> for SyntaxNode {
	fn from(n:CssImportSupports) -> SyntaxNode { n.syntax }
}
impl From<CssImportSupports> for SyntaxElement {
	fn from(n:CssImportSupports) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssKeyframesAtRule {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_KEYFRAMES_AT_RULE as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_KEYFRAMES_AT_RULE }
...
impl std::fmt::Debug for CssKeyframesAtRule {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssKeyframesAtRule")
			.field("keyframes_token", &support::DebugSyntaxResult(self.keyframes_token()))
			.field("name", &support::DebugSyntaxResult(self.name()))
			.field("block", &support::DebugSyntaxResult(self.block()))
			.finish()
	}
...
impl From<CssKeyframesAtRule> for SyntaxNode {
	fn from(n:CssKeyframesAtRule) -> SyntaxNode { n.syntax }
}
impl From<CssKeyframesAtRule> for SyntaxElement {
	fn from(n:CssKeyframesAtRule) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssKeyframesBlock {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_KEYFRAMES_BLOCK as u16));
...
impl AstNode for CssKeyframesIdentSelector {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_KEYFRAMES_IDENT_SELECTOR }
...
impl From<CssKeyframesIdentSelector> for SyntaxNode {
	fn from(n:CssKeyframesIdentSelector) -> SyntaxNode { n.syntax }
}
impl From<CssKeyframesIdentSelector> for SyntaxElement {
	fn from(n:CssKeyframesIdentSelector) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssKeyframesItem {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_KEYFRAMES_ITEM as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_KEYFRAMES_ITEM }
...
impl From<CssKeyframesItem> for SyntaxNode {
	fn from(n:CssKeyframesItem) -> SyntaxNode { n.syntax }
}
impl From<CssKeyframesItem> for SyntaxElement {
	fn from(n:CssKeyframesItem) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssKeyframesPercentageSelector {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_KEYFRAMES_PERCENTAGE_SELECTOR }
...
impl From<CssKeyframesPercentageSelector> for SyntaxNode {
	fn from(n:CssKeyframesPercentageSelector) -> SyntaxNode { n.syntax }
}
impl From<CssKeyframesPercentageSelector> for SyntaxElement {
	fn from(n:CssKeyframesPercentageSelector) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssKeyframesScopeFunction {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_KEYFRAMES_SCOPE_FUNCTION }
...
impl From<CssKeyframesScopeFunction> for SyntaxNode {
	fn from(n:CssKeyframesScopeFunction) -> SyntaxNode { n.syntax }
}
impl From<CssKeyframesScopeFunction> for SyntaxElement {
	fn from(n:CssKeyframesScopeFunction) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssKeyframesScopePrefix {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_KEYFRAMES_SCOPE_PREFIX as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_KEYFRAMES_SCOPE_PREFIX }
...
impl From<CssKeyframesScopePrefix> for SyntaxNode {
	fn from(n:CssKeyframesScopePrefix) -> SyntaxNode { n.syntax }
}
impl From<CssKeyframesScopePrefix> for SyntaxElement {
	fn from(n:CssKeyframesScopePrefix) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssKeyframesScopedName {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_KEYFRAMES_SCOPED_NAME as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_KEYFRAMES_SCOPED_NAME }
...
impl From<CssKeyframesScopedName> for SyntaxNode {
	fn from(n:CssKeyframesScopedName) -> SyntaxNode { n.syntax }
}
impl From<CssKeyframesScopedName> for SyntaxElement {
	fn from(n:CssKeyframesScopedName) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssLayerAtRule {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_LAYER_AT_RULE as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_LAYER_AT_RULE }
...
impl From<CssLayerAtRule> for SyntaxNode {
	fn from(n:CssLayerAtRule) -> SyntaxNode { n.syntax }
}
impl From<CssLayerAtRule> for SyntaxElement {
	fn from(n:CssLayerAtRule) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssLayerDeclaration {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_LAYER_DECLARATION as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_LAYER_DECLARATION }
...
impl From<CssLayerDeclaration> for SyntaxNode {
	fn from(n:CssLayerDeclaration) -> SyntaxNode { n.syntax }
}
impl From<CssLayerDeclaration> for SyntaxElement {
	fn from(n:CssLayerDeclaration) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssLayerReference {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_LAYER_REFERENCE as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_LAYER_REFERENCE }
...
impl From<CssLayerReference> for SyntaxNode {
	fn from(n:CssLayerReference) -> SyntaxNode { n.syntax }
}
impl From<CssLayerReference> for SyntaxElement {
	fn from(n:CssLayerReference) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssListOfComponentValuesExpression {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> =
		SyntaxKindSet::from_raw(RawSyntaxKind(CSS_LIST_OF_COMPONENT_VALUES_EXPRESSION as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_LIST_OF_COMPONENT_VALUES_EXPRESSION }
...
impl From<CssListOfComponentValuesExpression> for SyntaxNode {
	fn from(n:CssListOfComponentValuesExpression) -> SyntaxNode { n.syntax }
}
impl From<CssListOfComponentValuesExpression> for SyntaxElement {
	fn from(n:CssListOfComponentValuesExpression) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssMarginAtRule {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_MARGIN_AT_RULE as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_MARGIN_AT_RULE }
...
impl From<CssMarginAtRule> for SyntaxNode {
	fn from(n:CssMarginAtRule) -> SyntaxNode { n.syntax }
}
impl From<CssMarginAtRule> for SyntaxElement {
	fn from(n:CssMarginAtRule) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssMediaAndCondition {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_MEDIA_AND_CONDITION as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_MEDIA_AND_CONDITION }
...
impl From<CssMediaAndCondition> for SyntaxNode {
	fn from(n:CssMediaAndCondition) -> SyntaxNode { n.syntax }
}
impl From<CssMediaAndCondition> for SyntaxElement {
	fn from(n:CssMediaAndCondition) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssMediaAndTypeQuery {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_MEDIA_AND_TYPE_QUERY as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_MEDIA_AND_TYPE_QUERY }
...
impl From<CssMediaAndTypeQuery> for SyntaxNode {
	fn from(n:CssMediaAndTypeQuery) -> SyntaxNode { n.syntax }
}
impl From<CssMediaAndTypeQuery> for SyntaxElement {
	fn from(n:CssMediaAndTypeQuery) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssMediaAtRule {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_MEDIA_AT_RULE as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_MEDIA_AT_RULE }
...
impl std::fmt::Debug for CssMediaAtRule {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssMediaAtRule")
			.field("media_token", &support::DebugSyntaxResult(self.media_token()))
...
impl From<CssMediaAtRule> for SyntaxNode {
	fn from(n:CssMediaAtRule) -> SyntaxNode { n.syntax }
}
impl From<CssMediaAtRule> for SyntaxElement {
	fn from(n:CssMediaAtRule) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssMediaConditionInParens {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_MEDIA_CONDITION_IN_PARENS }
...
impl From<CssMediaConditionInParens> for SyntaxNode {
	fn from(n:CssMediaConditionInParens) -> SyntaxNode { n.syntax }
}
impl From<CssMediaConditionInParens> for SyntaxElement {
	fn from(n:CssMediaConditionInParens) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssMediaConditionQuery {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_MEDIA_CONDITION_QUERY as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_MEDIA_CONDITION_QUERY }
...
impl From<CssMediaConditionQuery> for SyntaxNode {
	fn from(n:CssMediaConditionQuery) -> SyntaxNode { n.syntax }
}
impl From<CssMediaConditionQuery> for SyntaxElement {
	fn from(n:CssMediaConditionQuery) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssMediaFeatureInParens {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_MEDIA_FEATURE_IN_PARENS as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_MEDIA_FEATURE_IN_PARENS }
...
impl From<CssMediaFeatureInParens> for SyntaxNode {
	fn from(n:CssMediaFeatureInParens) -> SyntaxNode { n.syntax }
}
impl From<CssMediaFeatureInParens> for SyntaxElement {
	fn from(n:CssMediaFeatureInParens) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssMediaNotCondition {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_MEDIA_NOT_CONDITION as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_MEDIA_NOT_CONDITION }
...
impl From<CssMediaNotCondition> for SyntaxNode {
	fn from(n:CssMediaNotCondition) -> SyntaxNode { n.syntax }
}
impl From<CssMediaNotCondition> for SyntaxElement {
	fn from(n:CssMediaNotCondition) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssMediaOrCondition {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_MEDIA_OR_CONDITION as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_MEDIA_OR_CONDITION }
...
impl From<CssMediaOrCondition> for SyntaxNode {
	fn from(n:CssMediaOrCondition) -> SyntaxNode { n.syntax }
}
impl From<CssMediaOrCondition> for SyntaxElement {
	fn from(n:CssMediaOrCondition) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssMediaType {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_MEDIA_TYPE as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_MEDIA_TYPE }
...
impl From<CssMediaType> for SyntaxNode {
	fn from(n:CssMediaType) -> SyntaxNode { n.syntax }
}
impl From<CssMediaType> for SyntaxElement {
	fn from(n:CssMediaType) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssMediaTypeQuery {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_MEDIA_TYPE_QUERY as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_MEDIA_TYPE_QUERY }
...
impl From<CssMediaTypeQuery> for SyntaxNode {
	fn from(n:CssMediaTypeQuery) -> SyntaxNode { n.syntax }
}
impl From<CssMediaTypeQuery> for SyntaxElement {
	fn from(n:CssMediaTypeQuery) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssMetavariable {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_METAVARIABLE as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_METAVARIABLE }
...
impl From<CssMetavariable> for SyntaxNode {
	fn from(n:CssMetavariable) -> SyntaxNode { n.syntax }
}
impl From<CssMetavariable> for SyntaxElement {
	fn from(n:CssMetavariable) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssNamedNamespacePrefix {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_NAMED_NAMESPACE_PREFIX as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_NAMED_NAMESPACE_PREFIX }
...
impl From<CssNamedNamespacePrefix> for SyntaxNode {
	fn from(n:CssNamedNamespacePrefix) -> SyntaxNode { n.syntax }
}
impl From<CssNamedNamespacePrefix> for SyntaxElement {
	fn from(n:CssNamedNamespacePrefix) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssNamespace {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_NAMESPACE as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_NAMESPACE }
...
impl std::fmt::Debug for CssNamespace {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssNamespace")
			...
			.field("bitwise_or_token", &support::DebugSyntaxResult(self.bitwise_or_token()))
			.finish()
	}
}
impl From<CssNamespace> for SyntaxNode {
	fn from(n:CssNamespace) -> SyntaxNode { n.syntax }
}
impl From<CssNamespace> for SyntaxElement {
	fn from(n:CssNamespace) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssNamespaceAtRule {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_NAMESPACE_AT_RULE as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_NAMESPACE_AT_RULE }
...
impl std::fmt::Debug for CssNamespaceAtRule {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssNamespaceAtRule")
			.field("namespace_token", &support::DebugSyntaxResult(self.namespace_token()))
			.field("prefix", &support::DebugOptionalElement(self.prefix()))
			.field("url", &support::DebugSyntaxResult(self.url()))
			.field("semicolon_token", &support::DebugSyntaxResult(self.semicolon_token()))
			.finish()
...
impl From<CssNamespaceAtRule> for SyntaxNode {
	fn from(n:CssNamespaceAtRule) -> SyntaxNode { n.syntax }
}
impl From<CssNamespaceAtRule> for SyntaxElement {
	fn from(n:CssNamespaceAtRule) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssNestedQualifiedRule {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_NESTED_QUALIFIED_RULE as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_NESTED_QUALIFIED_RULE }
...
impl From<CssNestedQualifiedRule> for SyntaxNode {
	fn from(n:CssNestedQualifiedRule) -> SyntaxNode { n.syntax }
}
impl From<CssNestedQualifiedRule> for SyntaxElement {
	fn from(n:CssNestedQualifiedRule) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssNestedSelector {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_NESTED_SELECTOR as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_NESTED_SELECTOR }
...
impl From<CssNestedSelector> for SyntaxNode {
	fn from(n:CssNestedSelector) -> SyntaxNode { n.syntax }
}
impl From<CssNestedSelector> for SyntaxElement {
	fn from(n:CssNestedSelector) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssNthOffset {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_NTH_OFFSET as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_NTH_OFFSET }
...
impl From<CssNthOffset> for SyntaxNode {
	fn from(n:CssNthOffset) -> SyntaxNode { n.syntax }
}
impl From<CssNthOffset> for SyntaxElement {
	fn from(n:CssNthOffset) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssNumber {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_NUMBER as u16));
...
impl AstNode for CssPageAtRule {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_PAGE_AT_RULE as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_PAGE_AT_RULE }
...
impl From<CssPageAtRule> for SyntaxNode {
	fn from(n:CssPageAtRule) -> SyntaxNode { n.syntax }
}
impl From<CssPageAtRule> for SyntaxElement {
	fn from(n:CssPageAtRule) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssPageAtRuleBlock {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_PAGE_AT_RULE_BLOCK as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_PAGE_AT_RULE_BLOCK }
...
impl From<CssPageAtRuleBlock> for SyntaxNode {
	fn from(n:CssPageAtRuleBlock) -> SyntaxNode { n.syntax }
}
impl From<CssPageAtRuleBlock> for SyntaxElement {
	fn from(n:CssPageAtRuleBlock) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssPageSelector {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_PAGE_SELECTOR as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_PAGE_SELECTOR }
...
impl From<CssPageSelector> for SyntaxNode {
	fn from(n:CssPageSelector) -> SyntaxNode { n.syntax }
}
impl From<CssPageSelector> for SyntaxElement {
	fn from(n:CssPageSelector) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssPageSelectorPseudo {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_PAGE_SELECTOR_PSEUDO as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_PAGE_SELECTOR_PSEUDO }
...
impl From<CssPageSelectorPseudo> for SyntaxNode {
	fn from(n:CssPageSelectorPseudo) -> SyntaxNode { n.syntax }
}
impl From<CssPageSelectorPseudo> for SyntaxElement {
	fn from(n:CssPageSelectorPseudo) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssParameter {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_PARAMETER as u16));
...
impl std::fmt::Debug for CssParameter {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssParameter")
			.field("any_css_expression", &support::DebugSyntaxResult(self.any_css_expression()))
			.finish()
	}
}
...
impl AstNode for CssParenthesizedExpression {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_PARENTHESIZED_EXPRESSION }
...
impl std::fmt::Debug for CssParenthesizedExpression {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssParenthesizedExpression")
			.field("l_paren_token", &support::DebugSyntaxResult(self.l_paren_token()))
			.field("expression", &support::DebugOptionalElement(self.expression()))
			.field("r_paren_token", &support::DebugSyntaxResult(self.r_paren_token()))
			.finish()
	}
}
impl From<CssParenthesizedExpression> for SyntaxNode {
	fn from(n:CssParenthesizedExpression) -> SyntaxNode { n.syntax }
}
impl From<CssParenthesizedExpression> for SyntaxElement {
	fn from(n:CssParenthesizedExpression) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssPercentage {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_PERCENTAGE as u16));
...
impl std::fmt::Debug for CssPercentage {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssPercentage")
			.field("value_token", &support::DebugSyntaxResult(self.value_token()))
			.field("percent_token", &support::DebugSyntaxResult(self.percent_token()))
			.finish()
	}
}
...
impl AstNode for CssPropertyAtRule {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_PROPERTY_AT_RULE as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_PROPERTY_AT_RULE }
...
impl std::fmt::Debug for CssPropertyAtRule {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssPropertyAtRule")
			.field("property_token", &support::DebugSyntaxResult(self.property_token()))
			.field("name", &support::DebugSyntaxResult(self.name()))
			.field("block", &support::DebugSyntaxResult(self.block()))
			.finish()
	}
...
impl From<CssPropertyAtRule> for SyntaxNode {
	fn from(n:CssPropertyAtRule) -> SyntaxNode { n.syntax }
}
impl From<CssPropertyAtRule> for SyntaxElement {
	fn from(n:CssPropertyAtRule) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssPseudoClassFunctionCompoundSelector {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> =
		SyntaxKindSet::from_raw(RawSyntaxKind(CSS_PSEUDO_CLASS_FUNCTION_COMPOUND_SELECTOR as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_PSEUDO_CLASS_FUNCTION_COMPOUND_SELECTOR }
...
impl From<CssPseudoClassFunctionCompoundSelector> for SyntaxNode {
	fn from(n:CssPseudoClassFunctionCompoundSelector) -> SyntaxNode { n.syntax }
}
impl From<CssPseudoClassFunctionCompoundSelector> for SyntaxElement {
	fn from(n:CssPseudoClassFunctionCompoundSelector) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssPseudoClassFunctionCompoundSelectorList {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> =
		SyntaxKindSet::from_raw(RawSyntaxKind(CSS_PSEUDO_CLASS_FUNCTION_COMPOUND_SELECTOR_LIST as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_PSEUDO_CLASS_FUNCTION_COMPOUND_SELECTOR_LIST }
...
impl From<CssPseudoClassFunctionCompoundSelectorList> for SyntaxNode {
	fn from(n:CssPseudoClassFunctionCompoundSelectorList) -> SyntaxNode { n.syntax }
}
impl From<CssPseudoClassFunctionCompoundSelectorList> for SyntaxElement {
	fn from(n:CssPseudoClassFunctionCompoundSelectorList) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssPseudoClassFunctionIdentifier {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_PSEUDO_CLASS_FUNCTION_IDENTIFIER }
...
impl From<CssPseudoClassFunctionIdentifier> for SyntaxNode {
	fn from(n:CssPseudoClassFunctionIdentifier) -> SyntaxNode { n.syntax }
}
impl From<CssPseudoClassFunctionIdentifier> for SyntaxElement {
	fn from(n:CssPseudoClassFunctionIdentifier) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssPseudoClassFunctionNth {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_PSEUDO_CLASS_FUNCTION_NTH }
...
impl From<CssPseudoClassFunctionNth> for SyntaxNode {
	fn from(n:CssPseudoClassFunctionNth) -> SyntaxNode { n.syntax }
}
impl From<CssPseudoClassFunctionNth> for SyntaxElement {
	fn from(n:CssPseudoClassFunctionNth) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssPseudoClassFunctionRelativeSelectorList {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> =
		SyntaxKindSet::from_raw(RawSyntaxKind(CSS_PSEUDO_CLASS_FUNCTION_RELATIVE_SELECTOR_LIST as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_PSEUDO_CLASS_FUNCTION_RELATIVE_SELECTOR_LIST }
...
impl From<CssPseudoClassFunctionRelativeSelectorList> for SyntaxNode {
	fn from(n:CssPseudoClassFunctionRelativeSelectorList) -> SyntaxNode { n.syntax }
}
impl From<CssPseudoClassFunctionRelativeSelectorList> for SyntaxElement {
	fn from(n:CssPseudoClassFunctionRelativeSelectorList) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssPseudoClassFunctionSelector {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_PSEUDO_CLASS_FUNCTION_SELECTOR }
...
impl From<CssPseudoClassFunctionSelector> for SyntaxNode {
	fn from(n:CssPseudoClassFunctionSelector) -> SyntaxNode { n.syntax }
}
impl From<CssPseudoClassFunctionSelector> for SyntaxElement {
	fn from(n:CssPseudoClassFunctionSelector) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssPseudoClassFunctionSelectorList {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> =
		SyntaxKindSet::from_raw(RawSyntaxKind(CSS_PSEUDO_CLASS_FUNCTION_SELECTOR_LIST as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_PSEUDO_CLASS_FUNCTION_SELECTOR_LIST }
...
impl From<CssPseudoClassFunctionSelectorList> for SyntaxNode {
	fn from(n:CssPseudoClassFunctionSelectorList) -> SyntaxNode { n.syntax }
}
impl From<CssPseudoClassFunctionSelectorList> for SyntaxElement {
	fn from(n:CssPseudoClassFunctionSelectorList) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssPseudoClassFunctionValueList {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_PSEUDO_CLASS_FUNCTION_VALUE_LIST }
...
impl From<CssPseudoClassFunctionValueList> for SyntaxNode {
	fn from(n:CssPseudoClassFunctionValueList) -> SyntaxNode { n.syntax }
}
impl From<CssPseudoClassFunctionValueList> for SyntaxElement {
	fn from(n:CssPseudoClassFunctionValueList) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssPseudoClassIdentifier {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_PSEUDO_CLASS_IDENTIFIER as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_PSEUDO_CLASS_IDENTIFIER }
...
impl From<CssPseudoClassIdentifier> for SyntaxNode {
	fn from(n:CssPseudoClassIdentifier) -> SyntaxNode { n.syntax }
}
impl From<CssPseudoClassIdentifier> for SyntaxElement {
	fn from(n:CssPseudoClassIdentifier) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssPseudoClassNth {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_PSEUDO_CLASS_NTH as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_PSEUDO_CLASS_NTH }
...
impl std::fmt::Debug for CssPseudoClassNth {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssPseudoClassNth")
			...
			.field("value", &support::DebugOptionalElement(self.value()))
			.field("symbol_token", &support::DebugSyntaxResult(self.symbol_token()))
			.field("offset", &support::DebugOptionalElement(self.offset()))
			.finish()
	}
}
impl From<CssPseudoClassNth> for SyntaxNode {
	fn from(n:CssPseudoClassNth) -> SyntaxNode { n.syntax }
}
impl From<CssPseudoClassNth> for SyntaxElement {
	fn from(n:CssPseudoClassNth) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssPseudoClassNthIdentifier {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_PSEUDO_CLASS_NTH_IDENTIFIER }
...
impl From<CssPseudoClassNthIdentifier> for SyntaxNode {
	fn from(n:CssPseudoClassNthIdentifier) -> SyntaxNode { n.syntax }
}
impl From<CssPseudoClassNthIdentifier> for SyntaxElement {
	fn from(n:CssPseudoClassNthIdentifier) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssPseudoClassNthNumber {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_PSEUDO_CLASS_NTH_NUMBER as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_PSEUDO_CLASS_NTH_NUMBER }
...
impl From<CssPseudoClassNthNumber> for SyntaxNode {
	fn from(n:CssPseudoClassNthNumber) -> SyntaxNode { n.syntax }
}
impl From<CssPseudoClassNthNumber> for SyntaxElement {
	fn from(n:CssPseudoClassNthNumber) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssPseudoClassNthSelector {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_PSEUDO_CLASS_NTH_SELECTOR }
...
impl std::fmt::Debug for CssPseudoClassNthSelector {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssPseudoClassNthSelector")
			...
			.field("of_selector", &support::DebugOptionalElement(self.of_selector()))
			.finish()
	}
}
impl From<CssPseudoClassNthSelector> for SyntaxNode {
	fn from(n:CssPseudoClassNthSelector) -> SyntaxNode { n.syntax }
}
impl From<CssPseudoClassNthSelector> for SyntaxElement {
	fn from(n:CssPseudoClassNthSelector) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssPseudoClassOfNthSelector {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_PSEUDO_CLASS_OF_NTH_SELECTOR }
...
impl From<CssPseudoClassOfNthSelector> for SyntaxNode {
	fn from(n:CssPseudoClassOfNthSelector) -> SyntaxNode { n.syntax }
}
impl From<CssPseudoClassOfNthSelector> for SyntaxElement {
	fn from(n:CssPseudoClassOfNthSelector) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssPseudoClassSelector {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_PSEUDO_CLASS_SELECTOR as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_PSEUDO_CLASS_SELECTOR }
...
impl From<CssPseudoClassSelector> for SyntaxNode {
	fn from(n:CssPseudoClassSelector) -> SyntaxNode { n.syntax }
}
impl From<CssPseudoClassSelector> for SyntaxElement {
	fn from(n:CssPseudoClassSelector) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssPseudoElementFunctionIdentifier {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_PSEUDO_ELEMENT_FUNCTION_IDENTIFIER }
...
impl From<CssPseudoElementFunctionIdentifier> for SyntaxNode {
	fn from(n:CssPseudoElementFunctionIdentifier) -> SyntaxNode { n.syntax }
}
impl From<CssPseudoElementFunctionIdentifier> for SyntaxElement {
	fn from(n:CssPseudoElementFunctionIdentifier) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssPseudoElementFunctionSelector {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_PSEUDO_ELEMENT_FUNCTION_SELECTOR }
...
impl From<CssPseudoElementFunctionSelector> for SyntaxNode {
	fn from(n:CssPseudoElementFunctionSelector) -> SyntaxNode { n.syntax }
}
impl From<CssPseudoElementFunctionSelector> for SyntaxElement {
	fn from(n:CssPseudoElementFunctionSelector) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssPseudoElementIdentifier {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_PSEUDO_ELEMENT_IDENTIFIER }
...
impl From<CssPseudoElementIdentifier> for SyntaxNode {
	fn from(n:CssPseudoElementIdentifier) -> SyntaxNode { n.syntax }
}
impl From<CssPseudoElementIdentifier> for SyntaxElement {
	fn from(n:CssPseudoElementIdentifier) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssPseudoElementSelector {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_PSEUDO_ELEMENT_SELECTOR as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_PSEUDO_ELEMENT_SELECTOR }
...
impl std::fmt::Debug for CssPseudoElementSelector {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssPseudoElementSelector")
			.field("double_colon_token", &support::DebugSyntaxResult(self.double_colon_token()))
			.field("element", &support::DebugSyntaxResult(self.element()))
			.finish()
	}
}
impl From<CssPseudoElementSelector> for SyntaxNode {
	fn from(n:CssPseudoElementSelector) -> SyntaxNode { n.syntax }
}
impl From<CssPseudoElementSelector> for SyntaxElement {
	fn from(n:CssPseudoElementSelector) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssQualifiedRule {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_QUALIFIED_RULE as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_QUALIFIED_RULE }
...
impl From<CssQualifiedRule> for SyntaxNode {
	fn from(n:CssQualifiedRule) -> SyntaxNode { n.syntax }
}
impl From<CssQualifiedRule> for SyntaxElement {
	fn from(n:CssQualifiedRule) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssQueryFeatureBoolean {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_QUERY_FEATURE_BOOLEAN as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_QUERY_FEATURE_BOOLEAN }
...
impl From<CssQueryFeatureBoolean> for SyntaxNode {
	fn from(n:CssQueryFeatureBoolean) -> SyntaxNode { n.syntax }
}
impl From<CssQueryFeatureBoolean> for SyntaxElement {
	fn from(n:CssQueryFeatureBoolean) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssQueryFeaturePlain {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_QUERY_FEATURE_PLAIN as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_QUERY_FEATURE_PLAIN }
...
impl From<CssQueryFeaturePlain> for SyntaxNode {
	fn from(n:CssQueryFeaturePlain) -> SyntaxNode { n.syntax }
}
impl From<CssQueryFeaturePlain> for SyntaxElement {
	fn from(n:CssQueryFeaturePlain) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssQueryFeatureRange {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_QUERY_FEATURE_RANGE as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_QUERY_FEATURE_RANGE }
...
impl From<CssQueryFeatureRange> for SyntaxNode {
	fn from(n:CssQueryFeatureRange) -> SyntaxNode { n.syntax }
}
impl From<CssQueryFeatureRange> for SyntaxElement {
	fn from(n:CssQueryFeatureRange) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssQueryFeatureRangeComparison {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_QUERY_FEATURE_RANGE_COMPARISON }
...
impl From<CssQueryFeatureRangeComparison> for SyntaxNode {
	fn from(n:CssQueryFeatureRangeComparison) -> SyntaxNode { n.syntax }
}
impl From<CssQueryFeatureRangeComparison> for SyntaxElement {
	fn from(n:CssQueryFeatureRangeComparison) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssQueryFeatureRangeInterval {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_QUERY_FEATURE_RANGE_INTERVAL }
...
impl std::fmt::Debug for CssQueryFeatureRangeInterval {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssQueryFeatureRangeInterval")
			.field("left", &support::DebugSyntaxResult(self.left()))
			.field("left_comparison", &support::DebugSyntaxResult(self.left_comparison()))
			.field("name", &support::DebugSyntaxResult(self.name()))
			.field("right_comparison", &support::DebugSyntaxResult(self.right_comparison()))
			.field("right", &support::DebugSyntaxResult(self.right()))
			.finish()
	}
}
impl From<CssQueryFeatureRangeInterval> for SyntaxNode {
	fn from(n:CssQueryFeatureRangeInterval) -> SyntaxNode { n.syntax }
}
impl From<CssQueryFeatureRangeInterval> for SyntaxElement {
	fn from(n:CssQueryFeatureRangeInterval) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssQueryFeatureReverseRange {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_QUERY_FEATURE_REVERSE_RANGE }
...
impl From<CssQueryFeatureReverseRange> for SyntaxNode {
	fn from(n:CssQueryFeatureReverseRange) -> SyntaxNode { n.syntax }
}
impl From<CssQueryFeatureReverseRange> for SyntaxElement {
	fn from(n:CssQueryFeatureReverseRange) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssRatio {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_RATIO as u16));
...
impl std::fmt::Debug for CssRatio {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssRatio")
			...
			.field("slash_token", &support::DebugSyntaxResult(self.slash_token()))
			.field("denominator", &support::DebugSyntaxResult(self.denominator()))
			.finish()
	}
}
...
impl AstNode for CssRegularDimension {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_REGULAR_DIMENSION as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_REGULAR_DIMENSION }
...
impl From<CssRegularDimension> for SyntaxNode {
	fn from(n:CssRegularDimension) -> SyntaxNode { n.syntax }
}
impl From<CssRegularDimension> for SyntaxElement {
	fn from(n:CssRegularDimension) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssRelativeSelector {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_RELATIVE_SELECTOR as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_RELATIVE_SELECTOR }
...
impl std::fmt::Debug for CssRelativeSelector {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssRelativeSelector")
			.field("combinator", &support::DebugOptionalElement(self.combinator()))
			.field("selector", &support::DebugSyntaxResult(self.selector()))
			.finish()
	}
}
impl From<CssRelativeSelector> for SyntaxNode {
	fn from(n:CssRelativeSelector) -> SyntaxNode { n.syntax }
}
impl From<CssRelativeSelector> for SyntaxElement {
	fn from(n:CssRelativeSelector) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssRoot {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_ROOT as u16));
...
impl std::fmt::Debug for CssRoot {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssRoot")
			.field("bom_token", &support::DebugOptionalElement(self.bom_token()))
...
impl AstNode for CssRuleBlock {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_RULE_BLOCK as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_RULE_BLOCK }
...
impl From<CssRuleBlock> for SyntaxNode {
	fn from(n:CssRuleBlock) -> SyntaxNode { n.syntax }
}
impl From<CssRuleBlock> for SyntaxElement {
	fn from(n:CssRuleBlock) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssScopeAtRule {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_SCOPE_AT_RULE as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_SCOPE_AT_RULE }
...
impl std::fmt::Debug for CssScopeAtRule {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssScopeAtRule")
			.field("scope_token", &support::DebugSyntaxResult(self.scope_token()))
...
impl From<CssScopeAtRule> for SyntaxNode {
	fn from(n:CssScopeAtRule) -> SyntaxNode { n.syntax }
}
impl From<CssScopeAtRule> for SyntaxElement {
	fn from(n:CssScopeAtRule) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssScopeEdge {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_SCOPE_EDGE as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_SCOPE_EDGE }
...
impl From<CssScopeEdge> for SyntaxNode {
	fn from(n:CssScopeEdge) -> SyntaxNode { n.syntax }
}
impl From<CssScopeEdge> for SyntaxElement {
	fn from(n:CssScopeEdge) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssScopeRangeEnd {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_SCOPE_RANGE_END as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_SCOPE_RANGE_END }
...
impl From<CssScopeRangeEnd> for SyntaxNode {
	fn from(n:CssScopeRangeEnd) -> SyntaxNode { n.syntax }
}
impl From<CssScopeRangeEnd> for SyntaxElement {
	fn from(n:CssScopeRangeEnd) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssScopeRangeInterval {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_SCOPE_RANGE_INTERVAL as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_SCOPE_RANGE_INTERVAL }
...
impl From<CssScopeRangeInterval> for SyntaxNode {
	fn from(n:CssScopeRangeInterval) -> SyntaxNode { n.syntax }
}
impl From<CssScopeRangeInterval> for SyntaxElement {
	fn from(n:CssScopeRangeInterval) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssScopeRangeStart {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_SCOPE_RANGE_START as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_SCOPE_RANGE_START }
...
impl From<CssScopeRangeStart> for SyntaxNode {
	fn from(n:CssScopeRangeStart) -> SyntaxNode { n.syntax }
}
impl From<CssScopeRangeStart> for SyntaxElement {
	fn from(n:CssScopeRangeStart) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssStartingStyleAtRule {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_STARTING_STYLE_AT_RULE as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_STARTING_STYLE_AT_RULE }
...
impl std::fmt::Debug for CssStartingStyleAtRule {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssStartingStyleAtRule")
			.field("starting_style_token", &support::DebugSyntaxResult(self.starting_style_token()))
			.field("block", &support::DebugSyntaxResult(self.block()))
			.finish()
	}
}
impl From<CssStartingStyleAtRule> for SyntaxNode {
	fn from(n:CssStartingStyleAtRule) -> SyntaxNode { n.syntax }
}
impl From<CssStartingStyleAtRule> for SyntaxElement {
	fn from(n:CssStartingStyleAtRule) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssString {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_STRING as u16));
...
impl AstNode for CssSupportsAndCondition {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_SUPPORTS_AND_CONDITION as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_SUPPORTS_AND_CONDITION }
...
impl From<CssSupportsAndCondition> for SyntaxNode {
	fn from(n:CssSupportsAndCondition) -> SyntaxNode { n.syntax }
}
impl From<CssSupportsAndCondition> for SyntaxElement {
	fn from(n:CssSupportsAndCondition) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssSupportsAtRule {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_SUPPORTS_AT_RULE as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_SUPPORTS_AT_RULE }
...
impl From<CssSupportsAtRule> for SyntaxNode {
	fn from(n:CssSupportsAtRule) -> SyntaxNode { n.syntax }
}
impl From<CssSupportsAtRule> for SyntaxElement {
	fn from(n:CssSupportsAtRule) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssSupportsConditionInParens {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_SUPPORTS_CONDITION_IN_PARENS }
...
impl From<CssSupportsConditionInParens> for SyntaxNode {
	fn from(n:CssSupportsConditionInParens) -> SyntaxNode { n.syntax }
}
impl From<CssSupportsConditionInParens> for SyntaxElement {
	fn from(n:CssSupportsConditionInParens) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssSupportsFeatureDeclaration {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_SUPPORTS_FEATURE_DECLARATION }
...
impl From<CssSupportsFeatureDeclaration> for SyntaxNode {
	fn from(n:CssSupportsFeatureDeclaration) -> SyntaxNode { n.syntax }
}
impl From<CssSupportsFeatureDeclaration> for SyntaxElement {
	fn from(n:CssSupportsFeatureDeclaration) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssSupportsFeatureSelector {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_SUPPORTS_FEATURE_SELECTOR }
...
impl std::fmt::Debug for CssSupportsFeatureSelector {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssSupportsFeatureSelector")
			.field("selector_token", &support::DebugSyntaxResult(self.selector_token()))
			.field("l_paren_token", &support::DebugSyntaxResult(self.l_paren_token()))
			.field("selector", &support::DebugSyntaxResult(self.selector()))
			.field("r_paren_token", &support::DebugSyntaxResult(self.r_paren_token()))
			.finish()
...
impl From<CssSupportsFeatureSelector> for SyntaxNode {
	fn from(n:CssSupportsFeatureSelector) -> SyntaxNode { n.syntax }
}
impl From<CssSupportsFeatureSelector> for SyntaxElement {
	fn from(n:CssSupportsFeatureSelector) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssSupportsNotCondition {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_SUPPORTS_NOT_CONDITION as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_SUPPORTS_NOT_CONDITION }
...
impl From<CssSupportsNotCondition> for SyntaxNode {
	fn from(n:CssSupportsNotCondition) -> SyntaxNode { n.syntax }
}
impl From<CssSupportsNotCondition> for SyntaxElement {
	fn from(n:CssSupportsNotCondition) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssSupportsOrCondition {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_SUPPORTS_OR_CONDITION as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_SUPPORTS_OR_CONDITION }
...
impl From<CssSupportsOrCondition> for SyntaxNode {
	fn from(n:CssSupportsOrCondition) -> SyntaxNode { n.syntax }
}
impl From<CssSupportsOrCondition> for SyntaxElement {
	fn from(n:CssSupportsOrCondition) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssTypeSelector {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_TYPE_SELECTOR as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_TYPE_SELECTOR }
...
impl From<CssTypeSelector> for SyntaxNode {
	fn from(n:CssTypeSelector) -> SyntaxNode { n.syntax }
}
impl From<CssTypeSelector> for SyntaxElement {
	fn from(n:CssTypeSelector) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssUnicodeCodepoint {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_UNICODE_CODEPOINT as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_UNICODE_CODEPOINT }
...
impl From<CssUnicodeCodepoint> for SyntaxNode {
	fn from(n:CssUnicodeCodepoint) -> SyntaxNode { n.syntax }
}
impl From<CssUnicodeCodepoint> for SyntaxElement {
	fn from(n:CssUnicodeCodepoint) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssUnicodeRange {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_UNICODE_RANGE as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_UNICODE_RANGE }
...
impl std::fmt::Debug for CssUnicodeRange {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssUnicodeRange")
			.field("prefix_token", &support::DebugSyntaxResult(self.prefix_token()))
			.field("value", &support::DebugSyntaxResult(self.value()))
			.finish()
	}
}
impl From<CssUnicodeRange> for SyntaxNode {
	fn from(n:CssUnicodeRange) -> SyntaxNode { n.syntax }
}
impl From<CssUnicodeRange> for SyntaxElement {
	fn from(n:CssUnicodeRange) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssUnicodeRangeInterval {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_UNICODE_RANGE_INTERVAL as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_UNICODE_RANGE_INTERVAL }
...
impl std::fmt::Debug for CssUnicodeRangeInterval {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("CssUnicodeRangeInterval")
			.field("start", &support::DebugSyntaxResult(self.start()))
			.field("minus_token", &support::DebugSyntaxResult(self.minus_token()))
			.field("end", &support::DebugSyntaxResult(self.end()))
			.finish()
	}
}
impl From<CssUnicodeRangeInterval> for SyntaxNode {
	fn from(n:CssUnicodeRangeInterval) -> SyntaxNode { n.syntax }
}
impl From<CssUnicodeRangeInterval> for SyntaxElement {
	fn from(n:CssUnicodeRangeInterval) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssUnicodeRangeWildcard {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_UNICODE_RANGE_WILDCARD as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_UNICODE_RANGE_WILDCARD }
...
impl From<CssUnicodeRangeWildcard> for SyntaxNode {
	fn from(n:CssUnicodeRangeWildcard) -> SyntaxNode { n.syntax }
}
impl From<CssUnicodeRangeWildcard> for SyntaxElement {
	fn from(n:CssUnicodeRangeWildcard) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssUniversalNamespacePrefix {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_UNIVERSAL_NAMESPACE_PREFIX }
...
impl From<CssUniversalNamespacePrefix> for SyntaxNode {
	fn from(n:CssUniversalNamespacePrefix) -> SyntaxNode { n.syntax }
}
impl From<CssUniversalNamespacePrefix> for SyntaxElement {
	fn from(n:CssUniversalNamespacePrefix) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssUniversalSelector {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_UNIVERSAL_SELECTOR as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_UNIVERSAL_SELECTOR }
...
impl From<CssUniversalSelector> for SyntaxNode {
	fn from(n:CssUniversalSelector) -> SyntaxNode { n.syntax }
}
impl From<CssUniversalSelector> for SyntaxElement {
	fn from(n:CssUniversalSelector) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssUnknownBlockAtRule {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_UNKNOWN_BLOCK_AT_RULE as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_UNKNOWN_BLOCK_AT_RULE }
...
impl From<CssUnknownBlockAtRule> for SyntaxNode {
	fn from(n:CssUnknownBlockAtRule) -> SyntaxNode { n.syntax }
}
impl From<CssUnknownBlockAtRule> for SyntaxElement {
	fn from(n:CssUnknownBlockAtRule) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssUnknownDimension {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_UNKNOWN_DIMENSION as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_UNKNOWN_DIMENSION }
...
impl From<CssUnknownDimension> for SyntaxNode {
	fn from(n:CssUnknownDimension) -> SyntaxNode { n.syntax }
}
impl From<CssUnknownDimension> for SyntaxElement {
	fn from(n:CssUnknownDimension) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssUnknownValueAtRule {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_UNKNOWN_VALUE_AT_RULE as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_UNKNOWN_VALUE_AT_RULE }
...
impl From<CssUnknownValueAtRule> for SyntaxNode {
	fn from(n:CssUnknownValueAtRule) -> SyntaxNode { n.syntax }
}
impl From<CssUnknownValueAtRule> for SyntaxElement {
	fn from(n:CssUnknownValueAtRule) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssUrlFunction {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_URL_FUNCTION as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_URL_FUNCTION }
...
impl From<CssUrlFunction> for SyntaxNode {
	fn from(n:CssUrlFunction) -> SyntaxNode { n.syntax }
}
impl From<CssUrlFunction> for SyntaxElement {
	fn from(n:CssUrlFunction) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssUrlValueRaw {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_URL_VALUE_RAW as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_URL_VALUE_RAW }
...
impl From<CssUrlValueRaw> for SyntaxNode {
	fn from(n:CssUrlValueRaw) -> SyntaxNode { n.syntax }
}
impl From<CssUrlValueRaw> for SyntaxElement {
	fn from(n:CssUrlValueRaw) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssValueAtRule {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_VALUE_AT_RULE as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_VALUE_AT_RULE }
...
impl From<CssValueAtRule> for SyntaxNode {
	fn from(n:CssValueAtRule) -> SyntaxNode { n.syntax }
}
impl From<CssValueAtRule> for SyntaxElement {
	fn from(n:CssValueAtRule) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssValueAtRuleDeclarationClause {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_VALUE_AT_RULE_DECLARATION_CLAUSE }
...
impl From<CssValueAtRuleDeclarationClause> for SyntaxNode {
	fn from(n:CssValueAtRuleDeclarationClause) -> SyntaxNode { n.syntax }
}
impl From<CssValueAtRuleDeclarationClause> for SyntaxElement {
	fn from(n:CssValueAtRuleDeclarationClause) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssValueAtRuleGenericProperty {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_VALUE_AT_RULE_GENERIC_PROPERTY }
...
impl From<CssValueAtRuleGenericProperty> for SyntaxNode {
	fn from(n:CssValueAtRuleGenericProperty) -> SyntaxNode { n.syntax }
}
impl From<CssValueAtRuleGenericProperty> for SyntaxElement {
	fn from(n:CssValueAtRuleGenericProperty) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssValueAtRuleImportClause {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_VALUE_AT_RULE_IMPORT_CLAUSE }
...
impl From<CssValueAtRuleImportClause> for SyntaxNode {
	fn from(n:CssValueAtRuleImportClause) -> SyntaxNode { n.syntax }
}
impl From<CssValueAtRuleImportClause> for SyntaxElement {
	fn from(n:CssValueAtRuleImportClause) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssValueAtRuleImportSpecifier {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_VALUE_AT_RULE_IMPORT_SPECIFIER }
...
impl From<CssValueAtRuleImportSpecifier> for SyntaxNode {
	fn from(n:CssValueAtRuleImportSpecifier) -> SyntaxNode { n.syntax }
}
impl From<CssValueAtRuleImportSpecifier> for SyntaxElement {
	fn from(n:CssValueAtRuleImportSpecifier) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for CssValueAtRuleNamedImportSpecifier {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> =
		SyntaxKindSet::from_raw(RawSyntaxKind(CSS_VALUE_AT_RULE_NAMED_IMPORT_SPECIFIER as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_VALUE_AT_RULE_NAMED_IMPORT_SPECIFIER }
...
impl From<CssValueAtRuleNamedImportSpecifier> for SyntaxNode {
	fn from(n:CssValueAtRuleNamedImportSpecifier) -> SyntaxNode { n.syntax }
}
impl From<CssValueAtRuleNamedImportSpecifier> for SyntaxElement {
	fn from(n:CssValueAtRuleNamedImportSpecifier) -> SyntaxElement { n.syntax.into() }
}
impl From<CssBogusAtRule> for AnyCssAtRule {
	fn from(node:CssBogusAtRule) -> AnyCssAtRule { AnyCssAtRule::CssBogusAtRule(node) }
}
impl From<CssCharsetAtRule> for AnyCssAtRule {
	fn from(node:CssCharsetAtRule) -> AnyCssAtRule { AnyCssAtRule::CssCharsetAtRule(node) }
}
impl From<CssColorProfileAtRule> for AnyCssAtRule {
	fn from(node:CssColorProfileAtRule) -> AnyCssAtRule { AnyCssAtRule::CssColorProfileAtRule(node) }
}
impl From<CssContainerAtRule> for AnyCssAtRule {
	fn from(node:CssContainerAtRule) -> AnyCssAtRule { AnyCssAtRule::CssContainerAtRule(node) }
}
impl From<CssCounterStyleAtRule> for AnyCssAtRule {
	fn from(node:CssCounterStyleAtRule) -> AnyCssAtRule { AnyCssAtRule::CssCounterStyleAtRule(node) }
}
impl From<CssDocumentAtRule> for AnyCssAtRule {
	fn from(node:CssDocumentAtRule) -> AnyCssAtRule { AnyCssAtRule::CssDocumentAtRule(node) }
}
impl From<CssFontFaceAtRule> for AnyCssAtRule {
	fn from(node:CssFontFaceAtRule) -> AnyCssAtRule { AnyCssAtRule::CssFontFaceAtRule(node) }
}
impl From<CssFontFeatureValuesAtRule> for AnyCssAtRule {
	fn from(node:CssFontFeatureValuesAtRule) -> AnyCssAtRule { AnyCssAtRule::CssFontFeatureValuesAtRule(node) }
}
impl From<CssFontPaletteValuesAtRule> for AnyCssAtRule {
	fn from(node:CssFontPaletteValuesAtRule) -> AnyCssAtRule { AnyCssAtRule::CssFontPaletteValuesAtRule(node) }
}
impl From<CssImportAtRule> for AnyCssAtRule {
	fn from(node:CssImportAtRule) -> AnyCssAtRule { AnyCssAtRule::CssImportAtRule(node) }
}
impl From<CssKeyframesAtRule> for AnyCssAtRule {
	fn from(node:CssKeyframesAtRule) -> AnyCssAtRule { AnyCssAtRule::CssKeyframesAtRule(node) }
}
impl From<CssLayerAtRule> for AnyCssAtRule {
	fn from(node:CssLayerAtRule) -> AnyCssAtRule { AnyCssAtRule::CssLayerAtRule(node) }
}
impl From<CssMediaAtRule> for AnyCssAtRule {
	fn from(node:CssMediaAtRule) -> AnyCssAtRule { AnyCssAtRule::CssMediaAtRule(node) }
}
impl From<CssNamespaceAtRule> for AnyCssAtRule {
	fn from(node:CssNamespaceAtRule) -> AnyCssAtRule { AnyCssAtRule::CssNamespaceAtRule(node) }
}
impl From<CssPageAtRule> for AnyCssAtRule {
	fn from(node:CssPageAtRule) -> AnyCssAtRule { AnyCssAtRule::CssPageAtRule(node) }
}
impl From<CssPropertyAtRule> for AnyCssAtRule {
	fn from(node:CssPropertyAtRule) -> AnyCssAtRule { AnyCssAtRule::CssPropertyAtRule(node) }
}
impl From<CssScopeAtRule> for AnyCssAtRule {
	fn from(node:CssScopeAtRule) -> AnyCssAtRule { AnyCssAtRule::CssScopeAtRule(node) }
}
impl From<CssStartingStyleAtRule> for AnyCssAtRule {
	fn from(node:CssStartingStyleAtRule) -> AnyCssAtRule { AnyCssAtRule::CssStartingStyleAtRule(node) }
}
impl From<CssSupportsAtRule> for AnyCssAtRule {
	fn from(node:CssSupportsAtRule) -> AnyCssAtRule { AnyCssAtRule::CssSupportsAtRule(node) }
}
impl From<CssUnknownBlockAtRule> for AnyCssAtRule {
	fn from(node:CssUnknownBlockAtRule) -> AnyCssAtRule { AnyCssAtRule::CssUnknownBlockAtRule(node) }
}
impl From<CssUnknownValueAtRule> for AnyCssAtRule {
	fn from(node:CssUnknownValueAtRule) -> AnyCssAtRule { AnyCssAtRule::CssUnknownValueAtRule(node) }
}
impl From<CssValueAtRule> for AnyCssAtRule {
	fn from(node:CssValueAtRule) -> AnyCssAtRule { AnyCssAtRule::CssValueAtRule(node) }
}
impl AstNode for AnyCssAtRule {
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			...
			CSS_COLOR_PROFILE_AT_RULE => AnyCssAtRule::CssColorProfileAtRule(CssColorProfileAtRule { syntax }),

			CSS_CONTAINER_AT_RULE => AnyCssAtRule::CssContainerAtRule(CssContainerAtRule { syntax }),

			CSS_COUNTER_STYLE_AT_RULE => AnyCssAtRule::CssCounterStyleAtRule(CssCounterStyleAtRule { syntax }),
			...
			CSS_KEYFRAMES_AT_RULE => AnyCssAtRule::CssKeyframesAtRule(CssKeyframesAtRule { syntax }),
			...
			CSS_NAMESPACE_AT_RULE => AnyCssAtRule::CssNamespaceAtRule(CssNamespaceAtRule { syntax }),
			...
			CSS_STARTING_STYLE_AT_RULE => AnyCssAtRule::CssStartingStyleAtRule(CssStartingStyleAtRule { syntax }),

			CSS_SUPPORTS_AT_RULE => AnyCssAtRule::CssSupportsAtRule(CssSupportsAtRule { syntax }),
			CSS_UNKNOWN_BLOCK_AT_RULE => AnyCssAtRule::CssUnknownBlockAtRule(CssUnknownBlockAtRule { syntax }),

			CSS_UNKNOWN_VALUE_AT_RULE => AnyCssAtRule::CssUnknownValueAtRule(CssUnknownValueAtRule { syntax }),
...
impl From<CssIdentifier> for AnyCssAttributeMatcherValue {
	fn from(node:CssIdentifier) -> AnyCssAttributeMatcherValue { AnyCssAttributeMatcherValue::CssIdentifier(node) }
}
impl From<CssString> for AnyCssAttributeMatcherValue {
	fn from(node:CssString) -> AnyCssAttributeMatcherValue { AnyCssAttributeMatcherValue::CssString(node) }
}
impl AstNode for AnyCssAttributeMatcherValue {
	...
	fn can_cast(kind:SyntaxKind) -> bool { matches!(kind, CSS_IDENTIFIER | CSS_STRING) }
...
impl From<CssIdentifier> for AnyCssComposesImportSource {
	fn from(node:CssIdentifier) -> AnyCssComposesImportSource { AnyCssComposesImportSource::CssIdentifier(node) }
}
impl From<CssString> for AnyCssComposesImportSource {
	fn from(node:CssString) -> AnyCssComposesImportSource { AnyCssComposesImportSource::CssString(node) }
}
...
impl From<CssBogusSelector> for AnyCssCompoundSelector {
	fn from(node:CssBogusSelector) -> AnyCssCompoundSelector { AnyCssCompoundSelector::CssBogusSelector(node) }
}
impl From<CssCompoundSelector> for AnyCssCompoundSelector {
	fn from(node:CssCompoundSelector) -> AnyCssCompoundSelector { AnyCssCompoundSelector::CssCompoundSelector(node) }
}
impl AstNode for AnyCssCompoundSelector {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = CssBogusSelector::KIND_SET.union(CssCompoundSelector::KIND_SET);

	fn can_cast(kind:SyntaxKind) -> bool { matches!(kind, CSS_BOGUS_SELECTOR | CSS_COMPOUND_SELECTOR) }

	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_BOGUS_SELECTOR => AnyCssCompoundSelector::CssBogusSelector(CssBogusSelector { syntax }),

			CSS_COMPOUND_SELECTOR => AnyCssCompoundSelector::CssCompoundSelector(CssCompoundSelector { syntax }),
...
impl From<CssBogusBlock> for AnyCssConditionalBlock {
	fn from(node:CssBogusBlock) -> AnyCssConditionalBlock { AnyCssConditionalBlock::CssBogusBlock(node) }
}
...
impl From<CssRuleBlock> for AnyCssConditionalBlock {
	fn from(node:CssRuleBlock) -> AnyCssConditionalBlock { AnyCssConditionalBlock::CssRuleBlock(node) }
}
impl AstNode for AnyCssConditionalBlock {
	...
	fn can_cast(kind:SyntaxKind) -> bool {
		matches!(kind, CSS_BOGUS_BLOCK | CSS_DECLARATION_OR_RULE_BLOCK | CSS_RULE_BLOCK)
	}
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			...
			CSS_DECLARATION_OR_RULE_BLOCK => {
				AnyCssConditionalBlock::CssDeclarationOrRuleBlock(CssDeclarationOrRuleBlock { syntax })
			},
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_CONTAINER_AND_QUERY => {
				AnyCssContainerAndCombinableQuery::CssContainerAndQuery(CssContainerAndQuery { syntax })
			},

			_ => {
				if let Some(any_css_container_query_in_parens) = AnyCssContainerQueryInParens::cast(syntax) {
					return Some(AnyCssContainerAndCombinableQuery::AnyCssContainerQueryInParens(
...
impl std::fmt::Debug for AnyCssContainerAndCombinableQuery {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		match self {
			AnyCssContainerAndCombinableQuery::AnyCssContainerQueryInParens(it) => std::fmt::Debug::fmt(it, f),

			AnyCssContainerAndCombinableQuery::CssContainerAndQuery(it) => std::fmt::Debug::fmt(it, f),
		}
	}
}
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_CONTAINER_OR_QUERY => {
				AnyCssContainerOrCombinableQuery::CssContainerOrQuery(CssContainerOrQuery { syntax })
			},

			_ => {
				if let Some(any_css_container_query_in_parens) = AnyCssContainerQueryInParens::cast(syntax) {
					return Some(AnyCssContainerOrCombinableQuery::AnyCssContainerQueryInParens(
						any_css_container_query_in_parens,
					));
				}
...
impl std::fmt::Debug for AnyCssContainerOrCombinableQuery {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		match self {
			AnyCssContainerOrCombinableQuery::AnyCssContainerQueryInParens(it) => std::fmt::Debug::fmt(it, f),

			AnyCssContainerOrCombinableQuery::CssContainerOrQuery(it) => std::fmt::Debug::fmt(it, f),
		}
	}
}
...
impl From<CssContainerAndQuery> for AnyCssContainerQuery {
	fn from(node:CssContainerAndQuery) -> AnyCssContainerQuery { AnyCssContainerQuery::CssContainerAndQuery(node) }
}
impl From<CssContainerNotQuery> for AnyCssContainerQuery {
	fn from(node:CssContainerNotQuery) -> AnyCssContainerQuery { AnyCssContainerQuery::CssContainerNotQuery(node) }
}
impl From<CssContainerOrQuery> for AnyCssContainerQuery {
	fn from(node:CssContainerOrQuery) -> AnyCssContainerQuery { AnyCssContainerQuery::CssContainerOrQuery(node) }
}
impl AstNode for AnyCssContainerQuery {
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_CONTAINER_AND_QUERY => AnyCssContainerQuery::CssContainerAndQuery(CssContainerAndQuery { syntax }),

			CSS_CONTAINER_NOT_QUERY => AnyCssContainerQuery::CssContainerNotQuery(CssContainerNotQuery { syntax }),

			CSS_CONTAINER_OR_QUERY => AnyCssContainerQuery::CssContainerOrQuery(CssContainerOrQuery { syntax }),
...
impl AstNode for AnyCssContainerQueryInParens {
	...
	fn can_cast(kind:SyntaxKind) -> bool {
		matches!(
			kind,
			CSS_CONTAINER_QUERY_IN_PARENS | CSS_CONTAINER_SIZE_FEATURE_IN_PARENS | CSS_CONTAINER_STYLE_QUERY_IN_PARENS
		)
	}
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_CONTAINER_QUERY_IN_PARENS => {
				AnyCssContainerQueryInParens::CssContainerQueryInParens(CssContainerQueryInParens { syntax })
			},

			CSS_CONTAINER_SIZE_FEATURE_IN_PARENS => {
				AnyCssContainerQueryInParens::CssContainerSizeFeatureInParens(CssContainerSizeFeatureInParens {
					syntax,
				})
			},

			CSS_CONTAINER_STYLE_QUERY_IN_PARENS => {
				AnyCssContainerQueryInParens::CssContainerStyleQueryInParens(CssContainerStyleQueryInParens { syntax })
			},
...
impl std::fmt::Debug for AnyCssContainerQueryInParens {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		match self {
			AnyCssContainerQueryInParens::CssContainerQueryInParens(it) => std::fmt::Debug::fmt(it, f),

			AnyCssContainerQueryInParens::CssContainerSizeFeatureInParens(it) => std::fmt::Debug::fmt(it, f),

			AnyCssContainerQueryInParens::CssContainerStyleQueryInParens(it) => std::fmt::Debug::fmt(it, f),
		}
	}
}
...
impl AstNode for AnyCssContainerStyleAndCombinableQuery {
	...
	fn can_cast(kind:SyntaxKind) -> bool {
		matches!(kind, CSS_CONTAINER_STYLE_AND_QUERY | CSS_CONTAINER_STYLE_IN_PARENS)
	}

	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_CONTAINER_STYLE_AND_QUERY => {
				AnyCssContainerStyleAndCombinableQuery::CssContainerStyleAndQuery(CssContainerStyleAndQuery { syntax })
			},

			CSS_CONTAINER_STYLE_IN_PARENS => {
				AnyCssContainerStyleAndCombinableQuery::CssContainerStyleInParens(CssContainerStyleInParens { syntax })
			},
...
impl std::fmt::Debug for AnyCssContainerStyleAndCombinableQuery {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		match self {
			AnyCssContainerStyleAndCombinableQuery::CssContainerStyleAndQuery(it) => std::fmt::Debug::fmt(it, f),

			AnyCssContainerStyleAndCombinableQuery::CssContainerStyleInParens(it) => std::fmt::Debug::fmt(it, f),
		}
	}
}
...
impl From<CssDeclaration> for AnyCssContainerStyleInParens {
	fn from(node:CssDeclaration) -> AnyCssContainerStyleInParens { AnyCssContainerStyleInParens::CssDeclaration(node) }
}
impl AstNode for AnyCssContainerStyleInParens {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = AnyCssContainerStyleQuery::KIND_SET.union(CssDeclaration::KIND_SET);
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_DECLARATION => AnyCssContainerStyleInParens::CssDeclaration(CssDeclaration { syntax }),
...
impl std::fmt::Debug for AnyCssContainerStyleInParens {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		match self {
			AnyCssContainerStyleInParens::AnyCssContainerStyleQuery(it) => std::fmt::Debug::fmt(it, f),
...
impl AstNode for AnyCssContainerStyleOrCombinableQuery {
	...
	fn can_cast(kind:SyntaxKind) -> bool {
		matches!(kind, CSS_CONTAINER_STYLE_IN_PARENS | CSS_CONTAINER_STYLE_OR_QUERY)
	}

	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_CONTAINER_STYLE_IN_PARENS => {
				AnyCssContainerStyleOrCombinableQuery::CssContainerStyleInParens(CssContainerStyleInParens { syntax })
			},

			CSS_CONTAINER_STYLE_OR_QUERY => {
				AnyCssContainerStyleOrCombinableQuery::CssContainerStyleOrQuery(CssContainerStyleOrQuery { syntax })
			},
...
impl std::fmt::Debug for AnyCssContainerStyleOrCombinableQuery {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		match self {
			AnyCssContainerStyleOrCombinableQuery::CssContainerStyleInParens(it) => std::fmt::Debug::fmt(it, f),

			AnyCssContainerStyleOrCombinableQuery::CssContainerStyleOrQuery(it) => std::fmt::Debug::fmt(it, f),
		}
	}
}
...
impl From<CssDeclaration> for AnyCssContainerStyleQuery {
	fn from(node:CssDeclaration) -> AnyCssContainerStyleQuery { AnyCssContainerStyleQuery::CssDeclaration(node) }
}
impl AstNode for AnyCssContainerStyleQuery {
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_CONTAINER_STYLE_AND_QUERY => {
				AnyCssContainerStyleQuery::CssContainerStyleAndQuery(CssContainerStyleAndQuery { syntax })
			},

			CSS_CONTAINER_STYLE_IN_PARENS => {
				AnyCssContainerStyleQuery::CssContainerStyleInParens(CssContainerStyleInParens { syntax })
			},

			CSS_CONTAINER_STYLE_NOT_QUERY => {
				AnyCssContainerStyleQuery::CssContainerStyleNotQuery(CssContainerStyleNotQuery { syntax })
			},

			CSS_CONTAINER_STYLE_OR_QUERY => {
				AnyCssContainerStyleQuery::CssContainerStyleOrQuery(CssContainerStyleOrQuery { syntax })
			},
...
impl From<CssCustomIdentifier> for AnyCssCustomIdentifier {
	fn from(node:CssCustomIdentifier) -> AnyCssCustomIdentifier { AnyCssCustomIdentifier::CssCustomIdentifier(node) }
}
impl AstNode for AnyCssCustomIdentifier {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = CssBogusCustomIdentifier::KIND_SET.union(CssCustomIdentifier::KIND_SET);

	fn can_cast(kind:SyntaxKind) -> bool { matches!(kind, CSS_BOGUS_CUSTOM_IDENTIFIER | CSS_CUSTOM_IDENTIFIER) }

	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_BOGUS_CUSTOM_IDENTIFIER => {
				AnyCssCustomIdentifier::CssBogusCustomIdentifier(CssBogusCustomIdentifier { syntax })
			},

			CSS_CUSTOM_IDENTIFIER => AnyCssCustomIdentifier::CssCustomIdentifier(CssCustomIdentifier { syntax }),
...
impl From<CssBogusBlock> for AnyCssDeclarationBlock {
	fn from(node:CssBogusBlock) -> AnyCssDeclarationBlock { AnyCssDeclarationBlock::CssBogusBlock(node) }
}
impl From<CssDeclarationBlock> for AnyCssDeclarationBlock {
	fn from(node:CssDeclarationBlock) -> AnyCssDeclarationBlock { AnyCssDeclarationBlock::CssDeclarationBlock(node) }
}
impl AstNode for AnyCssDeclarationBlock {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = CssBogusBlock::KIND_SET.union(CssDeclarationBlock::KIND_SET);

	fn can_cast(kind:SyntaxKind) -> bool { matches!(kind, CSS_BOGUS_BLOCK | CSS_DECLARATION_BLOCK) }

	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_BOGUS_BLOCK => AnyCssDeclarationBlock::CssBogusBlock(CssBogusBlock { syntax }),
			CSS_DECLARATION_BLOCK => AnyCssDeclarationBlock::CssDeclarationBlock(CssDeclarationBlock { syntax }),
...
impl From<CssDashedIdentifier> for AnyCssDeclarationName {
	fn from(node:CssDashedIdentifier) -> AnyCssDeclarationName { AnyCssDeclarationName::CssDashedIdentifier(node) }
}
impl From<CssIdentifier> for AnyCssDeclarationName {
	fn from(node:CssIdentifier) -> AnyCssDeclarationName { AnyCssDeclarationName::CssIdentifier(node) }
}
impl AstNode for AnyCssDeclarationName {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = CssDashedIdentifier::KIND_SET.union(CssIdentifier::KIND_SET);

	fn can_cast(kind:SyntaxKind) -> bool { matches!(kind, CSS_DASHED_IDENTIFIER | CSS_IDENTIFIER) }

	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_DASHED_IDENTIFIER => AnyCssDeclarationName::CssDashedIdentifier(CssDashedIdentifier { syntax }),
...
impl From<CssAtRule> for AnyCssDeclarationOrAtRule {
	fn from(node:CssAtRule) -> AnyCssDeclarationOrAtRule { AnyCssDeclarationOrAtRule::CssAtRule(node) }
}
...
impl AstNode for AnyCssDeclarationOrAtRule {
	...
	const KIND_SET:SyntaxKindSet<Language> = CssAtRule::KIND_SET.union(CssDeclarationWithSemicolon::KIND_SET);

	fn can_cast(kind:SyntaxKind) -> bool { matches!(kind, CSS_AT_RULE | CSS_DECLARATION_WITH_SEMICOLON) }

	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_AT_RULE => AnyCssDeclarationOrAtRule::CssAtRule(CssAtRule { syntax }),
			CSS_DECLARATION_WITH_SEMICOLON => {
				AnyCssDeclarationOrAtRule::CssDeclarationWithSemicolon(CssDeclarationWithSemicolon { syntax })
			},
...
impl std::fmt::Debug for AnyCssDeclarationOrAtRule {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		match self {
			...
			AnyCssDeclarationOrAtRule::CssDeclarationWithSemicolon(it) => std::fmt::Debug::fmt(it, f),
		}
	}
}
...
impl AstNode for AnyCssDeclarationOrAtRuleBlock {
	...
	const KIND_SET:SyntaxKindSet<Language> = CssBogusBlock::KIND_SET.union(CssDeclarationOrAtRuleBlock::KIND_SET);

	fn can_cast(kind:SyntaxKind) -> bool { matches!(kind, CSS_BOGUS_BLOCK | CSS_DECLARATION_OR_AT_RULE_BLOCK) }

	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_BOGUS_BLOCK => AnyCssDeclarationOrAtRuleBlock::CssBogusBlock(CssBogusBlock { syntax }),

			CSS_DECLARATION_OR_AT_RULE_BLOCK => {
				AnyCssDeclarationOrAtRuleBlock::CssDeclarationOrAtRuleBlock(CssDeclarationOrAtRuleBlock { syntax })
			},
...
impl std::fmt::Debug for AnyCssDeclarationOrAtRuleBlock {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		match self {
			...
			AnyCssDeclarationOrAtRuleBlock::CssDeclarationOrAtRuleBlock(it) => std::fmt::Debug::fmt(it, f),
		}
	}
}
...
impl From<CssBogus> for AnyCssDeclarationOrRule {
	fn from(node:CssBogus) -> AnyCssDeclarationOrRule { AnyCssDeclarationOrRule::CssBogus(node) }
}
...
impl From<CssEmptyDeclaration> for AnyCssDeclarationOrRule {
	fn from(node:CssEmptyDeclaration) -> AnyCssDeclarationOrRule { AnyCssDeclarationOrRule::CssEmptyDeclaration(node) }
}
impl From<CssMetavariable> for AnyCssDeclarationOrRule {
	fn from(node:CssMetavariable) -> AnyCssDeclarationOrRule { AnyCssDeclarationOrRule::CssMetavariable(node) }
}
impl AstNode for AnyCssDeclarationOrRule {
	...
	fn can_cast(kind:SyntaxKind) -> bool {
		match kind {
			CSS_BOGUS | CSS_DECLARATION_WITH_SEMICOLON | CSS_EMPTY_DECLARATION | CSS_METAVARIABLE => true,
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			...
			CSS_DECLARATION_WITH_SEMICOLON => {
				AnyCssDeclarationOrRule::CssDeclarationWithSemicolon(CssDeclarationWithSemicolon { syntax })
			},

			CSS_EMPTY_DECLARATION => AnyCssDeclarationOrRule::CssEmptyDeclaration(CssEmptyDeclaration { syntax }),

			CSS_METAVARIABLE => AnyCssDeclarationOrRule::CssMetavariable(CssMetavariable { syntax }),
...
impl From<CssBogusBlock> for AnyCssDeclarationOrRuleBlock {
	fn from(node:CssBogusBlock) -> AnyCssDeclarationOrRuleBlock { AnyCssDeclarationOrRuleBlock::CssBogusBlock(node) }
}
...
impl AstNode for AnyCssDeclarationOrRuleBlock {
	...
	const KIND_SET:SyntaxKindSet<Language> = CssBogusBlock::KIND_SET.union(CssDeclarationOrRuleBlock::KIND_SET);

	fn can_cast(kind:SyntaxKind) -> bool { matches!(kind, CSS_BOGUS_BLOCK | CSS_DECLARATION_OR_RULE_BLOCK) }

	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_BOGUS_BLOCK => AnyCssDeclarationOrRuleBlock::CssBogusBlock(CssBogusBlock { syntax }),

			CSS_DECLARATION_OR_RULE_BLOCK => {
				AnyCssDeclarationOrRuleBlock::CssDeclarationOrRuleBlock(CssDeclarationOrRuleBlock { syntax })
			},
...
impl std::fmt::Debug for AnyCssDeclarationOrRuleBlock {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		match self {
			...
			AnyCssDeclarationOrRuleBlock::CssDeclarationOrRuleBlock(it) => std::fmt::Debug::fmt(it, f),
		}
	}
}
...
impl From<CssPercentage> for AnyCssDimension {
	fn from(node:CssPercentage) -> AnyCssDimension { AnyCssDimension::CssPercentage(node) }
}
impl From<CssRegularDimension> for AnyCssDimension {
	fn from(node:CssRegularDimension) -> AnyCssDimension { AnyCssDimension::CssRegularDimension(node) }
}
impl From<CssUnknownDimension> for AnyCssDimension {
	fn from(node:CssUnknownDimension) -> AnyCssDimension { AnyCssDimension::CssUnknownDimension(node) }
}
impl AstNode for AnyCssDimension {
	...
	fn can_cast(kind:SyntaxKind) -> bool {
		matches!(kind, CSS_PERCENTAGE | CSS_REGULAR_DIMENSION | CSS_UNKNOWN_DIMENSION)
	}

	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_PERCENTAGE => AnyCssDimension::CssPercentage(CssPercentage { syntax }),
			CSS_REGULAR_DIMENSION => AnyCssDimension::CssRegularDimension(CssRegularDimension { syntax }),

			CSS_UNKNOWN_DIMENSION => AnyCssDimension::CssUnknownDimension(CssUnknownDimension { syntax }),
...
impl From<CssUrlFunction> for AnyCssDocumentMatcher {
	fn from(node:CssUrlFunction) -> AnyCssDocumentMatcher { AnyCssDocumentMatcher::CssUrlFunction(node) }
}
...
impl From<CssBinaryExpression> for AnyCssExpression {
	fn from(node:CssBinaryExpression) -> AnyCssExpression { AnyCssExpression::CssBinaryExpression(node) }
}
...
impl From<CssParenthesizedExpression> for AnyCssExpression {
	fn from(node:CssParenthesizedExpression) -> AnyCssExpression { AnyCssExpression::CssParenthesizedExpression(node) }
}
impl AstNode for AnyCssExpression {
	...
	fn can_cast(kind:SyntaxKind) -> bool {
		matches!(
			kind,
			CSS_BINARY_EXPRESSION | CSS_LIST_OF_COMPONENT_VALUES_EXPRESSION | CSS_PARENTHESIZED_EXPRESSION
		)
	}

	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_BINARY_EXPRESSION => AnyCssExpression::CssBinaryExpression(CssBinaryExpression { syntax }),

			CSS_LIST_OF_COMPONENT_VALUES_EXPRESSION => {
				AnyCssExpression::CssListOfComponentValuesExpression(CssListOfComponentValuesExpression { syntax })
			},
...
impl From<CssBogusFontFamilyName> for AnyCssFontFamilyName {
	fn from(node:CssBogusFontFamilyName) -> AnyCssFontFamilyName { AnyCssFontFamilyName::CssBogusFontFamilyName(node) }
}
impl From<CssFontFamilyName> for AnyCssFontFamilyName {
	fn from(node:CssFontFamilyName) -> AnyCssFontFamilyName { AnyCssFontFamilyName::CssFontFamilyName(node) }
}
impl From<CssString> for AnyCssFontFamilyName {
	fn from(node:CssString) -> AnyCssFontFamilyName { AnyCssFontFamilyName::CssString(node) }
}
impl AstNode for AnyCssFontFamilyName {
	...
	fn can_cast(kind:SyntaxKind) -> bool {
		matches!(kind, CSS_BOGUS_FONT_FAMILY_NAME | CSS_FONT_FAMILY_NAME | CSS_STRING)
	}
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			...
			CSS_FONT_FAMILY_NAME => AnyCssFontFamilyName::CssFontFamilyName(CssFontFamilyName { syntax }),
...
impl From<CssBogusBlock> for AnyCssFontFeatureValuesBlock {
	fn from(node:CssBogusBlock) -> AnyCssFontFeatureValuesBlock { AnyCssFontFeatureValuesBlock::CssBogusBlock(node) }
}
...
impl AstNode for AnyCssFontFeatureValuesBlock {
	...
	const KIND_SET:SyntaxKindSet<Language> = CssBogusBlock::KIND_SET.union(CssFontFeatureValuesBlock::KIND_SET);

	fn can_cast(kind:SyntaxKind) -> bool { matches!(kind, CSS_BOGUS_BLOCK | CSS_FONT_FEATURE_VALUES_BLOCK) }

	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_BOGUS_BLOCK => AnyCssFontFeatureValuesBlock::CssBogusBlock(CssBogusBlock { syntax }),

			CSS_FONT_FEATURE_VALUES_BLOCK => {
				AnyCssFontFeatureValuesBlock::CssFontFeatureValuesBlock(CssFontFeatureValuesBlock { syntax })
			},
...
impl std::fmt::Debug for AnyCssFontFeatureValuesBlock {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		match self {
			...
			AnyCssFontFeatureValuesBlock::CssFontFeatureValuesBlock(it) => std::fmt::Debug::fmt(it, f),
		}
	}
}
...
impl AstNode for AnyCssFontFeatureValuesItem {
	...
	fn can_cast(kind:SyntaxKind) -> bool {
		matches!(kind, CSS_BOGUS_FONT_FEATURE_VALUES_ITEM | CSS_FONT_FEATURE_VALUES_ITEM)
	}

	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_BOGUS_FONT_FEATURE_VALUES_ITEM => {
				AnyCssFontFeatureValuesItem::CssBogusFontFeatureValuesItem(CssBogusFontFeatureValuesItem { syntax })
			},

			CSS_FONT_FEATURE_VALUES_ITEM => {
				AnyCssFontFeatureValuesItem::CssFontFeatureValuesItem(CssFontFeatureValuesItem { syntax })
			},
...
impl std::fmt::Debug for AnyCssFontFeatureValuesItem {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		match self {
			AnyCssFontFeatureValuesItem::CssBogusFontFeatureValuesItem(it) => std::fmt::Debug::fmt(it, f),

			AnyCssFontFeatureValuesItem::CssFontFeatureValuesItem(it) => std::fmt::Debug::fmt(it, f),
		}
	}
}
...
impl From<CssFunction> for AnyCssFunction {
	fn from(node:CssFunction) -> AnyCssFunction { AnyCssFunction::CssFunction(node) }
}
impl From<CssUrlFunction> for AnyCssFunction {
	fn from(node:CssUrlFunction) -> AnyCssFunction { AnyCssFunction::CssUrlFunction(node) }
}
impl AstNode for AnyCssFunction {
	...
	fn can_cast(kind:SyntaxKind) -> bool { matches!(kind, CSS_FUNCTION | CSS_URL_FUNCTION) }
...
impl AstNode for AnyCssGenericComponentValue {
	...
	const KIND_SET:SyntaxKindSet<Language> = AnyCssValue::KIND_SET.union(CssGenericDelimiter::KIND_SET);
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_GENERIC_DELIMITER => AnyCssGenericComponentValue::CssGenericDelimiter(CssGenericDelimiter { syntax }),
...
impl From<CssImportAnonymousLayer> for AnyCssImportLayer {
	fn from(node:CssImportAnonymousLayer) -> AnyCssImportLayer { AnyCssImportLayer::CssImportAnonymousLayer(node) }
}
impl From<CssImportNamedLayer> for AnyCssImportLayer {
	fn from(node:CssImportNamedLayer) -> AnyCssImportLayer { AnyCssImportLayer::CssImportNamedLayer(node) }
}
impl AstNode for AnyCssImportLayer {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = CssImportAnonymousLayer::KIND_SET.union(CssImportNamedLayer::KIND_SET);

	fn can_cast(kind:SyntaxKind) -> bool { matches!(kind, CSS_IMPORT_ANONYMOUS_LAYER | CSS_IMPORT_NAMED_LAYER) }
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			...
			CSS_IMPORT_NAMED_LAYER => AnyCssImportLayer::CssImportNamedLayer(CssImportNamedLayer { syntax }),
...
impl AstNode for AnyCssImportSupportsCondition {
	...
	const KIND_SET:SyntaxKindSet<Language> = AnyCssSupportsCondition::KIND_SET.union(CssDeclaration::KIND_SET);
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_DECLARATION => AnyCssImportSupportsCondition::CssDeclaration(CssDeclaration { syntax }),
...
impl std::fmt::Debug for AnyCssImportSupportsCondition {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		match self {
			AnyCssImportSupportsCondition::AnyCssSupportsCondition(it) => std::fmt::Debug::fmt(it, f),
...
impl From<CssString> for AnyCssImportUrl {
	fn from(node:CssString) -> AnyCssImportUrl { AnyCssImportUrl::CssString(node) }
}
impl From<CssUrlFunction> for AnyCssImportUrl {
	fn from(node:CssUrlFunction) -> AnyCssImportUrl { AnyCssImportUrl::CssUrlFunction(node) }
}
impl AstNode for AnyCssImportUrl {
	...
	fn can_cast(kind:SyntaxKind) -> bool { matches!(kind, CSS_STRING | CSS_URL_FUNCTION) }
...
impl From<CssBogusBlock> for AnyCssKeyframesBlock {
	fn from(node:CssBogusBlock) -> AnyCssKeyframesBlock { AnyCssKeyframesBlock::CssBogusBlock(node) }
}
impl From<CssKeyframesBlock> for AnyCssKeyframesBlock {
	fn from(node:CssKeyframesBlock) -> AnyCssKeyframesBlock { AnyCssKeyframesBlock::CssKeyframesBlock(node) }
}
impl AstNode for AnyCssKeyframesBlock {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = CssBogusBlock::KIND_SET.union(CssKeyframesBlock::KIND_SET);

	fn can_cast(kind:SyntaxKind) -> bool { matches!(kind, CSS_BOGUS_BLOCK | CSS_KEYFRAMES_BLOCK) }

	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_BOGUS_BLOCK => AnyCssKeyframesBlock::CssBogusBlock(CssBogusBlock { syntax }),
			CSS_KEYFRAMES_BLOCK => AnyCssKeyframesBlock::CssKeyframesBlock(CssKeyframesBlock { syntax }),
...
impl From<CssString> for AnyCssKeyframesIdentifier {
	fn from(node:CssString) -> AnyCssKeyframesIdentifier { AnyCssKeyframesIdentifier::CssString(node) }
}
impl AstNode for AnyCssKeyframesIdentifier {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = CssCustomIdentifier::KIND_SET.union(CssString::KIND_SET);

	fn can_cast(kind:SyntaxKind) -> bool { matches!(kind, CSS_CUSTOM_IDENTIFIER | CSS_STRING) }

	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_CUSTOM_IDENTIFIER => AnyCssKeyframesIdentifier::CssCustomIdentifier(CssCustomIdentifier { syntax }),
...
impl From<CssBogusKeyframesItem> for AnyCssKeyframesItem {
	fn from(node:CssBogusKeyframesItem) -> AnyCssKeyframesItem { AnyCssKeyframesItem::CssBogusKeyframesItem(node) }
}
impl From<CssKeyframesItem> for AnyCssKeyframesItem {
	fn from(node:CssKeyframesItem) -> AnyCssKeyframesItem { AnyCssKeyframesItem::CssKeyframesItem(node) }
}
impl AstNode for AnyCssKeyframesItem {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = CssBogusKeyframesItem::KIND_SET.union(CssKeyframesItem::KIND_SET);

	fn can_cast(kind:SyntaxKind) -> bool { matches!(kind, CSS_BOGUS_KEYFRAMES_ITEM | CSS_KEYFRAMES_ITEM) }

	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_BOGUS_KEYFRAMES_ITEM => AnyCssKeyframesItem::CssBogusKeyframesItem(CssBogusKeyframesItem { syntax }),

			CSS_KEYFRAMES_ITEM => AnyCssKeyframesItem::CssKeyframesItem(CssKeyframesItem { syntax }),
...
impl From<CssBogusKeyframesName> for AnyCssKeyframesName {
	fn from(node:CssBogusKeyframesName) -> AnyCssKeyframesName { AnyCssKeyframesName::CssBogusKeyframesName(node) }
}
impl From<CssKeyframesScopedName> for AnyCssKeyframesName {
	fn from(node:CssKeyframesScopedName) -> AnyCssKeyframesName { AnyCssKeyframesName::CssKeyframesScopedName(node) }
}
impl AstNode for AnyCssKeyframesName {
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_BOGUS_KEYFRAMES_NAME => AnyCssKeyframesName::CssBogusKeyframesName(CssBogusKeyframesName { syntax }),

			CSS_KEYFRAMES_SCOPED_NAME => AnyCssKeyframesName::CssKeyframesScopedName(CssKeyframesScopedName { syntax }),

			_ => {
				if let Some(any_css_keyframes_identifier) = AnyCssKeyframesIdentifier::cast(syntax) {
					return Some(AnyCssKeyframesName::AnyCssKeyframesIdentifier(any_css_keyframes_identifier));
				}
...
impl AstNode for AnyCssKeyframesScope {
	...
	fn can_cast(kind:SyntaxKind) -> bool { matches!(kind, CSS_KEYFRAMES_SCOPE_FUNCTION | CSS_KEYFRAMES_SCOPE_PREFIX) }

	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_KEYFRAMES_SCOPE_FUNCTION => {
				AnyCssKeyframesScope::CssKeyframesScopeFunction(CssKeyframesScopeFunction { syntax })
			},
...
impl From<CssBogusSelector> for AnyCssKeyframesSelector {
	fn from(node:CssBogusSelector) -> AnyCssKeyframesSelector { AnyCssKeyframesSelector::CssBogusSelector(node) }
}
...
impl AstNode for AnyCssKeyframesSelector {
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_BOGUS_SELECTOR => AnyCssKeyframesSelector::CssBogusSelector(CssBogusSelector { syntax }),

			CSS_KEYFRAMES_IDENT_SELECTOR => {
				AnyCssKeyframesSelector::CssKeyframesIdentSelector(CssKeyframesIdentSelector { syntax })
			},

			CSS_KEYFRAMES_PERCENTAGE_SELECTOR => {
				AnyCssKeyframesSelector::CssKeyframesPercentageSelector(CssKeyframesPercentageSelector { syntax })
			},
...
impl std::fmt::Debug for AnyCssKeyframesSelector {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		match self {
			...
			AnyCssKeyframesSelector::CssKeyframesPercentageSelector(it) => std::fmt::Debug::fmt(it, f),
		}
	}
}
...
impl From<CssBogusLayer> for AnyCssLayer {
	fn from(node:CssBogusLayer) -> AnyCssLayer { AnyCssLayer::CssBogusLayer(node) }
}
impl From<CssLayerDeclaration> for AnyCssLayer {
	fn from(node:CssLayerDeclaration) -> AnyCssLayer { AnyCssLayer::CssLayerDeclaration(node) }
}
impl From<CssLayerReference> for AnyCssLayer {
	fn from(node:CssLayerReference) -> AnyCssLayer { AnyCssLayer::CssLayerReference(node) }
}
impl AstNode for AnyCssLayer {
	...
	fn can_cast(kind:SyntaxKind) -> bool {
		matches!(kind, CSS_BOGUS_LAYER | CSS_LAYER_DECLARATION | CSS_LAYER_REFERENCE)
	}

	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_BOGUS_LAYER => AnyCssLayer::CssBogusLayer(CssBogusLayer { syntax }),
			CSS_LAYER_DECLARATION => AnyCssLayer::CssLayerDeclaration(CssLayerDeclaration { syntax }),
...
impl AstNode for AnyCssMediaAndCombinableCondition {
	...
	const KIND_SET:SyntaxKindSet<Language> = AnyCssMediaInParens::KIND_SET.union(CssMediaAndCondition::KIND_SET);
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_MEDIA_AND_CONDITION => {
				AnyCssMediaAndCombinableCondition::CssMediaAndCondition(CssMediaAndCondition { syntax })
			},

			_ => {
				if let Some(any_css_media_in_parens) = AnyCssMediaInParens::cast(syntax) {
					return Some(AnyCssMediaAndCombinableCondition::AnyCssMediaInParens(any_css_media_in_parens));
				}
...
impl std::fmt::Debug for AnyCssMediaAndCombinableCondition {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		match self {
			AnyCssMediaAndCombinableCondition::AnyCssMediaInParens(it) => std::fmt::Debug::fmt(it, f),

			AnyCssMediaAndCombinableCondition::CssMediaAndCondition(it) => std::fmt::Debug::fmt(it, f),
		}
	}
}
...
impl From<CssMediaAndCondition> for AnyCssMediaCondition {
	fn from(node:CssMediaAndCondition) -> AnyCssMediaCondition { AnyCssMediaCondition::CssMediaAndCondition(node) }
}
impl From<CssMediaNotCondition> for AnyCssMediaCondition {
	fn from(node:CssMediaNotCondition) -> AnyCssMediaCondition { AnyCssMediaCondition::CssMediaNotCondition(node) }
}
impl From<CssMediaOrCondition> for AnyCssMediaCondition {
	fn from(node:CssMediaOrCondition) -> AnyCssMediaCondition { AnyCssMediaCondition::CssMediaOrCondition(node) }
}
impl AstNode for AnyCssMediaCondition {
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_MEDIA_AND_CONDITION => AnyCssMediaCondition::CssMediaAndCondition(CssMediaAndCondition { syntax }),

			CSS_MEDIA_NOT_CONDITION => AnyCssMediaCondition::CssMediaNotCondition(CssMediaNotCondition { syntax }),

			CSS_MEDIA_OR_CONDITION => AnyCssMediaCondition::CssMediaOrCondition(CssMediaOrCondition { syntax }),

			_ => {
				if let Some(any_css_media_in_parens) = AnyCssMediaInParens::cast(syntax) {
					return Some(AnyCssMediaCondition::AnyCssMediaInParens(any_css_media_in_parens));
				}
...
impl From<CssMediaFeatureInParens> for AnyCssMediaInParens {
	fn from(node:CssMediaFeatureInParens) -> AnyCssMediaInParens { AnyCssMediaInParens::CssMediaFeatureInParens(node) }
}
impl AstNode for AnyCssMediaInParens {
	...
	fn can_cast(kind:SyntaxKind) -> bool { matches!(kind, CSS_MEDIA_CONDITION_IN_PARENS | CSS_MEDIA_FEATURE_IN_PARENS) }
...
impl AstNode for AnyCssMediaOrCombinableCondition {
	...
	const KIND_SET:SyntaxKindSet<Language> = AnyCssMediaInParens::KIND_SET.union(CssMediaOrCondition::KIND_SET);
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_MEDIA_OR_CONDITION => {
				AnyCssMediaOrCombinableCondition::CssMediaOrCondition(CssMediaOrCondition { syntax })
			},

			_ => {
				if let Some(any_css_media_in_parens) = AnyCssMediaInParens::cast(syntax) {
					return Some(AnyCssMediaOrCombinableCondition::AnyCssMediaInParens(any_css_media_in_parens));
				}
...
impl std::fmt::Debug for AnyCssMediaOrCombinableCondition {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		match self {
			AnyCssMediaOrCombinableCondition::AnyCssMediaInParens(it) => std::fmt::Debug::fmt(it, f),

			AnyCssMediaOrCombinableCondition::CssMediaOrCondition(it) => std::fmt::Debug::fmt(it, f),
		}
	}
}
...
impl From<CssBogusMediaQuery> for AnyCssMediaQuery {
	fn from(node:CssBogusMediaQuery) -> AnyCssMediaQuery { AnyCssMediaQuery::CssBogusMediaQuery(node) }
}
impl From<CssMediaConditionQuery> for AnyCssMediaQuery {
	fn from(node:CssMediaConditionQuery) -> AnyCssMediaQuery { AnyCssMediaQuery::CssMediaConditionQuery(node) }
}
impl From<CssMetavariable> for AnyCssMediaQuery {
	fn from(node:CssMetavariable) -> AnyCssMediaQuery { AnyCssMediaQuery::CssMetavariable(node) }
}
impl AstNode for AnyCssMediaQuery {
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_BOGUS_MEDIA_QUERY => AnyCssMediaQuery::CssBogusMediaQuery(CssBogusMediaQuery { syntax }),

			CSS_MEDIA_CONDITION_QUERY => AnyCssMediaQuery::CssMediaConditionQuery(CssMediaConditionQuery { syntax }),
			...
			_ => {
				if let Some(any_css_media_type_query) = AnyCssMediaTypeQuery::cast(syntax) {
					return Some(AnyCssMediaQuery::AnyCssMediaTypeQuery(any_css_media_type_query));
				}
...
impl AstNode for AnyCssMediaTypeCondition {
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_MEDIA_AND_CONDITION => AnyCssMediaTypeCondition::CssMediaAndCondition(CssMediaAndCondition { syntax }),

			CSS_MEDIA_NOT_CONDITION => AnyCssMediaTypeCondition::CssMediaNotCondition(CssMediaNotCondition { syntax }),

			_ => {
				if let Some(any_css_media_in_parens) = AnyCssMediaInParens::cast(syntax) {
					return Some(AnyCssMediaTypeCondition::AnyCssMediaInParens(any_css_media_in_parens));
				}
...
impl From<CssMediaAndTypeQuery> for AnyCssMediaTypeQuery {
	fn from(node:CssMediaAndTypeQuery) -> AnyCssMediaTypeQuery { AnyCssMediaTypeQuery::CssMediaAndTypeQuery(node) }
}
impl From<CssMediaTypeQuery> for AnyCssMediaTypeQuery {
	fn from(node:CssMediaTypeQuery) -> AnyCssMediaTypeQuery { AnyCssMediaTypeQuery::CssMediaTypeQuery(node) }
}
impl AstNode for AnyCssMediaTypeQuery {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = CssMediaAndTypeQuery::KIND_SET.union(CssMediaTypeQuery::KIND_SET);

	fn can_cast(kind:SyntaxKind) -> bool { matches!(kind, CSS_MEDIA_AND_TYPE_QUERY | CSS_MEDIA_TYPE_QUERY) }

	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_MEDIA_AND_TYPE_QUERY => AnyCssMediaTypeQuery::CssMediaAndTypeQuery(CssMediaAndTypeQuery { syntax }),

			CSS_MEDIA_TYPE_QUERY => AnyCssMediaTypeQuery::CssMediaTypeQuery(CssMediaTypeQuery { syntax }),
...
impl AstNode for AnyCssNamespacePrefix {
	...
	fn can_cast(kind:SyntaxKind) -> bool { matches!(kind, CSS_NAMED_NAMESPACE_PREFIX | CSS_UNIVERSAL_NAMESPACE_PREFIX) }
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			...
			CSS_UNIVERSAL_NAMESPACE_PREFIX => {
				AnyCssNamespacePrefix::CssUniversalNamespacePrefix(CssUniversalNamespacePrefix { syntax })
			},
...
impl From<CssString> for AnyCssNamespaceUrl {
	fn from(node:CssString) -> AnyCssNamespaceUrl { AnyCssNamespaceUrl::CssString(node) }
}
impl From<CssUrlFunction> for AnyCssNamespaceUrl {
	fn from(node:CssUrlFunction) -> AnyCssNamespaceUrl { AnyCssNamespaceUrl::CssUrlFunction(node) }
}
...
impl From<CssBogusBlock> for AnyCssPageAtRuleBlock {
	fn from(node:CssBogusBlock) -> AnyCssPageAtRuleBlock { AnyCssPageAtRuleBlock::CssBogusBlock(node) }
}
impl From<CssPageAtRuleBlock> for AnyCssPageAtRuleBlock {
	fn from(node:CssPageAtRuleBlock) -> AnyCssPageAtRuleBlock { AnyCssPageAtRuleBlock::CssPageAtRuleBlock(node) }
}
impl AstNode for AnyCssPageAtRuleBlock {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = CssBogusBlock::KIND_SET.union(CssPageAtRuleBlock::KIND_SET);

	fn can_cast(kind:SyntaxKind) -> bool { matches!(kind, CSS_BOGUS_BLOCK | CSS_PAGE_AT_RULE_BLOCK) }

	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_BOGUS_BLOCK => AnyCssPageAtRuleBlock::CssBogusBlock(CssBogusBlock { syntax }),
			CSS_PAGE_AT_RULE_BLOCK => AnyCssPageAtRuleBlock::CssPageAtRuleBlock(CssPageAtRuleBlock { syntax }),
...
impl From<CssAtRule> for AnyCssPageAtRuleItem {
	fn from(node:CssAtRule) -> AnyCssPageAtRuleItem { AnyCssPageAtRuleItem::CssAtRule(node) }
}
...
impl From<CssMarginAtRule> for AnyCssPageAtRuleItem {
	fn from(node:CssMarginAtRule) -> AnyCssPageAtRuleItem { AnyCssPageAtRuleItem::CssMarginAtRule(node) }
}
impl AstNode for AnyCssPageAtRuleItem {
	...
	fn can_cast(kind:SyntaxKind) -> bool {
		matches!(kind, CSS_AT_RULE | CSS_DECLARATION_WITH_SEMICOLON | CSS_MARGIN_AT_RULE)
	}
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			...
			CSS_DECLARATION_WITH_SEMICOLON => {
				AnyCssPageAtRuleItem::CssDeclarationWithSemicolon(CssDeclarationWithSemicolon { syntax })
			},
...
impl From<CssBogusSelector> for AnyCssPageSelector {
	fn from(node:CssBogusSelector) -> AnyCssPageSelector { AnyCssPageSelector::CssBogusSelector(node) }
}
impl From<CssPageSelector> for AnyCssPageSelector {
	fn from(node:CssPageSelector) -> AnyCssPageSelector { AnyCssPageSelector::CssPageSelector(node) }
}
impl AstNode for AnyCssPageSelector {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = CssBogusSelector::KIND_SET.union(CssPageSelector::KIND_SET);

	fn can_cast(kind:SyntaxKind) -> bool { matches!(kind, CSS_BOGUS_SELECTOR | CSS_PAGE_SELECTOR) }
...
impl AstNode for AnyCssPageSelectorPseudo {
	...
	fn can_cast(kind:SyntaxKind) -> bool { matches!(kind, CSS_BOGUS_PAGE_SELECTOR_PSEUDO | CSS_PAGE_SELECTOR_PSEUDO) }

	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_BOGUS_PAGE_SELECTOR_PSEUDO => {
				AnyCssPageSelectorPseudo::CssBogusPageSelectorPseudo(CssBogusPageSelectorPseudo { syntax })
			},
...
impl From<CssBogusProperty> for AnyCssProperty {
	fn from(node:CssBogusProperty) -> AnyCssProperty { AnyCssProperty::CssBogusProperty(node) }
}
impl From<CssComposesProperty> for AnyCssProperty {
	fn from(node:CssComposesProperty) -> AnyCssProperty { AnyCssProperty::CssComposesProperty(node) }
}
impl From<CssGenericProperty> for AnyCssProperty {
	fn from(node:CssGenericProperty) -> AnyCssProperty { AnyCssProperty::CssGenericProperty(node) }
}
impl AstNode for AnyCssProperty {
	...
	fn can_cast(kind:SyntaxKind) -> bool {
		matches!(kind, CSS_BOGUS_PROPERTY | CSS_COMPOSES_PROPERTY | CSS_GENERIC_PROPERTY)
	}

	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_BOGUS_PROPERTY => AnyCssProperty::CssBogusProperty(CssBogusProperty { syntax }),
			CSS_COMPOSES_PROPERTY => AnyCssProperty::CssComposesProperty(CssComposesProperty { syntax }),

			CSS_GENERIC_PROPERTY => AnyCssProperty::CssGenericProperty(CssGenericProperty { syntax }),
...
impl From<CssBogusPseudoClass> for AnyCssPseudoClass {
	fn from(node:CssBogusPseudoClass) -> AnyCssPseudoClass { AnyCssPseudoClass::CssBogusPseudoClass(node) }
}
...
impl From<CssPseudoClassFunctionNth> for AnyCssPseudoClass {
	fn from(node:CssPseudoClassFunctionNth) -> AnyCssPseudoClass { AnyCssPseudoClass::CssPseudoClassFunctionNth(node) }
}
...
impl From<CssPseudoClassIdentifier> for AnyCssPseudoClass {
	fn from(node:CssPseudoClassIdentifier) -> AnyCssPseudoClass { AnyCssPseudoClass::CssPseudoClassIdentifier(node) }
}
impl AstNode for AnyCssPseudoClass {
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_BOGUS_PSEUDO_CLASS => AnyCssPseudoClass::CssBogusPseudoClass(CssBogusPseudoClass { syntax }),

			CSS_PSEUDO_CLASS_FUNCTION_COMPOUND_SELECTOR => {
				AnyCssPseudoClass::CssPseudoClassFunctionCompoundSelector(CssPseudoClassFunctionCompoundSelector {
					syntax,
				})
			},
			...
			CSS_PSEUDO_CLASS_FUNCTION_IDENTIFIER => {
				AnyCssPseudoClass::CssPseudoClassFunctionIdentifier(CssPseudoClassFunctionIdentifier { syntax })
			},
			...
			CSS_PSEUDO_CLASS_FUNCTION_SELECTOR => {
				AnyCssPseudoClass::CssPseudoClassFunctionSelector(CssPseudoClassFunctionSelector { syntax })
			},

			CSS_PSEUDO_CLASS_FUNCTION_SELECTOR_LIST => {
				AnyCssPseudoClass::CssPseudoClassFunctionSelectorList(CssPseudoClassFunctionSelectorList { syntax })
			},

			CSS_PSEUDO_CLASS_FUNCTION_VALUE_LIST => {
				AnyCssPseudoClass::CssPseudoClassFunctionValueList(CssPseudoClassFunctionValueList { syntax })
			},
...
impl std::fmt::Debug for AnyCssPseudoClass {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		match self {
			...
			AnyCssPseudoClass::CssPseudoClassFunctionCompoundSelector(it) => std::fmt::Debug::fmt(it, f),

			AnyCssPseudoClass::CssPseudoClassFunctionCompoundSelectorList(it) => std::fmt::Debug::fmt(it, f),
			...
			AnyCssPseudoClass::CssPseudoClassFunctionRelativeSelectorList(it) => std::fmt::Debug::fmt(it, f),

			AnyCssPseudoClass::CssPseudoClassFunctionSelector(it) => std::fmt::Debug::fmt(it, f),
			AnyCssPseudoClass::CssPseudoClassFunctionSelectorList(it) => std::fmt::Debug::fmt(it, f),
...
impl From<CssPseudoClassNth> for AnyCssPseudoClassNth {
	fn from(node:CssPseudoClassNth) -> AnyCssPseudoClassNth { AnyCssPseudoClassNth::CssPseudoClassNth(node) }
}
...
impl AstNode for AnyCssPseudoClassNth {
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_PSEUDO_CLASS_NTH => AnyCssPseudoClassNth::CssPseudoClassNth(CssPseudoClassNth { syntax }),

			CSS_PSEUDO_CLASS_NTH_IDENTIFIER => {
				AnyCssPseudoClassNth::CssPseudoClassNthIdentifier(CssPseudoClassNthIdentifier { syntax })
			},
...
impl AstNode for AnyCssPseudoClassNthSelector {
	...
	const KIND_SET:SyntaxKindSet<Language> = CssBogusSelector::KIND_SET.union(CssPseudoClassNthSelector::KIND_SET);

	fn can_cast(kind:SyntaxKind) -> bool { matches!(kind, CSS_BOGUS_SELECTOR | CSS_PSEUDO_CLASS_NTH_SELECTOR) }

	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_BOGUS_SELECTOR => AnyCssPseudoClassNthSelector::CssBogusSelector(CssBogusSelector { syntax }),

			CSS_PSEUDO_CLASS_NTH_SELECTOR => {
				AnyCssPseudoClassNthSelector::CssPseudoClassNthSelector(CssPseudoClassNthSelector { syntax })
			},
...
impl std::fmt::Debug for AnyCssPseudoClassNthSelector {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		match self {
			...
			AnyCssPseudoClassNthSelector::CssPseudoClassNthSelector(it) => std::fmt::Debug::fmt(it, f),
		}
	}
}
...
impl From<CssBogusPseudoElement> for AnyCssPseudoElement {
	fn from(node:CssBogusPseudoElement) -> AnyCssPseudoElement { AnyCssPseudoElement::CssBogusPseudoElement(node) }
}
...
impl AstNode for AnyCssPseudoElement {
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_BOGUS_PSEUDO_ELEMENT => AnyCssPseudoElement::CssBogusPseudoElement(CssBogusPseudoElement { syntax }),

			CSS_PSEUDO_ELEMENT_FUNCTION_IDENTIFIER => {
				AnyCssPseudoElement::CssPseudoElementFunctionIdentifier(CssPseudoElementFunctionIdentifier { syntax })
			},

			CSS_PSEUDO_ELEMENT_FUNCTION_SELECTOR => {
				AnyCssPseudoElement::CssPseudoElementFunctionSelector(CssPseudoElementFunctionSelector { syntax })
			},

			CSS_PSEUDO_ELEMENT_IDENTIFIER => {
				AnyCssPseudoElement::CssPseudoElementIdentifier(CssPseudoElementIdentifier { syntax })
			},
...
impl std::fmt::Debug for AnyCssPseudoElement {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		match self {
			...
			AnyCssPseudoElement::CssPseudoElementFunctionIdentifier(it) => std::fmt::Debug::fmt(it, f),

			AnyCssPseudoElement::CssPseudoElementFunctionSelector(it) => std::fmt::Debug::fmt(it, f),
...
impl From<CssIdentifier> for AnyCssPseudoValue {
	fn from(node:CssIdentifier) -> AnyCssPseudoValue { AnyCssPseudoValue::CssIdentifier(node) }
}
impl From<CssString> for AnyCssPseudoValue {
	fn from(node:CssString) -> AnyCssPseudoValue { AnyCssPseudoValue::CssString(node) }
}
...
impl From<CssQueryFeatureBoolean> for AnyCssQueryFeature {
	fn from(node:CssQueryFeatureBoolean) -> AnyCssQueryFeature { AnyCssQueryFeature::CssQueryFeatureBoolean(node) }
}
impl From<CssQueryFeaturePlain> for AnyCssQueryFeature {
	fn from(node:CssQueryFeaturePlain) -> AnyCssQueryFeature { AnyCssQueryFeature::CssQueryFeaturePlain(node) }
}
impl From<CssQueryFeatureRange> for AnyCssQueryFeature {
	fn from(node:CssQueryFeatureRange) -> AnyCssQueryFeature { AnyCssQueryFeature::CssQueryFeatureRange(node) }
}
...
impl AstNode for AnyCssQueryFeature {
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_QUERY_FEATURE_BOOLEAN => AnyCssQueryFeature::CssQueryFeatureBoolean(CssQueryFeatureBoolean { syntax }),

			CSS_QUERY_FEATURE_PLAIN => AnyCssQueryFeature::CssQueryFeaturePlain(CssQueryFeaturePlain { syntax }),

			CSS_QUERY_FEATURE_RANGE => AnyCssQueryFeature::CssQueryFeatureRange(CssQueryFeatureRange { syntax }),

			CSS_QUERY_FEATURE_RANGE_INTERVAL => {
				AnyCssQueryFeature::CssQueryFeatureRangeInterval(CssQueryFeatureRangeInterval { syntax })
			},

			CSS_QUERY_FEATURE_REVERSE_RANGE => {
				AnyCssQueryFeature::CssQueryFeatureReverseRange(CssQueryFeatureReverseRange { syntax })
			},
...
impl From<CssIdentifier> for AnyCssQueryFeatureValue {
	fn from(node:CssIdentifier) -> AnyCssQueryFeatureValue { AnyCssQueryFeatureValue::CssIdentifier(node) }
}
impl From<CssNumber> for AnyCssQueryFeatureValue {
	fn from(node:CssNumber) -> AnyCssQueryFeatureValue { AnyCssQueryFeatureValue::CssNumber(node) }
}
impl From<CssRatio> for AnyCssQueryFeatureValue {
	fn from(node:CssRatio) -> AnyCssQueryFeatureValue { AnyCssQueryFeatureValue::CssRatio(node) }
}
...
impl From<CssBogusSelector> for AnyCssRelativeSelector {
	fn from(node:CssBogusSelector) -> AnyCssRelativeSelector { AnyCssRelativeSelector::CssBogusSelector(node) }
}
impl From<CssRelativeSelector> for AnyCssRelativeSelector {
	fn from(node:CssRelativeSelector) -> AnyCssRelativeSelector { AnyCssRelativeSelector::CssRelativeSelector(node) }
}
impl AstNode for AnyCssRelativeSelector {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = CssBogusSelector::KIND_SET.union(CssRelativeSelector::KIND_SET);

	fn can_cast(kind:SyntaxKind) -> bool { matches!(kind, CSS_BOGUS_SELECTOR | CSS_RELATIVE_SELECTOR) }

	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_BOGUS_SELECTOR => AnyCssRelativeSelector::CssBogusSelector(CssBogusSelector { syntax }),

			CSS_RELATIVE_SELECTOR => AnyCssRelativeSelector::CssRelativeSelector(CssRelativeSelector { syntax }),
...
impl From<CssAtRule> for AnyCssRule {
	fn from(node:CssAtRule) -> AnyCssRule { AnyCssRule::CssAtRule(node) }
}
impl From<CssBogusRule> for AnyCssRule {
	fn from(node:CssBogusRule) -> AnyCssRule { AnyCssRule::CssBogusRule(node) }
}
impl From<CssNestedQualifiedRule> for AnyCssRule {
	fn from(node:CssNestedQualifiedRule) -> AnyCssRule { AnyCssRule::CssNestedQualifiedRule(node) }
}
impl From<CssQualifiedRule> for AnyCssRule {
	fn from(node:CssQualifiedRule) -> AnyCssRule { AnyCssRule::CssQualifiedRule(node) }
}
impl AstNode for AnyCssRule {
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			...
			CSS_NESTED_QUALIFIED_RULE => AnyCssRule::CssNestedQualifiedRule(CssNestedQualifiedRule { syntax }),
...
impl From<CssBogusBlock> for AnyCssRuleBlock {
	fn from(node:CssBogusBlock) -> AnyCssRuleBlock { AnyCssRuleBlock::CssBogusBlock(node) }
}
impl From<CssRuleBlock> for AnyCssRuleBlock {
	fn from(node:CssRuleBlock) -> AnyCssRuleBlock { AnyCssRuleBlock::CssRuleBlock(node) }
}
impl AstNode for AnyCssRuleBlock {
	...
	fn can_cast(kind:SyntaxKind) -> bool { matches!(kind, CSS_BOGUS_BLOCK | CSS_RULE_BLOCK) }
...
impl From<CssBogusScopeRange> for AnyCssScopeRange {
	fn from(node:CssBogusScopeRange) -> AnyCssScopeRange { AnyCssScopeRange::CssBogusScopeRange(node) }
}
impl From<CssScopeRangeEnd> for AnyCssScopeRange {
	fn from(node:CssScopeRangeEnd) -> AnyCssScopeRange { AnyCssScopeRange::CssScopeRangeEnd(node) }
}
impl From<CssScopeRangeInterval> for AnyCssScopeRange {
	fn from(node:CssScopeRangeInterval) -> AnyCssScopeRange { AnyCssScopeRange::CssScopeRangeInterval(node) }
}
impl From<CssScopeRangeStart> for AnyCssScopeRange {
	fn from(node:CssScopeRangeStart) -> AnyCssScopeRange { AnyCssScopeRange::CssScopeRangeStart(node) }
}
impl AstNode for AnyCssScopeRange {
	...
	fn can_cast(kind:SyntaxKind) -> bool {
		matches!(
			kind,
			CSS_BOGUS_SCOPE_RANGE | CSS_SCOPE_RANGE_END | CSS_SCOPE_RANGE_INTERVAL | CSS_SCOPE_RANGE_START
		)
	}

	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_BOGUS_SCOPE_RANGE => AnyCssScopeRange::CssBogusScopeRange(CssBogusScopeRange { syntax }),

			CSS_SCOPE_RANGE_END => AnyCssScopeRange::CssScopeRangeEnd(CssScopeRangeEnd { syntax }),
			CSS_SCOPE_RANGE_INTERVAL => AnyCssScopeRange::CssScopeRangeInterval(CssScopeRangeInterval { syntax }),

			CSS_SCOPE_RANGE_START => AnyCssScopeRange::CssScopeRangeStart(CssScopeRangeStart { syntax }),
...
impl From<CssBogusSelector> for AnyCssSelector {
	fn from(node:CssBogusSelector) -> AnyCssSelector { AnyCssSelector::CssBogusSelector(node) }
}
impl From<CssComplexSelector> for AnyCssSelector {
	fn from(node:CssComplexSelector) -> AnyCssSelector { AnyCssSelector::CssComplexSelector(node) }
}
impl From<CssCompoundSelector> for AnyCssSelector {
	fn from(node:CssCompoundSelector) -> AnyCssSelector { AnyCssSelector::CssCompoundSelector(node) }
}
impl From<CssMetavariable> for AnyCssSelector {
	fn from(node:CssMetavariable) -> AnyCssSelector { AnyCssSelector::CssMetavariable(node) }
}
impl AstNode for AnyCssSelector {
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			...
			CSS_COMPLEX_SELECTOR => AnyCssSelector::CssComplexSelector(CssComplexSelector { syntax }),

			CSS_COMPOUND_SELECTOR => AnyCssSelector::CssCompoundSelector(CssCompoundSelector { syntax }),
...
impl From<CssTypeSelector> for AnyCssSimpleSelector {
	fn from(node:CssTypeSelector) -> AnyCssSimpleSelector { AnyCssSimpleSelector::CssTypeSelector(node) }
}
impl From<CssUniversalSelector> for AnyCssSimpleSelector {
	fn from(node:CssUniversalSelector) -> AnyCssSimpleSelector { AnyCssSimpleSelector::CssUniversalSelector(node) }
}
impl AstNode for AnyCssSimpleSelector {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = CssTypeSelector::KIND_SET.union(CssUniversalSelector::KIND_SET);

	fn can_cast(kind:SyntaxKind) -> bool { matches!(kind, CSS_TYPE_SELECTOR | CSS_UNIVERSAL_SELECTOR) }

	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_TYPE_SELECTOR => AnyCssSimpleSelector::CssTypeSelector(CssTypeSelector { syntax }),
			CSS_UNIVERSAL_SELECTOR => AnyCssSimpleSelector::CssUniversalSelector(CssUniversalSelector { syntax }),
...
impl From<CssBogusBlock> for AnyCssStartingStyleBlock {
	fn from(node:CssBogusBlock) -> AnyCssStartingStyleBlock { AnyCssStartingStyleBlock::CssBogusBlock(node) }
}
...
impl From<CssRuleBlock> for AnyCssStartingStyleBlock {
	fn from(node:CssRuleBlock) -> AnyCssStartingStyleBlock { AnyCssStartingStyleBlock::CssRuleBlock(node) }
}
impl AstNode for AnyCssStartingStyleBlock {
	...
	fn can_cast(kind:SyntaxKind) -> bool { matches!(kind, CSS_BOGUS_BLOCK | CSS_DECLARATION_BLOCK | CSS_RULE_BLOCK) }

	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_BOGUS_BLOCK => AnyCssStartingStyleBlock::CssBogusBlock(CssBogusBlock { syntax }),
			CSS_DECLARATION_BLOCK => AnyCssStartingStyleBlock::CssDeclarationBlock(CssDeclarationBlock { syntax }),
...
impl From<CssAttributeSelector> for AnyCssSubSelector {
	fn from(node:CssAttributeSelector) -> AnyCssSubSelector { AnyCssSubSelector::CssAttributeSelector(node) }
}
impl From<CssBogusSubSelector> for AnyCssSubSelector {
	fn from(node:CssBogusSubSelector) -> AnyCssSubSelector { AnyCssSubSelector::CssBogusSubSelector(node) }
}
impl From<CssClassSelector> for AnyCssSubSelector {
	fn from(node:CssClassSelector) -> AnyCssSubSelector { AnyCssSubSelector::CssClassSelector(node) }
}
impl From<CssIdSelector> for AnyCssSubSelector {
	fn from(node:CssIdSelector) -> AnyCssSubSelector { AnyCssSubSelector::CssIdSelector(node) }
}
impl From<CssPseudoClassSelector> for AnyCssSubSelector {
	fn from(node:CssPseudoClassSelector) -> AnyCssSubSelector { AnyCssSubSelector::CssPseudoClassSelector(node) }
}
impl From<CssPseudoElementSelector> for AnyCssSubSelector {
	fn from(node:CssPseudoElementSelector) -> AnyCssSubSelector { AnyCssSubSelector::CssPseudoElementSelector(node) }
}
impl AstNode for AnyCssSubSelector {
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_ATTRIBUTE_SELECTOR => AnyCssSubSelector::CssAttributeSelector(CssAttributeSelector { syntax }),

			CSS_BOGUS_SUB_SELECTOR => AnyCssSubSelector::CssBogusSubSelector(CssBogusSubSelector { syntax }),
			...
			CSS_PSEUDO_CLASS_SELECTOR => AnyCssSubSelector::CssPseudoClassSelector(CssPseudoClassSelector { syntax }),
...
impl AstNode for AnyCssSupportsAndCombinableCondition {
	...
	const KIND_SET:SyntaxKindSet<Language> = AnyCssSupportsInParens::KIND_SET.union(CssSupportsAndCondition::KIND_SET);
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_SUPPORTS_AND_CONDITION => {
				AnyCssSupportsAndCombinableCondition::CssSupportsAndCondition(CssSupportsAndCondition { syntax })
			},

			_ => {
				if let Some(any_css_supports_in_parens) = AnyCssSupportsInParens::cast(syntax) {
					return Some(AnyCssSupportsAndCombinableCondition::AnyCssSupportsInParens(
...
impl std::fmt::Debug for AnyCssSupportsAndCombinableCondition {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		match self {
			AnyCssSupportsAndCombinableCondition::AnyCssSupportsInParens(it) => std::fmt::Debug::fmt(it, f),

			AnyCssSupportsAndCombinableCondition::CssSupportsAndCondition(it) => std::fmt::Debug::fmt(it, f),
		}
	}
}
...
impl AstNode for AnyCssSupportsCondition {
	...
	fn can_cast(kind:SyntaxKind) -> bool {
		match kind {
			CSS_SUPPORTS_AND_CONDITION | CSS_SUPPORTS_NOT_CONDITION | CSS_SUPPORTS_OR_CONDITION => true,
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			...
			_ => {
				if let Some(any_css_supports_in_parens) = AnyCssSupportsInParens::cast(syntax) {
					return Some(AnyCssSupportsCondition::AnyCssSupportsInParens(any_css_supports_in_parens));
				}
...
impl From<CssFunction> for AnyCssSupportsInParens {
	fn from(node:CssFunction) -> AnyCssSupportsInParens { AnyCssSupportsInParens::CssFunction(node) }
}
...
impl AstNode for AnyCssSupportsInParens {
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			...
			CSS_SUPPORTS_CONDITION_IN_PARENS => {
				AnyCssSupportsInParens::CssSupportsConditionInParens(CssSupportsConditionInParens { syntax })
			},

			CSS_SUPPORTS_FEATURE_DECLARATION => {
				AnyCssSupportsInParens::CssSupportsFeatureDeclaration(CssSupportsFeatureDeclaration { syntax })
			},

			CSS_SUPPORTS_FEATURE_SELECTOR => {
				AnyCssSupportsInParens::CssSupportsFeatureSelector(CssSupportsFeatureSelector { syntax })
			},
...
impl std::fmt::Debug for AnyCssSupportsInParens {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		match self {
			...
			AnyCssSupportsInParens::CssSupportsFeatureDeclaration(it) => std::fmt::Debug::fmt(it, f),
...
impl AstNode for AnyCssSupportsOrCombinableCondition {
	...
	const KIND_SET:SyntaxKindSet<Language> = AnyCssSupportsInParens::KIND_SET.union(CssSupportsOrCondition::KIND_SET);
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_SUPPORTS_OR_CONDITION => {
				AnyCssSupportsOrCombinableCondition::CssSupportsOrCondition(CssSupportsOrCondition { syntax })
			},
...
impl std::fmt::Debug for AnyCssSupportsOrCombinableCondition {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		match self {
			AnyCssSupportsOrCombinableCondition::AnyCssSupportsInParens(it) => std::fmt::Debug::fmt(it, f),

			AnyCssSupportsOrCombinableCondition::CssSupportsOrCondition(it) => std::fmt::Debug::fmt(it, f),
		}
	}
}
...
impl From<CssUnicodeCodepoint> for AnyCssUnicodeValue {
	fn from(node:CssUnicodeCodepoint) -> AnyCssUnicodeValue { AnyCssUnicodeValue::CssUnicodeCodepoint(node) }
}
impl From<CssUnicodeRangeInterval> for AnyCssUnicodeValue {
	fn from(node:CssUnicodeRangeInterval) -> AnyCssUnicodeValue { AnyCssUnicodeValue::CssUnicodeRangeInterval(node) }
}
impl From<CssUnicodeRangeWildcard> for AnyCssUnicodeValue {
	fn from(node:CssUnicodeRangeWildcard) -> AnyCssUnicodeValue { AnyCssUnicodeValue::CssUnicodeRangeWildcard(node) }
}
impl AstNode for AnyCssUnicodeValue {
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			...
			CSS_UNICODE_CODEPOINT => AnyCssUnicodeValue::CssUnicodeCodepoint(CssUnicodeCodepoint { syntax }),
...
impl From<CssBogusUrlModifier> for AnyCssUrlModifier {
	fn from(node:CssBogusUrlModifier) -> AnyCssUrlModifier { AnyCssUrlModifier::CssBogusUrlModifier(node) }
}
impl From<CssFunction> for AnyCssUrlModifier {
	fn from(node:CssFunction) -> AnyCssUrlModifier { AnyCssUrlModifier::CssFunction(node) }
}
impl From<CssIdentifier> for AnyCssUrlModifier {
	fn from(node:CssIdentifier) -> AnyCssUrlModifier { AnyCssUrlModifier::CssIdentifier(node) }
}
impl AstNode for AnyCssUrlModifier {
	...
	fn can_cast(kind:SyntaxKind) -> bool { matches!(kind, CSS_BOGUS_URL_MODIFIER | CSS_FUNCTION | CSS_IDENTIFIER) }

	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_BOGUS_URL_MODIFIER => AnyCssUrlModifier::CssBogusUrlModifier(CssBogusUrlModifier { syntax }),
...
impl From<CssString> for AnyCssUrlValue {
	fn from(node:CssString) -> AnyCssUrlValue { AnyCssUrlValue::CssString(node) }
}
impl From<CssUrlValueRaw> for AnyCssUrlValue {
	fn from(node:CssUrlValueRaw) -> AnyCssUrlValue { AnyCssUrlValue::CssUrlValueRaw(node) }
}
impl AstNode for AnyCssUrlValue {
	...
	fn can_cast(kind:SyntaxKind) -> bool { matches!(kind, CSS_STRING | CSS_URL_VALUE_RAW) }
...
impl From<CssBracketedValue> for AnyCssValue {
	fn from(node:CssBracketedValue) -> AnyCssValue { AnyCssValue::CssBracketedValue(node) }
}
impl From<CssColor> for AnyCssValue {
	fn from(node:CssColor) -> AnyCssValue { AnyCssValue::CssColor(node) }
}
impl From<CssCustomIdentifier> for AnyCssValue {
	fn from(node:CssCustomIdentifier) -> AnyCssValue { AnyCssValue::CssCustomIdentifier(node) }
}
impl From<CssDashedIdentifier> for AnyCssValue {
	fn from(node:CssDashedIdentifier) -> AnyCssValue { AnyCssValue::CssDashedIdentifier(node) }
}
...
impl From<CssMetavariable> for AnyCssValue {
	fn from(node:CssMetavariable) -> AnyCssValue { AnyCssValue::CssMetavariable(node) }
}
...
impl From<CssUnicodeRange> for AnyCssValue {
	fn from(node:CssUnicodeRange) -> AnyCssValue { AnyCssValue::CssUnicodeRange(node) }
}
impl AstNode for AnyCssValue {
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			...
			CSS_CUSTOM_IDENTIFIER => AnyCssValue::CssCustomIdentifier(CssCustomIdentifier { syntax }),

			CSS_DASHED_IDENTIFIER => AnyCssValue::CssDashedIdentifier(CssDashedIdentifier { syntax }),
...
impl AstNode for AnyCssValueAtRuleClause {
	...
	fn can_cast(kind:SyntaxKind) -> bool {
		matches!(kind, CSS_VALUE_AT_RULE_DECLARATION_CLAUSE | CSS_VALUE_AT_RULE_IMPORT_CLAUSE)
	}

	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_VALUE_AT_RULE_DECLARATION_CLAUSE => {
				AnyCssValueAtRuleClause::CssValueAtRuleDeclarationClause(CssValueAtRuleDeclarationClause { syntax })
			},

			CSS_VALUE_AT_RULE_IMPORT_CLAUSE => {
				AnyCssValueAtRuleClause::CssValueAtRuleImportClause(CssValueAtRuleImportClause { syntax })
			},
...
impl std::fmt::Debug for AnyCssValueAtRuleClause {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		match self {
			AnyCssValueAtRuleClause::CssValueAtRuleDeclarationClause(it) => std::fmt::Debug::fmt(it, f),
...
impl From<CssIdentifier> for AnyCssValueAtRuleImportSource {
	fn from(node:CssIdentifier) -> AnyCssValueAtRuleImportSource { AnyCssValueAtRuleImportSource::CssIdentifier(node) }
}
impl From<CssString> for AnyCssValueAtRuleImportSource {
	fn from(node:CssString) -> AnyCssValueAtRuleImportSource { AnyCssValueAtRuleImportSource::CssString(node) }
}
impl AstNode for AnyCssValueAtRuleImportSource {
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_IDENTIFIER => AnyCssValueAtRuleImportSource::CssIdentifier(CssIdentifier { syntax }),
	...
	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_VALUE_AT_RULE_IMPORT_SPECIFIER => {
				AnyCssValueAtRuleImportSpecifier::CssValueAtRuleImportSpecifier(CssValueAtRuleImportSpecifier {
					syntax,
				})
			},
...
impl std::fmt::Debug for AnyCssValueAtRuleImportSpecifier {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		match self {
			AnyCssValueAtRuleImportSpecifier::CssValueAtRuleImportSpecifier(it) => std::fmt::Debug::fmt(it, f),

			AnyCssValueAtRuleImportSpecifier::CssValueAtRuleNamedImportSpecifier(it) => std::fmt::Debug::fmt(it, f),
		}
	}
}
...
impl From<CssBogusProperty> for AnyCssValueAtRuleProperty {
	fn from(node:CssBogusProperty) -> AnyCssValueAtRuleProperty { AnyCssValueAtRuleProperty::CssBogusProperty(node) }
}
...
impl AstNode for AnyCssValueAtRuleProperty {
	...
	const KIND_SET:SyntaxKindSet<Language> = CssBogusProperty::KIND_SET.union(CssValueAtRuleGenericProperty::KIND_SET);

	fn can_cast(kind:SyntaxKind) -> bool { matches!(kind, CSS_BOGUS_PROPERTY | CSS_VALUE_AT_RULE_GENERIC_PROPERTY) }

	fn cast(syntax:SyntaxNode) -> Option<Self> {
		let res = match syntax.kind() {
			CSS_BOGUS_PROPERTY => AnyCssValueAtRuleProperty::CssBogusProperty(CssBogusProperty { syntax }),

			CSS_VALUE_AT_RULE_GENERIC_PROPERTY => {
				AnyCssValueAtRuleProperty::CssValueAtRuleGenericProperty(CssValueAtRuleGenericProperty { syntax })
			},
...
impl std::fmt::Debug for AnyCssValueAtRuleProperty {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		match self {
			...
			AnyCssValueAtRuleProperty::CssValueAtRuleGenericProperty(it) => std::fmt::Debug::fmt(it, f),
		}
	}
}
...
impl AstNode for CssBogus {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_BOGUS as u16));
...
impl AstNode for CssBogusAtRule {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_BOGUS_AT_RULE as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_BOGUS_AT_RULE }
...
impl From<CssBogusAtRule> for SyntaxNode {
	fn from(n:CssBogusAtRule) -> SyntaxNode { n.syntax }
}
impl From<CssBogusAtRule> for SyntaxElement {
	fn from(n:CssBogusAtRule) -> SyntaxElement { n.syntax.into() }
}
#[derive(Clone, PartialEq, Eq, Hash, Serialize)]
...
impl AstNode for CssBogusBlock {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_BOGUS_BLOCK as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_BOGUS_BLOCK }
...
impl From<CssBogusBlock> for SyntaxNode {
	fn from(n:CssBogusBlock) -> SyntaxNode { n.syntax }
}
impl From<CssBogusBlock> for SyntaxElement {
	fn from(n:CssBogusBlock) -> SyntaxElement { n.syntax.into() }
}
#[derive(Clone, PartialEq, Eq, Hash, Serialize)]
...
impl AstNode for CssBogusCustomIdentifier {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_BOGUS_CUSTOM_IDENTIFIER as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_BOGUS_CUSTOM_IDENTIFIER }
...
impl From<CssBogusCustomIdentifier> for SyntaxNode {
	fn from(n:CssBogusCustomIdentifier) -> SyntaxNode { n.syntax }
}
impl From<CssBogusCustomIdentifier> for SyntaxElement {
	fn from(n:CssBogusCustomIdentifier) -> SyntaxElement { n.syntax.into() }
}
#[derive(Clone, PartialEq, Eq, Hash, Serialize)]
...
impl AstNode for CssBogusDeclarationItem {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_BOGUS_DECLARATION_ITEM as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_BOGUS_DECLARATION_ITEM }
...
impl From<CssBogusDeclarationItem> for SyntaxNode {
	fn from(n:CssBogusDeclarationItem) -> SyntaxNode { n.syntax }
}
impl From<CssBogusDeclarationItem> for SyntaxElement {
	fn from(n:CssBogusDeclarationItem) -> SyntaxElement { n.syntax.into() }
}
#[derive(Clone, PartialEq, Eq, Hash, Serialize)]
...
impl AstNode for CssBogusDocumentMatcher {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_BOGUS_DOCUMENT_MATCHER as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_BOGUS_DOCUMENT_MATCHER }
...
impl From<CssBogusDocumentMatcher> for SyntaxNode {
	fn from(n:CssBogusDocumentMatcher) -> SyntaxNode { n.syntax }
}
impl From<CssBogusDocumentMatcher> for SyntaxElement {
	fn from(n:CssBogusDocumentMatcher) -> SyntaxElement { n.syntax.into() }
}
#[derive(Clone, PartialEq, Eq, Hash, Serialize)]
...
impl AstNode for CssBogusFontFamilyName {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_BOGUS_FONT_FAMILY_NAME as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_BOGUS_FONT_FAMILY_NAME }
...
impl From<CssBogusFontFamilyName> for SyntaxNode {
	fn from(n:CssBogusFontFamilyName) -> SyntaxNode { n.syntax }
}
impl From<CssBogusFontFamilyName> for SyntaxElement {
	fn from(n:CssBogusFontFamilyName) -> SyntaxElement { n.syntax.into() }
}
#[derive(Clone, PartialEq, Eq, Hash, Serialize)]
...
impl AstNode for CssBogusFontFeatureValuesItem {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_BOGUS_FONT_FEATURE_VALUES_ITEM }
...
impl From<CssBogusFontFeatureValuesItem> for SyntaxNode {
	fn from(n:CssBogusFontFeatureValuesItem) -> SyntaxNode { n.syntax }
}
impl From<CssBogusFontFeatureValuesItem> for SyntaxElement {
	fn from(n:CssBogusFontFeatureValuesItem) -> SyntaxElement { n.syntax.into() }
}
#[derive(Clone, PartialEq, Eq, Hash, Serialize)]
...
impl AstNode for CssBogusKeyframesItem {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_BOGUS_KEYFRAMES_ITEM as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_BOGUS_KEYFRAMES_ITEM }
...
impl From<CssBogusKeyframesItem> for SyntaxNode {
	fn from(n:CssBogusKeyframesItem) -> SyntaxNode { n.syntax }
}
impl From<CssBogusKeyframesItem> for SyntaxElement {
	fn from(n:CssBogusKeyframesItem) -> SyntaxElement { n.syntax.into() }
}
#[derive(Clone, PartialEq, Eq, Hash, Serialize)]
...
impl AstNode for CssBogusKeyframesName {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_BOGUS_KEYFRAMES_NAME as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_BOGUS_KEYFRAMES_NAME }
...
impl From<CssBogusKeyframesName> for SyntaxNode {
	fn from(n:CssBogusKeyframesName) -> SyntaxNode { n.syntax }
}
impl From<CssBogusKeyframesName> for SyntaxElement {
	fn from(n:CssBogusKeyframesName) -> SyntaxElement { n.syntax.into() }
}
#[derive(Clone, PartialEq, Eq, Hash, Serialize)]
...
impl AstNode for CssBogusLayer {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_BOGUS_LAYER as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_BOGUS_LAYER }
...
impl From<CssBogusLayer> for SyntaxNode {
	fn from(n:CssBogusLayer) -> SyntaxNode { n.syntax }
}
impl From<CssBogusLayer> for SyntaxElement {
	fn from(n:CssBogusLayer) -> SyntaxElement { n.syntax.into() }
}
#[derive(Clone, PartialEq, Eq, Hash, Serialize)]
...
impl AstNode for CssBogusMediaQuery {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_BOGUS_MEDIA_QUERY as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_BOGUS_MEDIA_QUERY }
...
impl From<CssBogusMediaQuery> for SyntaxNode {
	fn from(n:CssBogusMediaQuery) -> SyntaxNode { n.syntax }
}
impl From<CssBogusMediaQuery> for SyntaxElement {
	fn from(n:CssBogusMediaQuery) -> SyntaxElement { n.syntax.into() }
}
#[derive(Clone, PartialEq, Eq, Hash, Serialize)]
...
impl AstNode for CssBogusPageSelectorPseudo {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_BOGUS_PAGE_SELECTOR_PSEUDO }
...
impl From<CssBogusPageSelectorPseudo> for SyntaxNode {
	fn from(n:CssBogusPageSelectorPseudo) -> SyntaxNode { n.syntax }
}
impl From<CssBogusPageSelectorPseudo> for SyntaxElement {
	fn from(n:CssBogusPageSelectorPseudo) -> SyntaxElement { n.syntax.into() }
}
#[derive(Clone, PartialEq, Eq, Hash, Serialize)]
...
impl AstNode for CssBogusParameter {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_BOGUS_PARAMETER as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_BOGUS_PARAMETER }
...
impl From<CssBogusParameter> for SyntaxNode {
	fn from(n:CssBogusParameter) -> SyntaxNode { n.syntax }
}
impl From<CssBogusParameter> for SyntaxElement {
	fn from(n:CssBogusParameter) -> SyntaxElement { n.syntax.into() }
}
#[derive(Clone, PartialEq, Eq, Hash, Serialize)]
...
impl AstNode for CssBogusProperty {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_BOGUS_PROPERTY as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_BOGUS_PROPERTY }
...
impl From<CssBogusProperty> for SyntaxNode {
	fn from(n:CssBogusProperty) -> SyntaxNode { n.syntax }
}
impl From<CssBogusProperty> for SyntaxElement {
	fn from(n:CssBogusProperty) -> SyntaxElement { n.syntax.into() }
}
#[derive(Clone, PartialEq, Eq, Hash, Serialize)]
...
impl AstNode for CssBogusPropertyValue {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_BOGUS_PROPERTY_VALUE as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_BOGUS_PROPERTY_VALUE }
...
impl From<CssBogusPropertyValue> for SyntaxNode {
	fn from(n:CssBogusPropertyValue) -> SyntaxNode { n.syntax }
}
impl From<CssBogusPropertyValue> for SyntaxElement {
	fn from(n:CssBogusPropertyValue) -> SyntaxElement { n.syntax.into() }
}
#[derive(Clone, PartialEq, Eq, Hash, Serialize)]
...
impl AstNode for CssBogusPseudoClass {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_BOGUS_PSEUDO_CLASS as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_BOGUS_PSEUDO_CLASS }
...
impl From<CssBogusPseudoClass> for SyntaxNode {
	fn from(n:CssBogusPseudoClass) -> SyntaxNode { n.syntax }
}
impl From<CssBogusPseudoClass> for SyntaxElement {
	fn from(n:CssBogusPseudoClass) -> SyntaxElement { n.syntax.into() }
}
#[derive(Clone, PartialEq, Eq, Hash, Serialize)]
...
impl AstNode for CssBogusPseudoElement {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_BOGUS_PSEUDO_ELEMENT as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_BOGUS_PSEUDO_ELEMENT }
...
impl From<CssBogusPseudoElement> for SyntaxNode {
	fn from(n:CssBogusPseudoElement) -> SyntaxNode { n.syntax }
}
impl From<CssBogusPseudoElement> for SyntaxElement {
	fn from(n:CssBogusPseudoElement) -> SyntaxElement { n.syntax.into() }
}
#[derive(Clone, PartialEq, Eq, Hash, Serialize)]
...
impl AstNode for CssBogusRule {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_BOGUS_RULE as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_BOGUS_RULE }
...
impl From<CssBogusRule> for SyntaxNode {
	fn from(n:CssBogusRule) -> SyntaxNode { n.syntax }
}
impl From<CssBogusRule> for SyntaxElement {
	fn from(n:CssBogusRule) -> SyntaxElement { n.syntax.into() }
}
#[derive(Clone, PartialEq, Eq, Hash, Serialize)]
...
impl AstNode for CssBogusScopeRange {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_BOGUS_SCOPE_RANGE as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_BOGUS_SCOPE_RANGE }
...
impl From<CssBogusScopeRange> for SyntaxNode {
	fn from(n:CssBogusScopeRange) -> SyntaxNode { n.syntax }
}
impl From<CssBogusScopeRange> for SyntaxElement {
	fn from(n:CssBogusScopeRange) -> SyntaxElement { n.syntax.into() }
}
#[derive(Clone, PartialEq, Eq, Hash, Serialize)]
...
impl AstNode for CssBogusSelector {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_BOGUS_SELECTOR as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_BOGUS_SELECTOR }
...
impl From<CssBogusSelector> for SyntaxNode {
	fn from(n:CssBogusSelector) -> SyntaxNode { n.syntax }
}
impl From<CssBogusSelector> for SyntaxElement {
	fn from(n:CssBogusSelector) -> SyntaxElement { n.syntax.into() }
}
#[derive(Clone, PartialEq, Eq, Hash, Serialize)]
...
impl AstNode for CssBogusSubSelector {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_BOGUS_SUB_SELECTOR as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_BOGUS_SUB_SELECTOR }
...
impl From<CssBogusSubSelector> for SyntaxNode {
	fn from(n:CssBogusSubSelector) -> SyntaxNode { n.syntax }
}
impl From<CssBogusSubSelector> for SyntaxElement {
	fn from(n:CssBogusSubSelector) -> SyntaxElement { n.syntax.into() }
}
#[derive(Clone, PartialEq, Eq, Hash, Serialize)]
...
impl AstNode for CssBogusUnicodeRangeValue {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_BOGUS_UNICODE_RANGE_VALUE }
...
impl From<CssBogusUnicodeRangeValue> for SyntaxNode {
	fn from(n:CssBogusUnicodeRangeValue) -> SyntaxNode { n.syntax }
}
impl From<CssBogusUnicodeRangeValue> for SyntaxElement {
	fn from(n:CssBogusUnicodeRangeValue) -> SyntaxElement { n.syntax.into() }
}
#[derive(Clone, PartialEq, Eq, Hash, Serialize)]
...
impl AstNode for CssBogusUrlModifier {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_BOGUS_URL_MODIFIER as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_BOGUS_URL_MODIFIER }
...
impl From<CssBogusUrlModifier> for SyntaxNode {
	fn from(n:CssBogusUrlModifier) -> SyntaxNode { n.syntax }
}
impl From<CssBogusUrlModifier> for SyntaxElement {
	fn from(n:CssBogusUrlModifier) -> SyntaxElement { n.syntax.into() }
}
#[derive(Clone, PartialEq, Eq, Hash, Serialize)]
...
impl AstNode for CssUnknownAtRuleComponentList {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_UNKNOWN_AT_RULE_COMPONENT_LIST }
...
impl From<CssUnknownAtRuleComponentList> for SyntaxNode {
	fn from(n:CssUnknownAtRuleComponentList) -> SyntaxNode { n.syntax }
}
impl From<CssUnknownAtRuleComponentList> for SyntaxElement {
	fn from(n:CssUnknownAtRuleComponentList) -> SyntaxElement { n.syntax.into() }
}
#[derive(Clone, PartialEq, Eq, Hash, Serialize)]
...
impl AstNode for CssValueAtRuleGenericValue {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_VALUE_AT_RULE_GENERIC_VALUE }
...
impl From<CssValueAtRuleGenericValue> for SyntaxNode {
	fn from(n:CssValueAtRuleGenericValue) -> SyntaxNode { n.syntax }
}
impl From<CssValueAtRuleGenericValue> for SyntaxElement {
	fn from(n:CssValueAtRuleGenericValue) -> SyntaxElement { n.syntax.into() }
}
...
impl CssBracketedValueList {
	...
	/// or a match on [SyntaxNode::kind]
	#[inline]
	pub unsafe fn new_unchecked(syntax:SyntaxNode) -> Self { Self { syntax_list:syntax.into_list() } }
}
impl AstNode for CssBracketedValueList {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_BRACKETED_VALUE_LIST as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_BRACKETED_VALUE_LIST }

	fn cast(syntax:SyntaxNode) -> Option<CssBracketedValueList> {
		if Self::can_cast(syntax.kind()) {
			Some(CssBracketedValueList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for CssComponentValueList {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_COMPONENT_VALUE_LIST as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_COMPONENT_VALUE_LIST }

	fn cast(syntax:SyntaxNode) -> Option<CssComponentValueList> {
		if Self::can_cast(syntax.kind()) {
			Some(CssComponentValueList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for CssComposesClassList {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_COMPOSES_CLASS_LIST as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_COMPOSES_CLASS_LIST }

	fn cast(syntax:SyntaxNode) -> Option<CssComposesClassList> {
		if Self::can_cast(syntax.kind()) {
			Some(CssComposesClassList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for CssCompoundSelectorList {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_COMPOUND_SELECTOR_LIST as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_COMPOUND_SELECTOR_LIST }

	fn cast(syntax:SyntaxNode) -> Option<CssCompoundSelectorList> {
		if Self::can_cast(syntax.kind()) {
			Some(CssCompoundSelectorList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for CssCustomIdentifierList {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_CUSTOM_IDENTIFIER_LIST as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_CUSTOM_IDENTIFIER_LIST }

	fn cast(syntax:SyntaxNode) -> Option<CssCustomIdentifierList> {
		if Self::can_cast(syntax.kind()) {
			Some(CssCustomIdentifierList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for CssDeclarationList {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_DECLARATION_LIST as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_DECLARATION_LIST }

	fn cast(syntax:SyntaxNode) -> Option<CssDeclarationList> {
		if Self::can_cast(syntax.kind()) {
			Some(CssDeclarationList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for CssDeclarationOrAtRuleList {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_DECLARATION_OR_AT_RULE_LIST }

	fn cast(syntax:SyntaxNode) -> Option<CssDeclarationOrAtRuleList> {
		if Self::can_cast(syntax.kind()) {
			Some(CssDeclarationOrAtRuleList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for CssDeclarationOrRuleList {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_DECLARATION_OR_RULE_LIST }

	fn cast(syntax:SyntaxNode) -> Option<CssDeclarationOrRuleList> {
		if Self::can_cast(syntax.kind()) {
			Some(CssDeclarationOrRuleList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for CssDocumentMatcherList {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_DOCUMENT_MATCHER_LIST as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_DOCUMENT_MATCHER_LIST }

	fn cast(syntax:SyntaxNode) -> Option<CssDocumentMatcherList> {
		if Self::can_cast(syntax.kind()) {
			Some(CssDocumentMatcherList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for CssFontFamilyNameList {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_FONT_FAMILY_NAME_LIST as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_FONT_FAMILY_NAME_LIST }

	fn cast(syntax:SyntaxNode) -> Option<CssFontFamilyNameList> {
		if Self::can_cast(syntax.kind()) {
			Some(CssFontFamilyNameList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for CssFontFeatureValuesItemList {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_FONT_FEATURE_VALUES_ITEM_LIST }

	fn cast(syntax:SyntaxNode) -> Option<CssFontFeatureValuesItemList> {
		if Self::can_cast(syntax.kind()) {
			Some(CssFontFeatureValuesItemList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for CssGenericComponentValueList {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_GENERIC_COMPONENT_VALUE_LIST }

	fn cast(syntax:SyntaxNode) -> Option<CssGenericComponentValueList> {
		if Self::can_cast(syntax.kind()) {
			Some(CssGenericComponentValueList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for CssKeyframesItemList {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_KEYFRAMES_ITEM_LIST as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_KEYFRAMES_ITEM_LIST }

	fn cast(syntax:SyntaxNode) -> Option<CssKeyframesItemList> {
		if Self::can_cast(syntax.kind()) {
			Some(CssKeyframesItemList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for CssKeyframesSelectorList {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_KEYFRAMES_SELECTOR_LIST as u16));
	...
	fn cast(syntax:SyntaxNode) -> Option<CssKeyframesSelectorList> {
		if Self::can_cast(syntax.kind()) {
			Some(CssKeyframesSelectorList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for CssLayerNameList {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_LAYER_NAME_LIST as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_LAYER_NAME_LIST }

	fn cast(syntax:SyntaxNode) -> Option<CssLayerNameList> {
		if Self::can_cast(syntax.kind()) {
			Some(CssLayerNameList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for CssLayerReferenceList {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_LAYER_REFERENCE_LIST as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_LAYER_REFERENCE_LIST }

	fn cast(syntax:SyntaxNode) -> Option<CssLayerReferenceList> {
		if Self::can_cast(syntax.kind()) {
			Some(CssLayerReferenceList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for CssMediaQueryList {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_MEDIA_QUERY_LIST as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_MEDIA_QUERY_LIST }

	fn cast(syntax:SyntaxNode) -> Option<CssMediaQueryList> {
		if Self::can_cast(syntax.kind()) {
			Some(CssMediaQueryList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for CssNestedSelectorList {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_NESTED_SELECTOR_LIST as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_NESTED_SELECTOR_LIST }

	fn cast(syntax:SyntaxNode) -> Option<CssNestedSelectorList> {
		if Self::can_cast(syntax.kind()) {
			Some(CssNestedSelectorList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for CssPageAtRuleItemList {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_PAGE_AT_RULE_ITEM_LIST as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_PAGE_AT_RULE_ITEM_LIST }

	fn cast(syntax:SyntaxNode) -> Option<CssPageAtRuleItemList> {
		if Self::can_cast(syntax.kind()) {
			Some(CssPageAtRuleItemList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for CssPageSelectorList {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_PAGE_SELECTOR_LIST as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_PAGE_SELECTOR_LIST }

	fn cast(syntax:SyntaxNode) -> Option<CssPageSelectorList> {
		if Self::can_cast(syntax.kind()) {
			Some(CssPageSelectorList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for CssPageSelectorPseudoList {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_PAGE_SELECTOR_PSEUDO_LIST }

	fn cast(syntax:SyntaxNode) -> Option<CssPageSelectorPseudoList> {
		if Self::can_cast(syntax.kind()) {
			Some(CssPageSelectorPseudoList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for CssParameterList {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_PARAMETER_LIST as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_PARAMETER_LIST }

	fn cast(syntax:SyntaxNode) -> Option<CssParameterList> {
		if Self::can_cast(syntax.kind()) {
			Some(CssParameterList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for CssPseudoValueList {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_PSEUDO_VALUE_LIST as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_PSEUDO_VALUE_LIST }

	fn cast(syntax:SyntaxNode) -> Option<CssPseudoValueList> {
		if Self::can_cast(syntax.kind()) {
			Some(CssPseudoValueList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for CssRelativeSelectorList {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_RELATIVE_SELECTOR_LIST as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_RELATIVE_SELECTOR_LIST }

	fn cast(syntax:SyntaxNode) -> Option<CssRelativeSelectorList> {
		if Self::can_cast(syntax.kind()) {
			Some(CssRelativeSelectorList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for CssRuleList {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_RULE_LIST as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_RULE_LIST }

	fn cast(syntax:SyntaxNode) -> Option<CssRuleList> {
		if Self::can_cast(syntax.kind()) {
			Some(CssRuleList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for CssSelectorList {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_SELECTOR_LIST as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_SELECTOR_LIST }

	fn cast(syntax:SyntaxNode) -> Option<CssSelectorList> {
		if Self::can_cast(syntax.kind()) {
			Some(CssSelectorList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for CssSubSelectorList {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_SUB_SELECTOR_LIST as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_SUB_SELECTOR_LIST }

	fn cast(syntax:SyntaxNode) -> Option<CssSubSelectorList> {
		if Self::can_cast(syntax.kind()) {
			Some(CssSubSelectorList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for CssUrlModifierList {
	...
	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(CSS_URL_MODIFIER_LIST as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_URL_MODIFIER_LIST }

	fn cast(syntax:SyntaxNode) -> Option<CssUrlModifierList> {
		if Self::can_cast(syntax.kind()) {
			Some(CssUrlModifierList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for CssValueAtRuleImportSpecifierList {
	...
	const KIND_SET:SyntaxKindSet<Language> =
		SyntaxKindSet::from_raw(RawSyntaxKind(CSS_VALUE_AT_RULE_IMPORT_SPECIFIER_LIST as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_VALUE_AT_RULE_IMPORT_SPECIFIER_LIST }

	fn cast(syntax:SyntaxNode) -> Option<CssValueAtRuleImportSpecifierList> {
		if Self::can_cast(syntax.kind()) {
			Some(CssValueAtRuleImportSpecifierList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for CssValueAtRulePropertyList {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == CSS_VALUE_AT_RULE_PROPERTY_LIST }

	fn cast(syntax:SyntaxNode) -> Option<CssValueAtRulePropertyList> {
		if Self::can_cast(syntax.kind()) {
			Some(CssValueAtRulePropertyList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl Debug for DebugSyntaxElementChildren {
	fn fmt(&self, f:&mut Formatter<'_>) -> std::fmt::Result {
		f.debug_list().entries(self.clone().0.map(DebugSyntaxElement)).finish()
	}
}
