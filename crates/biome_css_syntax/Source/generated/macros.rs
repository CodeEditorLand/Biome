...
macro_rules! map_syntax_node {
	($node:expr, $pattern:pat => $body:expr) => {
		match $node {
			node => {
				match $crate::CssSyntaxNode::kind(&node) {
					...
					$crate::CssSyntaxKind::CSS_COMPOSES_IMPORT_SPECIFIER => {
						let $pattern = unsafe { $crate::CssComposesImportSpecifier::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_CONTAINER_QUERY_IN_PARENS => {
						let $pattern = unsafe { $crate::CssContainerQueryInParens::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_CONTAINER_SIZE_FEATURE_IN_PARENS => {
						let $pattern = unsafe { $crate::CssContainerSizeFeatureInParens::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_CONTAINER_STYLE_AND_QUERY => {
						let $pattern = unsafe { $crate::CssContainerStyleAndQuery::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_CONTAINER_STYLE_IN_PARENS => {
						let $pattern = unsafe { $crate::CssContainerStyleInParens::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_CONTAINER_STYLE_NOT_QUERY => {
						let $pattern = unsafe { $crate::CssContainerStyleNotQuery::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_CONTAINER_STYLE_QUERY_IN_PARENS => {
						let $pattern = unsafe { $crate::CssContainerStyleQueryInParens::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_DECLARATION_OR_AT_RULE_BLOCK => {
						let $pattern = unsafe { $crate::CssDeclarationOrAtRuleBlock::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_DECLARATION_OR_RULE_BLOCK => {
						let $pattern = unsafe { $crate::CssDeclarationOrRuleBlock::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_DECLARATION_WITH_SEMICOLON => {
						let $pattern = unsafe { $crate::CssDeclarationWithSemicolon::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_FONT_FEATURE_VALUES_AT_RULE => {
						let $pattern = unsafe { $crate::CssFontFeatureValuesAtRule::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_FONT_FEATURE_VALUES_BLOCK => {
						let $pattern = unsafe { $crate::CssFontFeatureValuesBlock::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_FONT_PALETTE_VALUES_AT_RULE => {
						let $pattern = unsafe { $crate::CssFontPaletteValuesAtRule::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_KEYFRAMES_IDENT_SELECTOR => {
						let $pattern = unsafe { $crate::CssKeyframesIdentSelector::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_KEYFRAMES_PERCENTAGE_SELECTOR => {
						let $pattern = unsafe { $crate::CssKeyframesPercentageSelector::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_KEYFRAMES_SCOPE_FUNCTION => {
						let $pattern = unsafe { $crate::CssKeyframesScopeFunction::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_LIST_OF_COMPONENT_VALUES_EXPRESSION => {
						let $pattern = unsafe { $crate::CssListOfComponentValuesExpression::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_MEDIA_CONDITION_IN_PARENS => {
						let $pattern = unsafe { $crate::CssMediaConditionInParens::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_PARENTHESIZED_EXPRESSION => {
						let $pattern = unsafe { $crate::CssParenthesizedExpression::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_PSEUDO_CLASS_FUNCTION_COMPOUND_SELECTOR => {
						let $pattern = unsafe { $crate::CssPseudoClassFunctionCompoundSelector::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_PSEUDO_CLASS_FUNCTION_COMPOUND_SELECTOR_LIST => {
						let $pattern =
							unsafe { $crate::CssPseudoClassFunctionCompoundSelectorList::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_PSEUDO_CLASS_FUNCTION_IDENTIFIER => {
						let $pattern = unsafe { $crate::CssPseudoClassFunctionIdentifier::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_PSEUDO_CLASS_FUNCTION_NTH => {
						let $pattern = unsafe { $crate::CssPseudoClassFunctionNth::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_PSEUDO_CLASS_FUNCTION_RELATIVE_SELECTOR_LIST => {
						let $pattern =
							unsafe { $crate::CssPseudoClassFunctionRelativeSelectorList::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_PSEUDO_CLASS_FUNCTION_SELECTOR => {
						let $pattern = unsafe { $crate::CssPseudoClassFunctionSelector::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_PSEUDO_CLASS_FUNCTION_SELECTOR_LIST => {
						let $pattern = unsafe { $crate::CssPseudoClassFunctionSelectorList::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_PSEUDO_CLASS_FUNCTION_VALUE_LIST => {
						let $pattern = unsafe { $crate::CssPseudoClassFunctionValueList::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_PSEUDO_CLASS_NTH_IDENTIFIER => {
						let $pattern = unsafe { $crate::CssPseudoClassNthIdentifier::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_PSEUDO_CLASS_NTH_SELECTOR => {
						let $pattern = unsafe { $crate::CssPseudoClassNthSelector::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_PSEUDO_CLASS_OF_NTH_SELECTOR => {
						let $pattern = unsafe { $crate::CssPseudoClassOfNthSelector::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_PSEUDO_ELEMENT_FUNCTION_IDENTIFIER => {
						let $pattern = unsafe { $crate::CssPseudoElementFunctionIdentifier::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_PSEUDO_ELEMENT_FUNCTION_SELECTOR => {
						let $pattern = unsafe { $crate::CssPseudoElementFunctionSelector::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_PSEUDO_ELEMENT_IDENTIFIER => {
						let $pattern = unsafe { $crate::CssPseudoElementIdentifier::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_QUERY_FEATURE_RANGE_COMPARISON => {
						let $pattern = unsafe { $crate::CssQueryFeatureRangeComparison::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_QUERY_FEATURE_RANGE_INTERVAL => {
						let $pattern = unsafe { $crate::CssQueryFeatureRangeInterval::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_QUERY_FEATURE_REVERSE_RANGE => {
						let $pattern = unsafe { $crate::CssQueryFeatureReverseRange::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_SUPPORTS_CONDITION_IN_PARENS => {
						let $pattern = unsafe { $crate::CssSupportsConditionInParens::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_SUPPORTS_FEATURE_DECLARATION => {
						let $pattern = unsafe { $crate::CssSupportsFeatureDeclaration::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_SUPPORTS_FEATURE_SELECTOR => {
						let $pattern = unsafe { $crate::CssSupportsFeatureSelector::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_UNIVERSAL_NAMESPACE_PREFIX => {
						let $pattern = unsafe { $crate::CssUniversalNamespacePrefix::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_VALUE_AT_RULE_DECLARATION_CLAUSE => {
						let $pattern = unsafe { $crate::CssValueAtRuleDeclarationClause::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_VALUE_AT_RULE_GENERIC_PROPERTY => {
						let $pattern = unsafe { $crate::CssValueAtRuleGenericProperty::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_VALUE_AT_RULE_IMPORT_CLAUSE => {
						let $pattern = unsafe { $crate::CssValueAtRuleImportClause::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_VALUE_AT_RULE_IMPORT_SPECIFIER => {
						let $pattern = unsafe { $crate::CssValueAtRuleImportSpecifier::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_VALUE_AT_RULE_NAMED_IMPORT_SPECIFIER => {
						let $pattern = unsafe { $crate::CssValueAtRuleNamedImportSpecifier::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_BOGUS_FONT_FEATURE_VALUES_ITEM => {
						let $pattern = unsafe { $crate::CssBogusFontFeatureValuesItem::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_BOGUS_PAGE_SELECTOR_PSEUDO => {
						let $pattern = unsafe { $crate::CssBogusPageSelectorPseudo::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_BOGUS_UNICODE_RANGE_VALUE => {
						let $pattern = unsafe { $crate::CssBogusUnicodeRangeValue::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_UNKNOWN_AT_RULE_COMPONENT_LIST => {
						let $pattern = unsafe { $crate::CssUnknownAtRuleComponentList::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_VALUE_AT_RULE_GENERIC_VALUE => {
						let $pattern = unsafe { $crate::CssValueAtRuleGenericValue::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_DECLARATION_OR_AT_RULE_LIST => {
						let $pattern = unsafe { $crate::CssDeclarationOrAtRuleList::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_FONT_FEATURE_VALUES_ITEM_LIST => {
						let $pattern = unsafe { $crate::CssFontFeatureValuesItemList::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_GENERIC_COMPONENT_VALUE_LIST => {
						let $pattern = unsafe { $crate::CssGenericComponentValueList::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_PAGE_SELECTOR_PSEUDO_LIST => {
						let $pattern = unsafe { $crate::CssPageSelectorPseudoList::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_VALUE_AT_RULE_IMPORT_SPECIFIER_LIST => {
						let $pattern = unsafe { $crate::CssValueAtRuleImportSpecifierList::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_VALUE_AT_RULE_PROPERTY_LIST => {
						let $pattern = unsafe { $crate::CssValueAtRulePropertyList::new_unchecked(node) };
						$body
					},
