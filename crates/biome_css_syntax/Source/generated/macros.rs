			...
			node => {
				match $crate::CssSyntaxNode::kind(&node) {
					...
					$crate::CssSyntaxKind::CSS_ATTRIBUTE_MATCHER_VALUE => {
						let $pattern =
							unsafe { $crate::CssAttributeMatcherValue::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_COLOR_PROFILE_AT_RULE => {
						let $pattern =
							unsafe { $crate::CssColorProfileAtRule::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_COMPOSES_PROPERTY_VALUE => {
						let $pattern =
							unsafe { $crate::CssComposesPropertyValue::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_CONTAINER_STYLE_OR_QUERY => {
						let $pattern =
							unsafe { $crate::CssContainerStyleOrQuery::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_COUNTER_STYLE_AT_RULE => {
						let $pattern =
							unsafe { $crate::CssCounterStyleAtRule::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_DECLARATION_IMPORTANT => {
						let $pattern =
							unsafe { $crate::CssDeclarationImportant::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_DOCUMENT_CUSTOM_MATCHER => {
						let $pattern =
							unsafe { $crate::CssDocumentCustomMatcher::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_FONT_FEATURE_VALUES_ITEM => {
						let $pattern =
							unsafe { $crate::CssFontFeatureValuesItem::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_IMPORT_ANONYMOUS_LAYER => {
						let $pattern =
							unsafe { $crate::CssImportAnonymousLayer::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_KEYFRAMES_SCOPE_PREFIX => {
						let $pattern =
							unsafe { $crate::CssKeyframesScopePrefix::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_KEYFRAMES_SCOPED_NAME => {
						let $pattern =
							unsafe { $crate::CssKeyframesScopedName::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_LIST_OF_COMPONENT_VALUES_EXPRESSION => {
						let $pattern = unsafe {
							$crate::CssListOfComponentValuesExpression::new_unchecked(node)
						};
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_MEDIA_CONDITION_QUERY => {
						let $pattern =
							unsafe { $crate::CssMediaConditionQuery::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_MEDIA_FEATURE_IN_PARENS => {
						let $pattern =
							unsafe { $crate::CssMediaFeatureInParens::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_NAMED_NAMESPACE_PREFIX => {
						let $pattern =
							unsafe { $crate::CssNamedNamespacePrefix::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_NESTED_QUALIFIED_RULE => {
						let $pattern =
							unsafe { $crate::CssNestedQualifiedRule::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_PAGE_SELECTOR_PSEUDO => {
						let $pattern =
							unsafe { $crate::CssPageSelectorPseudo::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_PSEUDO_CLASS_FUNCTION_IDENTIFIER => {
						let $pattern = unsafe {
							$crate::CssPseudoClassFunctionIdentifier::new_unchecked(node)
						};
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_PSEUDO_CLASS_FUNCTION_SELECTOR_LIST => {
						let $pattern = unsafe {
							$crate::CssPseudoClassFunctionSelectorList::new_unchecked(node)
						};
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_PSEUDO_CLASS_IDENTIFIER => {
						let $pattern =
							unsafe { $crate::CssPseudoClassIdentifier::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_PSEUDO_CLASS_NTH_NUMBER => {
						let $pattern =
							unsafe { $crate::CssPseudoClassNthNumber::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_PSEUDO_CLASS_SELECTOR => {
						let $pattern =
							unsafe { $crate::CssPseudoClassSelector::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_PSEUDO_ELEMENT_FUNCTION_IDENTIFIER => {
						let $pattern = unsafe {
							$crate::CssPseudoElementFunctionIdentifier::new_unchecked(node)
						};
						$body
					},
					$crate::CssSyntaxKind::CSS_PSEUDO_ELEMENT_FUNCTION_SELECTOR => {
						let $pattern = unsafe {
							$crate::CssPseudoElementFunctionSelector::new_unchecked(node)
						};
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_PSEUDO_ELEMENT_SELECTOR => {
						let $pattern =
							unsafe { $crate::CssPseudoElementSelector::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_QUERY_FEATURE_BOOLEAN => {
						let $pattern =
							unsafe { $crate::CssQueryFeatureBoolean::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_SCOPE_RANGE_INTERVAL => {
						let $pattern =
							unsafe { $crate::CssScopeRangeInterval::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_STARTING_STYLE_AT_RULE => {
						let $pattern =
							unsafe { $crate::CssStartingStyleAtRule::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_SUPPORTS_AND_CONDITION => {
						let $pattern =
							unsafe { $crate::CssSupportsAndCondition::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_SUPPORTS_NOT_CONDITION => {
						let $pattern =
							unsafe { $crate::CssSupportsNotCondition::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_SUPPORTS_OR_CONDITION => {
						let $pattern =
							unsafe { $crate::CssSupportsOrCondition::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_UNICODE_RANGE_INTERVAL => {
						let $pattern =
							unsafe { $crate::CssUnicodeRangeInterval::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_UNICODE_RANGE_WILDCARD => {
						let $pattern =
							unsafe { $crate::CssUnicodeRangeWildcard::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_UNKNOWN_BLOCK_AT_RULE => {
						let $pattern =
							unsafe { $crate::CssUnknownBlockAtRule::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_UNKNOWN_VALUE_AT_RULE => {
						let $pattern =
							unsafe { $crate::CssUnknownValueAtRule::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_VALUE_AT_RULE_NAMED_IMPORT_SPECIFIER => {
						let $pattern = unsafe {
							$crate::CssValueAtRuleNamedImportSpecifier::new_unchecked(node)
						};
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_BOGUS_CUSTOM_IDENTIFIER => {
						let $pattern =
							unsafe { $crate::CssBogusCustomIdentifier::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_BOGUS_DECLARATION_ITEM => {
						let $pattern =
							unsafe { $crate::CssBogusDeclarationItem::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_BOGUS_DOCUMENT_MATCHER => {
						let $pattern =
							unsafe { $crate::CssBogusDocumentMatcher::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_BOGUS_FONT_FAMILY_NAME => {
						let $pattern =
							unsafe { $crate::CssBogusFontFamilyName::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_BOGUS_KEYFRAMES_ITEM => {
						let $pattern =
							unsafe { $crate::CssBogusKeyframesItem::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_BOGUS_KEYFRAMES_NAME => {
						let $pattern =
							unsafe { $crate::CssBogusKeyframesName::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_BOGUS_PROPERTY_VALUE => {
						let $pattern =
							unsafe { $crate::CssBogusPropertyValue::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_BOGUS_PSEUDO_ELEMENT => {
						let $pattern =
							unsafe { $crate::CssBogusPseudoElement::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_BRACKETED_VALUE_LIST => {
						let $pattern =
							unsafe { $crate::CssBracketedValueList::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_COMPONENT_VALUE_LIST => {
						let $pattern =
							unsafe { $crate::CssComponentValueList::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_COMPOUND_SELECTOR_LIST => {
						let $pattern =
							unsafe { $crate::CssCompoundSelectorList::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_CUSTOM_IDENTIFIER_LIST => {
						let $pattern =
							unsafe { $crate::CssCustomIdentifierList::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_DECLARATION_OR_RULE_LIST => {
						let $pattern =
							unsafe { $crate::CssDeclarationOrRuleList::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_DOCUMENT_MATCHER_LIST => {
						let $pattern =
							unsafe { $crate::CssDocumentMatcherList::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_FONT_FAMILY_NAME_LIST => {
						let $pattern =
							unsafe { $crate::CssFontFamilyNameList::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_KEYFRAMES_SELECTOR_LIST => {
						let $pattern =
							unsafe { $crate::CssKeyframesSelectorList::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_LAYER_REFERENCE_LIST => {
						let $pattern =
							unsafe { $crate::CssLayerReferenceList::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_NESTED_SELECTOR_LIST => {
						let $pattern =
							unsafe { $crate::CssNestedSelectorList::new_unchecked(node) };
						$body
					},
					$crate::CssSyntaxKind::CSS_PAGE_AT_RULE_ITEM_LIST => {
						let $pattern =
							unsafe { $crate::CssPageAtRuleItemList::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_RELATIVE_SELECTOR_LIST => {
						let $pattern =
							unsafe { $crate::CssRelativeSelectorList::new_unchecked(node) };
						$body
					},
					...
					$crate::CssSyntaxKind::CSS_VALUE_AT_RULE_IMPORT_SPECIFIER_LIST => {
						let $pattern = unsafe {
							$crate::CssValueAtRuleImportSpecifierList::new_unchecked(node)
						};
						$body
					},
