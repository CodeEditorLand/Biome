...
impl FormatLanguage for GraphqlFormatLanguage {
	...
	fn create_context(self, root: &GraphqlSyntaxNode, source_map: Option<TransformSourceMap>) -> Self::Context {
...
pub fn format_sub_tree(options: GraphqlFormatOptions, root: &GraphqlSyntaxNode) -> FormatResult<Printed> {
