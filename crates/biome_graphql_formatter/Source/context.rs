...
use crate::{
	GraphqlCommentStyle,
	comments::{FormatGraphqlLeadingComment, GraphqlComments},
};
...
impl CstFormatContext for GraphqlFormatContext {
	...
	fn comments(&self) -> &GraphqlComments { &self.comments }
}
...
impl GraphqlFormatOptions {
	...
	pub fn set_bracket_spacing(&mut self, bracket_spacing:BracketSpacing) { self.bracket_spacing = bracket_spacing; }
