...
use crate::{
	AsFormat, FormatBogusNodeRule, FormatNodeRule, GraphqlFormatContext,
	GraphqlFormatter, IntoFormat,
};
use biome_formatter::{
	...
	for crate::graphql::auxiliary::argument::FormatGraphqlArgument
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_graphql_syntax::GraphqlArgument>::fmt(
			self, node, f,
		)
	}
}
...
impl IntoFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlArgument
{
	type Format = FormatOwnedWithRule<
		biome_graphql_syntax::GraphqlArgument,
		crate::graphql::auxiliary::argument::FormatGraphqlArgument,
	...
	for crate::graphql::auxiliary::arguments::FormatGraphqlArguments
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_graphql_syntax::GraphqlArguments>::fmt(
			self, node, f,
		)
	}
}
...
impl IntoFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlArguments
{
	type Format = FormatOwnedWithRule<
		biome_graphql_syntax::GraphqlArguments,
		crate::graphql::auxiliary::arguments::FormatGraphqlArguments,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlArgumentsDefinition
{
	type Format<'a> = FormatRefWithRule<
        'a,
	...
	for crate::graphql::value::boolean_value::FormatGraphqlBooleanValue
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_graphql_syntax::GraphqlBooleanValue>::fmt(
			self, node, f,
		)
	}
}
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlBooleanValue
{
	type Format<'a> = FormatRefWithRule<
		'a,
	...
	for crate::graphql::value::default_value::FormatGraphqlDefaultValue
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_graphql_syntax::GraphqlDefaultValue>::fmt(
			self, node, f,
		)
	}
}
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlDefaultValue
{
	type Format<'a> = FormatRefWithRule<
		'a,
	...
	for crate::graphql::auxiliary::description::FormatGraphqlDescription
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_graphql_syntax::GraphqlDescription>::fmt(
			self, node, f,
		)
	}
}
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlDescription
{
	type Format<'a> = FormatRefWithRule<
		'a,
	...
	for crate::graphql::auxiliary::directive::FormatGraphqlDirective
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_graphql_syntax::GraphqlDirective>::fmt(
			self, node, f,
		)
	}
}
...
impl IntoFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlDirective
{
	type Format = FormatOwnedWithRule<
		biome_graphql_syntax::GraphqlDirective,
		crate::graphql::auxiliary::directive::FormatGraphqlDirective,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlDirectiveDefinition
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlDirectiveLocation
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlEnumTypeDefinition
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlEnumTypeExtension
{
	type Format<'a> = FormatRefWithRule<
        'a,
	...
	for crate::graphql::value::enum_value::FormatGraphqlEnumValue
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_graphql_syntax::GraphqlEnumValue>::fmt(
			self, node, f,
		)
	}
}
...
impl IntoFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlEnumValue
{
	type Format = FormatOwnedWithRule<
		biome_graphql_syntax::GraphqlEnumValue,
		crate::graphql::value::enum_value::FormatGraphqlEnumValue,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlEnumValueDefinition
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlEnumValuesDefinition
{
	type Format<'a> = FormatRefWithRule<
        'a,
	...
	for crate::graphql::definitions::field_definition::FormatGraphqlFieldDefinition
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_graphql_syntax::GraphqlFieldDefinition>::fmt(
			self, node, f,
		)
	}
}
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlFieldDefinition
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlFieldsDefinition
{
	type Format<'a> = FormatRefWithRule<
        'a,
	...
	for crate::graphql::value::float_value::FormatGraphqlFloatValue
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_graphql_syntax::GraphqlFloatValue>::fmt(
			self, node, f,
		)
	}
}
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlFloatValue
{
	type Format<'a> = FormatRefWithRule<
		'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlFragmentDefinition
{
	type Format<'a> = FormatRefWithRule<
        'a,
	...
	for crate::graphql::auxiliary::fragment_spread::FormatGraphqlFragmentSpread
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_graphql_syntax::GraphqlFragmentSpread>::fmt(
			self, node, f,
		)
	}
}
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlFragmentSpread
{
	type Format<'a> = FormatRefWithRule<
		'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlImplementsInterfaces
{
	type Format<'a> = FormatRefWithRule<
        'a,
	...
	for crate::graphql::auxiliary::inline_fragment::FormatGraphqlInlineFragment
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_graphql_syntax::GraphqlInlineFragment>::fmt(
			self, node, f,
		)
	}
}
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlInlineFragment
{
	type Format<'a> = FormatRefWithRule<
		'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlInputFieldsDefinition
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlInputObjectTypeDefinition
{
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlInputObjectTypeExtension
{
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlInputValueDefinition
{
	type Format<'a> = FormatRefWithRule<
        'a,
	...
	for crate::graphql::value::int_value::FormatGraphqlIntValue
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_graphql_syntax::GraphqlIntValue>::fmt(
			self, node, f,
		)
	}
}
...
impl IntoFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlIntValue
{
	type Format = FormatOwnedWithRule<
		biome_graphql_syntax::GraphqlIntValue,
		crate::graphql::value::int_value::FormatGraphqlIntValue,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlInterfaceTypeDefinition
{
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlInterfaceTypeExtension
{
	type Format<'a> = FormatRefWithRule<
        'a,
	...
	for crate::graphql::auxiliary::list_type::FormatGraphqlListType
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_graphql_syntax::GraphqlListType>::fmt(
			self, node, f,
		)
	}
}
...
impl IntoFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlListType
{
	type Format = FormatOwnedWithRule<
		biome_graphql_syntax::GraphqlListType,
		crate::graphql::auxiliary::list_type::FormatGraphqlListType,
	...
	for crate::graphql::value::list_value::FormatGraphqlListValue
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_graphql_syntax::GraphqlListValue>::fmt(
			self, node, f,
		)
	}
}
...
impl IntoFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlListValue
{
	type Format = FormatOwnedWithRule<
		biome_graphql_syntax::GraphqlListValue,
		crate::graphql::value::list_value::FormatGraphqlListValue,
	...
	for crate::graphql::auxiliary::literal_name::FormatGraphqlLiteralName
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_graphql_syntax::GraphqlLiteralName>::fmt(
			self, node, f,
		)
	}
}
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlLiteralName
{
	type Format<'a> = FormatRefWithRule<
		'a,
	...
	for crate::graphql::auxiliary::name_binding::FormatGraphqlNameBinding
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_graphql_syntax::GraphqlNameBinding>::fmt(
			self, node, f,
		)
	}
}
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlNameBinding
{
	type Format<'a> = FormatRefWithRule<
		'a,
	...
	for crate::graphql::auxiliary::name_reference::FormatGraphqlNameReference
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_graphql_syntax::GraphqlNameReference>::fmt(
			self, node, f,
		)
	}
}
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlNameReference
{
	type Format<'a> = FormatRefWithRule<
		'a,
	...
	for crate::graphql::auxiliary::non_null_type::FormatGraphqlNonNullType
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_graphql_syntax::GraphqlNonNullType>::fmt(
			self, node, f,
		)
	}
}
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlNonNullType
{
	type Format<'a> = FormatRefWithRule<
		'a,
	...
	for crate::graphql::value::null_value::FormatGraphqlNullValue
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_graphql_syntax::GraphqlNullValue>::fmt(
			self, node, f,
		)
	}
}
...
impl IntoFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlNullValue
{
	type Format = FormatOwnedWithRule<
		biome_graphql_syntax::GraphqlNullValue,
		crate::graphql::value::null_value::FormatGraphqlNullValue,
	...
	for crate::graphql::auxiliary::object_field::FormatGraphqlObjectField
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_graphql_syntax::GraphqlObjectField>::fmt(
			self, node, f,
		)
	}
}
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlObjectField
{
	type Format<'a> = FormatRefWithRule<
		'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlObjectTypeDefinition
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlObjectTypeExtension
{
	type Format<'a> = FormatRefWithRule<
        'a,
	...
	for crate::graphql::value::object_value::FormatGraphqlObjectValue
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_graphql_syntax::GraphqlObjectValue>::fmt(
			self, node, f,
		)
	}
}
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlObjectValue
{
	type Format<'a> = FormatRefWithRule<
		'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlOperationDefinition
{
	type Format<'a> = FormatRefWithRule<
        'a,
	...
	for crate::graphql::auxiliary::operation_type::FormatGraphqlOperationType
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_graphql_syntax::GraphqlOperationType>::fmt(
			self, node, f,
		)
	}
}
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlOperationType
{
	type Format<'a> = FormatRefWithRule<
		'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlRootOperationTypeDefinition
{
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlRootOperationTypes
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlScalarTypeDefinition
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlScalarTypeExtension
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlSchemaDefinition
{
	type Format<'a> = FormatRefWithRule<
        'a,
	...
	for crate::graphql::extensions::schema_extension::FormatGraphqlSchemaExtension
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_graphql_syntax::GraphqlSchemaExtension>::fmt(
			self, node, f,
		)
	}
}
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlSchemaExtension
{
	type Format<'a> = FormatRefWithRule<
        'a,
	...
	for crate::graphql::auxiliary::selection_set::FormatGraphqlSelectionSet
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_graphql_syntax::GraphqlSelectionSet>::fmt(
			self, node, f,
		)
	}
}
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlSelectionSet
{
	type Format<'a> = FormatRefWithRule<
		'a,
	...
	for crate::graphql::value::string_value::FormatGraphqlStringValue
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_graphql_syntax::GraphqlStringValue>::fmt(
			self, node, f,
		)
	}
}
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlStringValue
{
	type Format<'a> = FormatRefWithRule<
		'a,
	...
	for crate::graphql::auxiliary::type_condition::FormatGraphqlTypeCondition
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_graphql_syntax::GraphqlTypeCondition>::fmt(
			self, node, f,
		)
	}
}
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlTypeCondition
{
	type Format<'a> = FormatRefWithRule<
		'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlUnionMemberTypes
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlUnionTypeDefinition
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlUnionTypeExtension
{
	type Format<'a> = FormatRefWithRule<
        'a,
	...
	for crate::graphql::auxiliary::variable_binding::FormatGraphqlVariableBinding
{
	...
	fn fmt(
		...
		FormatNodeRule::<biome_graphql_syntax::GraphqlVariableBinding>::fmt(
			self, node, f,
		)
	}
}
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlVariableBinding
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlVariableDefinition
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlVariableDefinitions
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlVariableReference
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlArgumentDefinitionList
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlArgumentList
{
	type Format<'a> = FormatRefWithRule<
		'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlDefinitionList
{
	type Format<'a> = FormatRefWithRule<
		'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlDirectiveList
{
	type Format<'a> = FormatRefWithRule<
		'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlDirectiveLocationList
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlEnumValueList
{
	type Format<'a> = FormatRefWithRule<
		'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlFieldDefinitionList
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlImplementsInterfaceList
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlInputFieldList
{
	type Format<'a> = FormatRefWithRule<
		'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlListValueElementList
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlObjectValueMemberList
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlSelectionList
{
	type Format<'a> = FormatRefWithRule<
		'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlUnionMemberTypeList
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlVariableDefinitionList
{
	type Format<'a> = FormatRefWithRule<
        'a,
	...
	for crate::graphql::bogus::bogus::FormatGraphqlBogus
{
	...
	fn fmt(
		...
		FormatBogusNodeRule::<biome_graphql_syntax::GraphqlBogus>::fmt(
			self, node, f,
		)
	}
}
	...
	for crate::graphql::bogus::bogus_definition::FormatGraphqlBogusDefinition
{
	...
	fn fmt(
		...
		FormatBogusNodeRule::<biome_graphql_syntax::GraphqlBogusDefinition>::fmt(
			self, node, f,
		)
	}
}
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlBogusDefinition
{
	type Format<'a> = FormatRefWithRule<
		'a,
	...
	for crate::graphql::bogus::bogus_selection::FormatGraphqlBogusSelection
{
	...
	fn fmt(
		...
		FormatBogusNodeRule::<biome_graphql_syntax::GraphqlBogusSelection>::fmt(
			self, node, f,
		)
	}
}
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlBogusSelection
{
	type Format<'a> = FormatRefWithRule<
		'a,
	...
	for crate::graphql::bogus::bogus_type::FormatGraphqlBogusType
{
	...
	fn fmt(
		...
		FormatBogusNodeRule::<biome_graphql_syntax::GraphqlBogusType>::fmt(
			self, node, f,
		)
	}
}
...
impl IntoFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlBogusType
{
	type Format = FormatOwnedWithRule<
		biome_graphql_syntax::GraphqlBogusType,
		crate::graphql::bogus::bogus_type::FormatGraphqlBogusType,
	...
	for crate::graphql::bogus::bogus_value::FormatGraphqlBogusValue
{
	...
	fn fmt(
		...
		FormatBogusNodeRule::<biome_graphql_syntax::GraphqlBogusValue>::fmt(
			self, node, f,
		)
	}
}
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::GraphqlBogusValue
{
	type Format<'a> = FormatRefWithRule<
		'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::AnyGraphqlDefinition
{
	type Format<'a> = FormatRefWithRule<
		'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::AnyGraphqlOperationDefinition
{
	type Format<'a> = FormatRefWithRule<
        'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::AnyGraphqlPrimitiveType
{
	type Format<'a> = FormatRefWithRule<
		'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::AnyGraphqlSelection
{
	type Format<'a> = FormatRefWithRule<
		'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::AnyGraphqlTypeDefinition
{
	type Format<'a> = FormatRefWithRule<
		'a,
...
impl AsFormat<GraphqlFormatContext>
	for biome_graphql_syntax::AnyGraphqlTypeExtension
{
	type Format<'a> = FormatRefWithRule<
		'a,
...
impl IntoFormat<GraphqlFormatContext>
	for biome_graphql_syntax::AnyGraphqlValue
{
	type Format = FormatOwnedWithRule<
		biome_graphql_syntax::AnyGraphqlValue,
		crate::graphql::any::value::FormatAnyGraphqlValue,
