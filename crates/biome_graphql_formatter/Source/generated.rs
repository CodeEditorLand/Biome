...
impl FormatRule<biome_graphql_syntax::GraphqlInputObjectTypeExtension>
	for crate::graphql::extensions::input_object_type_extension::FormatGraphqlInputObjectTypeExtension
{
	type Context = GraphqlFormatContext;
	#[inline(always)]
	fn fmt(
		&self,
		node: &biome_graphql_syntax::GraphqlInputObjectTypeExtension,
		f: &mut GraphqlFormatter,
	) -> FormatResult<()> {
		FormatNodeRule::<biome_graphql_syntax::GraphqlInputObjectTypeExtension>::fmt(self, node, f)
	}
}
...
impl AsFormat<GraphqlFormatContext> for biome_graphql_syntax::GraphqlRoot {
	...
	fn format(&self) -> Self::Format<'_> {
		#![allow(clippy::default_constructed_unit_structs)]
		FormatRefWithRule::new(self, crate::graphql::auxiliary::root::FormatGraphqlRoot::default())
	}
}
...
impl AsFormat<GraphqlFormatContext> for biome_graphql_syntax::GraphqlBogus {
	...
	fn format(&self) -> Self::Format<'_> {
		#![allow(clippy::default_constructed_unit_structs)]
		FormatRefWithRule::new(self, crate::graphql::bogus::bogus::FormatGraphqlBogus::default())
	}
}
impl IntoFormat<GraphqlFormatContext> for biome_graphql_syntax::GraphqlBogus {
	...
	fn into_format(self) -> Self::Format {
		#![allow(clippy::default_constructed_unit_structs)]
		FormatOwnedWithRule::new(self, crate::graphql::bogus::bogus::FormatGraphqlBogus::default())
	}
}
...
impl AsFormat<GraphqlFormatContext> for biome_graphql_syntax::AnyGraphqlType {
	...
	fn format(&self) -> Self::Format<'_> {
		#![allow(clippy::default_constructed_unit_structs)]
		FormatRefWithRule::new(self, crate::graphql::any::ts_type::FormatAnyGraphqlType::default())
	}
}
...
impl AsFormat<GraphqlFormatContext> for biome_graphql_syntax::AnyGraphqlValue {
	...
	fn format(&self) -> Self::Format<'_> {
		#![allow(clippy::default_constructed_unit_structs)]
		FormatRefWithRule::new(self, crate::graphql::any::value::FormatAnyGraphqlValue::default())
	}
}
impl IntoFormat<GraphqlFormatContext> for biome_graphql_syntax::AnyGraphqlValue {
	...
	fn into_format(self) -> Self::Format {
		#![allow(clippy::default_constructed_unit_structs)]
		FormatOwnedWithRule::new(self, crate::graphql::any::value::FormatAnyGraphqlValue::default())
	}
}
