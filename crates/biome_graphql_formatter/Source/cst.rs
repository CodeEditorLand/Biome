...
impl AsFormat<GraphqlFormatContext> for GraphqlSyntaxNode {
	...
	fn format(&self) -> Self::Format<'_> { FormatRefWithRule::new(self, FormatGraphqlSyntaxNode) }
}
...
impl IntoFormat<GraphqlFormatContext> for GraphqlSyntaxNode {
	...
	fn into_format(self) -> Self::Format { FormatOwnedWithRule::new(self, FormatGraphqlSyntaxNode) }
}
