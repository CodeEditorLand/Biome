...
use crate::{
	...
	JsonLanguage as Language,
	JsonSyntaxElement as SyntaxElement,
	JsonSyntaxElementChildren as SyntaxElementChildren,
	JsonSyntaxKind::{self as SyntaxKind, *},
	JsonSyntaxList as SyntaxList,
	JsonSyntaxNode as SyntaxNode,
...
impl JsonBooleanValue {
	...
	pub fn as_fields(&self) -> JsonBooleanValueFields {
		JsonBooleanValueFields { value_token:self.value_token() }
	}
...
impl JsonMember {
	...
	pub fn as_fields(&self) -> JsonMemberFields {
		JsonMemberFields { name:self.name(), colon_token:self.colon_token(), value:self.value() }
	}
...
impl JsonMemberName {
	...
	pub fn as_fields(&self) -> JsonMemberNameFields {
		JsonMemberNameFields { value_token:self.value_token() }
	}
...
impl JsonNullValue {
	...
	pub fn as_fields(&self) -> JsonNullValueFields {
		JsonNullValueFields { value_token:self.value_token() }
	}
...
impl JsonNumberValue {
	...
	pub fn as_fields(&self) -> JsonNumberValueFields {
		JsonNumberValueFields { value_token:self.value_token() }
	}
...
impl JsonStringValue {
	...
	pub fn as_fields(&self) -> JsonStringValueFields {
		JsonStringValueFields { value_token:self.value_token() }
	}
...
impl AstNode for JsonArrayElementList {
	...
	fn cast(syntax:SyntaxNode) -> Option<JsonArrayElementList> {
		if Self::can_cast(syntax.kind()) {
			Some(JsonArrayElementList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for JsonMemberList {
	...
	fn cast(syntax:SyntaxNode) -> Option<JsonMemberList> {
		if Self::can_cast(syntax.kind()) {
			Some(JsonMemberList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
