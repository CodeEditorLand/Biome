...
impl JsonFileSource {
	...
	const WELL_KNOWN_JSON_ALLOW_COMMENTS_AND_TRAILING_COMMAS_FILES:&'static [&'static [u8]] = &[
		...
		// See `.babelrc`
		b"babel.config.json",
		// Uses `jsonc-parser`, and allows comments and trailing commas by
		// default https://github.com/denoland/deno/blob/5a716d1d06f73800b280259204789260774d465d/cli/tools/registry/pm.rs#L114
		b"deno.json",
		// See `.devcontainer.json`
		b"devcontainer.json",
		// Uses `jsonc-parser`, and allows comments and trailing commas by
		// default https://github.com/dprint/dprint/blob/f523f4db9750af5e73a9cdd3384ed9cd7e223e53/crates/dprint/src/configuration/manipulation.rs#L85
		b"dprint.json",
		// See `tsconfig.json`
		b"jsconfig.json",
		// Uses `jsonc-parser`, and allows comments and trailing commas by
		// default https://github.com/jsr-io/jsr/blob/32d3481d32f566079d33ba2ec1b598ea0c38b32c/api/src/tarball.rs#L194-L198
	...
	const WELL_KNOWN_JSON_ALLOW_COMMENTS_FILES:&'static [&'static [u8]] = &[
		...
		// Uses `strip-json-comments`, which doesn't allow trailing commas by
		// default https://github.com/eslint/eslintrc/blob/fb8d7ffbb27214686318a07e16ac8878aaafc805/lib/config-array-factory.js#L192
		// https://github.com/sindresorhus/strip-json-comments/blob/85611bf8a07246bca27f949c997a1460c57bbe9f/index.js#L19
		b".eslintrc.json",
		// Uses `strip-json-comments`, which doesn't allow trailing commas by
		// default https://github.com/jscs-dev/node-jscs/blob/38d33a0e455d965106ad3c8948c870f8f4e5dda9/lib/cli-config.js#L81
		b".jscsrc",
		// `.jsfmtrc` can be either an `ini` file or a `json` file (which will
		// be parsed after `strip-with-comments`), so we shouldn't include it
		// here. https://github.com/rdio/jsfmt?tab=readme-ov-file#jsfmtrc

		// Uses `strip-json-comments`, which doesn't allow trailing commas by
		// default https://github.com/jshint/jshint/blob/0a5644f8f529e252e7dd0c0d54334ae435b13de0/src/cli.js#L538
		b".jshintrc",
		// Uses `strip-json-comments`, which doesn't allow trailing commas by
		// default https://github.com/jestjs/jest/blob/bd1c6db7c15c23788ca3e09c919138e48dd3b28a/packages/jest-config/src/readConfigFileAndSetRootDir.ts#L46
		b"jest.config.json",
		// Just strip comments
	...
	pub fn json() -> Self { Self { allow_comments:false, allow_trailing_commas:false } }

	pub fn json_allow_comments() -> Self {
		Self { allow_comments:true, allow_trailing_commas:false }
	}
	...
	pub fn allow_trailing_commas(&self) -> bool { self.allow_trailing_commas }
	...
	pub fn allow_comments(&self) -> bool { self.allow_comments }

	pub fn is_well_known_json_file(file_name:&OsStr) -> bool {
		Self::WELL_KNOWN_JSON_FILES.binary_search(&file_name.as_encoded_bytes()).is_ok()
	}
	...
	pub fn is_well_known_json_allow_comments_directory(dirname:&OsStr) -> bool {
		// Note: we don't use a binary search because the slice has only a few
		// elements.
	...
	/// Try to return the JSON file source corresponding to this file name from
	/// well-known files
