...
#[derive(
	Clone, Default, Debug, Deserialize, Eq, Partial, PartialEq, Serialize,
)]
...
pub struct CssFormatter {
	...
	#[partial(bpaf(
		long("css-formatter-indent-style"),
		argument("tab|space"),
		optional
	))]
	...
	#[partial(bpaf(
		long("css-formatter-indent-width"),
		argument("NUMBER"),
		optional
	))]
	...
	#[partial(bpaf(
		long("css-formatter-line-ending"),
		argument("lf|crlf|cr"),
		optional
	))]
	...
	#[partial(bpaf(
		long("css-formatter-quote-style"),
...
#[derive(
	Clone, Debug, Deserialize, Eq, Partial, PartialEq, Default, Serialize,
)]
#[partial(derive(Bpaf, Clone, Deserializable, Eq, Merge, PartialEq))]
#[partial(cfg_attr(feature = "schema", derive(schemars::JsonSchema)))]
#[partial(serde(rename_all = "camelCase", default, deny_unknown_fields))]
