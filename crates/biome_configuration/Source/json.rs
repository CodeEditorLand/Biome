...
pub struct JsonFormatter {
	...
	#[partial(bpaf(
		long("json-formatter-indent-style"),
		argument("tab|space"),
		optional
	))]
	...
	#[partial(bpaf(
		long("json-formatter-indent-width"),
		argument("NUMBER"),
		optional
	))]
	...
	/// The size of the indentation applied to JSON (and its super languages) files. Default to 2.
	#[partial(bpaf(
		long("json-formatter-indent-size"),
		argument("NUMBER"),
		optional
	))]
	#[partial(deserializable(deprecated(
		use_instead = "json.formatter.indentWidth"
	)))]
	...
	#[partial(bpaf(
		long("json-formatter-line-width"),
		argument("NUMBER"),
		optional
	))]
