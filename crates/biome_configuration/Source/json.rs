...
pub struct JsonFormatter {
	...
	/// The size of the indentation applied to JSON (and its super languages)
	/// files. Default to 2.
	...
	/// The type of line ending applied to JSON (and its super languages)
	/// files.
	#[partial(bpaf(long("json-formatter-line-ending"), argument("lf|crlf|cr"), optional))]
	pub line_ending:Option<LineEnding>,

	/// What's the max width of a line applied to JSON (and its super
