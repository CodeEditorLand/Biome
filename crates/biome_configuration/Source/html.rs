...
use biome_formatter::{AttributePosition, BracketSameLine, IndentStyle, IndentWidth, LineEnding, LineWidth};
...
pub struct HtmlFormatterConfiguration {
	...
	#[bpaf(long("html-formatter-attribute-position"), argument("multiline|auto"), optional)]
	#[serde(skip_serializing_if = "Option::is_none")]
	...
	#[bpaf(long("html-formatter-bracket-same-line"), argument("true|false"), optional)]
	#[serde(skip_serializing_if = "Option::is_none")]
	...
	#[bpaf(long("html-formatter-indent-script-and-style"), argument("true|false"), optional)]
	#[serde(skip_serializing_if = "Option::is_none")]
