...
pub struct GraphqlFormatter {
	...
	#[partial(bpaf(long("graphql-formatter-indent-style"), argument("tab|space"), optional))]
	...
	#[partial(bpaf(long("graphql-formatter-line-ending"), argument("lf|crlf|cr"), optional))]
	...
	#[partial(bpaf(long("graphql-formatter-quote-style"), argument("double|single"), optional))]
...
impl PartialGraphqlLinter {
	pub fn get_linter_configuration(&self) -> GraphqlLinter {
		GraphqlLinter { enabled:self.enabled.unwrap_or_default() }
	}
}
