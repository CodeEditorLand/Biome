...
pub struct Rules {
	...
	/// It enables ALL rules. The rules that belong to `nursery` won't be
	/// enabled.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub all:Option<bool>,
...
impl DeserializableValidator for Rules {
	fn validate(&mut self, _name:&str, range:TextRange, diagnostics:&mut Vec<DeserializationDiagnostic>) -> bool {
...
impl Rules {
	/// Checks if the code coming from [biome_diagnostics::Diagnostic]
	...
	/// Given a category coming from
	/// [Diagnostic](biome_diagnostics::Diagnostic), this function returns
	/// the [Severity](biome_diagnostics::Severity) associated to the rule, if
	/// the configuration changed it.
	/// If the severity is off or not set, then the function returns the default
	/// severity of the rule:
	/// [Severity::Error] for recommended rules and [Severity::Warning] for
	/// other rules.
	///
	...
	pub(crate) const fn is_recommended_false(&self) -> bool { matches!(self.recommended, Some(false)) }

	pub(crate) const fn is_all_true(&self) -> bool { matches!(self.all, Some(true)) }

	/// It returns the enabled rules by default.
	///
	/// The enabled rules are calculated from the difference with the disabled
	/// rules.
	pub fn as_enabled_rules(&self) -> FxHashSet<RuleFilter<'static>> {
		...
		if let Some(group) = self.a11y.as_ref() {
			group.collect_preset_rules(self.is_all_true(), !self.is_recommended_false(), &mut enabled_rules);
...
pub struct A11y {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_aria_hidden_on_focusable:Option<RuleFixConfiguration<biome_js_analyze::options::NoAriaHiddenOnFocusable>>,
	/// Enforce that elements that do not support ARIA roles, states, and
	/// properties do not have those attributes.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_aria_unsupported_elements:Option<RuleFixConfiguration<biome_js_analyze::options::NoAriaUnsupportedElements>>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_distracting_elements:Option<RuleFixConfiguration<biome_js_analyze::options::NoDistractingElements>>,
	/// The scope prop should be used only on \<th> elements.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_header_scope:Option<RuleFixConfiguration<biome_js_analyze::options::NoHeaderScope>>,
	/// Enforce that non-interactive ARIA roles are not assigned to interactive
	/// HTML elements.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_interactive_element_to_noninteractive_role:
		Option<RuleFixConfiguration<biome_js_analyze::options::NoInteractiveElementToNoninteractiveRole>>,
	/// Enforce that a label element or component has a text label and an
	/// associated input.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_label_without_control:Option<RuleConfiguration<biome_js_analyze::options::NoLabelWithoutControl>>,
	/// Enforce that interactive ARIA roles are not assigned to non-interactive
	/// HTML elements.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_noninteractive_element_to_interactive_role:
		Option<RuleFixConfiguration<biome_js_analyze::options::NoNoninteractiveElementToInteractiveRole>>,
	/// Enforce that tabIndex is not assigned to non-interactive HTML elements.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_noninteractive_tabindex:Option<RuleFixConfiguration<biome_js_analyze::options::NoNoninteractiveTabindex>>,
	/// Prevent the usage of positive integers on tabIndex property
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_positive_tabindex:Option<RuleFixConfiguration<biome_js_analyze::options::NoPositiveTabindex>>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_redundant_roles:Option<RuleFixConfiguration<biome_js_analyze::options::NoRedundantRoles>>,
	/// Enforces the usage of the title element for the svg element.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_svg_without_title:Option<RuleConfiguration<biome_js_analyze::options::NoSvgWithoutTitle>>,
	...
	/// Enforce that anchors have content and that the content is accessible to
	/// screen readers.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_anchor_content:Option<RuleFixConfiguration<biome_js_analyze::options::UseAnchorContent>>,
	/// Enforce that tabIndex is assigned to non-interactive HTML elements with
	/// aria-activedescendant.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_aria_activedescendant_with_tabindex:
		Option<RuleFixConfiguration<biome_js_analyze::options::UseAriaActivedescendantWithTabindex>>,
	/// Enforce that elements with ARIA roles must have all required ARIA
	/// attributes for that role.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_aria_props_for_role:Option<RuleConfiguration<biome_js_analyze::options::UseAriaPropsForRole>>,
	...
	/// focusable.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_focusable_interactive:Option<RuleConfiguration<biome_js_analyze::options::UseFocusableInteractive>>,
	/// Disallow a missing generic family keyword within font families.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_generic_font_names:Option<RuleConfiguration<biome_css_analyze::options::UseGenericFontNames>>,
	/// Enforce that heading elements (h1, h2, etc.) have content and that the
	/// content is accessible to screen readers. Accessible means that it is not
	/// hidden using the aria-hidden prop.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_heading_content:Option<RuleConfiguration<biome_js_analyze::options::UseHeadingContent>>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_key_with_click_events:Option<RuleConfiguration<biome_js_analyze::options::UseKeyWithClickEvents>>,
	/// Enforce onMouseOver / onMouseOut are accompanied by onFocus / onBlur.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_key_with_mouse_events:Option<RuleConfiguration<biome_js_analyze::options::UseKeyWithMouseEvents>>,
	/// Enforces that audio and video elements must have a track for captions.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_media_caption:Option<RuleConfiguration<biome_js_analyze::options::UseMediaCaption>>,
	/// It detects the use of role attributes in JSX elements and suggests using
	/// semantic elements instead.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_semantic_elements:Option<RuleConfiguration<biome_js_analyze::options::UseSemanticElements>>,
	/// Enforce that all anchors are valid, and they are navigable elements.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_valid_anchor:Option<RuleConfiguration<biome_js_analyze::options::UseValidAnchor>>,
	/// Ensures that ARIA properties aria-* are all valid.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_valid_aria_props:Option<RuleFixConfiguration<biome_js_analyze::options::UseValidAriaProps>>,
	/// Elements with ARIA roles must use a valid, non-abstract ARIA role.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_valid_aria_role:Option<RuleFixConfiguration<biome_js_analyze::options::UseValidAriaRole>>,
	/// Enforce that ARIA state and property values are valid.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_valid_aria_values:Option<RuleConfiguration<biome_js_analyze::options::UseValidAriaValues>>,
	/// Ensure that the attribute passed to the lang attribute is a correct ISO
...
impl A11y {
	...
	pub(crate) fn is_recommended_true(&self) -> bool { matches!(self.recommended, Some(true)) }

	pub(crate) fn is_recommended_unset(&self) -> bool { self.recommended.is_none() }

	pub(crate) fn is_all_true(&self) -> bool { matches!(self.all, Some(true)) }

	pub(crate) fn is_all_unset(&self) -> bool { self.all.is_none() }
	...
	/// Checks if, given a rule name, matches one of the rules contained in this
	/// category
	...
	pub(crate) fn is_recommended_rule(rule_name:&str) -> bool { Self::RECOMMENDED_RULES.contains(&rule_name) }

	pub(crate) fn recommended_rules_as_filters() -> &'static [RuleFilter<'static>] {
		Self::RECOMMENDED_RULES_AS_FILTERS
	}

	pub(crate) fn all_rules_as_filters() -> &'static [RuleFilter<'static>] { Self::ALL_RULES_AS_FILTERS }
	...
	pub(crate) fn get_rule_configuration(
		...
		match rule_name {
			"noAccessKey" => self.no_access_key.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noAriaHiddenOnFocusable" => {
			...
			"noAriaUnsupportedElements" => {
				self.no_aria_unsupported_elements
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noAutofocus" => self.no_autofocus.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noBlankTarget" => self.no_blank_target.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noDistractingElements" => {
				self.no_distracting_elements
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noHeaderScope" => self.no_header_scope.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noInteractiveElementToNoninteractiveRole" => {
			...
			"noPositiveTabindex" => {
				self.no_positive_tabindex
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noRedundantAlt" => self.no_redundant_alt.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noRedundantRoles" => self.no_redundant_roles.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noSvgWithoutTitle" => {
				self.no_svg_without_title
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useAltText" => self.use_alt_text.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useAnchorContent" => self.use_anchor_content.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useAriaActivedescendantWithTabindex" => {
			...
			"useAriaPropsForRole" => {
				self.use_aria_props_for_role
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useButtonType" => self.use_button_type.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useFocusableInteractive" => {
				self.use_focusable_interactive
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useGenericFontNames" => {
				self.use_generic_font_names
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useHeadingContent" => self.use_heading_content.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useHtmlLang" => self.use_html_lang.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useIframeTitle" => self.use_iframe_title.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useKeyWithClickEvents" => {
				self.use_key_with_click_events
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useKeyWithMouseEvents" => {
			...
			"useMediaCaption" => self.use_media_caption.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useSemanticElements" => {
				self.use_semantic_elements
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useValidAnchor" => self.use_valid_anchor.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useValidAriaProps" => {
				self.use_valid_aria_props
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useValidAriaRole" => self.use_valid_aria_role.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useValidAriaValues" => {
				self.use_valid_aria_values
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useValidLang" => self.use_valid_lang.as_ref().map(|conf| (conf.level(), conf.get_options())),
			_ => None,
		}
	}
}
...
pub struct Complexity {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_empty_type_parameters:Option<RuleConfiguration<biome_js_analyze::options::NoEmptyTypeParameters>>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_extra_boolean_cast:Option<RuleFixConfiguration<biome_js_analyze::options::NoExtraBooleanCast>>,
	/// Prefer for...of statement instead of Array.forEach.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_for_each:Option<RuleConfiguration<biome_js_analyze::options::NoForEach>>,
	/// Disallow unclear usage of consecutive space characters in regular
	/// expression literals
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_multiple_spaces_in_regular_expression_literals:
		Option<RuleFixConfiguration<biome_js_analyze::options::NoMultipleSpacesInRegularExpressionLiterals>>,
	/// This rule reports when a class has no non-static members, such as for a
	/// class used exclusively as a static namespace.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_static_only_class:Option<RuleConfiguration<biome_js_analyze::options::NoStaticOnlyClass>>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_useless_constructor:Option<RuleFixConfiguration<biome_js_analyze::options::NoUselessConstructor>>,
	/// Disallow empty exports that don't change anything in a module file.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_useless_empty_export:Option<RuleFixConfiguration<biome_js_analyze::options::NoUselessEmptyExport>>,
	/// Disallow unnecessary fragments
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_useless_fragments:Option<RuleFixConfiguration<biome_js_analyze::options::NoUselessFragments>>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_useless_string_concat:Option<RuleFixConfiguration<biome_js_analyze::options::NoUselessStringConcat>>,
	/// Disallow useless case in switch statements.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_useless_switch_case:Option<RuleFixConfiguration<biome_js_analyze::options::NoUselessSwitchCase>>,
	/// Disallow ternary operators when simpler alternatives exist.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_useless_ternary:Option<RuleFixConfiguration<biome_js_analyze::options::NoUselessTernary>>,
	/// Disallow useless this aliasing.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_useless_this_alias:Option<RuleFixConfiguration<biome_js_analyze::options::NoUselessThisAlias>>,
	/// Disallow using any or unknown as type constraint.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_useless_type_constraint:Option<RuleFixConfiguration<biome_js_analyze::options::NoUselessTypeConstraint>>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_arrow_function:Option<RuleFixConfiguration<biome_js_analyze::options::UseArrowFunction>>,
	...
	/// Enforce the usage of a literal access to properties over computed
	/// property access.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_literal_keys:Option<RuleFixConfiguration<biome_js_analyze::options::UseLiteralKeys>>,
	/// Enforce using concise optional chain instead of chained logical
	/// expressions.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_optional_chain:Option<RuleFixConfiguration<biome_js_analyze::options::UseOptionalChain>>,
	/// Enforce the use of the regular expression literals instead of the RegExp
	/// constructor if possible.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_regex_literals:Option<RuleFixConfiguration<biome_js_analyze::options::UseRegexLiterals>>,
	/// Disallow number literal object member names which are not base10 or uses
	/// underscore as separator
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_simple_number_keys:Option<RuleFixConfiguration<biome_js_analyze::options::UseSimpleNumberKeys>>,
...
impl Complexity {
	...
	pub(crate) fn get_enabled_rules(&self) -> FxHashSet<RuleFilter<'static>> {
		...
		if let Some(rule) = self.no_multiple_spaces_in_regular_expression_literals.as_ref() {
			if rule.is_enabled() {
				index_set.insert(RuleFilter::Rule(Self::GROUP_NAME, Self::GROUP_RULES[6]));
			}
		}
	...
	pub(crate) fn get_rule_configuration(
		...
		match rule_name {
			"noBannedTypes" => self.no_banned_types.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noEmptyTypeParameters" => {
				self.no_empty_type_parameters
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noExcessiveCognitiveComplexity" => {
				self.no_excessive_cognitive_complexity
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noExcessiveNestedTestSuites" => {
			...
			"noExtraBooleanCast" => {
				self.no_extra_boolean_cast
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noForEach" => self.no_for_each.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noMultipleSpacesInRegularExpressionLiterals" => {
			...
			"noStaticOnlyClass" => {
				self.no_static_only_class
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noThisInStatic" => self.no_this_in_static.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noUselessCatch" => self.no_useless_catch.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noUselessConstructor" => {
				self.no_useless_constructor
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noUselessEmptyExport" => {
				self.no_useless_empty_export
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noUselessFragments" => {
			...
			"noUselessLabel" => self.no_useless_label.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noUselessLoneBlockStatements" => {
				self.no_useless_lone_block_statements
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noUselessRename" => self.no_useless_rename.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noUselessStringConcat" => {
				self.no_useless_string_concat
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noUselessSwitchCase" => {
				self.no_useless_switch_case
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noUselessTernary" => self.no_useless_ternary.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noUselessThisAlias" => {
				self.no_useless_this_alias
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noUselessTypeConstraint" => {
			...
			"noVoid" => self.no_void.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noWith" => self.no_with.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useArrowFunction" => self.use_arrow_function.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useDateNow" => self.use_date_now.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useFlatMap" => self.use_flat_map.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useLiteralKeys" => self.use_literal_keys.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useOptionalChain" => self.use_optional_chain.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useRegexLiterals" => self.use_regex_literals.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useSimpleNumberKeys" => {
			...
			"useSimplifiedLogicExpression" => {
				self.use_simplified_logic_expression
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			_ => None,
...
pub struct Correctness {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_constant_condition:Option<RuleConfiguration<biome_js_analyze::options::NoConstantCondition>>,
	/// Disallow the use of Math.min and Math.max to clamp a value where the
	/// result itself is constant.
	#[serde(skip_serializing_if = "Option::is_none")]
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_constructor_return:Option<RuleConfiguration<biome_js_analyze::options::NoConstructorReturn>>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_flat_map_identity:Option<RuleFixConfiguration<biome_js_analyze::options::NoFlatMapIdentity>>,
	/// Disallow calling global object properties as functions
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_global_object_calls:Option<RuleConfiguration<biome_js_analyze::options::NoGlobalObjectCalls>>,
	/// Disallow function and var declarations that are accessible outside their
	/// block.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_inner_declarations:Option<RuleConfiguration<biome_js_analyze::options::NoInnerDeclarations>>,
	...
	/// Prevents the incorrect use of super() inside classes. It also checks
	/// whether a call super() is missing from classes that extends other
	/// constructors.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_invalid_constructor_super:Option<RuleConfiguration<biome_js_analyze::options::NoInvalidConstructorSuper>>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_invalid_grid_areas:Option<RuleConfiguration<biome_css_analyze::options::NoInvalidGridAreas>>,
	/// Disallow new operators with global non-constructor functions.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_invalid_new_builtin:Option<RuleFixConfiguration<biome_js_analyze::options::NoInvalidNewBuiltin>>,
	...
	/// Disallow the use of variables and function parameters before their
	/// declaration
	#[serde(skip_serializing_if = "Option::is_none")]
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_nonoctal_decimal_escape:Option<RuleFixConfiguration<biome_js_analyze::options::NoNonoctalDecimalEscape>>,
	/// Disallow literal numbers that lose precision
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_precision_loss:Option<RuleConfiguration<biome_js_analyze::options::NoPrecisionLoss>>,
	/// Prevent the usage of the return value of React.render.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_render_return_value:Option<RuleConfiguration<biome_js_analyze::options::NoRenderReturnValue>>,
	...
	/// Disallow comparison of expressions modifying the string case with
	/// non-compliant value.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_string_case_mismatch:Option<RuleFixConfiguration<biome_js_analyze::options::NoStringCaseMismatch>>,
	/// Disallow lexical declarations in switch clauses.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_switch_declarations:Option<RuleFixConfiguration<biome_js_analyze::options::NoSwitchDeclarations>>,
	/// Disallow the use of dependencies that aren't specified in the
	/// package.json.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_undeclared_dependencies:Option<RuleConfiguration<biome_js_analyze::options::NoUndeclaredDependencies>>,
	/// Prevents the usage of variables that haven't been declared inside the
	/// document.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_undeclared_variables:Option<RuleConfiguration<biome_js_analyze::options::NoUndeclaredVariables>>,
	/// Disallow unknown CSS value functions.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_unknown_function:Option<RuleConfiguration<biome_css_analyze::options::NoUnknownFunction>>,
	/// Disallow unknown media feature names.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_unknown_media_feature_name:Option<RuleConfiguration<biome_css_analyze::options::NoUnknownMediaFeatureName>>,
	/// Disallow unknown properties.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_unknown_property:Option<RuleConfiguration<biome_css_analyze::options::NoUnknownProperty>>,
	/// Disallow unknown CSS units.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_unknown_unit:Option<RuleConfiguration<biome_css_analyze::options::NoUnknownUnit>>,
	/// Disallow unmatchable An+B selectors.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_unmatchable_anb_selector:Option<RuleConfiguration<biome_css_analyze::options::NoUnmatchableAnbSelector>>,
	/// Avoid using unnecessary continue.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_unnecessary_continue:Option<RuleFixConfiguration<biome_js_analyze::options::NoUnnecessaryContinue>>,
	...
	/// path in a class constructor before this is accessed if the class has a
	/// superclass
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_unreachable_super:Option<RuleConfiguration<biome_js_analyze::options::NoUnreachableSuper>>,
	/// Disallow control flow statements in finally blocks.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_unsafe_finally:Option<RuleConfiguration<biome_js_analyze::options::NoUnsafeFinally>>,
	/// Disallow the use of optional chaining in contexts where the undefined
	/// value is not allowed.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_unsafe_optional_chaining:Option<RuleConfiguration<biome_js_analyze::options::NoUnsafeOptionalChaining>>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_unused_variables:Option<RuleFixConfiguration<biome_js_analyze::options::NoUnusedVariables>>,
	/// This rules prevents void elements (AKA self-closing elements) from
	/// having children.
	#[serde(skip_serializing_if = "Option::is_none")]
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_array_literals:Option<RuleFixConfiguration<biome_js_analyze::options::UseArrayLiterals>>,
	/// Enforce all dependencies are correctly specified in a React hook.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_exhaustive_dependencies:Option<RuleConfiguration<biome_js_analyze::options::UseExhaustiveDependencies>>,
	/// Enforce that all React hooks are being called from the Top Level
	/// component functions.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_hook_at_top_level:Option<RuleConfiguration<biome_js_analyze::options::UseHookAtTopLevel>>,
	/// Enforce file extensions for relative imports.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_import_extensions:Option<RuleFixConfiguration<biome_js_analyze::options::UseImportExtensions>>,
	/// Require calls to isNaN() when checking for NaN.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_is_nan:Option<RuleFixConfiguration<biome_js_analyze::options::UseIsNan>>,
	/// Disallow missing key props in iterators/collection literals.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_jsx_key_in_iterable:Option<RuleConfiguration<biome_js_analyze::options::UseJsxKeyInIterable>>,
	/// Enforce "for" loop update clause moving the counter in the right
	/// direction.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_valid_for_direction:Option<RuleConfiguration<biome_js_analyze::options::UseValidForDirection>>,
...
impl Correctness {
	...
	pub(crate) fn get_rule_configuration(
		...
		match rule_name {
			"noChildrenProp" => self.no_children_prop.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noConstAssign" => self.no_const_assign.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noConstantCondition" => {
				self.no_constant_condition
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noConstantMathMinMaxClamp" => {
				self.no_constant_math_min_max_clamp
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noConstructorReturn" => {
				self.no_constructor_return
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noEmptyCharacterClassInRegex" => {
			...
			"noEmptyPattern" => self.no_empty_pattern.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noFlatMapIdentity" => {
				self.no_flat_map_identity
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noGlobalObjectCalls" => {
				self.no_global_object_calls
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noInnerDeclarations" => {
				self.no_inner_declarations
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noInvalidBuiltinInstantiation" => {
				self.no_invalid_builtin_instantiation
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noInvalidConstructorSuper" => {
				self.no_invalid_constructor_super
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noInvalidDirectionInLinearGradient" => {
				self.no_invalid_direction_in_linear_gradient
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noInvalidGridAreas" => {
				self.no_invalid_grid_areas
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noInvalidNewBuiltin" => {
				self.no_invalid_new_builtin
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noInvalidPositionAtImportRule" => {
				self.no_invalid_position_at_import_rule
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noInvalidUseBeforeDeclaration" => {
				self.no_invalid_use_before_declaration
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noNewSymbol" => self.no_new_symbol.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noNodejsModules" => self.no_nodejs_modules.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noNonoctalDecimalEscape" => {
				self.no_nonoctal_decimal_escape
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noPrecisionLoss" => self.no_precision_loss.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noRenderReturnValue" => {
				self.no_render_return_value
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noSelfAssign" => self.no_self_assign.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noSetterReturn" => self.no_setter_return.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noStringCaseMismatch" => {
				self.no_string_case_mismatch
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noSwitchDeclarations" => {
				self.no_switch_declarations
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noUndeclaredDependencies" => {
				self.no_undeclared_dependencies
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noUndeclaredVariables" => {
				self.no_undeclared_variables
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noUnknownFunction" => self.no_unknown_function.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noUnknownMediaFeatureName" => {
				self.no_unknown_media_feature_name
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noUnknownProperty" => self.no_unknown_property.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noUnknownUnit" => self.no_unknown_unit.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noUnmatchableAnbSelector" => {
				self.no_unmatchable_anb_selector
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noUnnecessaryContinue" => {
				self.no_unnecessary_continue
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noUnreachable" => self.no_unreachable.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noUnreachableSuper" => {
				self.no_unreachable_super
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noUnsafeFinally" => self.no_unsafe_finally.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noUnsafeOptionalChaining" => {
			...
			"noUnusedFunctionParameters" => {
				self.no_unused_function_parameters
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noUnusedImports" => self.no_unused_imports.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noUnusedLabels" => self.no_unused_labels.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noUnusedPrivateClassMembers" => {
				self.no_unused_private_class_members
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noUnusedVariables" => self.no_unused_variables.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noVoidElementsWithChildren" => {
				self.no_void_elements_with_children
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noVoidTypeReturn" => self.no_void_type_return.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useArrayLiterals" => self.use_array_literals.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useExhaustiveDependencies" => {
				self.use_exhaustive_dependencies
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useHookAtTopLevel" => {
				self.use_hook_at_top_level
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useImportExtensions" => {
				self.use_import_extensions
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useIsNan" => self.use_is_nan.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useJsxKeyInIterable" => {
				self.use_jsx_key_in_iterable
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useValidForDirection" => {
				self.use_valid_for_direction
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useYield" => self.use_yield.as_ref().map(|conf| (conf.level(), conf.get_options())),
			_ => None,
		}
	}
}
...
pub struct Nursery {
	...
	/// Disallow a lower specificity selector from coming after a higher
	/// specificity selector.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_descending_specificity:Option<RuleConfiguration<biome_css_analyze::options::NoDescendingSpecificity>>,
	/// Disallow direct assignments to document.cookie.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_document_cookie:Option<RuleConfiguration<biome_js_analyze::options::NoDocumentCookie>>,
	/// Prevents importing next/document outside of pages/_document.jsx in
	/// Next.js projects.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_document_import_in_page:Option<RuleConfiguration<biome_js_analyze::options::NoDocumentImportInPage>>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_duplicate_else_if:Option<RuleConfiguration<biome_js_analyze::options::NoDuplicateElseIf>>,
	/// Disallow duplicate properties within declaration blocks.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_duplicate_properties:Option<RuleConfiguration<biome_css_analyze::options::NoDuplicateProperties>>,
	/// No duplicated fields in GraphQL operations.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_duplicated_fields:Option<RuleConfiguration<biome_graphql_analyze::options::NoDuplicatedFields>>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_exported_imports:Option<RuleConfiguration<biome_js_analyze::options::NoExportedImports>>,
	/// Disallow the use of __dirname and __filename in the global scope.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_global_dirname_filename:Option<RuleFixConfiguration<biome_js_analyze::options::NoGlobalDirnameFilename>>,
	/// Prevent usage of \<head> element in a Next.js project.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_head_element:Option<RuleConfiguration<biome_js_analyze::options::NoHeadElement>>,
	/// Prevent using the next/head module in pages/_document.js on Next.js
	/// projects.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_head_import_in_document:Option<RuleConfiguration<biome_js_analyze::options::NoHeadImportInDocument>>,
	/// Prevent usage of \<img> element in a Next.js project.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_img_element:Option<RuleConfiguration<biome_js_analyze::options::NoImgElement>>,
	/// Disallows the use of irregular whitespace characters.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_irregular_whitespace:Option<RuleConfiguration<biome_css_analyze::options::NoIrregularWhitespace>>,
	/// Disallow missing var function for css variables.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_missing_var_function:Option<RuleConfiguration<biome_css_analyze::options::NoMissingVarFunction>>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_restricted_imports:Option<RuleConfiguration<biome_js_analyze::options::NoRestrictedImports>>,
	/// Disallow user defined types.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_restricted_types:Option<RuleFixConfiguration<biome_js_analyze::options::NoRestrictedTypes>>,
	/// Disallow usage of sensitive data such as API keys and tokens.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_secrets:Option<RuleConfiguration<biome_js_analyze::options::NoSecrets>>,
	/// Enforce that static, visible elements (such as \<div>) that have click
	/// handlers use the valid role attribute.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_static_element_interactions:
		Option<RuleConfiguration<biome_js_analyze::options::NoStaticElementInteractions>>,
	/// Enforce the use of String.slice() over String.substr() and
	/// String.substring().
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_substr:Option<RuleFixConfiguration<biome_js_analyze::options::NoSubstr>>,
	/// Disallow template literal placeholder syntax in regular strings.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_template_curly_in_string:Option<RuleConfiguration<biome_js_analyze::options::NoTemplateCurlyInString>>,
	/// Disallow unknown at-rules.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_unknown_at_rule:Option<RuleConfiguration<biome_css_analyze::options::NoUnknownAtRule>>,
	/// Disallow unknown pseudo-class selectors.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_unknown_pseudo_class:Option<RuleConfiguration<biome_css_analyze::options::NoUnknownPseudoClass>>,
	/// Disallow unknown pseudo-element selectors.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_unknown_pseudo_element:Option<RuleConfiguration<biome_css_analyze::options::NoUnknownPseudoElement>>,
	/// Disallow unknown type selectors.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_unknown_type_selector:Option<RuleConfiguration<biome_css_analyze::options::NoUnknownTypeSelector>>,
	/// Disallow unnecessary escape sequence in regular expression literals.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_useless_escape_in_regex:Option<RuleFixConfiguration<biome_js_analyze::options::NoUselessEscapeInRegex>>,
	/// Disallow unnecessary String.raw function in template string literals
	/// without any escape sequence.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_useless_string_raw:Option<RuleConfiguration<biome_js_analyze::options::NoUselessStringRaw>>,
	/// Disallow the use of useless undefined.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_useless_undefined:Option<RuleFixConfiguration<biome_js_analyze::options::NoUselessUndefined>>,
	...
	/// Enforce that ARIA properties are valid for the roles that are supported
	/// by the element.
	#[serde(skip_serializing_if = "Option::is_none")]
	...
	/// Enforce declaring components only within modules that export React
	...
	/// This rule enforces consistent use of curly braces inside JSX attributes
	/// and JSX children.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_consistent_curly_braces:Option<RuleFixConfiguration<biome_js_analyze::options::UseConsistentCurlyBraces>>,
	/// Require consistent accessibility modifiers on class properties and
	/// methods.
	#[serde(skip_serializing_if = "Option::is_none")]
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_deprecated_reason:Option<RuleConfiguration<biome_graphql_analyze::options::UseDeprecatedReason>>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_google_font_display:Option<RuleConfiguration<biome_js_analyze::options::UseGoogleFontDisplay>>,
	/// Ensure the preconnect attribute is used when using Google Fonts.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_google_font_preconnect:Option<RuleFixConfiguration<biome_js_analyze::options::UseGoogleFontPreconnect>>,
	/// Require for-in loops to include an if statement.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_guard_for_in:Option<RuleConfiguration<biome_js_analyze::options::UseGuardForIn>>,
	/// Disallows package private imports.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_import_restrictions:Option<RuleConfiguration<biome_js_analyze::options::UseImportRestrictions>>,
	/// Enforce specifying the name of GraphQL operations.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_named_operation:Option<RuleFixConfiguration<biome_graphql_analyze::options::UseNamedOperation>>,
	/// Validates that all enum values are capitalized.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_naming_convention:Option<RuleConfiguration<biome_graphql_analyze::options::UseNamingConvention>>,
	/// Enforce the sorting of CSS utility classes.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_sorted_classes:Option<RuleFixConfiguration<biome_js_analyze::options::UseSortedClasses>>,
	/// Enforce the use of the directive "use strict" in script files.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_strict_mode:Option<RuleFixConfiguration<biome_js_analyze::options::UseStrictMode>>,
	/// Enforce the use of String.trimStart() and String.trimEnd() over
	/// String.trimLeft() and String.trimRight().
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_trim_start_end:Option<RuleFixConfiguration<biome_js_analyze::options::UseTrimStartEnd>>,
	/// Use valid values for the autocomplete attribute on input elements.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_valid_autocomplete:Option<RuleConfiguration<biome_js_analyze::options::UseValidAutocomplete>>,
}
...
impl Nursery {
	...
	pub(crate) fn get_rule_configuration(
		...
		match rule_name {
			"noCommonJs" => self.no_common_js.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noDescendingSpecificity" => {
				self.no_descending_specificity
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noDocumentCookie" => self.no_document_cookie.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noDocumentImportInPage" => {
			...
			"noDuplicateCustomProperties" => {
				self.no_duplicate_custom_properties
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noDuplicateElseIf" => {
				self.no_duplicate_else_if
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noDuplicateProperties" => {
			...
			"noDuplicatedFields" => {
				self.no_duplicated_fields
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noDynamicNamespaceImportAccess" => {
				self.no_dynamic_namespace_import_access
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noEnum" => self.no_enum.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noExportedImports" => self.no_exported_imports.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noGlobalDirnameFilename" => {
				self.no_global_dirname_filename
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noHeadElement" => self.no_head_element.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noHeadImportInDocument" => {
				self.no_head_import_in_document
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noImgElement" => self.no_img_element.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noIrregularWhitespace" => {
				self.no_irregular_whitespace
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noMissingVarFunction" => {
				self.no_missing_var_function
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noNestedTernary" => self.no_nested_ternary.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noOctalEscape" => self.no_octal_escape.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noProcessEnv" => self.no_process_env.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noRestrictedImports" => {
				self.no_restricted_imports
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noRestrictedTypes" => self.no_restricted_types.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noSecrets" => self.no_secrets.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noStaticElementInteractions" => {
				self.no_static_element_interactions
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noSubstr" => self.no_substr.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noTemplateCurlyInString" => {
				self.no_template_curly_in_string
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noUnknownAtRule" => self.no_unknown_at_rule.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noUnknownPseudoClass" => {
				self.no_unknown_pseudo_class
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noUnknownPseudoElement" => {
				self.no_unknown_pseudo_element
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noUnknownTypeSelector" => {
				self.no_unknown_type_selector
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noUselessEscapeInRegex" => {
				self.no_useless_escape_in_regex
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noUselessStringRaw" => {
				self.no_useless_string_raw
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noUselessUndefined" => {
			...
			"noValueAtRule" => self.no_value_at_rule.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useAdjacentOverloadSignatures" => {
				self.use_adjacent_overload_signatures
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useAriaPropsSupportedByRole" => {
				self.use_aria_props_supported_by_role
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useAtIndex" => self.use_at_index.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useCollapsedIf" => self.use_collapsed_if.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useComponentExportOnlyModules" => {
				self.use_component_export_only_modules
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useConsistentCurlyBraces" => {
			...
			"useConsistentMemberAccessibility" => {
				self.use_consistent_member_accessibility
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useDeprecatedReason" => {
				self.use_deprecated_reason
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useExplicitType" => self.use_explicit_type.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useExportsLast" => self.use_exports_last.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useGoogleFontDisplay" => {
				self.use_google_font_display
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useGoogleFontPreconnect" => {
				self.use_google_font_preconnect
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useGuardForIn" => self.use_guard_for_in.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useImportRestrictions" => {
				self.use_import_restrictions
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useNamedOperation" => self.use_named_operation.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useNamingConvention" => {
				self.use_naming_convention
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useSortedClasses" => self.use_sorted_classes.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useStrictMode" => self.use_strict_mode.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useTrimStartEnd" => self.use_trim_start_end.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useValidAutocomplete" => {
				self.use_valid_autocomplete
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			_ => None,
...
pub struct Performance {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_accumulating_spread:Option<RuleConfiguration<biome_js_analyze::options::NoAccumulatingSpread>>,
...
impl Performance {
	...
	pub(crate) fn get_rule_configuration(
		...
		match rule_name {
			...
			"noBarrelFile" => self.no_barrel_file.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noDelete" => self.no_delete.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noReExportAll" => self.no_re_export_all.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useTopLevelRegex" => self.use_top_level_regex.as_ref().map(|conf| (conf.level(), conf.get_options())),
			_ => None,
		}
	}
}
...
pub struct Security {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_dangerously_set_inner_html:Option<RuleConfiguration<biome_js_analyze::options::NoDangerouslySetInnerHtml>>,
	/// Report when a DOM element or a component uses both children and
...
impl Security {
	...
	pub(crate) fn get_rule_configuration(
		...
		match rule_name {
			"noDangerouslySetInnerHtml" => {
				self.no_dangerously_set_inner_html
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noDangerouslySetInnerHtmlWithChildren" => {
			...
			"noGlobalEval" => self.no_global_eval.as_ref().map(|conf| (conf.level(), conf.get_options())),
			_ => None,
		}
	}
}
...
pub struct Style {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_implicit_boolean:Option<RuleFixConfiguration<biome_js_analyze::options::NoImplicitBoolean>>,
	/// Disallow type annotations for variables, parameters, and class
	/// properties initialized with a literal expression.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_inferrable_types:Option<RuleFixConfiguration<biome_js_analyze::options::NoInferrableTypes>>,
	/// Disallow the use of TypeScript's namespaces.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_namespace:Option<RuleConfiguration<biome_js_analyze::options::NoNamespace>>,
	/// Disallow the use of namespace imports.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_namespace_import:Option<RuleConfiguration<biome_js_analyze::options::NoNamespaceImport>>,
	/// Disallow negation in the condition of an if statement if it has an else
	/// clause.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_negation_else:Option<RuleFixConfiguration<biome_js_analyze::options::NoNegationElse>>,
	/// Disallow non-null assertions using the ! postfix operator.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_non_null_assertion:Option<RuleFixConfiguration<biome_js_analyze::options::NoNonNullAssertion>>,
	/// Disallow reassigning function parameters.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_parameter_assign:Option<RuleConfiguration<biome_js_analyze::options::NoParameterAssign>>,
	/// Disallow the use of parameter properties in class constructors.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_parameter_properties:Option<RuleConfiguration<biome_js_analyze::options::NoParameterProperties>>,
	/// This rule allows you to specify global variable names that you don’t
	/// want to use in your application.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_restricted_globals:Option<RuleConfiguration<biome_js_analyze::options::NoRestrictedGlobals>>,
	/// Disallow the use of constants which its value is the upper-case version
	/// of its name.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_shouty_constants:Option<RuleFixConfiguration<biome_js_analyze::options::NoShoutyConstants>>,
	/// Disallow template literals if interpolation and special-character
	/// handling are not needed
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_unused_template_literal:Option<RuleFixConfiguration<biome_js_analyze::options::NoUnusedTemplateLiteral>>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_yoda_expression:Option<RuleFixConfiguration<biome_js_analyze::options::NoYodaExpression>>,
	/// Enforce the use of as const over literal type and type annotation.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_as_const_assertion:Option<RuleFixConfiguration<biome_js_analyze::options::UseAsConstAssertion>>,
	/// Requires following curly brace conventions.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_block_statements:Option<RuleFixConfiguration<biome_js_analyze::options::UseBlockStatements>>,
	/// Enforce using else if instead of nested if in else clauses.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_collapsed_else_if:Option<RuleFixConfiguration<biome_js_analyze::options::UseCollapsedElseIf>>,
	/// Require consistently using either T\[] or Array\<T>
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_consistent_array_type:Option<RuleFixConfiguration<biome_js_analyze::options::UseConsistentArrayType>>,
	...
	/// Enforce default function parameters and optional function parameters to
	/// be last.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_default_parameter_last:Option<RuleFixConfiguration<biome_js_analyze::options::UseDefaultParameterLast>>,
	/// Require the default clause in switch statements.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_default_switch_clause:Option<RuleConfiguration<biome_js_analyze::options::UseDefaultSwitchClause>>,
	/// Require that each enum member value be explicitly initialized.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_enum_initializers:Option<RuleFixConfiguration<biome_js_analyze::options::UseEnumInitializers>>,
	/// Enforce explicitly comparing the length, size, byteLength or byteOffset
	/// property of a value.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_explicit_length_check:Option<RuleFixConfiguration<biome_js_analyze::options::UseExplicitLengthCheck>>,
	/// Disallow the use of Math.pow in favor of the ** operator.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_exponentiation_operator:Option<RuleFixConfiguration<biome_js_analyze::options::UseExponentiationOperator>>,
	/// Promotes the use of export type for types.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_export_type:Option<RuleFixConfiguration<biome_js_analyze::options::UseExportType>>,
	/// Enforce naming conventions for JavaScript and TypeScript filenames.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_filenaming_convention:Option<RuleConfiguration<biome_js_analyze::options::UseFilenamingConvention>>,
	/// This rule recommends a for-of loop when in a for loop, the index used to
	/// extract an item from the iterated array.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_for_of:Option<RuleConfiguration<biome_js_analyze::options::UseForOf>>,
	/// This rule enforces the use of \<>...\</> over
	/// \<Fragment>...\</Fragment>.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_fragment_syntax:Option<RuleFixConfiguration<biome_js_analyze::options::UseFragmentSyntax>>,
	/// Promotes the use of import type for types.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_import_type:Option<RuleFixConfiguration<biome_js_analyze::options::UseImportType>>,
	/// Require all enum members to be literal values.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_literal_enum_members:Option<RuleConfiguration<biome_js_analyze::options::UseLiteralEnumMembers>>,
	/// Enforce naming conventions for everything across a codebase.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_naming_convention:Option<RuleFixConfiguration<biome_js_analyze::options::UseNamingConvention>>,
	/// Promotes the usage of node:assert/strict over node:assert.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_node_assert_strict:Option<RuleFixConfiguration<biome_js_analyze::options::UseNodeAssertStrict>>,
	/// Enforces using the node: protocol for Node.js builtin modules.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_nodejs_import_protocol:Option<RuleFixConfiguration<biome_js_analyze::options::UseNodejsImportProtocol>>,
	/// Use the Number properties instead of global ones.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_number_namespace:Option<RuleFixConfiguration<biome_js_analyze::options::UseNumberNamespace>>,
	/// Disallow parseInt() and Number.parseInt() in favor of binary, octal, and
	/// hexadecimal literals
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_numeric_literals:Option<RuleFixConfiguration<biome_js_analyze::options::UseNumericLiterals>>,
	/// Prevent extra closing tags for components without children
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_self_closing_elements:Option<RuleFixConfiguration<biome_js_analyze::options::UseSelfClosingElements>>,
	/// When expressing array types, this rule promotes the usage of T\[]
	/// shorthand instead of Array\<T>.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_shorthand_array_type:Option<RuleFixConfiguration<biome_js_analyze::options::UseShorthandArrayType>>,
	/// Require assignment operator shorthand where possible.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_shorthand_assign:Option<RuleFixConfiguration<biome_js_analyze::options::UseShorthandAssign>>,
	/// Enforce using function types instead of object type with call
	/// signatures.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_shorthand_function_type:Option<RuleFixConfiguration<biome_js_analyze::options::UseShorthandFunctionType>>,
	/// Enforces switch clauses have a single statement, emits a quick fix
	/// wrapping the statements in a block.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_single_case_statement:Option<RuleFixConfiguration<biome_js_analyze::options::UseSingleCaseStatement>>,
	/// Disallow multiple variable declarations in the same variable statement
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_single_var_declarator:Option<RuleFixConfiguration<biome_js_analyze::options::UseSingleVarDeclarator>>,
	/// Prefer template literals over string concatenation.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_template:Option<RuleFixConfiguration<biome_js_analyze::options::UseTemplate>>,
	/// Require new when throwing an error.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_throw_new_error:Option<RuleFixConfiguration<biome_js_analyze::options::UseThrowNewError>>,
	/// Disallow throwing non-Error values.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_throw_only_error:Option<RuleConfiguration<biome_js_analyze::options::UseThrowOnlyError>>,
	/// Enforce the use of while loops instead of for loops when the initializer
...
impl Style {
	...
	pub(crate) fn get_rule_configuration(
		...
		match rule_name {
			"noArguments" => self.no_arguments.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noCommaOperator" => self.no_comma_operator.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noDefaultExport" => self.no_default_export.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noDoneCallback" => self.no_done_callback.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noImplicitBoolean" => self.no_implicit_boolean.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noInferrableTypes" => self.no_inferrable_types.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noNamespace" => self.no_namespace.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noNamespaceImport" => self.no_namespace_import.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noNegationElse" => self.no_negation_else.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noNonNullAssertion" => {
				self.no_non_null_assertion
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noParameterAssign" => self.no_parameter_assign.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noParameterProperties" => {
				self.no_parameter_properties
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noRestrictedGlobals" => {
			...
			"noShoutyConstants" => self.no_shouty_constants.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noUnusedTemplateLiteral" => {
				self.no_unused_template_literal
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noUselessElse" => self.no_useless_else.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noVar" => self.no_var.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noYodaExpression" => self.no_yoda_expression.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useAsConstAssertion" => {
				self.use_as_const_assertion
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useBlockStatements" => {
				self.use_block_statements
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useCollapsedElseIf" => {
				self.use_collapsed_else_if
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useConsistentArrayType" => {
				self.use_consistent_array_type
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useConsistentBuiltinInstantiation" => {
				self.use_consistent_builtin_instantiation
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useConst" => self.use_const.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useDefaultParameterLast" => {
			...
			"useDefaultSwitchClause" => {
				self.use_default_switch_clause
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useEnumInitializers" => {
				self.use_enum_initializers
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useExplicitLengthCheck" => {
				self.use_explicit_length_check
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useExponentiationOperator" => {
				self.use_exponentiation_operator
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useExportType" => self.use_export_type.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useFilenamingConvention" => {
				self.use_filenaming_convention
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useForOf" => self.use_for_of.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useFragmentSyntax" => self.use_fragment_syntax.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useImportType" => self.use_import_type.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useLiteralEnumMembers" => {
			...
			"useNumberNamespace" => {
				self.use_number_namespace
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useNumericLiterals" => {
				self.use_numeric_literals
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useSelfClosingElements" => {
				self.use_self_closing_elements
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useShorthandArrayType" => {
				self.use_shorthand_array_type
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useShorthandAssign" => {
				self.use_shorthand_assign
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useShorthandFunctionType" => {
				self.use_shorthand_function_type
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useSingleCaseStatement" => {
			...
			"useTemplate" => self.use_template.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useThrowNewError" => self.use_throw_new_error.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useThrowOnlyError" => {
				self.use_throw_only_error
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useWhile" => self.use_while.as_ref().map(|conf| (conf.level(), conf.get_options())),
			_ => None,
		}
	}
}
...
pub struct Suspicious {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_assign_in_expressions:Option<RuleConfiguration<biome_js_analyze::options::NoAssignInExpressions>>,
	/// Disallows using an async function as a Promise executor.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_async_promise_executor:Option<RuleConfiguration<biome_js_analyze::options::NoAsyncPromiseExecutor>>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_compare_neg_zero:Option<RuleFixConfiguration<biome_js_analyze::options::NoCompareNegZero>>,
	/// Disallow labeled statements that are not loops.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_confusing_labels:Option<RuleConfiguration<biome_js_analyze::options::NoConfusingLabels>>,
	/// Disallow void type outside of generic or return types.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_confusing_void_type:Option<RuleFixConfiguration<biome_js_analyze::options::NoConfusingVoidType>>,
	...
	/// Prevents from having control characters and some escape sequences that
	/// match control characters in regular expressions.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_control_characters_in_regex:Option<RuleConfiguration<biome_js_analyze::options::NoControlCharactersInRegex>>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_duplicate_at_import_rules:Option<RuleConfiguration<biome_css_analyze::options::NoDuplicateAtImportRules>>,
	/// Disallow duplicate case labels.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_duplicate_case:Option<RuleConfiguration<biome_js_analyze::options::NoDuplicateCase>>,
	/// Disallow duplicate class members.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_duplicate_class_members:Option<RuleConfiguration<biome_js_analyze::options::NoDuplicateClassMembers>>,
	/// Disallow duplicate names within font families.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_duplicate_font_names:Option<RuleConfiguration<biome_css_analyze::options::NoDuplicateFontNames>>,
	/// Prevents JSX properties to be assigned multiple times.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_duplicate_jsx_props:Option<RuleConfiguration<biome_js_analyze::options::NoDuplicateJsxProps>>,
	/// Disallow two keys with the same name inside objects.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_duplicate_object_keys:Option<RuleConfiguration<biome_json_analyze::options::NoDuplicateObjectKeys>>,
	/// Disallow duplicate function parameter name.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_duplicate_parameters:Option<RuleConfiguration<biome_js_analyze::options::NoDuplicateParameters>>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_duplicate_test_hooks:Option<RuleConfiguration<biome_js_analyze::options::NoDuplicateTestHooks>>,
	/// Disallow CSS empty blocks.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_empty_block:Option<RuleConfiguration<biome_css_analyze::options::NoEmptyBlock>>,
	/// Disallow empty block statements and static blocks.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_empty_block_statements:Option<RuleConfiguration<biome_js_analyze::options::NoEmptyBlockStatements>>,
	/// Disallow the declaration of empty interfaces.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_empty_interface:Option<RuleFixConfiguration<biome_js_analyze::options::NoEmptyInterface>>,
	...
	/// Prevents the wrong usage of the non-null assertion operator (!) in
	/// TypeScript files.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_extra_non_null_assertion:Option<RuleFixConfiguration<biome_js_analyze::options::NoExtraNonNullAssertion>>,
	/// Disallow fallthrough of switch clauses.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_fallthrough_switch_clause:Option<RuleConfiguration<biome_js_analyze::options::NoFallthroughSwitchClause>>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_global_is_finite:Option<RuleFixConfiguration<biome_js_analyze::options::NoGlobalIsFinite>>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_important_in_keyframe:Option<RuleConfiguration<biome_css_analyze::options::NoImportantInKeyframe>>,
	/// Disallow labels that share a name with a variable
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_label_var:Option<RuleConfiguration<biome_js_analyze::options::NoLabelVar>>,
	/// Disallow characters made with multiple code points in character class
	/// syntax.
	#[serde(skip_serializing_if = "Option::is_none")]
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_misleading_instantiator:Option<RuleConfiguration<biome_js_analyze::options::NoMisleadingInstantiator>>,
	/// Checks that the assertion function, for example expect, is placed inside
	/// an it() function call.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_misplaced_assertion:Option<RuleConfiguration<biome_js_analyze::options::NoMisplacedAssertion>>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_prototype_builtins:Option<RuleFixConfiguration<biome_js_analyze::options::NoPrototypeBuiltins>>,
	/// Prevents React-specific JSX properties from being used.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_react_specific_props:Option<RuleFixConfiguration<biome_js_analyze::options::NoReactSpecificProps>>,
	/// Disallow variable, function, class, and type redeclarations in the same
	/// scope.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_redeclare:Option<RuleConfiguration<biome_js_analyze::options::NoRedeclare>>,
	/// Prevents from having redundant "use strict".
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_redundant_use_strict:Option<RuleFixConfiguration<biome_js_analyze::options::NoRedundantUseStrict>>,
	/// Disallow comparisons where both sides are exactly the same.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_self_compare:Option<RuleConfiguration<biome_js_analyze::options::NoSelfCompare>>,
	/// Disallow identifiers from shadowing restricted names.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_shadow_restricted_names:Option<RuleConfiguration<biome_js_analyze::options::NoShadowRestrictedNames>>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_suspicious_semicolon_in_jsx:Option<RuleConfiguration<biome_js_analyze::options::NoSuspiciousSemicolonInJsx>>,
	/// Disallow then property.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_then_property:Option<RuleConfiguration<biome_js_analyze::options::NoThenProperty>>,
	/// Disallow unsafe declaration merging between interfaces and classes.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_unsafe_declaration_merging:Option<RuleConfiguration<biome_js_analyze::options::NoUnsafeDeclarationMerging>>,
	/// Disallow using unsafe negation.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub no_unsafe_negation:Option<RuleFixConfiguration<biome_js_analyze::options::NoUnsafeNegation>>,
	/// Ensure async functions utilize await.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_await:Option<RuleConfiguration<biome_js_analyze::options::UseAwait>>,
	/// Enforce default clauses in switch statements to be last
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_default_switch_clause_last:Option<RuleConfiguration<biome_js_analyze::options::UseDefaultSwitchClauseLast>>,
	...
	/// Require using the namespace keyword over the module keyword to declare
	/// TypeScript namespaces.
	#[serde(skip_serializing_if = "Option::is_none")]
	pub use_namespace_keyword:Option<RuleFixConfiguration<biome_js_analyze::options::UseNamespaceKeyword>>,
	...
	/// This rule checks that the result of a `typeof' expression is compared to
	/// a valid value.
	#[serde(skip_serializing_if = "Option::is_none")]
...
impl Suspicious {
	...
	pub(crate) fn get_rule_configuration(
		...
		match rule_name {
			"noApproximativeNumericConstant" => {
				self.no_approximative_numeric_constant
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noArrayIndexKey" => self.no_array_index_key.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noAssignInExpressions" => {
				self.no_assign_in_expressions
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noAsyncPromiseExecutor" => {
			...
			"noCatchAssign" => self.no_catch_assign.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noClassAssign" => self.no_class_assign.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noCommentText" => self.no_comment_text.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noCompareNegZero" => self.no_compare_neg_zero.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noConfusingLabels" => self.no_confusing_labels.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noConfusingVoidType" => {
				self.no_confusing_void_type
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noConsole" => self.no_console.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noConsoleLog" => self.no_console_log.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noConstEnum" => self.no_const_enum.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noControlCharactersInRegex" => {
				self.no_control_characters_in_regex
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noDebugger" => self.no_debugger.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noDoubleEquals" => self.no_double_equals.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noDuplicateAtImportRules" => {
				self.no_duplicate_at_import_rules
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noDuplicateCase" => self.no_duplicate_case.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noDuplicateClassMembers" => {
				self.no_duplicate_class_members
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noDuplicateFontNames" => {
				self.no_duplicate_font_names
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noDuplicateJsxProps" => {
				self.no_duplicate_jsx_props
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noDuplicateObjectKeys" => {
				self.no_duplicate_object_keys
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noDuplicateParameters" => {
			...
			"noDuplicateTestHooks" => {
				self.no_duplicate_test_hooks
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noEmptyBlock" => self.no_empty_block.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noEmptyBlockStatements" => {
				self.no_empty_block_statements
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noEmptyInterface" => self.no_empty_interface.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noEvolvingTypes" => self.no_evolving_types.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noExplicitAny" => self.no_explicit_any.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noExportsInTest" => self.no_exports_in_test.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noExtraNonNullAssertion" => {
				self.no_extra_non_null_assertion
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noFallthroughSwitchClause" => {
				self.no_fallthrough_switch_clause
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noFocusedTests" => self.no_focused_tests.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noFunctionAssign" => self.no_function_assign.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noGlobalAssign" => self.no_global_assign.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noGlobalIsFinite" => self.no_global_is_finite.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noGlobalIsNan" => self.no_global_is_nan.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noImplicitAnyLet" => self.no_implicit_any_let.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noImportAssign" => self.no_import_assign.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noImportantInKeyframe" => {
				self.no_important_in_keyframe
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noLabelVar" => self.no_label_var.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noMisleadingCharacterClass" => {
				self.no_misleading_character_class
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noMisleadingInstantiator" => {
				self.no_misleading_instantiator
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noMisplacedAssertion" => {
				self.no_misplaced_assertion
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noMisrefactoredShorthandAssign" => {
				self.no_misrefactored_shorthand_assign
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noPrototypeBuiltins" => {
				self.no_prototype_builtins
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noReactSpecificProps" => {
			...
			"noRedeclare" => self.no_redeclare.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noRedundantUseStrict" => {
				self.no_redundant_use_strict
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noSelfCompare" => self.no_self_compare.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noShadowRestrictedNames" => {
				self.no_shadow_restricted_names
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noShorthandPropertyOverrides" => {
				self.no_shorthand_property_overrides
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noSkippedTests" => self.no_skipped_tests.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noSparseArray" => self.no_sparse_array.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noSuspiciousSemicolonInJsx" => {
				self.no_suspicious_semicolon_in_jsx
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noThenProperty" => self.no_then_property.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"noUnsafeDeclarationMerging" => {
				self.no_unsafe_declaration_merging
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"noUnsafeNegation" => self.no_unsafe_negation.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useAwait" => self.use_await.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useDefaultSwitchClauseLast" => {
				self.use_default_switch_clause_last
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useErrorMessage" => self.use_error_message.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useGetterReturn" => self.use_getter_return.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useIsArray" => self.use_is_array.as_ref().map(|conf| (conf.level(), conf.get_options())),
			"useNamespaceKeyword" => {
				self.use_namespace_keyword
					.as_ref()
					.map(|conf| (conf.level(), conf.get_options()))
			},
			"useNumberToFixedDigitsArgument" => {
			...
			"useValidTypeof" => self.use_valid_typeof.as_ref().map(|conf| (conf.level(), conf.get_options())),
			_ => None,
		}
	}
}
