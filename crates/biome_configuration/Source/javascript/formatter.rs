...
use biome_formatter::{AttributePosition, BracketSpacing, IndentStyle, IndentWidth, LineEnding, LineWidth, QuoteStyle};
use biome_js_formatter::context::{ArrowParentheses, QuoteProperties, Semicolons, trailing_commas::TrailingCommas};
use bpaf::Bpaf;
...
pub struct JavascriptFormatter {
	...
	/// Whether the formatter prints semicolons for all statements or only in
	/// for statements where it is necessary because of ASI.
	...
	// TODO: Remove in 2.0.0
	/// The size of the indentation applied to JavaScript (and its super
	...
	/// The size of the indentation applied to JavaScript (and its super
	/// languages) files. Default to 2.
	#[partial(bpaf(long("javascript-formatter-indent-width"), argument("NUMBER"), optional))]
	pub indent_width:Option<IndentWidth>,

	/// The type of line ending applied to JavaScript (and its super languages)
	/// files.
	#[partial(bpaf(long("javascript-formatter-line-ending"), argument("lf|crlf|cr"), optional))]
	pub line_ending:Option<LineEnding>,

	/// What's the max width of a line applied to JavaScript (and its super
	...
	#[partial(bpaf(long("javascript-attribute-position"), argument("multiline|auto"), optional))]
