...
use crate::analyzer::assists::{
	partial_assists_configuration, AssistsConfiguration,
...
pub use analyzer::{
	partial_linter_configuration, LinterConfiguration,
	PartialLinterConfiguration, RuleConfiguration, RuleFixConfiguration,
...
use bpaf::Bpaf;
pub use css::{
	partial_css_configuration, CssConfiguration, CssFormatter,
	PartialCssConfiguration, PartialCssFormatter,
};
pub use formatter::{
	partial_formatter_configuration, FormatterConfiguration,
	PartialFormatterConfiguration,
};
pub use graphql::{
	partial_graphql_configuration, GraphqlConfiguration, GraphqlFormatter,
	GraphqlLinter, PartialGraphqlConfiguration, PartialGraphqlFormatter,
	PartialGraphqlLinter,
};
pub use javascript::{
	partial_javascript_configuration, JavascriptConfiguration,
	JavascriptFormatter, PartialJavascriptConfiguration,
	PartialJavascriptFormatter,
};
pub use json::{
	partial_json_configuration, JsonConfiguration, JsonFormatter,
	PartialJsonConfiguration, PartialJsonFormatter,
};
pub use overrides::{
...
#[derive(
	Clone, Debug, Default, Deserialize, Eq, Partial, PartialEq, Serialize,
)]
...
pub struct Configuration {
	...
	#[partial(
		type,
		bpaf(external(partial_javascript_configuration), optional)
	)]
...
impl PartialConfiguration {
	...
	pub fn get_javascript_formatter_configuration(
		&self,
	) -> JavascriptFormatter {
		self.javascript
			.as_ref()
