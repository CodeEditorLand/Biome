...
use crate::{
	...
	json::JsonLinter,
	organize_imports::{partial_organize_imports, OrganizeImports, PartialOrganizeImports},
	vcs::{partial_vcs_configuration, PartialVcsConfiguration, VcsConfiguration},
};
pub use crate::{
...
pub struct ConfigurationPayload {
	...
	/// The path of where the `biome.json` or `biome.jsonc` file was found.
