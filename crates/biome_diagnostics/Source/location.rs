...
mod tests {
	...
	fn line_starts_with_carriage_return_line_feed() {
		...
		assert_eq!(vec![TextSize::from(0u32), TextSize::from(3u32), TextSize::from(6u32)], starts);
	}
	...
	fn line_starts_with_carriage_return() {
		...
		assert_eq!(vec![TextSize::from(0u32), TextSize::from(2u32), TextSize::from(4u32)], starts);
	}
