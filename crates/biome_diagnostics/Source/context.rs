...
mod internal {
	...
	use crate::{
		Advices, Backtrace, Category, Diagnostic, DiagnosticTags, LineIndex, LineIndexBuf, Location, LogCategory,
		Resource, Severity, SourceCode, Visit, diagnostic::internal::AsDiagnostic,
	};
