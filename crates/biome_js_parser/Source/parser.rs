...
pub(crate) use crate::parser::parse_recovery::{ParseRecoveryTokenSet, RecoveryError, RecoveryResult};
use crate::prelude::*;
...
mod tests {
	...
	fn uncompleted_markers_panic() {
		let mut parser = JsParser::new("'use strict'", JsFileSource::default(), JsParserOptions::default());
	...
	fn completed_marker_doesnt_panic() {
		let mut p = JsParser::new("'use strict'", JsFileSource::default(), JsParserOptions::default());
