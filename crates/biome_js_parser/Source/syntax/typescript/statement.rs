...
use crate::{
	...
	syntax::{
		...
		expr::{is_nth_at_identifier, parse_name, ExpressionContext},
		js_parse_error::{expected_identifier, expected_module_source},
		module::{parse_module_item_list, parse_module_source, ModuleItemListParent},
		stmt::{semi, STMT_RECOVERY_SET},
		typescript::{
			expect_ts_type_list,
