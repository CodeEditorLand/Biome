...
pub trait Deserializable: Sized {
	...
	fn deserialize(ctx: &mut impl DeserializationContext, value: &impl DeserializableValue, name: &str)
	-> Option<Self>;
}
...
impl<'a> DefaultDeserializationContext<'a> {
	fn new(id: &'a str) -> Self {
		Self { diagnostics: Default::default(), id: Some(id) }
	}
}
...
pub trait DeserializationVisitor: Sized {
	...
	fn visit_null(self, ctx: &mut impl DeserializationContext, range: TextRange, name: &str) -> Option<Self::Output> {
		debug_assert!(
