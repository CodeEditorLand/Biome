...
use super::{
	literals::{parse_boolean_literal, parse_literal},
	parse_error::*,
	parse_maybe_named_arg,
	parse_name,
	parse_not,
	patterns::{parse_container, parse_pattern},
	GritParser,
};
use crate::constants::*;
...
impl ParseSeparatedList for PredicateList {
	...
	fn parse_element(&mut self, p:&mut Self::Parser<'_>) -> ParsedSyntax { parse_predicate(p) }
