...
pub(crate) const PATTERN_ELSE_RECOVERY_SET: TokenSet<GritSyntaxKind> = token_set!(T![')'], T!['}'], UNTIL_KW, EOF);

pub(crate) const PATTERN_LIST_RECOVERY_SET: TokenSet<GritSyntaxKind> = token_set!(T![,], T![']']);

pub(crate) const PATTERN_UNTIL_RECOVERY_SET: TokenSet<GritSyntaxKind> = token_set!(T![')'], T!['}'], UNTIL_KW, EOF);

pub(crate) const PREDICATE_RECOVERY_SET: TokenSet<GritSyntaxKind> = token_set!(T![')'], T!['}'], T![,], ELSE_KW);
...
pub(crate) const SUPPORTED_ENGINE_SET: TokenSet<GritSyntaxKind> = token_set![T![biome], T![marzano]];
...
pub(crate) const SUPPORTED_LANGUAGE_FLAVOR_SET: TokenSet<GritSyntaxKind> = token_set![T![typescript], T![jsx]];
