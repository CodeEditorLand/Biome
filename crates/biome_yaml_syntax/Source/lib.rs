...
impl From<YamlSyntaxKind> for u16 {
	fn from(k:YamlSyntaxKind) -> u16 { k as u16 }
}
...
impl biome_rowan::SyntaxKind for YamlSyntaxKind {
	...
	fn is_bogus(&self) -> bool {
		matches!(self, YamlSyntaxKind::YAML_BOGUS | YamlSyntaxKind::YAML_BOGUS_VALUE)
	}
	...
	fn is_root(&self) -> bool { matches!(self, YamlSyntaxKind::YAML_ROOT) }

	fn is_list(&self) -> bool { YamlSyntaxKind::is_list(*self) }
	...
	fn to_string(&self) -> Option<&'static str> { YamlSyntaxKind::to_string(self) }
}
...
impl YamlSyntaxKind {
	...
	pub fn is_comments(self) -> bool { matches!(self, YamlSyntaxKind::COMMENT) }

	#[inline]
	pub const fn is_keyword(self) -> bool { matches!(self, T![null]) }
}
