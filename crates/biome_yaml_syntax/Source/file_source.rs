...
impl YamlFileSource {
	...
	const WELL_KNOWN_YAML_FILES: &'static [&'static str] = &[".clang-format", ".clang-tidy", ".gemrc"];
	...
	pub fn try_from_extension(extension: &str) -> Result<Self, FileSourceError> {
		...
		match extension {
			...
			"yaml" | "yml" | "eyaml" | "eyml" | "cff" | "yaml-tmlanguage" | "yaml-tmpreferences" | "yaml-tmtheme"
			| "mir" | "reek" | "rviz" | "sublime-syntax" | "syntax" | "yaml.sed" | "yml.mysql" => Ok(Self::yaml()),
