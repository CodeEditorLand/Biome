...
use crate::{
	...
	YamlLanguage as Language,
	YamlSyntaxElement as SyntaxElement,
	YamlSyntaxElementChildren as SyntaxElementChildren,
	YamlSyntaxKind::{self as SyntaxKind, *},
	YamlSyntaxList as SyntaxList,
	YamlSyntaxNode as SyntaxNode,
...
impl YamlArray {
	...
	pub fn as_fields(&self) -> YamlArrayFields { YamlArrayFields { items:self.items() } }

	pub fn items(&self) -> YamlArrayItemList { support::list(&self.syntax, 0usize) }
}
...
impl YamlArrayInline {
	...
	pub fn items(&self) -> YamlArrayInlineList { support::list(&self.syntax, 1usize) }
...
impl YamlArrayItem {
	...
	pub fn as_fields(&self) -> YamlArrayItemFields {
		YamlArrayItemFields { minus_token:self.minus_token(), item:self.item() }
	}
...
impl YamlBlockFolded {
	...
	pub fn as_fields(&self) -> YamlBlockFoldedFields {
		YamlBlockFoldedFields { r_angle_token:self.r_angle_token(), value:self.value() }
	}
...
impl YamlBlockLiteral {
	...
	pub fn as_fields(&self) -> YamlBlockLiteralFields {
		YamlBlockLiteralFields { bitwise_or_token:self.bitwise_or_token(), value:self.value() }
	}
...
impl YamlBlockValue {
	...
	pub fn as_fields(&self) -> YamlBlockValueFields {
		YamlBlockValueFields { yaml_block_value_token:self.yaml_block_value_token() }
	}
...
impl YamlBooleanValue {
	...
	pub fn as_fields(&self) -> YamlBooleanValueFields {
		YamlBooleanValueFields { value_token:self.value_token() }
	}
...
impl YamlDocument {
	...
	pub fn dashdashdash_token(&self) -> Option<SyntaxToken> { support::token(&self.syntax, 0usize) }

	pub fn body(&self) -> SyntaxResult<AnyYamlValue> {
		support::required_node(&self.syntax, 1usize)
	}

	pub fn dotdotdot_token(&self) -> Option<SyntaxToken> { support::token(&self.syntax, 2usize) }
}
...
impl YamlIdentifier {
	...
	pub fn as_fields(&self) -> YamlIdentifierFields {
		YamlIdentifierFields { value_token:self.value_token() }
	}
...
impl YamlNullValue {
	...
	pub fn as_fields(&self) -> YamlNullValueFields {
		YamlNullValueFields { value_token:self.value_token() }
	}
...
impl YamlNumberValue {
	...
	pub fn as_fields(&self) -> YamlNumberValueFields {
		YamlNumberValueFields { value_token:self.value_token() }
	}
...
impl YamlObject {
	...
	pub fn as_fields(&self) -> YamlObjectFields { YamlObjectFields { members:self.members() } }

	pub fn members(&self) -> YamlObjectMemberList { support::list(&self.syntax, 0usize) }
}
...
impl YamlRoot {
	...
	pub fn documents(&self) -> YamlDocumentList { support::list(&self.syntax, 1usize) }
...
impl YamlStringValue {
	...
	pub fn as_fields(&self) -> YamlStringValueFields {
		YamlStringValueFields { value_token:self.value_token() }
	}
...
impl AstNode for YamlArray {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == YAML_ARRAY }
...
impl std::fmt::Debug for YamlArray {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("YamlArray").field("items", &self.items()).finish()
	}
}
impl From<YamlArray> for SyntaxNode {
	fn from(n:YamlArray) -> SyntaxNode { n.syntax }
}
impl From<YamlArray> for SyntaxElement {
	fn from(n:YamlArray) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for YamlArrayInline {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == YAML_ARRAY_INLINE }
...
impl From<YamlArrayInline> for SyntaxNode {
	fn from(n:YamlArrayInline) -> SyntaxNode { n.syntax }
}
impl From<YamlArrayInline> for SyntaxElement {
	fn from(n:YamlArrayInline) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for YamlArrayItem {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == YAML_ARRAY_ITEM }
...
impl From<YamlArrayItem> for SyntaxNode {
	fn from(n:YamlArrayItem) -> SyntaxNode { n.syntax }
}
impl From<YamlArrayItem> for SyntaxElement {
	fn from(n:YamlArrayItem) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for YamlBlockFolded {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == YAML_BLOCK_FOLDED }
...
impl From<YamlBlockFolded> for SyntaxNode {
	fn from(n:YamlBlockFolded) -> SyntaxNode { n.syntax }
}
impl From<YamlBlockFolded> for SyntaxElement {
	fn from(n:YamlBlockFolded) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for YamlBlockLiteral {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == YAML_BLOCK_LITERAL }
...
impl From<YamlBlockLiteral> for SyntaxNode {
	fn from(n:YamlBlockLiteral) -> SyntaxNode { n.syntax }
}
impl From<YamlBlockLiteral> for SyntaxElement {
	fn from(n:YamlBlockLiteral) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for YamlBlockValue {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == YAML_BLOCK_VALUE }
...
impl From<YamlBlockValue> for SyntaxNode {
	fn from(n:YamlBlockValue) -> SyntaxNode { n.syntax }
}
impl From<YamlBlockValue> for SyntaxElement {
	fn from(n:YamlBlockValue) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for YamlBooleanValue {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == YAML_BOOLEAN_VALUE }
...
impl From<YamlBooleanValue> for SyntaxNode {
	fn from(n:YamlBooleanValue) -> SyntaxNode { n.syntax }
}
impl From<YamlBooleanValue> for SyntaxElement {
	fn from(n:YamlBooleanValue) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for YamlDocument {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == YAML_DOCUMENT }
...
impl std::fmt::Debug for YamlDocument {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("YamlDocument")
			.field("dashdashdash_token", &support::DebugOptionalElement(self.dashdashdash_token()))
			.field("body", &support::DebugSyntaxResult(self.body()))
			.field("dotdotdot_token", &support::DebugOptionalElement(self.dotdotdot_token()))
			.finish()
	}
}
impl From<YamlDocument> for SyntaxNode {
	fn from(n:YamlDocument) -> SyntaxNode { n.syntax }
}
impl From<YamlDocument> for SyntaxElement {
	fn from(n:YamlDocument) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for YamlIdentifier {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == YAML_IDENTIFIER }
...
impl From<YamlIdentifier> for SyntaxNode {
	fn from(n:YamlIdentifier) -> SyntaxNode { n.syntax }
}
impl From<YamlIdentifier> for SyntaxElement {
	fn from(n:YamlIdentifier) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for YamlNullValue {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == YAML_NULL_VALUE }
...
impl From<YamlNullValue> for SyntaxNode {
	fn from(n:YamlNullValue) -> SyntaxNode { n.syntax }
}
impl From<YamlNullValue> for SyntaxElement {
	fn from(n:YamlNullValue) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for YamlNumberValue {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == YAML_NUMBER_VALUE }
...
impl From<YamlNumberValue> for SyntaxNode {
	fn from(n:YamlNumberValue) -> SyntaxNode { n.syntax }
}
impl From<YamlNumberValue> for SyntaxElement {
	fn from(n:YamlNumberValue) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for YamlObject {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == YAML_OBJECT }
...
impl std::fmt::Debug for YamlObject {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("YamlObject").field("members", &self.members()).finish()
	}
}
impl From<YamlObject> for SyntaxNode {
	fn from(n:YamlObject) -> SyntaxNode { n.syntax }
}
impl From<YamlObject> for SyntaxElement {
	fn from(n:YamlObject) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for YamlObjectMember {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == YAML_OBJECT_MEMBER }
...
impl From<YamlObjectMember> for SyntaxNode {
	fn from(n:YamlObjectMember) -> SyntaxNode { n.syntax }
}
impl From<YamlObjectMember> for SyntaxElement {
	fn from(n:YamlObjectMember) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for YamlRoot {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == YAML_ROOT }
...
impl From<YamlRoot> for SyntaxNode {
	fn from(n:YamlRoot) -> SyntaxNode { n.syntax }
}
impl From<YamlRoot> for SyntaxElement {
	fn from(n:YamlRoot) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for YamlStringValue {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == YAML_STRING_VALUE }
...
impl From<YamlStringValue> for SyntaxNode {
	fn from(n:YamlStringValue) -> SyntaxNode { n.syntax }
}
impl From<YamlStringValue> for SyntaxElement {
	fn from(n:YamlStringValue) -> SyntaxElement { n.syntax.into() }
}
impl From<YamlBooleanValue> for AnyYamlScalar {
	fn from(node:YamlBooleanValue) -> AnyYamlScalar { AnyYamlScalar::YamlBooleanValue(node) }
}
impl From<YamlNullValue> for AnyYamlScalar {
	fn from(node:YamlNullValue) -> AnyYamlScalar { AnyYamlScalar::YamlNullValue(node) }
}
impl From<YamlNumberValue> for AnyYamlScalar {
	fn from(node:YamlNumberValue) -> AnyYamlScalar { AnyYamlScalar::YamlNumberValue(node) }
}
impl From<YamlStringValue> for AnyYamlScalar {
	fn from(node:YamlStringValue) -> AnyYamlScalar { AnyYamlScalar::YamlStringValue(node) }
}
...
impl From<YamlArray> for AnyYamlValue {
	fn from(node:YamlArray) -> AnyYamlValue { AnyYamlValue::YamlArray(node) }
}
impl From<YamlArrayInline> for AnyYamlValue {
	fn from(node:YamlArrayInline) -> AnyYamlValue { AnyYamlValue::YamlArrayInline(node) }
}
impl From<YamlBogusValue> for AnyYamlValue {
	fn from(node:YamlBogusValue) -> AnyYamlValue { AnyYamlValue::YamlBogusValue(node) }
}
impl From<YamlObject> for AnyYamlValue {
	fn from(node:YamlObject) -> AnyYamlValue { AnyYamlValue::YamlObject(node) }
}
...
impl AstNode for YamlBogus {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == YAML_BOGUS }
...
impl From<YamlBogus> for SyntaxNode {
	fn from(n:YamlBogus) -> SyntaxNode { n.syntax }
}
impl From<YamlBogus> for SyntaxElement {
	fn from(n:YamlBogus) -> SyntaxElement { n.syntax.into() }
}
#[derive(Clone, PartialEq, Eq, Hash, Serialize)]
...
impl AstNode for YamlBogusValue {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == YAML_BOGUS_VALUE }
...
impl From<YamlBogusValue> for SyntaxNode {
	fn from(n:YamlBogusValue) -> SyntaxNode { n.syntax }
}
impl From<YamlBogusValue> for SyntaxElement {
	fn from(n:YamlBogusValue) -> SyntaxElement { n.syntax.into() }
}
...
impl AstNode for YamlArrayInlineList {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == YAML_ARRAY_INLINE_LIST }

	fn cast(syntax:SyntaxNode) -> Option<YamlArrayInlineList> {
		if Self::can_cast(syntax.kind()) {
			Some(YamlArrayInlineList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for YamlArrayItemList {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == YAML_ARRAY_ITEM_LIST }

	fn cast(syntax:SyntaxNode) -> Option<YamlArrayItemList> {
		if Self::can_cast(syntax.kind()) {
			Some(YamlArrayItemList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for YamlDocumentList {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == YAML_DOCUMENT_LIST }

	fn cast(syntax:SyntaxNode) -> Option<YamlDocumentList> {
		if Self::can_cast(syntax.kind()) {
			Some(YamlDocumentList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for YamlObjectMemberList {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == YAML_OBJECT_MEMBER_LIST }

	fn cast(syntax:SyntaxNode) -> Option<YamlObjectMemberList> {
		if Self::can_cast(syntax.kind()) {
			Some(YamlObjectMemberList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
