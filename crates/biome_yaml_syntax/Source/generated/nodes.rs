...
impl YamlArray {
	...
	pub fn as_fields(&self) -> YamlArrayFields {
		YamlArrayFields { items: self.items() }
	}
...
impl YamlObject {
	...
	pub fn as_fields(&self) -> YamlObjectFields {
		YamlObjectFields { members: self.members() }
	}
...
impl AstNode for AnyYamlScalar {
	...
	fn can_cast(kind: SyntaxKind) -> bool {
		matches!(kind, YAML_BOOLEAN_VALUE | YAML_NULL_VALUE | YAML_NUMBER_VALUE | YAML_STRING_VALUE)
	}
	fn cast(syntax: SyntaxNode) -> Option<Self> {
