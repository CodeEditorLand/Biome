...
use biome_js_syntax::{parentheses::NeedsParentheses, TsFunctionType, TsFunctionTypeFields};
...
mod tests {
	...
	fn needs_parentheses() {
		...
		// This does require parentheses but the formatter will strip the
		// leading `&`, leaving only the inner type thus, no parentheses are
		// required
