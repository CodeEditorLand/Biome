...
use biome_js_syntax::{TsConstructorType, TsConstructorTypeFields, parentheses::NeedsParentheses};
...
impl FormatNodeRule<TsConstructorType> for FormatTsConstructorType {
	...
	fn needs_parentheses(&self, item:&TsConstructorType) -> bool { item.needs_parentheses() }
}
...
mod tests {
	...
	fn needs_parentheses() {
		...
		assert_needs_parentheses!("type s = [number, ...(new () => string)]", TsConstructorType);
