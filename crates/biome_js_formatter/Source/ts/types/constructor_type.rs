...
mod tests {
	...
	fn needs_parentheses() {
		...
		assert_not_needs_parentheses!("type s = A extends string ? (new () => string) : number", TsConstructorType);
		assert_not_needs_parentheses!("type s = A extends string ? string : (new () => string)", TsConstructorType)
	}
}
