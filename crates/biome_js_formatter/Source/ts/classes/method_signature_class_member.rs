...
use crate::{js::classes::method_class_member::FormatAnyJsMethodMember, prelude::*, utils::FormatOptionalSemicolon};
...
impl FormatNodeRule<TsMethodSignatureClassMember> for FormatTsMethodSignatureClassMember {
	fn fmt_fields(&self, node: &TsMethodSignatureClassMember, f: &mut JsFormatter) -> FormatResult<()> {
