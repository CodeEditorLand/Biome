...
use crate::{js::classes::method_class_member::FormatAnyJsMethodMember, prelude::*, utils::FormatTypeMemberSeparator};
...
impl FormatNodeRule<TsMethodSignatureTypeMember> for FormatTsMethodSignatureTypeMember {
	fn fmt_fields(&self, node: &TsMethodSignatureTypeMember, f: &mut JsFormatter) -> FormatResult<()> {
		write![
			f,
			[
