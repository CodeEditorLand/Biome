use biome_js_syntax::{parentheses::NeedsParentheses, TsSatisfiesExpression};
...
impl FormatNodeRule<TsSatisfiesExpression> for FormatTsSatisfiesExpression {
	...
	fn needs_parentheses(&self, item:&TsSatisfiesExpression) -> bool { item.needs_parentheses() }
}
