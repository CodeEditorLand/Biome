...
use crate::{prelude::*, JsFormatContext, JsFormatOptions};

/// This enum is used within formatting functions to print or omit trailing
/// commas.
#[derive(Debug, Copy, Clone)]
pub(crate) enum FormatTrailingCommas {
	/// Print trailing commas if the option is [TrailingCommas::All].
	All,
	/// Print trailing commas if the option is [TrailingCommas::All] or
	/// [TrailingCommas::Es5].
	ES5,
}

impl FormatTrailingCommas {
	/// This function returns corresponding [TrailingSeparator] for
	/// [format_separated] function.
...
pub enum TrailingCommas {
	...
	#[default]
	All,
	/// Trailing commas where valid in ES5 (objects, arrays, etc.). No trailing
...
impl TrailingCommas {
	pub const fn is_es5(&self) -> bool { matches!(self, TrailingCommas::Es5) }

	pub const fn is_all(&self) -> bool { matches!(self, TrailingCommas::All) }

	pub const fn is_none(&self) -> bool { matches!(self, TrailingCommas::None) }
}
