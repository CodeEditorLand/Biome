...
use biome_js_syntax::{parentheses::NeedsParentheses, JsObjectAssignmentPattern};

use crate::{prelude::*, utils::JsObjectPatternLike};
...
impl FormatNodeRule<JsObjectAssignmentPattern> for FormatJsObjectAssignmentPattern {
	fn fmt_fields(&self, node:&JsObjectAssignmentPattern, f:&mut JsFormatter) -> FormatResult<()> {
