use biome_js_syntax::{parentheses::NeedsParentheses, JsStaticMemberAssignment};
...
impl FormatNodeRule<JsStaticMemberAssignment> for FormatJsStaticMemberAssignment {
	...
	fn needs_parentheses(&self, item:&JsStaticMemberAssignment) -> bool { item.needs_parentheses() }
}
