...
use crate::{prelude::*, utils::format_modifiers::should_expand_decorators};
...
impl FormatRule<JsDecoratorList> for FormatJsDecoratorList {
	...
	fn fmt(&self, node:&JsDecoratorList, f:&mut JsFormatter) -> FormatResult<()> {
		...
		// we need to rearrange decorators to be before export if we have
		// decorators before class and after export
