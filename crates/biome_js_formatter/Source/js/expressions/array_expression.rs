...
impl FormatNodeRule<JsArrayExpression> for FormatJsArrayExpression {
	...
	fn needs_parentheses(&self, item:&JsArrayExpression) -> bool { item.needs_parentheses() }
...
/// * each child array expression has at least two elements, or each child
///   object expression has at least two members.
