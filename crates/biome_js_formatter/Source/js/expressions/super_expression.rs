...
use biome_js_syntax::{parentheses::NeedsParentheses, JsSuperExpression, JsSuperExpressionFields};
...
impl FormatNodeRule<JsSuperExpression> for FormatJsSuperExpression {
	...
	fn needs_parentheses(&self, item:&JsSuperExpression) -> bool { item.needs_parentheses() }
}
