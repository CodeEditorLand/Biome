...
use biome_js_syntax::{parentheses::NeedsParentheses, JsAssignmentExpression};
...
impl FormatNodeRule<JsAssignmentExpression> for FormatJsAssignmentExpression {
	...
	fn needs_parentheses(&self, item:&JsAssignmentExpression) -> bool { item.needs_parentheses() }
}
