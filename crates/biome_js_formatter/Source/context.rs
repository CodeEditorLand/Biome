...
pub struct JsFormatOptions {
	...
	/// Whether to add non-necessary parentheses to arrow functions. Defaults
	/// to "always".
	...
	/// Whether to hug the closing bracket of multiline HTML/JSX tags to the
	/// end of the last line, rather than being alone on the following line.
	/// Defaults to false.
