...
use biome_formatter::{
	AttributePosition, BracketSpacing, CstFormatContext, FormatContext,
	FormatElement, FormatOptions, IndentStyle, IndentWidth, LineEnding,
...
impl JsFormatContext {
	...
	pub(crate) fn get_cached_function_body(
		...
		self.cached_function_body.as_ref().and_then(
			|(expected_body, formatted)| {
...
impl JsFormatOptions {
	...
	pub fn with_attribute_position(
		mut self,
		attribute_position: AttributePosition,
	) -> Self {
