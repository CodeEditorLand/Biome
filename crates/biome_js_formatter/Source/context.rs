...
use biome_formatter::{
	AttributePosition, BracketSameLine, BracketSpacing, CstFormatContext, Expand, FormatContext, FormatElement,
...
impl JsFormatContext {
	...
	pub(crate) fn get_cached_function_body(&self, body: &AnyJsFunctionBody) -> Option<FormatElement> {
	...
	///
	/// See [JsFormatContext::cached_function_body] for more in depth documentation.
	pub(crate) fn set_cached_function_body(&mut self, body: &AnyJsFunctionBody, formatted: FormatElement) {
