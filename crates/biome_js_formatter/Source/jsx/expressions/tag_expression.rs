...
use biome_js_syntax::{
	JsArrowFunctionExpression, JsCallArgumentList, JsCallExpression, JsxExpressionChild, JsxTagExpression,
};
...
pub fn should_expand(expression: &JsxTagExpression) -> bool {
	...
	call.parent().is_some_and(|parent| JsxExpressionChild::can_cast(parent.kind()))
}
