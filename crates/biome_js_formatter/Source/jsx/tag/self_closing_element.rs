...
use crate::{jsx::tag::opening_element::AnyJsxOpeningElement, prelude::*, utils::jsx::is_jsx_suppressed};
...
impl FormatNodeRule<JsxSelfClosingElement> for FormatJsxSelfClosingElement {
	...
	fn fmt_leading_comments(&self, node: &JsxSelfClosingElement, f: &mut JsFormatter) -> FormatResult<()> {
		debug_assert!(
	...
	fn fmt_dangling_comments(&self, node: &JsxSelfClosingElement, f: &mut JsFormatter) -> FormatResult<()> {
		debug_assert!(
	...
	fn fmt_trailing_comments(&self, node: &JsxSelfClosingElement, f: &mut JsFormatter) -> FormatResult<()> {
		debug_assert!(
