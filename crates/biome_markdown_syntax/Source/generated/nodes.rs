...
use crate::{
	...
	MarkdownSyntaxElement as SyntaxElement,
	MarkdownSyntaxElementChildren as SyntaxElementChildren,
	MarkdownSyntaxKind::{self as SyntaxKind, *},
	MarkdownSyntaxList as SyntaxList,
	MarkdownSyntaxNode as SyntaxNode,
...
impl MdBulletListItem {
	...
	pub fn as_fields(&self) -> MdBulletListItemFields {
		MdBulletListItemFields { md_bullet_list:self.md_bullet_list() }
	}

	pub fn md_bullet_list(&self) -> MdBulletList { support::list(&self.syntax, 0usize) }
}
...
impl MdDocument {
	...
	pub fn value(&self) -> MdBlockList { support::list(&self.syntax, 1usize) }
...
impl MdFencedCodeBlock {
	...
	pub fn as_fields(&self) -> MdFencedCodeBlockFields {
		MdFencedCodeBlockFields { md_textual:self.md_textual() }
	}
...
impl MdHardLine {
	...
	pub fn as_fields(&self) -> MdHardLineFields {
		MdHardLineFields { value_token:self.value_token() }
	}
...
impl MdHash {
	...
	pub fn as_fields(&self) -> MdHashFields { MdHashFields { hash_token:self.hash_token() } }
...
impl MdHeader {
	...
	pub fn before(&self) -> MdHashList { support::list(&self.syntax, 0usize) }

	pub fn md_paragraph(&self) -> Option<MdParagraph> { support::node(&self.syntax, 1usize) }

	pub fn after(&self) -> MdHashList { support::list(&self.syntax, 2usize) }
}
...
impl MdHtmlBlock {
	...
	pub fn as_fields(&self) -> MdHtmlBlockFields {
		MdHtmlBlockFields { md_textual:self.md_textual() }
	}
...
impl MdIndent {
	...
	pub fn as_fields(&self) -> MdIndentFields { MdIndentFields { value_token:self.value_token() } }
...
impl MdIndentCodeBlock {
	...
	pub fn as_fields(&self) -> MdIndentCodeBlockFields {
		MdIndentCodeBlockFields { md_textual:self.md_textual() }
	}
...
impl MdInlineCode {
	...
	pub fn as_fields(&self) -> MdInlineCodeFields {
		MdInlineCodeFields { md_textual:self.md_textual() }
	}
...
impl MdInlineEmphasis {
	...
	pub fn as_fields(&self) -> MdInlineEmphasisFields {
		MdInlineEmphasisFields { md_textual:self.md_textual() }
	}
...
impl MdInlineImage {
	...
	pub fn as_fields(&self) -> MdInlineImageFields {
		MdInlineImageFields { alt:self.alt(), src:self.src(), title:self.title() }
	}

	pub fn alt(&self) -> SyntaxResult<MdTextual> { support::required_node(&self.syntax, 0usize) }

	pub fn src(&self) -> SyntaxResult<MdTextual> { support::required_node(&self.syntax, 1usize) }

	pub fn title(&self) -> Option<MdTextual> { support::node(&self.syntax, 2usize) }
}
...
impl MdInlineLink {
	...
	pub fn as_fields(&self) -> MdInlineLinkFields {
		MdInlineLinkFields { label:self.label(), url:self.url(), title:self.title() }
	}

	pub fn label(&self) -> SyntaxResult<MdTextual> { support::required_node(&self.syntax, 0usize) }

	pub fn url(&self) -> SyntaxResult<MdTextual> { support::required_node(&self.syntax, 1usize) }
...
impl MdLinkBlock {
	...
	pub fn as_fields(&self) -> MdLinkBlockFields {
		MdLinkBlockFields { label:self.label(), url:self.url(), title:self.title() }
	}
...
impl MdOrderListItem {
	...
	pub fn as_fields(&self) -> MdOrderListItemFields {
		MdOrderListItemFields { md_bullet_list:self.md_bullet_list() }
	}
...
impl MdParagraph {
	...
	pub fn as_fields(&self) -> MdParagraphFields {
		MdParagraphFields { md_paragraph_item_list:self.md_paragraph_item_list() }
	}
...
impl MdQuote {
	...
	pub fn as_fields(&self) -> MdQuoteFields { MdQuoteFields { any_md_block:self.any_md_block() } }
...
impl MdSetextHeader {
	...
	pub fn as_fields(&self) -> MdSetextHeaderFields {
		MdSetextHeaderFields { md_paragraph:self.md_paragraph() }
	}
...
impl MdSoftBreak {
	...
	pub fn as_fields(&self) -> MdSoftBreakFields {
		MdSoftBreakFields { value_token:self.value_token() }
	}
...
impl MdTextual {
	...
	pub fn as_fields(&self) -> MdTextualFields {
		MdTextualFields { value_token:self.value_token() }
	}
...
impl MdThematicBreakBlock {
	...
	pub fn as_fields(&self) -> MdThematicBreakBlockFields {
		MdThematicBreakBlockFields { value_token:self.value_token() }
	}
...
impl AstNode for MdBulletListItem {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == MD_BULLET_LIST_ITEM }
...
impl From<MdBulletListItem> for SyntaxNode {
	fn from(n:MdBulletListItem) -> SyntaxNode { n.syntax }
}
impl From<MdBulletListItem> for SyntaxElement {
	fn from(n:MdBulletListItem) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for MdDocument {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == MD_DOCUMENT }
...
impl From<MdDocument> for SyntaxNode {
	fn from(n:MdDocument) -> SyntaxNode { n.syntax }
}
impl From<MdDocument> for SyntaxElement {
	fn from(n:MdDocument) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for MdFencedCodeBlock {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == MD_FENCED_CODE_BLOCK }
...
impl From<MdFencedCodeBlock> for SyntaxNode {
	fn from(n:MdFencedCodeBlock) -> SyntaxNode { n.syntax }
}
impl From<MdFencedCodeBlock> for SyntaxElement {
	fn from(n:MdFencedCodeBlock) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for MdHardLine {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == MD_HARD_LINE }
...
impl From<MdHardLine> for SyntaxNode {
	fn from(n:MdHardLine) -> SyntaxNode { n.syntax }
}
impl From<MdHardLine> for SyntaxElement {
	fn from(n:MdHardLine) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for MdHash {
	type Language = Language;

	const KIND_SET:SyntaxKindSet<Language> = SyntaxKindSet::from_raw(RawSyntaxKind(MD_HASH as u16));

	fn can_cast(kind:SyntaxKind) -> bool { kind == MD_HASH }
...
impl From<MdHash> for SyntaxNode {
	fn from(n:MdHash) -> SyntaxNode { n.syntax }
}
impl From<MdHash> for SyntaxElement {
	fn from(n:MdHash) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for MdHeader {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == MD_HEADER }
...
impl std::fmt::Debug for MdHeader {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("MdHeader")
			...
			.field("md_paragraph", &support::DebugOptionalElement(self.md_paragraph()))
			.field("after", &self.after())
			.finish()
	}
}
impl From<MdHeader> for SyntaxNode {
	fn from(n:MdHeader) -> SyntaxNode { n.syntax }
}
impl From<MdHeader> for SyntaxElement {
	fn from(n:MdHeader) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for MdHtmlBlock {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == MD_HTML_BLOCK }
...
impl From<MdHtmlBlock> for SyntaxNode {
	fn from(n:MdHtmlBlock) -> SyntaxNode { n.syntax }
}
impl From<MdHtmlBlock> for SyntaxElement {
	fn from(n:MdHtmlBlock) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for MdIndent {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == MD_INDENT }
...
impl From<MdIndent> for SyntaxNode {
	fn from(n:MdIndent) -> SyntaxNode { n.syntax }
}
impl From<MdIndent> for SyntaxElement {
	fn from(n:MdIndent) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for MdIndentCodeBlock {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == MD_INDENT_CODE_BLOCK }
...
impl From<MdIndentCodeBlock> for SyntaxNode {
	fn from(n:MdIndentCodeBlock) -> SyntaxNode { n.syntax }
}
impl From<MdIndentCodeBlock> for SyntaxElement {
	fn from(n:MdIndentCodeBlock) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for MdInlineCode {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == MD_INLINE_CODE }
...
impl From<MdInlineCode> for SyntaxNode {
	fn from(n:MdInlineCode) -> SyntaxNode { n.syntax }
}
impl From<MdInlineCode> for SyntaxElement {
	fn from(n:MdInlineCode) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for MdInlineEmphasis {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == MD_INLINE_EMPHASIS }
...
impl From<MdInlineEmphasis> for SyntaxNode {
	fn from(n:MdInlineEmphasis) -> SyntaxNode { n.syntax }
}
impl From<MdInlineEmphasis> for SyntaxElement {
	fn from(n:MdInlineEmphasis) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for MdInlineImage {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == MD_INLINE_IMAGE }
...
impl From<MdInlineImage> for SyntaxNode {
	fn from(n:MdInlineImage) -> SyntaxNode { n.syntax }
}
impl From<MdInlineImage> for SyntaxElement {
	fn from(n:MdInlineImage) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for MdInlineLink {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == MD_INLINE_LINK }
...
impl From<MdInlineLink> for SyntaxNode {
	fn from(n:MdInlineLink) -> SyntaxNode { n.syntax }
}
impl From<MdInlineLink> for SyntaxElement {
	fn from(n:MdInlineLink) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for MdLinkBlock {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == MD_LINK_BLOCK }
...
impl From<MdLinkBlock> for SyntaxNode {
	fn from(n:MdLinkBlock) -> SyntaxNode { n.syntax }
}
impl From<MdLinkBlock> for SyntaxElement {
	fn from(n:MdLinkBlock) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for MdOrderListItem {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == MD_ORDER_LIST_ITEM }
...
impl From<MdOrderListItem> for SyntaxNode {
	fn from(n:MdOrderListItem) -> SyntaxNode { n.syntax }
}
impl From<MdOrderListItem> for SyntaxElement {
	fn from(n:MdOrderListItem) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for MdParagraph {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == MD_PARAGRAPH }
...
impl From<MdParagraph> for SyntaxNode {
	fn from(n:MdParagraph) -> SyntaxNode { n.syntax }
}
impl From<MdParagraph> for SyntaxElement {
	fn from(n:MdParagraph) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for MdQuote {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == MD_QUOTE }
...
impl std::fmt::Debug for MdQuote {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("MdQuote")
			.field("any_md_block", &support::DebugSyntaxResult(self.any_md_block()))
			.finish()
	}
}
impl From<MdQuote> for SyntaxNode {
	fn from(n:MdQuote) -> SyntaxNode { n.syntax }
}
impl From<MdQuote> for SyntaxElement {
	fn from(n:MdQuote) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for MdSetextHeader {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == MD_SETEXT_HEADER }
...
impl std::fmt::Debug for MdSetextHeader {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("MdSetextHeader")
			.field("md_paragraph", &support::DebugSyntaxResult(self.md_paragraph()))
			.finish()
	}
}
impl From<MdSetextHeader> for SyntaxNode {
	fn from(n:MdSetextHeader) -> SyntaxNode { n.syntax }
}
impl From<MdSetextHeader> for SyntaxElement {
	fn from(n:MdSetextHeader) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for MdSoftBreak {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == MD_SOFT_BREAK }
...
impl From<MdSoftBreak> for SyntaxNode {
	fn from(n:MdSoftBreak) -> SyntaxNode { n.syntax }
}
impl From<MdSoftBreak> for SyntaxElement {
	fn from(n:MdSoftBreak) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for MdTextual {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == MD_TEXTUAL }
...
impl From<MdTextual> for SyntaxNode {
	fn from(n:MdTextual) -> SyntaxNode { n.syntax }
}
impl From<MdTextual> for SyntaxElement {
	fn from(n:MdTextual) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for MdThematicBreakBlock {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == MD_THEMATIC_BREAK_BLOCK }
...
impl From<MdThematicBreakBlock> for SyntaxNode {
	fn from(n:MdThematicBreakBlock) -> SyntaxNode { n.syntax }
}
impl From<MdThematicBreakBlock> for SyntaxElement {
	fn from(n:MdThematicBreakBlock) -> SyntaxElement { n.syntax.into() }
}
impl From<MdFencedCodeBlock> for AnyCodeBlock {
	fn from(node:MdFencedCodeBlock) -> AnyCodeBlock { AnyCodeBlock::MdFencedCodeBlock(node) }
}
impl From<MdIndentCodeBlock> for AnyCodeBlock {
	fn from(node:MdIndentCodeBlock) -> AnyCodeBlock { AnyCodeBlock::MdIndentCodeBlock(node) }
}
...
impl From<MdOrderListItem> for AnyContainerBlock {
	fn from(node:MdOrderListItem) -> AnyContainerBlock { AnyContainerBlock::MdOrderListItem(node) }
}
impl From<MdQuote> for AnyContainerBlock {
	fn from(node:MdQuote) -> AnyContainerBlock { AnyContainerBlock::MdQuote(node) }
}
...
impl From<MdHeader> for AnyLeafBlock {
	fn from(node:MdHeader) -> AnyLeafBlock { AnyLeafBlock::MdHeader(node) }
}
impl From<MdHtmlBlock> for AnyLeafBlock {
	fn from(node:MdHtmlBlock) -> AnyLeafBlock { AnyLeafBlock::MdHtmlBlock(node) }
}
impl From<MdLinkBlock> for AnyLeafBlock {
	fn from(node:MdLinkBlock) -> AnyLeafBlock { AnyLeafBlock::MdLinkBlock(node) }
}
impl From<MdParagraph> for AnyLeafBlock {
	fn from(node:MdParagraph) -> AnyLeafBlock { AnyLeafBlock::MdParagraph(node) }
}
impl From<MdSetextHeader> for AnyLeafBlock {
	fn from(node:MdSetextHeader) -> AnyLeafBlock { AnyLeafBlock::MdSetextHeader(node) }
}
impl From<MdThematicBreakBlock> for AnyLeafBlock {
	fn from(node:MdThematicBreakBlock) -> AnyLeafBlock { AnyLeafBlock::MdThematicBreakBlock(node) }
}
...
impl From<MdHardLine> for AnyMdInline {
	fn from(node:MdHardLine) -> AnyMdInline { AnyMdInline::MdHardLine(node) }
}
impl From<MdHtmlBlock> for AnyMdInline {
	fn from(node:MdHtmlBlock) -> AnyMdInline { AnyMdInline::MdHtmlBlock(node) }
}
impl From<MdInlineCode> for AnyMdInline {
	fn from(node:MdInlineCode) -> AnyMdInline { AnyMdInline::MdInlineCode(node) }
}
impl From<MdInlineEmphasis> for AnyMdInline {
	fn from(node:MdInlineEmphasis) -> AnyMdInline { AnyMdInline::MdInlineEmphasis(node) }
}
impl From<MdInlineImage> for AnyMdInline {
	fn from(node:MdInlineImage) -> AnyMdInline { AnyMdInline::MdInlineImage(node) }
}
impl From<MdInlineLink> for AnyMdInline {
	fn from(node:MdInlineLink) -> AnyMdInline { AnyMdInline::MdInlineLink(node) }
}
impl From<MdSoftBreak> for AnyMdInline {
	fn from(node:MdSoftBreak) -> AnyMdInline { AnyMdInline::MdSoftBreak(node) }
}
impl From<MdTextual> for AnyMdInline {
	fn from(node:MdTextual) -> AnyMdInline { AnyMdInline::MdTextual(node) }
}
...
impl AstNode for MdBlockList {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == MD_BLOCK_LIST }

	fn cast(syntax:SyntaxNode) -> Option<MdBlockList> {
		if Self::can_cast(syntax.kind()) {
			Some(MdBlockList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for MdBulletList {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == MD_BULLET_LIST }

	fn cast(syntax:SyntaxNode) -> Option<MdBulletList> {
		if Self::can_cast(syntax.kind()) {
			Some(MdBulletList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for MdHashList {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == MD_HASH_LIST }

	fn cast(syntax:SyntaxNode) -> Option<MdHashList> {
		if Self::can_cast(syntax.kind()) {
			Some(MdHashList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for MdOrderList {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == MD_ORDER_LIST }

	fn cast(syntax:SyntaxNode) -> Option<MdOrderList> {
		if Self::can_cast(syntax.kind()) {
			Some(MdOrderList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for MdParagraphItemList {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == MD_PARAGRAPH_ITEM_LIST }

	fn cast(syntax:SyntaxNode) -> Option<MdParagraphItemList> {
		if Self::can_cast(syntax.kind()) {
			Some(MdParagraphItemList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
