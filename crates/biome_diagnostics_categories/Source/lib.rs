...
///
/// This type cannot be instantiated outside of the
/// `biome_diagnostics_categories` crate, which serves as a registry for all
/// known diagnostic categories (currently this registry is fully static and
...
impl Category {
	...
	/// with this category
	pub fn link(&self) -> Option<&'static str> { self.link }
}
...
// Import the code generated by the build script from the content of
// `src/categories.rs`
