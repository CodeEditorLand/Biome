...
pub fn css_attribute_matcher(operator_token:SyntaxToken, value:CssAttributeMatcherValue) -> CssAttributeMatcherBuilder {
	CssAttributeMatcherBuilder { operator_token, value, modifier_token:None }
}
...
pub fn css_attribute_name(name:CssIdentifier) -> CssAttributeNameBuilder {
	CssAttributeNameBuilder { name, namespace:None }
}
...
impl CssAttributeNameBuilder {
	...
	pub fn build(self) -> CssAttributeName {
		CssAttributeName::unwrap_cast(SyntaxNode::new_detached(
			...
			[
				self.namespace.map(|token| SyntaxElement::Node(token.into_syntax())),
...
pub fn css_attribute_selector(
	...
	CssAttributeSelectorBuilder { l_brack_token, name, r_brack_token, matcher:None }
}
	...
	pub fn build(self) -> CssAttributeSelector {
		CssAttributeSelector::unwrap_cast(SyntaxNode::new_detached(
			...
			[
				...
				Some(SyntaxElement::Node(self.name.into_syntax())),
				self.matcher.map(|token| SyntaxElement::Node(token.into_syntax())),
...
pub fn css_composes_property_value(classes:CssComposesClassList) -> CssComposesPropertyValueBuilder {
	CssComposesPropertyValueBuilder { classes, specifier:None }
}
	...
	pub fn build(self) -> CssComposesPropertyValue {
		CssComposesPropertyValue::unwrap_cast(SyntaxNode::new_detached(
			...
			[
				...
				self.specifier.map(|token| SyntaxElement::Node(token.into_syntax())),
			],
		))
	}
}
pub fn css_compound_selector(
	...
	CssCompoundSelectorBuilder { nesting_selectors, sub_selectors, simple_selector:None }
}
	...
	pub fn build(self) -> CssCompoundSelector {
		CssCompoundSelector::unwrap_cast(SyntaxNode::new_detached(
			...
			[
				...
				self.simple_selector.map(|token| SyntaxElement::Node(token.into_syntax())),
...
pub fn css_container_at_rule(
	...
	CssContainerAtRuleBuilder { container_token, query, block, name:None }
}
	...
	pub fn build(self) -> CssContainerAtRule {
		CssContainerAtRule::unwrap_cast(SyntaxNode::new_detached(
			...
			[
				...
				self.name.map(|token| SyntaxElement::Node(token.into_syntax())),
...
pub fn css_container_not_query(not_token:SyntaxToken, query:AnyCssContainerQueryInParens) -> CssContainerNotQuery {
...
pub fn css_declaration(property:AnyCssProperty) -> CssDeclarationBuilder {
	CssDeclarationBuilder { property, important:None }
}
	...
	pub fn build(self) -> CssDeclaration {
		CssDeclaration::unwrap_cast(SyntaxNode::new_detached(
			...
			[
				...
				self.important.map(|token| SyntaxElement::Node(token.into_syntax())),
			],
		))
	}
}
...
pub fn css_declaration_important(excl_token:SyntaxToken, important_token:SyntaxToken) -> CssDeclarationImportant {
...
pub fn css_declaration_with_semicolon(declaration:CssDeclaration) -> CssDeclarationWithSemicolonBuilder {
	CssDeclarationWithSemicolonBuilder { declaration, semicolon_token:None }
}
...
pub fn css_document_custom_matcher(
	...
	CssDocumentCustomMatcherBuilder { name_token, l_paren_token, r_paren_token, value:None }
}
...
pub fn css_font_face_at_rule(font_face_token:SyntaxToken, block:AnyCssDeclarationBlock) -> CssFontFaceAtRule {
...
pub fn css_import_at_rule(
	...
	CssImportAtRuleBuilder { import_token, url, media, semicolon_token, layer:None, supports:None }
}
	...
	pub fn build(self) -> CssImportAtRule {
		CssImportAtRule::unwrap_cast(SyntaxNode::new_detached(
			...
			[
				...
				self.layer.map(|token| SyntaxElement::Node(token.into_syntax())),
				self.supports.map(|token| SyntaxElement::Node(token.into_syntax())),
...
pub fn css_keyframes_item(selectors:CssKeyframesSelectorList, block:AnyCssDeclarationBlock) -> CssKeyframesItem {
...
pub fn css_keyframes_percentage_selector(selector:CssPercentage) -> CssKeyframesPercentageSelector {
...
pub fn css_keyframes_scope_prefix(scope_token:SyntaxToken, name:AnyCssKeyframesIdentifier) -> CssKeyframesScopePrefix {
...
pub fn css_keyframes_scoped_name(colon_token:SyntaxToken, scope:AnyCssKeyframesScope) -> CssKeyframesScopedName {
...
pub fn css_layer_declaration(references:CssLayerReferenceList, block:AnyCssConditionalBlock) -> CssLayerDeclaration {
...
pub fn css_layer_reference(references:CssLayerReferenceList, semicolon_token:SyntaxToken) -> CssLayerReference {
...
pub fn css_media_not_condition(not_token:SyntaxToken, condition:AnyCssMediaInParens) -> CssMediaNotCondition {
...
pub fn css_media_type_query(ty:CssMediaType) -> CssMediaTypeQueryBuilder {
	CssMediaTypeQueryBuilder { ty, modifier_token:None }
}
...
pub fn css_namespace(bitwise_or_token:SyntaxToken) -> CssNamespaceBuilder {
	CssNamespaceBuilder { bitwise_or_token, prefix:None }
}
...
impl CssNamespaceBuilder {
	...
	pub fn build(self) -> CssNamespace {
		CssNamespace::unwrap_cast(SyntaxNode::new_detached(
			...
			[
				self.prefix.map(|token| SyntaxElement::Node(token.into_syntax())),
...
pub fn css_namespace_at_rule(
	...
	CssNamespaceAtRuleBuilder { namespace_token, url, semicolon_token, prefix:None }
}
...
impl CssPageSelectorBuilder {
	...
	pub fn build(self) -> CssPageSelector {
		CssPageSelector::unwrap_cast(SyntaxNode::new_detached(
			...
			[
				self.ty.map(|token| SyntaxElement::Node(token.into_syntax())),
				Some(SyntaxElement::Node(self.pseudos.into_syntax())),
			],
		))
	}
}
pub fn css_page_selector_pseudo(colon_token:SyntaxToken, selector_token:SyntaxToken) -> CssPageSelectorPseudo {
...
pub fn css_parenthesized_expression(
	...
	CssParenthesizedExpressionBuilder { l_paren_token, r_paren_token, expression:None }
}
...
pub fn css_pseudo_class_nth(symbol_token:SyntaxToken) -> CssPseudoClassNthBuilder {
	CssPseudoClassNthBuilder { symbol_token, sign_token:None, value:None, offset:None }
}
	...
	pub fn build(self) -> CssPseudoClassNth {
		CssPseudoClassNth::unwrap_cast(SyntaxNode::new_detached(
			...
			[
				...
				self.offset.map(|token| SyntaxElement::Node(token.into_syntax())),
			],
		))
	}
}
...
pub fn css_pseudo_class_nth_number(value:CssNumber) -> CssPseudoClassNthNumberBuilder {
	CssPseudoClassNthNumberBuilder { value, sign_token:None }
}
...
pub fn css_pseudo_class_nth_selector(nth:AnyCssPseudoClassNth) -> CssPseudoClassNthSelectorBuilder {
	CssPseudoClassNthSelectorBuilder { nth, of_selector:None }
}
	...
	pub fn build(self) -> CssPseudoClassNthSelector {
		CssPseudoClassNthSelector::unwrap_cast(SyntaxNode::new_detached(
			...
			[
				...
				self.of_selector.map(|token| SyntaxElement::Node(token.into_syntax())),
			],
		))
	}
}
...
pub fn css_pseudo_class_selector(colon_token:SyntaxToken, class:AnyCssPseudoClass) -> CssPseudoClassSelector {
...
pub fn css_qualified_rule(prelude:CssSelectorList, block:AnyCssDeclarationOrRuleBlock) -> CssQualifiedRule {
...
pub fn css_query_feature_range_comparison(operator_token:SyntaxToken) -> CssQueryFeatureRangeComparison {
...
pub fn css_ratio(numerator:CssNumber, slash_token:SyntaxToken, denominator:CssNumber) -> CssRatio {
...
pub fn css_regular_dimension(value_token:SyntaxToken, unit_token:SyntaxToken) -> CssRegularDimension {
	CssRegularDimension::unwrap_cast(SyntaxNode::new_detached(
		CssSyntaxKind::CSS_REGULAR_DIMENSION,
		[Some(SyntaxElement::Token(value_token)), Some(SyntaxElement::Token(unit_token))],
	))
}
pub fn css_relative_selector(selector:AnyCssSelector) -> CssRelativeSelectorBuilder {
	CssRelativeSelectorBuilder { selector, combinator_token:None }
}
...
impl CssRelativeSelectorBuilder {
	...
	pub fn build(self) -> CssRelativeSelector {
		CssRelativeSelector::unwrap_cast(SyntaxNode::new_detached(
			...
			[
				self.combinator_token.map(|token| SyntaxElement::Token(token)),
...
pub fn css_root(rules:CssRuleList, eof_token:SyntaxToken) -> CssRootBuilder {
	CssRootBuilder { rules, eof_token, bom_token:None }
}
...
pub fn css_rule_block(l_curly_token:SyntaxToken, rules:CssRuleList, r_curly_token:SyntaxToken) -> CssRuleBlock {
...
pub fn css_scope_at_rule(scope_token:SyntaxToken, block:AnyCssConditionalBlock) -> CssScopeAtRuleBuilder {
	CssScopeAtRuleBuilder { scope_token, block, range:None }
}
	...
	pub fn build(self) -> CssScopeAtRule {
		CssScopeAtRule::unwrap_cast(SyntaxNode::new_detached(
			...
			[
				...
				self.range.map(|token| SyntaxElement::Node(token.into_syntax())),
				Some(SyntaxElement::Node(self.block.into_syntax())),
			],
		))
	}
}
pub fn css_scope_edge(l_paren_token:SyntaxToken, selectors:CssSelectorList, r_paren_token:SyntaxToken) -> CssScopeEdge {
...
pub fn css_scope_range_interval(start:CssScopeEdge, to_token:SyntaxToken, end:CssScopeEdge) -> CssScopeRangeInterval {
...
pub fn css_supports_not_condition(not_token:SyntaxToken, query:AnyCssSupportsInParens) -> CssSupportsNotCondition {
...
pub fn css_type_selector(ident:CssIdentifier) -> CssTypeSelectorBuilder {
	CssTypeSelectorBuilder { ident, namespace:None }
}
...
pub fn css_universal_selector(star_token:SyntaxToken) -> CssUniversalSelectorBuilder {
	CssUniversalSelectorBuilder { star_token, namespace:None }
}
...
pub fn css_unknown_dimension(value_token:SyntaxToken, unit_token:SyntaxToken) -> CssUnknownDimension {
...
pub fn css_url_function(
	...
	CssUrlFunctionBuilder { name_token, l_paren_token, modifiers, r_paren_token, value:None }
}
...
pub fn css_value_at_rule_declaration_clause(properties:CssValueAtRulePropertyList) -> CssValueAtRuleDeclarationClause {
...
pub fn css_value_at_rule_import_specifier_list<I, S>(items:I, separators:S) -> CssValueAtRuleImportSpecifierList
where
...
where
	I: IntoIterator<Item = Option<SyntaxElement>>,
	I::IntoIter: ExactSizeIterator, {
	CssBogusAtRule::unwrap_cast(SyntaxNode::new_detached(CssSyntaxKind::CSS_BOGUS_AT_RULE, slots))
}
pub fn css_bogus_block<I>(slots:I) -> CssBogusBlock
where
	I: IntoIterator<Item = Option<SyntaxElement>>,
	I::IntoIter: ExactSizeIterator, {
	CssBogusBlock::unwrap_cast(SyntaxNode::new_detached(CssSyntaxKind::CSS_BOGUS_BLOCK, slots))
}
pub fn css_bogus_custom_identifier<I>(slots:I) -> CssBogusCustomIdentifier
where
	I: IntoIterator<Item = Option<SyntaxElement>>,
	I::IntoIter: ExactSizeIterator, {
	CssBogusCustomIdentifier::unwrap_cast(SyntaxNode::new_detached(CssSyntaxKind::CSS_BOGUS_CUSTOM_IDENTIFIER, slots))
}
pub fn css_bogus_declaration_item<I>(slots:I) -> CssBogusDeclarationItem
where
	I: IntoIterator<Item = Option<SyntaxElement>>,
	I::IntoIter: ExactSizeIterator, {
	CssBogusDeclarationItem::unwrap_cast(SyntaxNode::new_detached(CssSyntaxKind::CSS_BOGUS_DECLARATION_ITEM, slots))
}
pub fn css_bogus_document_matcher<I>(slots:I) -> CssBogusDocumentMatcher
where
	I: IntoIterator<Item = Option<SyntaxElement>>,
	I::IntoIter: ExactSizeIterator, {
	CssBogusDocumentMatcher::unwrap_cast(SyntaxNode::new_detached(CssSyntaxKind::CSS_BOGUS_DOCUMENT_MATCHER, slots))
}
pub fn css_bogus_font_family_name<I>(slots:I) -> CssBogusFontFamilyName
where
	I: IntoIterator<Item = Option<SyntaxElement>>,
	I::IntoIter: ExactSizeIterator, {
	CssBogusFontFamilyName::unwrap_cast(SyntaxNode::new_detached(CssSyntaxKind::CSS_BOGUS_FONT_FAMILY_NAME, slots))
}
...
where
	I: IntoIterator<Item = Option<SyntaxElement>>,
	I::IntoIter: ExactSizeIterator, {
	CssBogusKeyframesItem::unwrap_cast(SyntaxNode::new_detached(CssSyntaxKind::CSS_BOGUS_KEYFRAMES_ITEM, slots))
}
pub fn css_bogus_keyframes_name<I>(slots:I) -> CssBogusKeyframesName
where
	I: IntoIterator<Item = Option<SyntaxElement>>,
	I::IntoIter: ExactSizeIterator, {
	CssBogusKeyframesName::unwrap_cast(SyntaxNode::new_detached(CssSyntaxKind::CSS_BOGUS_KEYFRAMES_NAME, slots))
}
pub fn css_bogus_layer<I>(slots:I) -> CssBogusLayer
where
	I: IntoIterator<Item = Option<SyntaxElement>>,
	I::IntoIter: ExactSizeIterator, {
	CssBogusLayer::unwrap_cast(SyntaxNode::new_detached(CssSyntaxKind::CSS_BOGUS_LAYER, slots))
}
pub fn css_bogus_media_query<I>(slots:I) -> CssBogusMediaQuery
where
	I: IntoIterator<Item = Option<SyntaxElement>>,
	I::IntoIter: ExactSizeIterator, {
	CssBogusMediaQuery::unwrap_cast(SyntaxNode::new_detached(CssSyntaxKind::CSS_BOGUS_MEDIA_QUERY, slots))
}
...
where
	I: IntoIterator<Item = Option<SyntaxElement>>,
	I::IntoIter: ExactSizeIterator, {
	CssBogusParameter::unwrap_cast(SyntaxNode::new_detached(CssSyntaxKind::CSS_BOGUS_PARAMETER, slots))
}
pub fn css_bogus_property<I>(slots:I) -> CssBogusProperty
where
	I: IntoIterator<Item = Option<SyntaxElement>>,
	I::IntoIter: ExactSizeIterator, {
	CssBogusProperty::unwrap_cast(SyntaxNode::new_detached(CssSyntaxKind::CSS_BOGUS_PROPERTY, slots))
}
pub fn css_bogus_property_value<I>(slots:I) -> CssBogusPropertyValue
where
	I: IntoIterator<Item = Option<SyntaxElement>>,
	I::IntoIter: ExactSizeIterator, {
	CssBogusPropertyValue::unwrap_cast(SyntaxNode::new_detached(CssSyntaxKind::CSS_BOGUS_PROPERTY_VALUE, slots))
}
pub fn css_bogus_pseudo_class<I>(slots:I) -> CssBogusPseudoClass
where
	I: IntoIterator<Item = Option<SyntaxElement>>,
	I::IntoIter: ExactSizeIterator, {
	CssBogusPseudoClass::unwrap_cast(SyntaxNode::new_detached(CssSyntaxKind::CSS_BOGUS_PSEUDO_CLASS, slots))
}
pub fn css_bogus_pseudo_element<I>(slots:I) -> CssBogusPseudoElement
where
	I: IntoIterator<Item = Option<SyntaxElement>>,
	I::IntoIter: ExactSizeIterator, {
	CssBogusPseudoElement::unwrap_cast(SyntaxNode::new_detached(CssSyntaxKind::CSS_BOGUS_PSEUDO_ELEMENT, slots))
}
pub fn css_bogus_rule<I>(slots:I) -> CssBogusRule
where
	I: IntoIterator<Item = Option<SyntaxElement>>,
	I::IntoIter: ExactSizeIterator, {
	CssBogusRule::unwrap_cast(SyntaxNode::new_detached(CssSyntaxKind::CSS_BOGUS_RULE, slots))
}
pub fn css_bogus_scope_range<I>(slots:I) -> CssBogusScopeRange
where
	I: IntoIterator<Item = Option<SyntaxElement>>,
	I::IntoIter: ExactSizeIterator, {
	CssBogusScopeRange::unwrap_cast(SyntaxNode::new_detached(CssSyntaxKind::CSS_BOGUS_SCOPE_RANGE, slots))
}
pub fn css_bogus_selector<I>(slots:I) -> CssBogusSelector
where
	I: IntoIterator<Item = Option<SyntaxElement>>,
	I::IntoIter: ExactSizeIterator, {
	CssBogusSelector::unwrap_cast(SyntaxNode::new_detached(CssSyntaxKind::CSS_BOGUS_SELECTOR, slots))
}
pub fn css_bogus_sub_selector<I>(slots:I) -> CssBogusSubSelector
where
	I: IntoIterator<Item = Option<SyntaxElement>>,
	I::IntoIter: ExactSizeIterator, {
	CssBogusSubSelector::unwrap_cast(SyntaxNode::new_detached(CssSyntaxKind::CSS_BOGUS_SUB_SELECTOR, slots))
}
...
where
	I: IntoIterator<Item = Option<SyntaxElement>>,
	I::IntoIter: ExactSizeIterator, {
	CssBogusUrlModifier::unwrap_cast(SyntaxNode::new_detached(CssSyntaxKind::CSS_BOGUS_URL_MODIFIER, slots))
}
