...
impl SyntaxFactory for CssSyntaxFactory {
	...
	fn make_syntax(kind:Self::Kind, children:ParsedChildren<Self::Kind>) -> RawSyntaxNode<Self::Kind> {
		match kind {
			...
			| CSS_VALUE_AT_RULE_GENERIC_VALUE => RawSyntaxNode::new(kind, children.into_iter().map(Some)),
			...
			CSS_AT_RULE => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_AT_RULE.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_ATTRIBUTE_MATCHER => {
				...
				if let Some(element) = &current_element {
					if matches!(element.kind(), T ! [~=] | T ! [|=] | T ! [^=] | T!["$="] | T ! [*=] | T ! [=]) {
						slots.mark_present();
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_ATTRIBUTE_MATCHER.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_ATTRIBUTE_MATCHER_VALUE => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_ATTRIBUTE_MATCHER_VALUE.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_ATTRIBUTE_NAME => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_ATTRIBUTE_NAME.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_ATTRIBUTE_SELECTOR => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_ATTRIBUTE_SELECTOR.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_BINARY_EXPRESSION => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_BINARY_EXPRESSION.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_BRACKETED_VALUE => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_BRACKETED_VALUE.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_CHARSET_AT_RULE => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_CHARSET_AT_RULE.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_CLASS_SELECTOR => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_CLASS_SELECTOR.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_COLOR => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_COLOR.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_COLOR_PROFILE_AT_RULE => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_COLOR_PROFILE_AT_RULE.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_COMPLEX_SELECTOR => {
				...
				if let Some(element) = &current_element {
					if matches!(element.kind(), T ! [>] | T ! [+] | T ! [~] | T ! [||] | CSS_SPACE_LITERAL) {
						slots.mark_present();
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_COMPLEX_SELECTOR.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_COMPOSES_PROPERTY => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_COMPOSES_PROPERTY.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_COMPOSES_PROPERTY_VALUE => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_COMPOSES_PROPERTY_VALUE.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_COMPOUND_SELECTOR => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_COMPOUND_SELECTOR.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_CONTAINER_AND_QUERY => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_CONTAINER_AND_QUERY.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_CONTAINER_AT_RULE => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_CONTAINER_AT_RULE.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_CONTAINER_NOT_QUERY => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_CONTAINER_NOT_QUERY.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_CONTAINER_OR_QUERY => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_CONTAINER_OR_QUERY.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_CONTAINER_STYLE_OR_QUERY => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_CONTAINER_STYLE_OR_QUERY.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_COUNTER_STYLE_AT_RULE => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_COUNTER_STYLE_AT_RULE.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_CUSTOM_IDENTIFIER => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_CUSTOM_IDENTIFIER.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_DASHED_IDENTIFIER => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_DASHED_IDENTIFIER.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_DECLARATION => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_DECLARATION.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_DECLARATION_BLOCK => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_DECLARATION_BLOCK.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_DECLARATION_IMPORTANT => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_DECLARATION_IMPORTANT.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_DOCUMENT_AT_RULE => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_DOCUMENT_AT_RULE.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_DOCUMENT_CUSTOM_MATCHER => {
				...
				if let Some(element) = &current_element {
					if matches!(element.kind(), T![url_prefix] | T![domain] | T![media_document] | T![regexp]) {
						slots.mark_present();
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_DOCUMENT_CUSTOM_MATCHER.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_EMPTY_DECLARATION => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_EMPTY_DECLARATION.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_FONT_FACE_AT_RULE => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_FONT_FACE_AT_RULE.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_FONT_FAMILY_NAME => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_FONT_FAMILY_NAME.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_FONT_FEATURE_VALUES_ITEM => {
				...
				if let Some(element) = &current_element {
					if matches!(
						...
						T![stylistic]
							| T![historical_forms]
							| T![styleset] | T![character_variant]
							| T![swash] | T![ornaments]
							| T![annotation]
					) {
						slots.mark_present();
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_FONT_FEATURE_VALUES_ITEM.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_FUNCTION => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_FUNCTION.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_GENERIC_DELIMITER => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_GENERIC_DELIMITER.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_GENERIC_PROPERTY => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_GENERIC_PROPERTY.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_ID_SELECTOR => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_ID_SELECTOR.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_IDENTIFIER => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_IDENTIFIER.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_IMPORT_ANONYMOUS_LAYER => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_IMPORT_ANONYMOUS_LAYER.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_IMPORT_AT_RULE => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_IMPORT_AT_RULE.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_IMPORT_NAMED_LAYER => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_IMPORT_NAMED_LAYER.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_IMPORT_SUPPORTS => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_IMPORT_SUPPORTS.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_KEYFRAMES_AT_RULE => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_KEYFRAMES_AT_RULE.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_KEYFRAMES_BLOCK => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_KEYFRAMES_BLOCK.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_KEYFRAMES_IDENT_SELECTOR => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_KEYFRAMES_IDENT_SELECTOR.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_KEYFRAMES_ITEM => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_KEYFRAMES_ITEM.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_KEYFRAMES_SCOPE_FUNCTION => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_KEYFRAMES_SCOPE_FUNCTION.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_KEYFRAMES_SCOPE_PREFIX => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_KEYFRAMES_SCOPE_PREFIX.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_KEYFRAMES_SCOPED_NAME => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_KEYFRAMES_SCOPED_NAME.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_LAYER_AT_RULE => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_LAYER_AT_RULE.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_LAYER_DECLARATION => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_LAYER_DECLARATION.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_LAYER_REFERENCE => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_LAYER_REFERENCE.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_MARGIN_AT_RULE => {
				...
				if let Some(element) = &current_element {
					if matches!(
						element.kind(),
						T![top_left_corner]
							| T![top_left] | T![top_center]
							| T![top_right] | T![top_right_corner]
							| T![bottom_left_corner]
							| T![bottom_left] | T![bottom_center]
							| T![bottom_right] | T![bottom_right_corner]
							| T![left_top] | T![left_middle]
							| T![left_bottom] | T![right_top]
							| T![right_middle] | T![right_bottom]
					) {
						slots.mark_present();
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_MARGIN_AT_RULE.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_MEDIA_AND_CONDITION => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_MEDIA_AND_CONDITION.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_MEDIA_AND_TYPE_QUERY => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_MEDIA_AND_TYPE_QUERY.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_MEDIA_AT_RULE => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_MEDIA_AT_RULE.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_MEDIA_CONDITION_QUERY => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_MEDIA_CONDITION_QUERY.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_MEDIA_FEATURE_IN_PARENS => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_MEDIA_FEATURE_IN_PARENS.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_MEDIA_NOT_CONDITION => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_MEDIA_NOT_CONDITION.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_MEDIA_OR_CONDITION => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_MEDIA_OR_CONDITION.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_MEDIA_TYPE => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_MEDIA_TYPE.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_MEDIA_TYPE_QUERY => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_MEDIA_TYPE_QUERY.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_METAVARIABLE => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_METAVARIABLE.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_NAMED_NAMESPACE_PREFIX => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_NAMED_NAMESPACE_PREFIX.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_NAMESPACE => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_NAMESPACE.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_NAMESPACE_AT_RULE => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_NAMESPACE_AT_RULE.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_NESTED_QUALIFIED_RULE => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_NESTED_QUALIFIED_RULE.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_NESTED_SELECTOR => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_NESTED_SELECTOR.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_NTH_OFFSET => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_NTH_OFFSET.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_NUMBER => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_NUMBER.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_PAGE_AT_RULE => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_PAGE_AT_RULE.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_PAGE_AT_RULE_BLOCK => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_PAGE_AT_RULE_BLOCK.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_PAGE_SELECTOR => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_PAGE_SELECTOR.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_PAGE_SELECTOR_PSEUDO => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_PAGE_SELECTOR_PSEUDO.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_PARAMETER => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_PARAMETER.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_PARENTHESIZED_EXPRESSION => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_PARENTHESIZED_EXPRESSION.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_PERCENTAGE => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_PERCENTAGE.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_PROPERTY_AT_RULE => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_PROPERTY_AT_RULE.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_PSEUDO_CLASS_FUNCTION_COMPOUND_SELECTOR_LIST => {
				...
				if let Some(element) = &current_element {
					if matches!(element.kind(), T![any] | T![past] | T![current] | T![future]) {
						slots.mark_present();
			...
			CSS_PSEUDO_CLASS_FUNCTION_NTH => {
				...
				if let Some(element) = &current_element {
					if matches!(
						element.kind(),
						T![nth_child]
							| T![nth_last_child] | T![nth_of_type]
							| T![nth_last_of_type]
							| T![nth_col] | T![nth_last_col]
					) {
						slots.mark_present();
			...
			CSS_PSEUDO_CLASS_IDENTIFIER => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_PSEUDO_CLASS_IDENTIFIER.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_PSEUDO_CLASS_NTH => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_PSEUDO_CLASS_NTH.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_PSEUDO_CLASS_NTH_NUMBER => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_PSEUDO_CLASS_NTH_NUMBER.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_PSEUDO_CLASS_SELECTOR => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_PSEUDO_CLASS_SELECTOR.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_PSEUDO_ELEMENT_SELECTOR => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_PSEUDO_ELEMENT_SELECTOR.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_QUALIFIED_RULE => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_QUALIFIED_RULE.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_QUERY_FEATURE_BOOLEAN => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_QUERY_FEATURE_BOOLEAN.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_QUERY_FEATURE_PLAIN => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_QUERY_FEATURE_PLAIN.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_QUERY_FEATURE_RANGE => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_QUERY_FEATURE_RANGE.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_QUERY_FEATURE_RANGE_COMPARISON => {
				...
				if let Some(element) = &current_element {
					if matches!(element.kind(), T ! [>] | T ! [<] | T ! [=] | T ! [>=] | T ! [<=]) {
						slots.mark_present();
			...
			CSS_RATIO => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_RATIO.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_REGULAR_DIMENSION => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_REGULAR_DIMENSION.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_RELATIVE_SELECTOR => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_RELATIVE_SELECTOR.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_RULE_BLOCK => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_RULE_BLOCK.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_SCOPE_AT_RULE => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_SCOPE_AT_RULE.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_SCOPE_EDGE => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_SCOPE_EDGE.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_SCOPE_RANGE_END => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_SCOPE_RANGE_END.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_SCOPE_RANGE_INTERVAL => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_SCOPE_RANGE_INTERVAL.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_SCOPE_RANGE_START => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_SCOPE_RANGE_START.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_STARTING_STYLE_AT_RULE => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_STARTING_STYLE_AT_RULE.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_STRING => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_STRING.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_SUPPORTS_AND_CONDITION => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_SUPPORTS_AND_CONDITION.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_SUPPORTS_AT_RULE => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_SUPPORTS_AT_RULE.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_SUPPORTS_NOT_CONDITION => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_SUPPORTS_NOT_CONDITION.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_SUPPORTS_OR_CONDITION => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_SUPPORTS_OR_CONDITION.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_TYPE_SELECTOR => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_TYPE_SELECTOR.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_UNICODE_CODEPOINT => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_UNICODE_CODEPOINT.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_UNICODE_RANGE => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_UNICODE_RANGE.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_UNICODE_RANGE_INTERVAL => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_UNICODE_RANGE_INTERVAL.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_UNICODE_RANGE_WILDCARD => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_UNICODE_RANGE_WILDCARD.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_UNIVERSAL_SELECTOR => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_UNIVERSAL_SELECTOR.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_UNKNOWN_BLOCK_AT_RULE => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_UNKNOWN_BLOCK_AT_RULE.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_UNKNOWN_DIMENSION => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_UNKNOWN_DIMENSION.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_UNKNOWN_VALUE_AT_RULE => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_UNKNOWN_VALUE_AT_RULE.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_URL_FUNCTION => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_URL_FUNCTION.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_URL_VALUE_RAW => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_URL_VALUE_RAW.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_VALUE_AT_RULE => {
				...
				if current_element.is_some() {
					return RawSyntaxNode::new(CSS_VALUE_AT_RULE.to_bogus(), children.into_iter().map(Some));
				}
			...
			CSS_BRACKETED_VALUE_LIST => Self::make_node_list_syntax(kind, children, AnyCssCustomIdentifier::can_cast),

			CSS_COMPONENT_VALUE_LIST => Self::make_node_list_syntax(kind, children, AnyCssValue::can_cast),

			CSS_COMPOSES_CLASS_LIST => Self::make_node_list_syntax(kind, children, CssCustomIdentifier::can_cast),

			CSS_COMPOUND_SELECTOR_LIST => {
				Self::make_separated_list_syntax(kind, children, AnyCssCompoundSelector::can_cast, T ! [,], false)
			},
			CSS_CUSTOM_IDENTIFIER_LIST => Self::make_node_list_syntax(kind, children, AnyCssCustomIdentifier::can_cast),

			CSS_DECLARATION_LIST => Self::make_node_list_syntax(kind, children, CssDeclarationWithSemicolon::can_cast),
			...
			CSS_DOCUMENT_MATCHER_LIST => {
				Self::make_separated_list_syntax(kind, children, AnyCssDocumentMatcher::can_cast, T ! [,], false)
			},
			CSS_FONT_FAMILY_NAME_LIST => {
				Self::make_separated_list_syntax(kind, children, AnyCssFontFamilyName::can_cast, T ! [,], false)
			},
			...
			CSS_KEYFRAMES_ITEM_LIST => Self::make_node_list_syntax(kind, children, AnyCssKeyframesItem::can_cast),

			CSS_KEYFRAMES_SELECTOR_LIST => {
				Self::make_separated_list_syntax(kind, children, AnyCssKeyframesSelector::can_cast, T ! [,], false)
			},
			CSS_LAYER_NAME_LIST => {
				Self::make_separated_list_syntax(kind, children, CssIdentifier::can_cast, T ! [.], false)
			},
			CSS_LAYER_REFERENCE_LIST => {
				Self::make_separated_list_syntax(kind, children, CssLayerNameList::can_cast, T ! [,], false)
			},
			CSS_MEDIA_QUERY_LIST => {
				Self::make_separated_list_syntax(kind, children, AnyCssMediaQuery::can_cast, T ! [,], false)
			},
			CSS_NESTED_SELECTOR_LIST => Self::make_node_list_syntax(kind, children, CssNestedSelector::can_cast),

			CSS_PAGE_AT_RULE_ITEM_LIST => Self::make_node_list_syntax(kind, children, AnyCssPageAtRuleItem::can_cast),

			CSS_PAGE_SELECTOR_LIST => {
				Self::make_separated_list_syntax(kind, children, AnyCssPageSelector::can_cast, T ! [,], false)
			},
			...
			CSS_PARAMETER_LIST => {
				Self::make_separated_list_syntax(kind, children, CssParameter::can_cast, T ! [,], true)
			},
			CSS_PSEUDO_VALUE_LIST => {
				Self::make_separated_list_syntax(kind, children, AnyCssPseudoValue::can_cast, T ! [,], false)
			},
			CSS_RELATIVE_SELECTOR_LIST => {
				Self::make_separated_list_syntax(kind, children, AnyCssRelativeSelector::can_cast, T ! [,], false)
			},
			CSS_RULE_LIST => Self::make_node_list_syntax(kind, children, AnyCssRule::can_cast),
			CSS_SELECTOR_LIST => {
				Self::make_separated_list_syntax(kind, children, AnyCssSelector::can_cast, T ! [,], false)
			},
			CSS_SUB_SELECTOR_LIST => Self::make_node_list_syntax(kind, children, AnyCssSubSelector::can_cast),

			CSS_URL_MODIFIER_LIST => Self::make_node_list_syntax(kind, children, AnyCssUrlModifier::can_cast),
			...
			CSS_VALUE_AT_RULE_PROPERTY_LIST => {
				Self::make_separated_list_syntax(kind, children, AnyCssValueAtRuleProperty::can_cast, T ! [,], false)
			},
