...
macro_rules! map_syntax_node {
	($node:expr, $pattern:pat => $body:expr) => {
		match $node {
			node => {
				match $crate::GraphqlSyntaxNode::kind(&node) {
					...
					$crate::GraphqlSyntaxKind::GRAPHQL_DIRECTIVE_LOCATION => {
						let $pattern =
							unsafe { $crate::GraphqlDirectiveLocation::new_unchecked(node) };
						$body
					},
					...
					$crate::GraphqlSyntaxKind::GRAPHQL_ENUM_TYPE_EXTENSION => {
						let $pattern =
							unsafe { $crate::GraphqlEnumTypeExtension::new_unchecked(node) };
						$body
					},
					...
					$crate::GraphqlSyntaxKind::GRAPHQL_FIELD_DEFINITION => {
						let $pattern =
							unsafe { $crate::GraphqlFieldDefinition::new_unchecked(node) };
						$body
					},
					$crate::GraphqlSyntaxKind::GRAPHQL_FIELDS_DEFINITION => {
						let $pattern =
							unsafe { $crate::GraphqlFieldsDefinition::new_unchecked(node) };
						$body
					},
					...
					$crate::GraphqlSyntaxKind::GRAPHQL_FRAGMENT_SPREAD => {
						let $pattern =
							unsafe { $crate::GraphqlFragmentSpread::new_unchecked(node) };
						$body
					},
					...
					$crate::GraphqlSyntaxKind::GRAPHQL_INLINE_FRAGMENT => {
						let $pattern =
							unsafe { $crate::GraphqlInlineFragment::new_unchecked(node) };
						$body
					},
					...
					$crate::GraphqlSyntaxKind::GRAPHQL_INPUT_OBJECT_TYPE_DEFINITION => {
						let $pattern = unsafe {
							$crate::GraphqlInputObjectTypeDefinition::new_unchecked(node)
						};
						$body
					},
					...
					$crate::GraphqlSyntaxKind::GRAPHQL_ROOT_OPERATION_TYPE_DEFINITION => {
						let $pattern = unsafe {
							$crate::GraphqlRootOperationTypeDefinition::new_unchecked(node)
						};
						$body
					},
					...
					$crate::GraphqlSyntaxKind::GRAPHQL_SCHEMA_DEFINITION => {
						let $pattern =
							unsafe { $crate::GraphqlSchemaDefinition::new_unchecked(node) };
						$body
					},
					$crate::GraphqlSyntaxKind::GRAPHQL_SCHEMA_EXTENSION => {
						let $pattern =
							unsafe { $crate::GraphqlSchemaExtension::new_unchecked(node) };
						$body
					},
					...
					$crate::GraphqlSyntaxKind::GRAPHQL_UNION_MEMBER_TYPES => {
						let $pattern =
							unsafe { $crate::GraphqlUnionMemberTypes::new_unchecked(node) };
						$body
					},
					...
					$crate::GraphqlSyntaxKind::GRAPHQL_VARIABLE_BINDING => {
						let $pattern =
							unsafe { $crate::GraphqlVariableBinding::new_unchecked(node) };
						$body
					},
					...
					$crate::GraphqlSyntaxKind::GRAPHQL_VARIABLE_REFERENCE => {
						let $pattern =
							unsafe { $crate::GraphqlVariableReference::new_unchecked(node) };
						$body
					},
					...
					$crate::GraphqlSyntaxKind::GRAPHQL_BOGUS_DEFINITION => {
						let $pattern =
							unsafe { $crate::GraphqlBogusDefinition::new_unchecked(node) };
						$body
					},
					$crate::GraphqlSyntaxKind::GRAPHQL_BOGUS_SELECTION => {
						let $pattern =
							unsafe { $crate::GraphqlBogusSelection::new_unchecked(node) };
						$body
					},
					...
					$crate::GraphqlSyntaxKind::GRAPHQL_DEFINITION_LIST => {
						let $pattern =
							unsafe { $crate::GraphqlDefinitionList::new_unchecked(node) };
						$body
					},
					...
					$crate::GraphqlSyntaxKind::GRAPHQL_INPUT_FIELD_LIST => {
						let $pattern =
							unsafe { $crate::GraphqlInputFieldList::new_unchecked(node) };
						$body
					},
