...
impl<'source> MarkdownParser<'source> {
	pub fn new(source:&'source str) -> Self {
		Self { context:ParserContext::default(), source:MarkdownTokenSource::from_str(source) }
	}
	...
	pub fn before_whitespace_count(&self) -> usize { self.source.before_whitespace_count() }
	...
	pub fn finish(self) -> (Vec<Event<MarkdownSyntaxKind>>, Vec<ParseDiagnostic>, Vec<Trivia>) {
