...
use biome_parser::{
	diagnostic::{merge_diagnostics, ParseDiagnostic},
	event::Event,
	prelude::*,
...
impl<'source> HtmlParser<'source> {
	pub fn new(source:&'source str) -> Self {
		Self { context:ParserContext::default(), source:HtmlTokenSource::from_str(source) }
	}

	pub fn finish(self) -> (Vec<Event<HtmlSyntaxKind>>, Vec<ParseDiagnostic>, Vec<Trivia>) {
