...
use crate::{
	...
	HtmlLanguage as Language,
	HtmlSyntaxElement as SyntaxElement,
	HtmlSyntaxElementChildren as SyntaxElementChildren,
	HtmlSyntaxKind::{self as SyntaxKind, *},
	HtmlSyntaxList as SyntaxList,
	HtmlSyntaxNode as SyntaxNode,
...
impl HtmlAttribute {
	...
	pub fn as_fields(&self) -> HtmlAttributeFields {
		HtmlAttributeFields { name:self.name(), initializer:self.initializer() }
	}

	pub fn name(&self) -> SyntaxResult<HtmlName> { support::required_node(&self.syntax, 0usize) }
...
impl HtmlAttributeInitializerClause {
	...
	pub fn as_fields(&self) -> HtmlAttributeInitializerClauseFields {
		HtmlAttributeInitializerClauseFields { eq_token:self.eq_token(), value:self.value() }
	}
	...
	pub fn value(&self) -> SyntaxResult<HtmlString> { support::required_node(&self.syntax, 1usize) }
}
...
impl HtmlClosingElement {
	...
	pub fn name(&self) -> SyntaxResult<HtmlName> { support::required_node(&self.syntax, 2usize) }
...
impl HtmlContent {
	...
	pub fn as_fields(&self) -> HtmlContentFields {
		HtmlContentFields { value_token:self.value_token() }
	}
...
impl HtmlDirective {
	...
	pub fn html_token(&self) -> Option<SyntaxToken> { support::token(&self.syntax, 3usize) }

	pub fn quirk_token(&self) -> Option<SyntaxToken> { support::token(&self.syntax, 4usize) }

	pub fn public_id_token(&self) -> Option<SyntaxToken> { support::token(&self.syntax, 5usize) }

	pub fn system_id_token(&self) -> Option<SyntaxToken> { support::token(&self.syntax, 6usize) }
...
impl HtmlElement {
	...
	pub fn children(&self) -> HtmlElementList { support::list(&self.syntax, 1usize) }
...
impl HtmlName {
	...
	pub fn as_fields(&self) -> HtmlNameFields { HtmlNameFields { value_token:self.value_token() } }
...
impl HtmlOpeningElement {
	...
	pub fn name(&self) -> SyntaxResult<HtmlName> { support::required_node(&self.syntax, 1usize) }

	pub fn attributes(&self) -> HtmlAttributeList { support::list(&self.syntax, 2usize) }
...
impl HtmlRoot {
	...
	pub fn directive(&self) -> Option<HtmlDirective> { support::node(&self.syntax, 1usize) }

	pub fn html(&self) -> HtmlElementList { support::list(&self.syntax, 2usize) }
...
impl HtmlSelfClosingElement {
	...
	pub fn slash_token(&self) -> Option<SyntaxToken> { support::token(&self.syntax, 3usize) }
...
impl HtmlString {
	...
	pub fn as_fields(&self) -> HtmlStringFields {
		HtmlStringFields { value_token:self.value_token() }
	}
...
impl AstNode for HtmlAttribute {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == HTML_ATTRIBUTE }
...
impl std::fmt::Debug for HtmlAttribute {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("HtmlAttribute")
			...
			.field("initializer", &support::DebugOptionalElement(self.initializer()))
			.finish()
	}
}
impl From<HtmlAttribute> for SyntaxNode {
	fn from(n:HtmlAttribute) -> SyntaxNode { n.syntax }
}
impl From<HtmlAttribute> for SyntaxElement {
	fn from(n:HtmlAttribute) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for HtmlAttributeInitializerClause {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == HTML_ATTRIBUTE_INITIALIZER_CLAUSE }
...
impl From<HtmlAttributeInitializerClause> for SyntaxNode {
	fn from(n:HtmlAttributeInitializerClause) -> SyntaxNode { n.syntax }
}
impl From<HtmlAttributeInitializerClause> for SyntaxElement {
	fn from(n:HtmlAttributeInitializerClause) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for HtmlClosingElement {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == HTML_CLOSING_ELEMENT }
...
impl From<HtmlClosingElement> for SyntaxNode {
	fn from(n:HtmlClosingElement) -> SyntaxNode { n.syntax }
}
impl From<HtmlClosingElement> for SyntaxElement {
	fn from(n:HtmlClosingElement) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for HtmlComment {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == HTML_COMMENT }
...
impl std::fmt::Debug for HtmlComment {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("HtmlComment")
			.field("comment_start_token", &support::DebugSyntaxResult(self.comment_start_token()))
			.field("content_token", &support::DebugSyntaxResult(self.content_token()))
			.field("comment_end_token", &support::DebugSyntaxResult(self.comment_end_token()))
			.finish()
	}
}
impl From<HtmlComment> for SyntaxNode {
	fn from(n:HtmlComment) -> SyntaxNode { n.syntax }
}
impl From<HtmlComment> for SyntaxElement {
	fn from(n:HtmlComment) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for HtmlContent {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == HTML_CONTENT }
...
impl From<HtmlContent> for SyntaxNode {
	fn from(n:HtmlContent) -> SyntaxNode { n.syntax }
}
impl From<HtmlContent> for SyntaxElement {
	fn from(n:HtmlContent) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for HtmlDirective {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == HTML_DIRECTIVE }
...
impl std::fmt::Debug for HtmlDirective {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("HtmlDirective")
			...
			.field("doctype_token", &support::DebugSyntaxResult(self.doctype_token()))
			.field("html_token", &support::DebugOptionalElement(self.html_token()))
			.field("quirk_token", &support::DebugOptionalElement(self.quirk_token()))
			.field("public_id_token", &support::DebugOptionalElement(self.public_id_token()))
			.field("system_id_token", &support::DebugOptionalElement(self.system_id_token()))
			.field("r_angle_token", &support::DebugSyntaxResult(self.r_angle_token()))
			.finish()
	}
}
impl From<HtmlDirective> for SyntaxNode {
	fn from(n:HtmlDirective) -> SyntaxNode { n.syntax }
}
impl From<HtmlDirective> for SyntaxElement {
	fn from(n:HtmlDirective) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for HtmlElement {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == HTML_ELEMENT }
...
impl std::fmt::Debug for HtmlElement {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("HtmlElement")
			...
			.field("closing_element", &support::DebugSyntaxResult(self.closing_element()))
			.finish()
	}
}
impl From<HtmlElement> for SyntaxNode {
	fn from(n:HtmlElement) -> SyntaxNode { n.syntax }
}
impl From<HtmlElement> for SyntaxElement {
	fn from(n:HtmlElement) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for HtmlName {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == HTML_NAME }
...
impl From<HtmlName> for SyntaxNode {
	fn from(n:HtmlName) -> SyntaxNode { n.syntax }
}
impl From<HtmlName> for SyntaxElement {
	fn from(n:HtmlName) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for HtmlOpeningElement {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == HTML_OPENING_ELEMENT }
...
impl From<HtmlOpeningElement> for SyntaxNode {
	fn from(n:HtmlOpeningElement) -> SyntaxNode { n.syntax }
}
impl From<HtmlOpeningElement> for SyntaxElement {
	fn from(n:HtmlOpeningElement) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for HtmlRoot {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == HTML_ROOT }
...
impl std::fmt::Debug for HtmlRoot {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("HtmlRoot")
			...
			.field("directive", &support::DebugOptionalElement(self.directive()))
...
impl From<HtmlRoot> for SyntaxNode {
	fn from(n:HtmlRoot) -> SyntaxNode { n.syntax }
}
impl From<HtmlRoot> for SyntaxElement {
	fn from(n:HtmlRoot) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for HtmlSelfClosingElement {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == HTML_SELF_CLOSING_ELEMENT }
...
impl std::fmt::Debug for HtmlSelfClosingElement {
	fn fmt(&self, f:&mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		f.debug_struct("HtmlSelfClosingElement")
			...
			.field("name", &support::DebugSyntaxResult(self.name()))
			.field("attributes", &self.attributes())
			.field("slash_token", &support::DebugOptionalElement(self.slash_token()))
			.field("r_angle_token", &support::DebugSyntaxResult(self.r_angle_token()))
			.finish()
	}
}
impl From<HtmlSelfClosingElement> for SyntaxNode {
	fn from(n:HtmlSelfClosingElement) -> SyntaxNode { n.syntax }
}
impl From<HtmlSelfClosingElement> for SyntaxElement {
	fn from(n:HtmlSelfClosingElement) -> SyntaxElement { n.syntax.into() }
}
impl AstNode for HtmlString {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == HTML_STRING }
...
impl From<HtmlString> for SyntaxNode {
	fn from(n:HtmlString) -> SyntaxNode { n.syntax }
}
impl From<HtmlString> for SyntaxElement {
	fn from(n:HtmlString) -> SyntaxElement { n.syntax.into() }
}
impl From<HtmlAttribute> for AnyHtmlAttribute {
	fn from(node:HtmlAttribute) -> AnyHtmlAttribute { AnyHtmlAttribute::HtmlAttribute(node) }
}
...
impl AstNode for AnyHtmlAttribute {
	...
	fn can_cast(kind:SyntaxKind) -> bool { matches!(kind, HTML_ATTRIBUTE | HTML_BOGUS_ATTRIBUTE) }
...
impl From<HtmlBogusElement> for AnyHtmlElement {
	fn from(node:HtmlBogusElement) -> AnyHtmlElement { AnyHtmlElement::HtmlBogusElement(node) }
}
impl From<HtmlComment> for AnyHtmlElement {
	fn from(node:HtmlComment) -> AnyHtmlElement { AnyHtmlElement::HtmlComment(node) }
}
impl From<HtmlContent> for AnyHtmlElement {
	fn from(node:HtmlContent) -> AnyHtmlElement { AnyHtmlElement::HtmlContent(node) }
}
impl From<HtmlElement> for AnyHtmlElement {
	fn from(node:HtmlElement) -> AnyHtmlElement { AnyHtmlElement::HtmlElement(node) }
}
...
impl AstNode for HtmlBogus {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == HTML_BOGUS }
...
impl From<HtmlBogus> for SyntaxNode {
	fn from(n:HtmlBogus) -> SyntaxNode { n.syntax }
}
impl From<HtmlBogus> for SyntaxElement {
	fn from(n:HtmlBogus) -> SyntaxElement { n.syntax.into() }
}
#[derive(Clone, PartialEq, Eq, Hash, Serialize)]
...
impl AstNode for HtmlBogusAttribute {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == HTML_BOGUS_ATTRIBUTE }
...
impl From<HtmlBogusAttribute> for SyntaxNode {
	fn from(n:HtmlBogusAttribute) -> SyntaxNode { n.syntax }
}
impl From<HtmlBogusAttribute> for SyntaxElement {
	fn from(n:HtmlBogusAttribute) -> SyntaxElement { n.syntax.into() }
}
#[derive(Clone, PartialEq, Eq, Hash, Serialize)]
...
impl AstNode for HtmlBogusElement {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == HTML_BOGUS_ELEMENT }
...
impl From<HtmlBogusElement> for SyntaxNode {
	fn from(n:HtmlBogusElement) -> SyntaxNode { n.syntax }
}
impl From<HtmlBogusElement> for SyntaxElement {
	fn from(n:HtmlBogusElement) -> SyntaxElement { n.syntax.into() }
}
...
impl AstNode for HtmlAttributeList {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == HTML_ATTRIBUTE_LIST }

	fn cast(syntax:SyntaxNode) -> Option<HtmlAttributeList> {
		if Self::can_cast(syntax.kind()) {
			Some(HtmlAttributeList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
...
impl AstNode for HtmlElementList {
	...
	fn can_cast(kind:SyntaxKind) -> bool { kind == HTML_ELEMENT_LIST }

	fn cast(syntax:SyntaxNode) -> Option<HtmlElementList> {
		if Self::can_cast(syntax.kind()) {
			Some(HtmlElementList { syntax_list:syntax.into_list() })
		} else {
			None
		}
	}
