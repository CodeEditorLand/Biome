...
use xtask_bench::{bench_formatter_group, criterion_group, criterion_main, Criterion, TestCase};
...
fn bench_graphql_formatter(criterion:&mut Criterion) {
...
criterion_group!(graphql_formatter, bench_graphql_formatter);
